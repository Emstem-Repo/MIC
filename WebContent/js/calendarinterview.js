...
function f_tcalShow (d_date) {
	...
	if (!this.e_input || !this.e_input.tagName || this.e_input.tagName != 'TEXTAREA')
...
function f_tcalHide (n_date) {
	if (n_date){
	    temp = this.e_input.value;
	    
		this.e_input.value = this.f_generDate(new Date(n_date))+","+temp;
