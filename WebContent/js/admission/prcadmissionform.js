...
//Detail Mark Entry JS
 ...
 function submitCancelButton(){
 	document.location.href="presidanceadmissionFormSubmit.do?method=forwardEducationAdmissionForm";
 }
 function submitApplicationCancelButton(){
	 	document.location.href="presidanceadmissionFormSubmit.do?method=cancelApplication";
	 }
 function submitEditResetButton(){
	 	document.location.href="presidanceadmissionFormSubmit.do?method=getApplicantDetailsForEdit";
	 }
  function submitEditCancelButton(){
	 	document.location.href="presidanceadmissionFormSubmit.do?method=initApplicationEdit";
	 }
  function submitApproveCancelButton(){
	 	document.location.href="presidanceadmissionFormSubmit.do?method=initAdmissionApproval";
	 }
  function submitModifyCancelButton(){
	 	document.location.href="presidanceadmissionFormSubmit.do?method=initApplicationModify";
	 }
 function submitEditDetailCancelButton(){
	 	document.location.href="presidanceadmissionFormSubmit.do?method=forwardEditApplicationPage";
	 }
 function submitModifyDetailCancelButton(){
	 	document.location.href="presidanceadmissionFormSubmit.do?method=forwardModifyApplicationPage";
	 }
 
 function submitConfirmCancelButton(){
	 	document.location.href="presidanceadmissionFormSubmit.do?method=forwardConfirmPage";
	 }
	...
	function calctotalMarkWithoutLan(count)
	 {
	  ...
	  function submitModifyCancelButtonForPUC(){
		 	document.location.href="presidanceadmissionFormSubmit.do?method=initApplicationModify&PUCEdit=true";
		 }
	  ...
	  function submitAdmission(){
		  document.location.href = "SinglePageServlet?presidance=true";
	  }
	  function submitEditButton(){
		 	document.location.href="presidanceadmissionFormSubmit.do?method=initApplicationModify";
		 }
	  function submitModifyButton(){
		 	document.location.href="presidanceadmissionFormSubmit.do?method=initApplicationEdit";
		 }