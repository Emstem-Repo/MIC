...
function submitExcel(){
	document.getElementById("method").value ="uploadEmpSmartCardNumber";
	document.employeeSmartCardUploadForm.submit();
}
...
<html:form action="/empSmartCardNoUpload" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="uploadEmpSmartCardNumber" />
	<html:hidden property="formName" value="employeeSmartCardUploadForm" />
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt; Smart Card No Upload &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> Smart Card No Upload</strong></div></td>
								...
								<tr>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										...
										<td height="25" class="row-odd" width="25%">
											...
											<html:file property="theFile" styleId="thefile" size="15" maxlength="30" name="employeeSmartCardUploadForm"/></label></td>
										</tr>
									</table>
									</td>
