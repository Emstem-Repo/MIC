                ...
                <td height="35" valign="top" class="body" ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                            ...
                            <td width="3%" class="row-even" align="center"><img src="images/View_icon.gif"
										...
										onclick="getDetailForEdit('<nested:write property="id"/>','loadEmployeeGenInfo')"></td>
              ...
              <tr>
                <td height="10" class="body" ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <html:submit styleClass="formbutton" property=""  onclick="cancelMe('InitEmpIdGen')" >Close</html:submit>
                      </div>
					  </td>
                      <td width="52%"></td>
                    </tr>
