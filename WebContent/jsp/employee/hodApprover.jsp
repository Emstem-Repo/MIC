...
function saveHodDetails(){
	document.getElementById("method").value="saveHodDetails";
}
...
<html:form action="/hodApprover">
	<html:hidden property="method" styleId="method" value="getHodDetails"/>
	<html:hidden property="formName" value="hodApproverForm" />
											        ...
											        <td height="25" class="row-even">
											        	<html:select property="departmentId" styleId="departmentId">
														  <html:option value=""><bean:message key="knowledgepro.select"/></html:option>
															<logic:notEmpty property="departmentMap" name="hodApproverForm">
							...
							<td>
									<div align="center">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
								          ...
								          <tr height="50"></tr>
							          	<logic:notEmpty property="employeeToList" name="hodApproverForm">
								          <tr>
								          	<td colspan="2">
								          		<table width="100%" border="0" cellspacing="0" cellpadding="0">
								          				 <tr>
																...
																<tr>
																	...
																	<table width="100%" cellspacing="1" cellpadding="2">
																		<tr>
																			...
																			<td class="row-odd">
																			<div align="center">Hod Details</div>
																			</td>
																		</tr>
																		
																			
																			<nested:iterate id="to" property="employeeToList" name="hodApproverForm" indexId="count">
																				<c:choose>
								          ...
								          <tr height="50"></tr>
								          <tr>
								          	<td height="25" class="row-odd" width="25%"><div align="right">Hod Approver:</div></td>
											 <td height="25" class="row-even">
								          ...
								          <tr>
											<td height="35" align="right">
												<html:submit  value="Submit" styleClass="formbutton"  property="" onclick="saveHodDetails()"></html:submit>
											</td>
								          </tr>
								          </logic:notEmpty>
										</table>
