...
function add() {
	document.location.href = "GuestFaculty.do?method=initEmployeeInfo";
...
<html:hidden property="method" value="getSearchedGuest" styleId="method"/>
<html:hidden property="pageType" value="13"/>
<html:hidden property="formName" value="GuestFacultyInfoForm"/>
	<table width="100%" border="0">
  <tr>
    <td><span class="Bredcrumbs"><bean:message key="knowledgepro.employee"/><span class="Bredcrumbs">&gt;&gt;<bean:message key="knowledgepro.guest.faculty" /> &gt;&gt;</span></span></td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" >
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td width="954" background="images/Tcenter.gif" class="body" ><strong class="boxheader"><bean:message key="knowledgepro.guest.faculty" /></strong></td>
            ...
            <tr>
              ...
              <td valign="top"><table width="100%" height="30" border="0" cellpadding="0" cellspacing="1">
                  <tr class="row-white">
                    ...
                    <td width="161" height="25" class="row-odd"><div align="right"><bean:message key="knowledgepro.admin.name"/>:</div></td>
                    <td width="164" class="row-even"><html:text property="tempName" styleId="tempName" name="GuestFacultyInfoForm"/></td>
                ...
                <td height="25" class="row-even" >
                 <html:select property="tempStreamId" styleId="tempStreamId" onchange="searchStreamWise(this.value)">
					  <html:option value=""><bean:message key="knowledgepro.select"/></html:option>
						<logic:notEmpty property="tempStreamMap" name="GuestFacultyInfoForm">
              ...
              <tr>
             	<td width="161" height="25" class="row-odd"><div align="right"><bean:message key="knowledgepro.employee.Department"/>:</div></td>
                    <td width="164" class="row-even">
                    <html:select property="tempDepartmentId" styleId="tempDepartmentId">
					  <html:option value=""><bean:message key="knowledgepro.select"/></html:option>
						<logic:notEmpty property="tempDepartmentMap" name="GuestFacultyInfoForm">
						<html:optionsCollection property="tempDepartmentMap" label="value" value="key"/>
					 </logic:notEmpty>
				    </html:select>
				   </td>
                   
                <td width="161" height="25" class="row-odd"><div align="right"><bean:message key="knowledgepro.employee.designation"/>:</div></td>
                 <td width="164" class="row-even"><html:select property="tempDesignationPfId" styleId="tempDesignationPfId">
				   	<html:option value=""><bean:message key="knowledgepro.select"/></html:option>
						<logic:notEmpty property="tempDesignationMap" name="GuestFacultyInfoForm">
      ...
      <tr>
        ...
        <td valign="top" class="news"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
           ...
           <!--   <html:button property="" styleClass="formbutton" value="Add New" onclick="add()"></html:button>-->
               <html:submit property="" styleClass="formbutton" value="Submit" onclick="edit()"></html:submit>
