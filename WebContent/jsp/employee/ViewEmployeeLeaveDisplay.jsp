...
<script type="text/javascript">
 ...
 {
	 document.location.href = "viewEmployeeLeave.do?method=initViewEmployeeLeave";
 }
 function closeAction1()
 {
	 document.location.href = "viewEmployeeLeave.do?method=initViewMyLeave";
 }
</script>
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <table width="100%" cellspacing="1" cellpadding="2">
              ...
              <nested:iterate property="listOfEmployeeLeave" indexId="count" >
				...
				<td align="center" class="bodytext"><nested:write property="status" /></td>
              </tr>
			</nested:iterate>
      	...
      	<c:choose>
      		<c:when test="${ViewEmployeeLeaveForm.temp}">
      			<td colspan="3" height="35" align="center">
      				<html:button property="" value="Close" styleClass="formbutton" onclick="closeAction()"></html:button>
      			</td>
      		</c:when>
      		<c:otherwise>
      			<td colspan="3" height="35" align="center">
      				<html:button property="" value="Close" styleClass="formbutton" onclick="closeAction1()"></html:button>
      			</td>
      		</c:otherwise>
