...
<html:hidden property="method" value="searchEmployeeReport" styleId="method"/>
<html:hidden property="formName" value="employeeReportForm"/>
	<table width="100%" border="0">
  <tr>
    <td><span class="Bredcrumbs"><bean:message key="knowledgepro.employee"/><span class="Bredcrumbs">&gt;&gt;<bean:message key="knowledgepro.employee.employeeReport" /> &gt;&gt;</span></span></td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" >
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td width="954" background="images/Tcenter.gif" class="body" ><strong class="boxheader"><bean:message key="knowledgepro.employee.employeeReport" /></strong></td>
            ...
            <tr>
                ...
                <td height="25%" class="row-even" >
                 <html:select property="streamDetails" styleId="streamDetailsId" onchange="searchStreamWise(this.value)">
					  <html:option value=""><bean:message key="knowledgepro.select"/></html:option>
						<logic:notEmpty property="streamMap" name="employeeReportForm">
             ...
             <td width="15%" height="25" class="row-odd"><div align="right"><bean:message key="knowledgepro.employee.Department"/>:</div></td>
                    ...
                    <html:select property="department" styleId="departmentId">
					  <html:option value=""><bean:message key="knowledgepro.select"/></html:option>
						<logic:notEmpty property="departmentMap" name="employeeReportForm">
              ...
              <tr>
                <td width="15%" height="25" class="row-odd"><div align="right"><bean:message key="knowledgepro.employee.designation"/>:</div></td>
                 <td width="25%" class="row-even"><html:select property="designation" styleId="designationId">
				   	<html:option value=""><bean:message key="knowledgepro.select"/></html:option>
						<logic:notEmpty property="designationMap" name="employeeReportForm">
                ...
                <td width="30%"class="row-even">
                	<html:select property="workLocation" styleId="workLocationId">
				   	<html:option value=""><bean:message key="knowledgepro.select"/></html:option>
						<logic:notEmpty property="workLocationMap" name="employeeReportForm">
             ...
             <tr>
									...
									<html:radio property="teachingStaff" value="2"/>All
									</td>
