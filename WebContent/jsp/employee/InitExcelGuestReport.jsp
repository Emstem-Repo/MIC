...
<html:form action="/guestfacultyExcelReport" method="POST">
...
<table width="100%" border="0">
  <tr>
    ...
    <bean:message key="knowledgepro.reports"/><span class="Bredcrumbs">&gt;&gt; 
     Guest Faculty Excel Report&gt;&gt;</span></span></td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><strong class="boxheader">Guest Faculty Excel Report</strong></td>
                  ...
                  <tr>
                   ...
                   <tr> 
                    ...
                    <td width="50%">
						...
						<html:option value="Teaching" styleClass="comboBig"></html:option>
						...
						<html:option value="Stream" styleClass="comboBig"></html:option>
						<html:option value="Work Location" styleClass="comboBig"></html:option>
						<html:option value="Title" styleClass="comboBig"></html:option>
						<html:option value="Reffered By" styleClass="comboBig"></html:option>
						<html:option value="Working Hours Per Week" styleClass="comboBig"></html:option>
						<html:option value="Subject/Specialization" styleClass="comboBig"></html:option>
						<html:option value="Honorarium" styleClass="comboBig"></html:option>
						...
						<html:option value="Eligibility Test" styleClass="comboBig"></html:option>
						...
						<html:option value="Additional Job Information" styleClass="comboBig"></html:option>
						</html:select>
					</td>
                	<td width="15%">	
					...
					<td width="50%">
						...
						<html:option value="Staff Id" styleClass="comboBig"></html:option>
