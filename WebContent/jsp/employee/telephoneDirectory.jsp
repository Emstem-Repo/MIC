...
<script type="text/javascript">
	function cancelAction() {
		document.location.href ="telephoneDictonary.do?method=initTelephoneDirectory";
	}
	function winOpen() {
...
<html:form action="/telephoneDictonary">
	          ...
	          <tr>
	            ...
	            <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
	              ...
	              <tr>
	                ...
	                <td height="20" class="row-odd" align="center">Email</td>
	                 <td height="10" class="row-odd" align="center">Mobile</td>
					 <td height="10" class="row-odd" align="center">Extension Number</td>
					 <!--<td height="20" class="row-odd" align="center">Photo</td>
	              --></tr>
				...
				<tr>
						<c:choose>
			                ...
			                <td width="10%" align="center"><bean:write name = "id" property="mobile"/></td>
