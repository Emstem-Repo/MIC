	...
	<tr>
      ...
      <tr>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td width="5"  background="images/left.gif"></td>
                      <td height="64" valign="top"><table width="100%" height="65" border="0" cellpadding="0" cellspacing="1">
                        <logic:notEmpty property="employeeDetail.languages" name="employeeInfoForm">          
						<nested:iterate property="employeeDetail.languages" name="employeeInfoForm" id="language" indexId="count"> 
						 <tr class="row-even">
                            <td width="225" height="29" class="row-odd"><div align="right"><bean:message key="employee.info.language.title"/> </div></td>
                            <td width="225" height="29" class="row-even">
							<logic:equal value="true" name="employeeInfoForm" property="adminUser">
							<nested:select property="name" styleClass="combo" >
								<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
                              <logic:notEmpty property="languages" name="employeeInfoForm"> 
								<html:optionsCollection property="languages" name="employeeInfoForm" label="languageName" value="languageName"/>
                              </logic:notEmpty>
                            </nested:select>
							</logic:equal>
                            ...
                            <td width="225" height="33" class="row-odd"><div align="right"><bean:message key="employee.info.language.fluency"/> </div></td>
                            <td width="225" height="33" class="row-even">
							<logic:equal value="true" name="employeeInfoForm" property="adminUser">
							<nested:select property="fluency" styleClass="combo" >
								<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
                      ...
                      <td  background="images/right.gif" width="5" height="64"></td>
              </tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                <tr class="row-even">
                            ...
                            <td  class="row-even"><html:button property="" styleClass="formbutton" value="Add more" onclick="submitEmployeeInfoAdd('resetLanguageInfo','LAddMore')"/>
							</td>
                          </tr>
            </table>
            </td>
	 ...
	 <logic:equal value="true" name="employeeInfoForm" property="adminUser">
      <tr>
        ...
        <td valign="top" class="news"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
            <td height="35"><div align="right"><html:button property="" styleClass="formbutton" value="Save" onclick="submitEmployeeInfo('saveEmployeeLanguageInfo')"/></div></td>
            <td width="10"><html:button property="" styleClass="formbutton" value="Reset" onclick="submitEmployeeInfo('resetLanguageValues')"/></td>
