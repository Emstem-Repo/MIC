...
<html:hidden property="formName" value="EmpResPubDetailsForm"/>
  ...
  <tr>
    <td><span class="Bredcrumbs"><bean:message key="knowledgepro.employee"/><span class="Bredcrumbs">&gt;&gt;Edit Research and Publication &gt;&gt;</span></span></td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" >
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td width="954" background="images/Tcenter.gif" class="body" ><strong class="boxheader">Edit Research and Publication</strong></td>
            ...
            <tr>
                ...
                <td width="20%" height="25" class="row-even" >
                 <html:select property="tempStreamId" styleId="tempStreamId" onchange="searchStreamWise(this.value)">
					  <html:option value=""><bean:message key="knowledgepro.select"/></html:option>
						<logic:notEmpty property="tempStreamMap" name="EmpResPubDetailsForm">
             ...
             <td width="15%" height="25" class="row-odd"><div align="right"><bean:message key="knowledgepro.employee.Department"/>:</div></td>
                    ...
                    <html:select property="tempDepartmentId" styleId="tempDepartmentId">
					  <html:option value=""><bean:message key="knowledgepro.select"/></html:option>
						<logic:notEmpty property="tempDepartmentMap" name="EmpResPubDetailsForm">
              ...
              <tr>
                <td width="15%" height="25" class="row-odd"><div align="right"><bean:message key="knowledgepro.employee.designation"/>:</div></td>
                 <td width="20%" class="row-even"><html:select property="tempDesignationPfId" styleId="tempDesignationPfId">
				   	<html:option value=""><bean:message key="knowledgepro.select"/></html:option>
						<logic:notEmpty property="tempDesignationMap" name="EmpResPubDetailsForm">
                ...
                <td width="30%" class="row-even">
                 <html:select property="tempEmptypeId" styleId="tempEmptypeId">
					  <html:option value=""><bean:message key="knowledgepro.select"/></html:option>
						<logic:notEmpty property="tempEmpTypeMap" name="EmpResPubDetailsForm">
					  ...
					  <td class="row-odd" width="15%">
								  ...
								  <tr>
								  	<td width="15%" height="25" class="row-odd">
								  	 <div align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.employee.isEmployee"/> </div></td>
               						 <td width="30%" class="row-even" colspan="2">
                					 <html:radio property="isEmployee" value="true"/>Employee&nbsp; 
					 					<html:radio property="isEmployee" value="false"/>Guest
               						 </td>	
								  </tr>
              </table></td>
