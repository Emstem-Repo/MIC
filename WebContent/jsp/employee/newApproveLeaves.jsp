					...
					<div align="right"><a href="#" onclick="viewReturnedRequestDocForApproval()"> View Returned/Request Documents</a></div></td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<td height="35" align="left">
								...
								&nbsp;&nbsp;&nbsp;<html:button  value="Clarify/Meet" styleClass="formbutton" property="" onclick="displayReason(this)"></html:button>
								&nbsp;&nbsp;&nbsp;<html:button styleId="" value="Cancel" styleClass="formbutton" onclick="loginPage()" property=""></html:button>
							</td>
				          </tr>
				          <tr height="50"></tr>
				          <tr>
