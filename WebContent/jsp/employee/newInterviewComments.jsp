...
<html:hidden property="method" styleId="method" value="searchDetails" />
	...
	<div id="errorMessage"><FONT color="red"><html:errors /></FONT>
        ...
        <td valign="top" class="news"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
              <tr >
                <td width="28%" height="25" class="row-odd"><div align="right" ><span class="Mandatory"></span>Name:</div></td>
                <td width="22%" class="row-even"><span class="star">
                 <input type="text" name="name"/>
                </span></td>
                <td width="18%" height="25" class="row-odd"><div align="right" >Application No: </div></td>
                <td width="32%" class="row-even"><span class="star">
                 <input type="text" name="applicationNo" onkeypress="return isNumberKey(event)"/>
                </span></td>
              </tr>
            </table></td>
      ...
      <tr>
        ...
        <td valign="top" class="news"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="49%" height="35" align="center"><input name="Submit" type="Submit" class="formbutton" value="Search" onclick="getDetails()" /></td>
          </tr>
        </table> </td>
        <td valign="top" background="images/Tright_3_3.gif" class="news"></td>
      </tr>
