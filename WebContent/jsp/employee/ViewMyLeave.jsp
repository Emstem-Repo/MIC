...
function getEmployeeLeavDetails(){
	...
	document.location.href = "viewEmployeeLeave.do?method=ViewMyLeaveDetails&academicYear="+year;
...
<table width="100%" border="0">
  <tr>
    <td><span class="heading">View My  Leave</span></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><strong class="boxheader">View My  Leave</strong></td>
          ...
          <tr>
            ...
            <table width="100%" cellspacing="1" cellpadding="2">
              <tr>
                ...
                <td width="20%" class="row-even"><div align="right">&nbsp;&nbsp;<img src="images/view_o.gif" border="0" onclick="getEmployeeLeavDetails()" style="cursor: pointer"/></div></td>
