    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      ...
                      <tr >
                            <td width="212" height="20" class="row-odd"><div align="right"><span class="Mandatory">*</span><bean:message key="employee.info.emergCont.name"/> </div></td>
                            <td width="236" height="20" class="row-even"><nested:text property="employeeDetail.emergencyContName" styleClass="TextBox" size="20" maxlength="100"></nested:text></td>
                            <td width="224" class="row-odd"><div align="right"><span class="Mandatory">*</span><bean:message key="employee.info.emergCont.reln"/> </div></td>
                            <td width="244" class="row-even"><nested:text property="employeeDetail.relationship" styleClass="TextBox" size="20" maxlength="50"></nested:text></td>
                        </tr>
                        
                          <tr >
                            <td width="212" height="20" class="row-odd"><div align="right"><bean:message key="employee.info.contact.hometele"/> </div></td>
                            <td width="236" height="20" class="row-even">
                            <logic:equal value="true" name="employeeInfoForm" property="adminUser">
                            <nested:text property="employeeDetail.emergencyHomeTelephone1" styleClass="TextBox" size="3" maxlength="3"></nested:text>&nbsp;
							<nested:text property="employeeDetail.emergencyHomeTelephone2" styleClass="TextBox" size="3" maxlength="3"></nested:text>&nbsp;
                            <nested:text property="employeeDetail.emergencyHomeTelephone" styleClass="TextBox" size="20" maxlength="12"></nested:text>
                            </logic:equal>
							<logic:equal value="false" name="employeeInfoForm" property="adminUser">
							<nested:text property="employeeDetail.emergencyHomeTelephone1"></nested:text>&nbsp;
							<nested:text property="employeeDetail.emergencyHomeTelephone2"></nested:text>&nbsp;
                            <nested:text property="employeeDetail.emergencyHomeTelephone"></nested:text>
                            </logic:equal>
                            </td>
                            <td width="224" class="row-odd"><div align="right"><bean:message key="employee.info.contact.mobile"/> </div></td>
                            <td width="244" class="row-even">
                            <logic:equal value="true" name="employeeInfoForm" property="adminUser">
                            <nested:text property="employeeDetail.emergencyMobile1" styleClass="TextBox" size="3" maxlength="3"></nested:text>&nbsp;
							<nested:text property="employeeDetail.emergencyMobile2" styleClass="TextBox" size="3" maxlength="3"></nested:text>&nbsp;
                            <nested:text property="employeeDetail.emergencyMobile" styleClass="TextBox" size="20" maxlength="10"></nested:text>
                            </logic:equal>
							<logic:equal value="false" name="employeeInfoForm" property="adminUser">
							<nested:text property="employeeDetail.emergencyMobile1" ></nested:text>&nbsp;
							<nested:text property="employeeDetail.emergencyMobile2" ></nested:text>&nbsp;
                            <nested:text property="employeeDetail.emergencyMobile" ></nested:text>
                            </logic:equal>
                            </td>
                          </tr>
                          <tr class="row-even">
                            ...
                            <logic:equal value="true" name="employeeInfoForm" property="adminUser">
                            <nested:text property="employeeDetail.emergencyWorkTelephone1" styleClass="TextBox" size="3" maxlength="3"></nested:text>&nbsp;
							<nested:text property="employeeDetail.emergencyWorkTelephone2" styleClass="TextBox" size="3" maxlength="3"></nested:text>&nbsp;
                            <nested:text property="employeeDetail.emergencyWorkTelephone" styleClass="TextBox" size="20" maxlength="12"></nested:text>
                            </logic:equal>
							<logic:equal value="false" name="employeeInfoForm" property="adminUser">
							<nested:text property="employeeDetail.emergencyWorkTelephone1" ></nested:text>&nbsp;
							<nested:text property="employeeDetail.emergencyWorkTelephone2" ></nested:text>&nbsp;
                            <nested:text property="employeeDetail.emergencyWorkTelephone" ></nested:text>
                            </logic:equal>
                            </td>
                          </tr>
      ...
      <tr>
        ...
        <td valign="top" class="news"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="35"><div align="right"><html:button property="" styleClass="formbutton" value="Save"  onclick="submitEmployeeInfo('saveEmployeeEmergencyInfo')"/></div></td>
	            <td width="10"><html:button property="" styleClass="formbutton" value="Reset" onclick="submitEmployeeInfo('resetEmergContInfo')"/></td>
