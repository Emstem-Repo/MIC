...
function cancel(){
	document.location.href = "employeeOnlineLeave.do?method=viewReturnedRequestDocForApproval";
}
...
function returnEmployeeLeave(){
	document.getElementById("method").value="returnEmployeeLeaveReturned";
	document.employeeOnlineLeaveForm.submit();
}
function clarifyEmployeeLeave(){
	document.getElementById("method").value="requestDocApproval";
	document.employeeOnlineLeaveForm.submit();
}
...
function viewEmployeeLeaves(employeeId,empTypeId){
	document.location.href = "employeeOnlineLeave.do?method=viewReturnedReqPendingApproval&empId="+employeeId+"&empTypeId="+empTypeId;
}
function loginPage(){
...
<html:form action="/employeeOnlineLeave">
	<html:hidden property="method" styleId="method" value="approveEmployeeLeaveReturned"/>
					...
					<td height="20" colspan="2">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<td height="35" align="left">
								...
								&nbsp;&nbsp;&nbsp;<html:button  value="Cancel" styleClass="formbutton" onclick="cancel()" property=""></html:button>
