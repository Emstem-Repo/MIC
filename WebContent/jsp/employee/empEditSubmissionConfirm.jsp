...
<script type="text/javascript">
	function cancel() {
		...
		//document.location.href ="EmployeeInfoEditDisplay.do?method=loadEmployeeInfo";
	}
</script>
<body>
<html:form action="/EmployeeInfoEditDisplay" method="POST">
  ...
  <tr>
    <td valign="top"><table width="98%" border="0" cellpadding="0" cellspacing="0" >
      <tr>
        ...
        <td width="100%" background="images/Tcenter.gif" class="body" ><strong class="boxheader"> <bean:message key="employee.Edit.submit.success" /></strong></td>
      ...
      <tr>
        ...
        <td height="20" valign="top" background="images/Tright_03_03.gif"></td>
        <td class="heading">
			<bean:message key="employee.Edit.submit.success" /><br>
