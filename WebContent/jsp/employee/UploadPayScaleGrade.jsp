...
<html:form action="/uploadPayScaleGrade" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="uploadPayScaleGrade" />
	<html:hidden property="formName" value="uploadPayScaleGradeForm" />
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt; <bean:message key="knowledgepro.employee.upload.payScaleGrade"/> &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> <bean:message key="knowledgepro.employee.upload.payScaleGrade"/></strong></div></td>
								...
								<tr>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										...
										<td height="25" class="row-odd" width="25%">
											...
											<html:file property="thefile" styleId="thefile" size="30" maxlength="30" name="uploadPayScaleGradeForm"/></label></td>
										</tr>
									</table>
									</td>
