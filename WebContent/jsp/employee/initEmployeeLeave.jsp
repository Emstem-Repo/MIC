...
function getLeaveTypeDetails(){
	...
	if((empId!=null && empId!='') && (stDate!=null && stDate!='') && (empTypeId!=null && empTypeId!='' && empTypeId!='0')){
		var url = "employeeApplyLeave.do?method=getDetails&employeeId="+empId+"&empTypeId="+empTypeId+"&startDate="+stDate;
		myRef = window
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								<tr>
									...
									<td class="row-even">
									<html:text name="employeeApplyLeaveForm" property="startDate" styleId="startDate" size="10" maxlength="16" onchange="checkDayDiff(),getLeaveTypeForEmployee(),getLeaveTaken()"/>
									<script
									language="JavaScript">
									new tcal( {
										// form name
								...
								<tr>
									...
									<td class="row-even"><a href="#" onclick="getLeaveTypeDetails()"> View Leaves</a> </td>
								</tr>
							</table>
							</td>
