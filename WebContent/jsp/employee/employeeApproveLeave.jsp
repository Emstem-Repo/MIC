...
<script type="text/javascript">
	function winOpen(employeeId) {
		...
		myRef = window
				.open(url, "viewAvailableLeaves",
						"left=20,top=20,width=800,height=400,toolbar=1,resizable=0,scrollbars=1");
	}
</script>
<html:form action="/EmployeeApproveLeave">
	<html:hidden property="method" styleId="method" value="updateStatus" />
	<html:hidden property="formName" value="employeeApproveLeaveForm" />
	<html:hidden property="pageType" value="1" />
	<table width="100%" border="0">
	  <tr>
	
	    <td><span class="heading"><bean:message key="knowledgepro.employee.approve.leave.request"/></span></td>
	  </tr>
	  <tr>
	    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
	      <tr>
	        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
	        <td background="images/Tcenter.gif" class="body" ><strong class="boxheader"> <bean:message key="knowledgepro.attendance.approveleave"/> </strong></td>
	
	        <td width="10" ><img src="images/Tright_1_01.gif" width="9" height="29"></td>
	      </tr>
			<tr>
	        <td height="19" valign="top" background="images/Tright_03_03.gif"></td>
	        <td valign="top" class="news"><div align="right"><span class='MandatoryMark'></span></div>
				...
				<nested:notEmpty name="employeeApproveLeaveForm" property="leaveApprovalList">
					<nested:iterate name="employeeApproveLeaveForm" property="leaveApprovalList" id="leaveApprovalList" type="com.kp.cms.to.employee.EmployeeApproveLeaveTO" indexId="count">
						...
						<div align="center"><c:out value="${count + 1}" /></div>
			                ...
			                <td width="18%">  <nested:write property="comments"/> </td>
			                <td width="18%">  <nested:write property="noOfDays"/> </td>
			                <td width="15%"> 
			                <nested:select property="status" styleClass="combo">
			                    <html:option value="Applied"></html:option>
			                    <html:option value="Approved"></html:option>
			                    <html:option value="On Hold"></html:option>
							...
							Available Leave </a>
							<td width="18%"><nested:text property="remarks" maxlength="100"></nested:text></td>
			                </tr>
					</nested:iterate>
				</nested:notEmpty>
	            </table></td>
	      ...
	      <tr>
	        ...
	        <td class="heading"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
	          <tr>
	            <td width="49%" height="35" align="right"><html:submit styleClass="formbutton"  /></td>
