...
function OnSubmit(){
	...
	{ 
		...
		document.getElementById("method").value="loadResumeInfo";
		document.GuestFacultyInfoForm.submit();
	}
	
	else if(applicationNo == null || applicationNo == '')
	{
		var x=window.confirm("Do u want to add new Guest Information without Application no?");
		if(x)
		{
...
<html:hidden property="flag" styleId="flag" name="GuestFacultyInfoForm"/>
