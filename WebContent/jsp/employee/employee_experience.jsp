    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      ...
                      <logic:notEmpty property="employeeDetail.experiences" name="employeeInfoForm">          
						<nested:iterate property="employeeDetail.experiences" name="employeeInfoForm" id="experience" indexId="count">    
						<tr >
                            <td width="214" height="20" class="row-odd"><div align="right"><bean:message key="employee.info.experience.employer"/> </div></td>
                            <td width="198" height="20" class="row-even">
								<logic:equal value="true" name="employeeInfoForm" property="adminUser">
					               <nested:text property="employer" styleClass="TextBox" size="20" maxlength="30"></nested:text>
								</logic:equal>
								<logic:equal value="false" name="employeeInfoForm" property="adminUser">
					               <nested:write property="employer"/>
								</logic:equal>	
							</td>
                            <td width="267" class="row-odd" height="20"><div align="right"><bean:message key="employee.info.education.startDt"/> </div></td>
							<%
								String startId="StartDate"+count;
								String endId="EndDate"+count;
							%>
                            <td width="249" class="row-even" height="30">
								<logic:equal value="true" name="employeeInfoForm" property="adminUser">
                          ...
                          <tr class="row-even">
                            <td height="20" class="row-odd"><div align="right"><bean:message key="employee.info.job.title"/> </div></td>
                            <td height="20" class="row-even" >
								<logic:equal value="true" name="employeeInfoForm" property="adminUser">
					               <nested:text property="jobTitle" styleClass="TextBox" size="20" maxlength="30"></nested:text>
								</logic:equal>
								<logic:equal value="false" name="employeeInfoForm" property="adminUser">
                          ...
                          <tr class="row-even">
                            ...
                            <td height="20" class="row-even" ><logic:equal value="true" name="employeeInfoForm" property="adminUser">
					               <nested:text property="comments" styleClass="TextBox" size="30" maxlength="100"></nested:text>
								</logic:equal>
								<logic:equal value="false" name="employeeInfoForm" property="adminUser">
					               <nested:write property="comments"/>
								</logic:equal></td>
                             <td height="20" class="row-odd"><div align="right"><bean:message key="employee.info.experience.internal"/> </div></td>
                            <td height="20" class="row-even" ><logic:equal value="true" name="employeeInfoForm" property="adminUser">
					               <input type="hidden" id="selected_<c:out value='${count}'/>" name="selected_<c:out value='${count}'/>" value="<nested:write name='experience' property='tempInternal'/>"/>
														<%--<nested:checkbox property="internal"/>--%>
														<input type="checkbox" id="selected1_<c:out value='${count}'/>" name="employeeDetail.experiences[<c:out value='${count}'/>].internal" />
								...
								<logic:equal value="false" name="employeeInfoForm" property="adminUser">
					               <nested:write property="internal"/>
								</logic:equal></td>
                          </tr>
							<tr>
		                      <td colspan="3">&nbsp;</td>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                <tr class="row-even">
                            ...
                            <td  class="row-even"><html:button property="" styleClass="formbutton" value="Add more" onclick="submitEmployeeInfoAdd('resetExperienceInfo','ExpAddMore')"/>
							</td>
                          </tr>
            </table>
            </td>
      ...
      <tr>
        ...
        <td valign="top" class="news"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
            <td height="35"><div align="right"><html:button property="" styleClass="formbutton" value="Save" onclick="submitEmployeeInfo('saveEmployeeExperienceInfo')"/> </div></td>
            <td width="10"><html:button property="" styleClass="formbutton" value="Reset" onclick="submitEmployeeInfo('resetExperienceValues')"/></td>
