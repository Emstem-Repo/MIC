    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<logic:notEmpty property="employeeDetail.skills" name="employeeInfoForm"> 	
				<nested:iterate property="employeeDetail.skills" name="employeeInfoForm" id="skill" indexId="count">
                    <tr>
                      <td width="5"  background="images/left.gif"></td>
                      <td height="73" valign="top"><table width="100%" height="64" border="0" cellpadding="0" cellspacing="1">
                          <tr class="row-even">
                            <td width="462" height="20" class="row-odd"><div align="right"><bean:message key="employee.info.skill.title"/> </div></td>
                            <td width="468" height="20" class="row-even">
							<logic:equal value="true" name="employeeInfoForm" property="adminUser">
				               <nested:text property="name" styleClass="TextBox" size="20" maxlength="50"></nested:text>
							</logic:equal>
                          ...
                          <tr class="row-even">
                            <td height="20" class="row-odd"><div align="right"><bean:message key="employee.info.skill.YOE"/> </div></td>
                            <td height="20" class="row-even">
								<logic:equal value="true" name="employeeInfoForm" property="adminUser">
					               <nested:text property="yearOfExperience" styleClass="TextBox" size="20" maxlength="30"></nested:text>
								</logic:equal>
								<logic:equal value="false" name="employeeInfoForm" property="adminUser">
					               <nested:write property="yearOfExperience"/>
								</logic:equal>
							</td>
                          </tr>
                          <tr class="row-even">
                            ...
                            <td height="20" class="row-even">
								<logic:equal value="true" name="employeeInfoForm" property="adminUser">
					               <nested:text property="comments" styleClass="TextBox" size="20" maxlength="100"></nested:text>
					           </logic:equal>
								<logic:equal value="false" name="employeeInfoForm" property="adminUser">
                      ...
                      <td  background="images/right.gif" width="5" height="73"></td>
              </tr>
			</nested:iterate>
			</logic:notEmpty>
			<tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                <tr class="row-even">
                            ...
                            <td  class="row-even"><html:button property="" styleClass="formbutton" value="Add more" onclick="submitEmployeeInfoAdd('resetSkillsInfo','AddMore')"/>
							</td>
                          </tr>
            </table>
            </td>
...
<logic:equal value="true" name="employeeInfoForm" property="adminUser">
      <tr>
        ...
        <td valign="top" class="news"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
            <td height="35"><div align="right"><html:button property="" styleClass="formbutton" value="Save" onclick="submitEmployeeInfo('saveEmployeeSkillsInfo')"/></div></td>
            <td width="10"><html:button property="" styleClass="formbutton" value="Reset" onclick="submitEmployeeInfo('resetSkillsValues')"/></td>
