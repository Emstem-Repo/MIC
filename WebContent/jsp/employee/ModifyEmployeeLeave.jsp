...
function getEmployeeLeavDetails(){
	...
	document.location.href = "ModifyEmployeeLeave.do?method=viewEmployeeLeaveDetails&academicYear="+year+"&fingerPrintId="+fingerPrintId+"&empCode="+empCode;
...
function editEmpLeave(id) {
	document.location.href = "ModifyEmployeeLeave.do?method=editEmployeeLeaveDetails&applyLeaveId="+id;
}
</script>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td background="images/Tcenter.gif" class="body" ><strong class="boxheader">Modify Employee  Leave</strong></td>
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								<logic:notEmpty property="modifyEmployeeLeaveTOs" name="ModifyEmployeeLeaveForm">
									...
									<logic:iterate id="leaveDetails" property="modifyEmployeeLeaveTOs" name="ModifyEmployeeLeaveForm" indexId="count">
										<c:choose>
										...
										<div align="center"><img src="images/edit_icon.gif"
											...
											onclick="editEmpLeave('<bean:write name="leaveDetails" property="id" />')" /></div>
										</td>
									</logic:iterate>
