...
<html:form action="/uploadEmpAttendance" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="uploadEmpAttendance" />
	<html:hidden property="formName" value="uploadEmpAttendanceForm" />
	<html:hidden property="pageType" styleId="pageType" value="1" />
	<table width="98%" border="0">
		<tr>
			<td><span class="Bredcrumbs">Employee
			<span class="Bredcrumbs">&gt;&gt; Upload Employee Attendance &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> Upload Employee Attendance</strong></div></td>
