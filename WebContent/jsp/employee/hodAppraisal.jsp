...
function submitHODAppraisal(){
	document.getElementById("method").value = "submitHODAppraisal";
	document.principalAppraisalForm.submit();
}
function resetMessages() {
	document.getElementById("method").value = "initHODAppraisal";
	document.principalAppraisalForm.submit();
}	
</script>
...
<table width="100%" border="0">
  <tr>
    ...
    <bean:message key="knowledgepro.employee.hod.appraisal"/></span> </span> </td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><strong class="boxheader"><bean:message key="knowledgepro.employee.hod.appraisal"/></strong></td>
        ...
        <td valign="top" class="news"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
              ...
              <tr>
                <td width="23%"  class="row-odd" ><div align="right"> <bean:message key="knowledgepro.employee.recommendation.col"/> </div></td>
      ...
      <tr>
        ...
        <td class="heading"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="49%" height="35" align="right"><html:button property="" value="Submit" styleClass="formbutton" onclick="submitHODAppraisal()" /></td>
