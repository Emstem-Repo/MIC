...
function getEmpResPubApprovedEdit(employeeId,method) {
...
<table width="98%" border="0">
   <tr>
			...
			<span class="Bredcrumbs">&gt;&gt; <bean:message key="knowledgepro.employee.searchapproved.list" /> &gt;&gt;</span></span></td>
		</tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="10"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><div align="left"><strong class="boxheader"><bean:message key="knowledgepro.employee.searchapproved.list"/></strong></div></td>
        <td width="13" ><img src="images/Tright_1_01.gif" width="9" height="29"></td>
      </tr>
      <tr>
        <td height="92" valign="top" background="images/Tright_03_03.gif"></td>
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
                            ...
                            <td class="row-odd"><bean:message key="knowledgepro.approved.view"/></td>
                          </tr>
                    ...
                    <tr>
                            ...
                            <td width="20%" height="39" class="row-even">&nbsp;<nested:write property="dummyDepartmentName"/></td>
                             ...
                             <td width="3%" class="row-even" align="center"><img src="images/edit_icon.gif"
										...
										onclick="getEmpResPubApprovedEdit('<nested:write property="id"/>','getEmpResApprovedEdit')"></td>                     
