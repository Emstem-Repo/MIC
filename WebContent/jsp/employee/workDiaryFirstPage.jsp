...
<html:form action="/WorkDiary">
	<html:hidden property="method" styleId="method" value="submitWorkDiaryMainPage" />
	        ...
	        <td valign="top" class="news"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	          ...
	          <tr>
	            ...
	            <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
	              <tr >
	                <td width="44%" height="25" class="row-odd"><div align="right" ><span class="Mandatory">*</span>Date:</div></td>
	                <td width="56%" height="25" class="row-even" ><table width="82" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
	                      <td width="60"><html:text property="date" styleId="date" size="11" maxlength="11"></html:text></td>
	                      <td width="40"><script language="JavaScript">
							new tcal( {
							// form name
							'formname' :'workDiaryForm',
							// input name
							'controlname' :'date'
						});
					</script></td>
