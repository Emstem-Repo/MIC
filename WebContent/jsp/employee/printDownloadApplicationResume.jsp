	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
				...
				<logic:notEmpty name="downloadApplicationForm" property="tos">
				<nested:iterate name="downloadApplicationForm" property="tos">
				<nested:write property="postAppliedFor"/></nested:iterate></logic:notEmpty> Staff
				<div align="right">Application No:<nested:write name="downloadApplicationForm" property="applicationNo"/></div></strong></td>
				</tr>
		<tr>
			<td valign="top">
				...
				<logic:notEmpty name="downloadApplicationForm" property="tos">
				<nested:iterate name="downloadApplicationForm" property="tos" id="to">
				<tr>
	           ...
	           <tr>
						...
						<c:when test="${!downloadApplicationForm.isCjc}">
	           		    ...
	           		    <c:otherwise>
	           		        <td>Subject</td><td align="left"><nested:write property="empSubjectName"/></td>
	           		    </c:otherwise>
	           		 </c:choose>
	           </tr>
	           <tr>
		...
		<tr>
			<td>
				...
				<tr> 
					...
					<logic:notEmpty name="downloadApplicationForm" property="tos"> 
						<nested:iterate name="downloadApplicationForm" property="tos" id="exp"> 
							<td><nested:write property="totalTeachingExperience" name="exp"></nested:write></td>
							<logic:notEmpty name="downloadApplicationForm" property="teachingExperience">
							<td></td>
							<td></td>
							<td></td>
							<td></td>
				...
				<tr>
					...
					<logic:notEmpty name="downloadApplicationForm" property="tos"> 
						<nested:iterate name="downloadApplicationForm" property="tos" id="TeachingfuncArea"> 
				...
				<nested:iterate name="downloadApplicationForm" property="teachingExperience" id="teaching">
					<tr>
		...
		<tr>
			<td>
				...
				<tr> 
					...
					<logic:notEmpty name="downloadApplicationForm" property="tos"> 
						<nested:iterate name="downloadApplicationForm" property="tos" id="exp"> 
							...
							<logic:notEmpty name="downloadApplicationForm" property="industryExperience">
							<td></td>
							<td></td>
							<td></td>
							<td></td>
				...
				<tr> 
					<td width="25%">Functional Area</td>
					<logic:notEmpty name="downloadApplicationForm" property="tos"> 
						<nested:iterate name="downloadApplicationForm" property="tos" id="indFuncArea"> 
				...
				<nested:iterate name="downloadApplicationForm" property="industryExperience" id="industry">
				<tr>
		...
		<tr>
			...
			<td><STRONG><p>Educational Qualification</p></STRONG>
				...
				<logic:notEmpty name="downloadApplicationForm" property="empEducationalDetails">
				<nested:iterate name="downloadApplicationForm" property="empEducationalDetails" id="educationalDetails">
				<tr>
		 ...
		 <tr>
		 	<logic:notEmpty name="downloadApplicationForm" property="additionalQualification">
			<td><STRONG><p>Additional Qualification</p></STRONG>
				...
				<nested:iterate name="downloadApplicationForm" property="additionalQualification" id="educationalDetails">
				<tr>
				<td><nested:write property="course" name="educationalDetails"></nested:write></td>
				<td><nested:write property="specialization" name="educationalDetails"/></td>
				<td><nested:write property="yearOfCompletion" name="educationalDetails"/></td>
		 ...
		 <%-- <tr>
		 <logic:equal value="true" name="downloadApplicationForm" property="publicationDetailsPresent">
		 <logic:notEmpty name="downloadApplicationForm" property="tos">
			<nested:iterate name="downloadApplicationForm" property="tos" id="publications">
		...
		<logic:equal value="false" name="downloadApplicationForm" property="isCjc">
		<logic:notEmpty name="downloadApplicationForm" property="tos">
			<nested:iterate name="downloadApplicationForm" property="tos" id="research">
			<STRONG>Research Contribution</STRONG><br><br>
		<strong><font size="2">Research Papers(Journals)</font></strong><br>
				Refereed: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  <input type="text" value="<nested:write property="researchPapersRefereed" name="research"></nested:write>" name="downloadApplicationForm" style="height: 20px;width: 50px; color: black;text-align: center;border:1px solid black;" disabled="disabled"/>
				  &nbsp;&nbsp;&nbsp;
				Non-refereed:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  <input type="text" value="<nested:write property="researchPapersNonRefereed" name="research"/>" name="downloadApplicationForm" style="height: 20px;width: 50px;color: black;text-align: center;border:1px solid black;" disabled="disabled"/>
				  &nbsp;&nbsp;&nbsp;
				  Proceedings:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  <input type="text" value="<nested:write property="researchPapersProceedings" name="research"/>" name="downloadApplicationForm" style="height: 20px;width: 50px;color: black;text-align: center;border:1px solid black;" disabled="disabled"/>
				  
				  <br><br>
				  <strong><font size="2">Book Publications</font></strong><br>
				
				  International:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  <input type="text" value="<nested:write property="internationalBookPublications" name="research"/>" name="downloadApplicationForm" style="height: 20px;width: 50px;color: black;text-align: center;border:1px solid black;" disabled="disabled"/>
				  &nbsp;&nbsp;&nbsp;
				  National:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  <input type="text" value="<nested:write property="nationalBookPublications" name="research"/>" name="downloadApplicationForm" style="height: 20px;width: 50px;color: black;text-align: center;border:1px solid black;" disabled="disabled"/>
				  &nbsp;&nbsp;&nbsp;
				  Local:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  <input type="text" value="<nested:write property="localBookPublications" name="research"/>" name="downloadApplicationForm" style="height: 20px;width: 50px;color: black;text-align: center;border:1px solid black;" disabled="disabled" align="top"/>
				  <br><br>
				 <strong><font size="2">Chapters in edited books</font></strong><br>
				International:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  <input type="text" value="<nested:write property="chaptersEditedBooksInternational" name="research"/>" name="downloadApplicationForm" style="height: 20px;width: 50px;color: black;text-align: center;border:1px solid black;" disabled="disabled"/>
				  &nbsp;&nbsp;&nbsp;
				  National:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  <input type="text" value="<nested:write property="chaptersEditedBooksNational" name="research"/>" name="downloadApplicationForm" style="height: 20px;width: 50px;color: black;text-align: center;border:1px solid black;" disabled="disabled"/>
				  <br><br>
				  <strong><font size="2">Sponsored projects(completed)</font></strong><br>
				Major (>5L):&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				   <input type="text" value="<nested:write property="majorSponseredProjects" name="research"/>" name="downloadApplicationForm" style="height: 20px;width: 50px;color: black;text-align: center;border:1px solid black;" disabled="disabled"/>
				   &nbsp;&nbsp;&nbsp;
				   Minor (<5L):&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				   <input type="text" value="<nested:write property="minorSponseredProjects" name="research"/>" name="downloadApplicationForm" style="height: 20px;width: 50px;color: black;text-align: center;border:1px solid black;" disabled="disabled"/>
				   &nbsp;&nbsp;&nbsp;
				    Consultancy (>10L):&nbsp;&nbsp;&nbsp;&nbsp;
				    <input type="text" value="<nested:write property="consultancy1SponseredProjects" name="research"></nested:write>" name="downloadApplicationForm" style="height: 20px;width: 50px;color: black;text-align: center;border:1px solid black;" disabled="disabled"/>
				    &nbsp;&nbsp;&nbsp;   <br><br>
				     Consultancy (>2L):&nbsp;
				     <input type="text" value="<nested:write property="consultancy2SponseredProjects" name="research"/>" name="downloadApplicationForm" style="height: 20px;width: 50px;color: black;text-align: center;border:1px solid black;" disabled="disabled"/>
				     <br><br>
				     <strong><font size="2">Research Guidance(Awarded)</font></strong><br>
				PhD:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  <input type="text" value="<nested:write property="phdResearchGuidance" name="research"/>" name="downloadApplicationForm" style="height: 20px;width: 50px;color: black;text-align: center;border:1px solid black;" disabled="disabled"/>
				  &nbsp;&nbsp;&nbsp;
				  Mphil:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  <input type="text" value="<nested:write property="mphilResearchGuidance" name="research"/>" name="downloadApplicationForm" style="height: 20px;width: 50px;color: black;text-align: center;border:1px solid black;" disabled="disabled"/>
				  <br><br>
				  <strong><font size="2">Training attended</font></strong><br>
				FDP (>2 weeks):&nbsp;&nbsp;&nbsp;&nbsp;
				  <input type="text" value="<nested:write property="trainingAttendedFdp2Weeks" name="research"/>" name="downloadApplicationForm" style="height: 20px;width: 50px;color: black;text-align: center;border:1px solid black;" disabled="disabled"/>
				  &nbsp;&nbsp;&nbsp;
				  FDP (>1 week):&nbsp;&nbsp;&nbsp;&nbsp;
				  <input type="text" value="<nested:write property="trainingAttendedFdp1Weeks" name="research"/>" name="downloadApplicationForm" style="height: 20px;width: 50px;color: black;text-align: center;border:1px solid black;" disabled="disabled"/>
				  <br><br>
				  <strong><font size="2">Conference presentation</font></strong><br>
				International:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  <input type="text" value="<nested:write property="internationalConferencePresentaion" name="research"/>" name="downloadApplicationForm" style="height: 20px;width: 50px;color: black;text-align: center;border:1px solid black;" disabled="disabled"/>
				  &nbsp;&nbsp;&nbsp;
				 National:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				   <input type="text" value="<nested:write property="nationalConferencePresentaion" name="research"/>" name="downloadApplicationForm" style="height: 20px;width: 50px;color: black;text-align: center;border:1px solid black;" disabled="disabled"/>
				   &nbsp;&nbsp;&nbsp;
				 Local:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  <input type="text" value="<nested:write property="localConferencePresentaion" name="research"/>" name="downloadApplicationForm" style="height: 20px;width: 50px;color: black;text-align: center;border:1px solid black;" disabled="disabled"/>
				  &nbsp;&nbsp;&nbsp; <br><br>
				  Regional:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  <input type="text" value="<nested:write property="regionalConferencePresentaion" name="research"/>" name="downloadApplicationForm" style="height: 20px;width: 50px;color: black;text-align: center;border:1px solid black;" disabled="disabled"/>
			</nested:iterate></logic:notEmpty></logic:equal>
		<table  width="100%">	
			<tr height="5px">
		
		</tr>
		<tr><logic:notEmpty name="downloadApplicationForm" property="tos">
			<nested:iterate name="downloadApplicationForm" property="tos" id="publications">
