								...
								<tr class="data" id="Research">
								   ...
								   <logic:equal value="true" name="empResearchProject" property="isResearchProject">
													...
													<tr>
														...
														<nested:textarea property="title" styleId="title" cols="90" rows="1" 
															...
															onclick="len_display(this,1000,'long_lenResearchProject','charCountResearchProject')" ></nested:textarea>
															</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<tr>
														...
														<td class="row-even" width="20%"><nested:textarea
															...
															onkeyup="len_display(this,1000,'long_lenArticleJournals','charCountArticleJournals')" ></nested:textarea></td>
														<td width="15%" height="25" class="row-odd">
														<div align="left"><bean:message
											...
											<tr>
                                             ...
                                             <tr>
												...
												<td  class="row-even"><div align="left">
				                  					<nested:text  property="datePublished" styleId="datePublished" size="20" maxlength="20" ></nested:text>
				                 				</div>
				                 			</td>
				                 			</tr>
											<!--<tr>		
													  	<td width="20%" class="row-odd">
														<div align="left"><bean:message
															key="knowledgepro.employee.datesent" />(dd/mm/yyyy)</div>
														</td>
														<%
													...
													<td  class="row-even"><div align="left">
										                  <nested:text  property="dateSent" styleId="<%=styleDateSent %>" size="20" maxlength="20" ></nested:text>
										                  <script
																language="JavaScript">
																	new tcal( {
																	// form name
                  								...
                  								<td width="20%" class="row-odd">
														<div align="left"><bean:message	key="knowledgepro.employee.dateaccepted" />(dd/mm/yyyy)</div>
												</td>
												<%	String styleDateAccepted = "dateAccepted_" + count;	%>
																		
																
												<td  class="row-even"><div align="left">
				                  					<nested:text  property="dateAccepted" styleId="<%=styleDateAccepted %>" size="20" maxlength="20" ></nested:text>
				                  <script
															language="JavaScript">
																new tcal( {
																// form name
                     							...
                     							<tr>
													...
													<tr>
														...
														<td width="30%" class="row-even"><nested:textarea
															...
															onkeypress="return imposeMaxLength(this, 0, 999);" onchange="return imposeMaxLength(this, 0, 999);" onkeyup="len_display(this,1000,'long_lenChapterArticlBook','charCountChapterArticlBook')" ></nested:textarea></td>
					...
					<td>
									...
									<logic:notEmpty property="empConferencePresentationTO"
										...
										<nested:iterate property="empConferencePresentationTO"
											...
											<tr>
													...
													<td><FONT color="red"><b>Rejected</b></FONT></td> 
													<td><div style="border: none; font-size: 10px; color: red"><b>Rejected Date:- 
													<bean:write name="empConferencePresentation" property="rejectDate" /></b></div></td>
													</logic:equal>
													</tr>
							...
							<logic:equal value="true" name="empConferencePresentation" property="isConferencePresentation">
											...
											<tr>
												...
												<td class="row-even" colspan="3"><nested:textarea
													property="abstractDetails" cols="40" rows="1"
									...
									%>
									     <div id="<%=other%>">
b									     	<nested:text property="otherTextConf" size="40" maxlength="300"></nested:text>
									     </div>	
									    <script type="text/javascript">
							...
							<logic:equal value="true" name="empInvitedTalk" property="isInvitedTalk">
											...
											<tr>
												...
												<td width="30%" class="row-even" colspan="3"><nested:textarea
													...
													onkeypress="return imposeMaxLength(this, 0, 999);" onchange="return imposeMaxLength(this, 0, 999);" 
													onkeyup="len_display(this,1000,'long_lenInvitedTalk','charCountInvitedTalk')" 
													></nested:textarea></td>
		...
		<tr class="data" id="PhdMPhilThesisGuided">
					...
					<logic:equal value="true" name="empPhdMPhilThesisGuided" property="isPhdMPhilThesisGuided">
											...
											<tr>
												...
												<td width="20%" height="25" class="row-odd">
												<div align="left">Title of Thesis</div>
												</td>
												<td width="30%" class="row-even"><nested:textarea
													property="title" cols="40" rows="1"
													onclick="len_display(this,1000,'long_lenPhdMPhilThesisGuided','charCountPhdMPhilThesisGuided')"
													onkeypress="return imposeMaxLength(this, 0, 999);" onchange="return imposeMaxLength(this, 0, 999);"
													onkeyup="len_display(this,1000,'long_lenPhdMPhilThesisGuided','charCountPhdMPhilThesisGuided')" ></nested:textarea></td>
				...
				<td>
					...
					<logic:equal value="true" name="empAwardsAchievementsOthers" property="isAwardsAchievementsOthers">
											...
											<tr>
														...
														<td width="20%" class="row-odd">
														<div align="left">Organisation /Institution Awarded</div>
														</td>
														<td width="30%" height="25" class="row-even">
