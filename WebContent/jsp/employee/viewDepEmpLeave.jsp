    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td valign="top" class="news"> <div id="errorMessage"><div align="right"><span class="Mandatory">*</span><span class='MandatoryMark'>mandatoryfields</span></div>
						...
						<bean:write name="employeeApplyLeaveForm" property="displayMessage"/><br>
        ...
        <td valign="top" class="news"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
              ...
              <tr>
              <td width="25%" height="25" class="row-odd"><div align="right" >
               <bean:message key="employee.info.reportto.empnm"/></div></td>
               <td width="25%" class="row-even">
                  <html:text property="employeeName" styleClass="TextBox" styleId="employeeName" size="16" maxlength="20" name="employeeApplyLeaveForm"/>
                </td>
