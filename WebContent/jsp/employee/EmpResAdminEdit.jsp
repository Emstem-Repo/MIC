...
<script type="text/javascript">
		function deleteEmpResPubDetails(id,name)
		{
			var x=window.confirm("Are you sure, you want to 'Delete' the details. Press 'Ok' if u want to Delete, else press Cancel ");
			if(x)
			{
				document.getElementById("selectedResId").value=id;
				document.getElementById("isDelete").value="true";
				document.getElementById("method").value="saveEmpResAdminEditAdmin";
	...
	function cancelAction() {
		document.location.href = "empResearchPublicDetails.do?method=initResearchPublicAdmin";
	}
	...
	function saveEmpResAdminEdit(name){
		charCountDisplay();
	...
	function getOtherConferencePreseantation(valueSelected,count){
		...
		if(other!=null && other!="" && other=="Other"){
			document.getElementById("otherTextConf_"+count).style.display="block";
		}else{
			document.getElementById("otherTextConf_"+count).style.display="none";
		}
	}
...
<html:form action="/empResearchPublicDetails" method="post">
	...
	<html:hidden property="isDelete" styleId="isDelete" value=""/>
	<html:hidden property="selectedResId" styleId="selectedResId" value=""/>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
							...
							<tr class="studentrow-odd">
								...
								<tr class="heading">
									...
									<div align="left" style="border:ridge 5px #d0e4fe; font-size: 11px;">Dear Faculty Member, Kindly fill the relevant details from the list given below.<br>
										...
										4. Click on 'Save' from each section after the form is filled.</div>
									</td>
								</tr>
							<!--<tr height="40" >
				...
				<tr>
							...
							<tr >
								...
								<td width="25%" align="left" class="row-even" style="border:ridge 5px #d0e4fe; "><bean:write name="EmpResPubDetailsForm" property="empName" />
							...
							<tr >
						        ...
						        <td width="25%" align="left"  class="row-even" style="border:ridge 5px #d0e4fe; "><bean:write name="EmpResPubDetailsForm" property="fingerprintId" /></td>
							</tr>
							<tr >
									
								<td width="25%" align="left" class="row-odd" style="border:ridge 5px #d0e4fe; "><bean:message key="knowledgepro.employee.Department"/></td>
										 <td width="25%"  align="left" class="row-even" style="border:ridge 5px #d0e4fe; "><bean:write name="EmpResPubDetailsForm" property="empDepartment" /> 
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										<tr class="row-odd">
											...
											<logic:notEmpty property="empResearchProjectTO"
												...
												<logic:equal value="true" name="empResearchProject" property="isResearchProject">
												...
												<logic:equal value="true" name="empResearchProject" property="isRejected">
													...
													<bean:write name="empResearchProject" property="entryRejectedDate" /></b></div></td>
													</logic:equal>
												<logic:equal value="true" name="empResearchProject" property="isApproved">
													<td><FONT color="red"><b>Approved</b></FONT></td> 
													<td><div style="border: none; font-size: 10px; color: red"><b>Approved Date:- 
													...
													<tr>
														<td height="25" class="row-odd"><div align="left" >Auto Approve </div></td>
                										<td class="row-even"><span class="star">
                 										<nested:radio property="autoApprove" value="1"/>Yes&nbsp; 
				 										<nested:radio property="autoApprove" value="0"/>No
                 										</span></td>
													</tr>
													</logic:equal>
													<tr>
												...
												<tr>
													...
													<td class="row-even" colspan="4">
														...
														<tr>
															...
															<input type="button" style="formbutton" value="Delete" onclick="deleteEmpResPubDetails('<nested:write property="id" name="empResearchProject"/>','ResearchProject')"/>&nbsp;&nbsp;
															</td>
														</tr>
													</table>
													</td>
										...
										<tr>
											...
											<logic:notEmpty property="empResearchProjectTO"
												name="EmpResPubDetailsForm">
								  			 <html:button property="" styleClass="formbutton" value="Save" onclick="saveEmpResAdminEdit('ResearchProject')"></html:button>&nbsp;&nbsp;
											</logic:notEmpty>
											&nbsp;<html:submit
			...
			<td >
										...
										<tr class="row-odd">
											<logic:notEmpty property="empBooksMonographsTO"
												...
												<nested:iterate property="empBooksMonographsTO"
													...
													<tr>
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Sl No:- <c:out value="${count + 1}"/></b></div></td>
												<logic:equal value="true" name="empBooksMonographs" property="isBookMonographs">
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Submitted Date:- 
													...
													<td><FONT color="red"><b>Rejected</b></FONT></td> 
													<td><div style="border: none; font-size: 10px; color: red"><b>Rejected Date:- 
													<bean:write name="empBooksMonographs" property="entryRejectedDate" /></b></div></td>
													</logic:equal>
												...
												<logic:equal value="false" name="empBooksMonographs" property="isApproved">
													...
													<td class="row-even" colspan="4">
														...
														<tr>
															<td height="25" align="right">
															<input type="button" style="formbutton" value="Delete" onclick="deleteEmpResPubDetails('<nested:write property="id" name="empBooksMonographs"/>','BooksMonographs')"/>&nbsp;&nbsp;
															</td>
														</tr>
													</table>
													</td>
								...
								<tr>
										...
										<tr>
											...
											<logic:notEmpty property="empBooksMonographsTO"
												name="EmpResPubDetailsForm">
								  			 <html:button property="" styleClass="formbutton" value="Save" onclick="saveEmpResAdminEdit('BooksMonographs')"></html:button>&nbsp;&nbsp;
											</logic:notEmpty>
											&nbsp;<html:submit
												property="" styleClass="formbutton" value="Add more"
												styleId="addMore"
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<tr class="row-odd">
											<logic:notEmpty property="empArticleJournalsTO"
												...
												<nested:iterate property="empArticleJournalsTO"
													...
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Sl No:- <c:out value="${count + 1}"/></b></div></td>
												<logic:equal value="true" name="empArticleJournals" property="isArticleJournal">
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Submitted Date:- 
												...
												<logic:equal value="true" name="empArticleJournals" property="isRejected">
													<td><FONT color="red"><b>Rejected</b></FONT></td> 
													<td><div style="border: none; font-size: 10px; color: red"><b>Rejected Date:- 
													<bean:write name="empArticleJournals" property="entryRejectedDate" /></b></div></td>
												</logic:equal>
											...
											<% String styleDatePublished = "datePublished_" + count; %>
												...
												<td  class="row-even"><div align="left">
													...
													<td class="row-even" colspan="4">
														...
														<tr>
															<td height="25" align="right">
															<input type="button" style="formbutton" value="Delete" onclick="deleteEmpResPubDetails('<nested:write property="id" name="empArticleJournals"/>','ArticleJournals')"/>&nbsp;&nbsp;
															</td>
														</tr>
													</table>
													</td>
										...
										<tr>
											...
											<logic:notEmpty property="empArticleJournalsTO"
								  			 ...
								  			 <html:button property="" styleClass="formbutton" value="Save" onclick="saveEmpResAdminEdit('ArticleJournals')"></html:button>&nbsp;&nbsp;			
											</logic:notEmpty>
											&nbsp;<html:submit
												property="" styleClass="formbutton" value="Add more"
												styleId="addMore"
								...
								<tr class="data" id="ChapArticlBook">
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<tr class="row-odd">
											<logic:notEmpty property="empChapterArticlBookTO"
												...
												<nested:iterate property="empChapterArticlBookTO"
													...
													<tr>
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Sl No:- <c:out value="${count + 1}"/></b></div></td>
												<logic:equal value="true" name="empChapterArticlBook" property="isChapterArticleBook">
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Submitted Date:- 
												...
												<logic:equal value="true" name="empChapterArticlBook" property="isRejected">
													<td><FONT color="red"><b>Rejected</b></FONT></td> 
													<td><div style="border: none; font-size: 10px; color: red"><b>Rejected Date:- 
													<bean:write name="empChapterArticlBook" property="entryRejectedDate" /></b></div></td>
												</logic:equal>
												...
												<logic:equal value="true" name="empChapterArticlBook" property="isChapterArticleBook">
													...
													<td class="row-even" colspan="4">
														...
														<tr>
															<td height="25" align="right">
															<input type="button" style="formbutton" value="Delete" onclick="deleteEmpResPubDetails('<nested:write property="id" name="empChapterArticlBook"/>','ChapterArticlBook')"/>&nbsp;&nbsp;
															</td>
														</tr>
													</table>
													</td>
										...
										<tr>
											...
											<logic:notEmpty property="empChapterArticlBookTO"
												name="EmpResPubDetailsForm">
													<html:button property="" styleClass="formbutton" value="Save" onclick="saveEmpResAdminEdit('ChapterArticlBook')"></html:button>&nbsp;&nbsp;	
											</logic:notEmpty>
											&nbsp;<html:submit
												property="" styleClass="formbutton" value="Add more"
												styleId="addMore"
								...
								<tr class="data" id="ArticlInPeriodicals">
										...
										<tr class="row-odd">
											<logic:notEmpty property="empArticlInPeriodicalsTO"
												...
												<nested:iterate property="empArticlInPeriodicalsTO"
													...
													<tr>
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Sl No:- <c:out value="${count + 1}"/></b></div></td>
												<logic:equal value="true" name="empArticlInPeriodicals" property="isArticleInPeriodicals">
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Submitted Date:- 
												...
												<logic:equal value="true" name="empArticlInPeriodicals" property="isRejected">
													<td><FONT color="red"><b>Rejected</b></FONT></td> 
													<td><div style="border: none; font-size: 10px; color: red"><b>Rejected Date:- 
													<bean:write name="empArticlInPeriodicals" property="entryRejectedDate" /></b></div></td>
												</logic:equal>
									...
									%>
									     ...
									     <script type="text/javascript">
												...
												<logic:equal value="true" name="empArticlInPeriodicals" property="isArticleInPeriodicals">
													...
													<td class="row-even" colspan="4">
														...
														<tr>
															<td height="25" align="right">
															<input type="button" style="formbutton" value="Delete" onclick="deleteEmpResPubDetails('<nested:write property="id" name="empArticlInPeriodicals"/>','ArticlInPeriodicals')"/>&nbsp;&nbsp;
															</td>
														</tr>
													</table>
													</td>
										...
										<tr>
											...
											<logic:notEmpty property="empArticlInPeriodicalsTO"
												name="EmpResPubDetailsForm">
											<html:button property="" styleClass="formbutton" value="Save" onclick="saveEmpResAdminEdit('ArticlInPeriodicals')"></html:button>&nbsp;&nbsp;	
											</logic:notEmpty>
											&nbsp;<html:submit
												property="" styleClass="formbutton" value="Add more"
												styleId="addMore"
			...
			<tr class="tdIMG" height="35px">
				   <td>
					...
					<td>
								...
								<tr class="row-odd">
									<logic:notEmpty property="empConferencePresentationTO"
										...
										<nested:iterate property="empConferencePresentationTO"
											...
											<tr>
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Sl No:- <c:out value="${count + 1}"/></b></div></td>
												<logic:equal value="true" name="empConferencePresentation" property="isConferencePresentation">
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Submitted Date:- 
													<bean:write name="empConferencePresentation" property="entryCreatedate" /></b></div></td>
												</logic:equal>	
												<logic:equal value="true" name="empConferencePresentation" property="isRejected">
													<td><FONT color="red"><b>Rejected</b></FONT></td> 
													<td><div style="border: none; font-size: 10px; color: red"><b>Rejected Date:- 
													<bean:write name="empConferencePresentation" property="entryRejectedDate" /></b></div></td>
												</logic:equal>
											...
											<tr>
												...
												<td class="row-even"><nested:textarea
													...
													onkeyup="len_display(this,2000,'long_lenConferencePresentation','charCountConferencePresentation')" ></nested:textarea>
													</td>
										...
										<logic:equal value="true" name="empConferencePresentation" property="isConferencePresentation">
											<tr>
													<td class="row-even" colspan="4">
														...
														<tr>
															<td height="25" align="right">
															<input type="button" style="formbutton" value="Delete" onclick="deleteEmpResPubDetails('<nested:write property="id" name="empConferencePresentation"/>','ConferencePresentation')"/>&nbsp;&nbsp;
															</td>
														</tr>
													</table>
													</td>
							...
							<logic:notEmpty property="empConferencePresentationTO"
										name="EmpResPubDetailsForm">
												<html:button property="" styleClass="formbutton" value="Save" onclick="saveEmpResAdminEdit('ConferencePresentation')"></html:button>&nbsp;&nbsp;
								...
								<tr class="row-odd">
									<logic:notEmpty property="empConferenceSeminarsAttendedTO"
										...
										<nested:iterate property="empConferenceSeminarsAttendedTO"
											...
											<tr>
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Sl No:- <c:out value="${count + 1}"/></b></div></td>
												<logic:equal value="true" name="empSeminarsAttended" property="isSeminarAttended">
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Submitted Date:- 
												...
												<logic:equal value="true" name="empSeminarsAttended" property="isRejected">
													<td><FONT color="red"><b>Rejected</b></FONT></td> 
													<td><div style="border: none; font-size: 10px; color: red"><b>Rejected Date:- 
													<bean:write name="empSeminarsAttended" property="entryRejectedDate" /></b></div></td>
												</logic:equal>
												<logic:equal value="true" name="empSeminarsAttended" property="isApproved">
													<td><FONT color="red"><b>Approved</b></FONT></td> 
													<td><div style="border: none; font-size: 10px; color: red"><b>Approved Date:- 
													<bean:write name="empSeminarsAttended" property="entryApprovedDate" /></b></div></td>
												</logic:equal>
													
													</tr>
												<logic:equal value="false" name="empSeminarsAttended" property="isApproved">
													<tr>
														<td height="25" class="row-odd"><div align="left" >Auto Approve </div></td>
                										<td class="row-even"><span class="star">
                 										<nested:radio property="autoApprove" value="1"/>Yes&nbsp; 
                  ...
                  <script
											language="JavaScript">
												...
												<tr>
													...
													<td class="row-even" colspan="4">
														...
														<tr>
															<td height="25" align="right">
															<input type="button" style="formbutton" value="Delete" onclick="deleteEmpResPubDetails('<nested:write property="id" name="empSeminarsAttended"/>','SeminarsAttended')"/>&nbsp;&nbsp;
															</td>
														</tr>
													</table>
													</td>
								 ...
								 <tr>
										...
										<tr>
											...
											<logic:notEmpty property="empConferenceSeminarsAttendedTO"
										name="EmpResPubDetailsForm">
											<html:button property="" styleClass="formbutton" value="Save" onclick="saveEmpResAdminEdit('SeminarsAttended')"></html:button>&nbsp;&nbsp;
											</logic:notEmpty>
	...
	<tr class="tdIMG" height="35px">
				   <td>
								...
								<tr class="row-odd">
									<logic:notEmpty property="empInvitedTalkTO"
										...
										<nested:iterate property="empInvitedTalkTO"
											...
											<tr>
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Sl No:- <c:out value="${count + 1}"/></b></div></td>
												<logic:equal value="true" name="empInvitedTalk" property="isInvitedTalk">
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Submitted Date:- 
												...
												<logic:equal value="true" name="empInvitedTalk" property="isRejected">
													<td><FONT color="red"><b>Rejected</b></FONT></td> 
													<td><div style="border: none; font-size: 10px; color: red"><b>Rejected Date:- 
													<bean:write name="empInvitedTalk" property="entryRejectedDate" /></b></div></td>
												</logic:equal>
					...
					<nested:textarea
											...
											%>
												<td width="30%" class="row-even"><nested:text
													property="nameTalksPresentation" styleId="<%=nameTalksPresentation%>" 
													size="40" maxlength="200"  onclick="charCountDisplay()"></nested:text></td>-->
                  						...
                  						<script
											...
											<tr>
													<td class="row-even" colspan="4">
														...
														<tr>
															<td height="25" align="right">
															<input type="button" style="formbutton" value="Delete" onclick="deleteEmpResPubDetails('<nested:write property="id" name="empInvitedTalk"/>','InvitedTalk')"/>&nbsp;&nbsp;
															</td>
														</tr>
													</table>
													</td>
							...
							<logic:notEmpty property="empInvitedTalkTO"	name="EmpResPubDetailsForm">
											...
											<html:button property="" styleClass="formbutton" value="Save" onclick="saveEmpResAdminEdit('InvitedTalk')"></html:button>&nbsp;&nbsp;
								...
								<tr class="row-odd">
									<logic:notEmpty property="empCasesNotesWorkingTO"
										...
										<nested:iterate property="empCasesNotesWorkingTO"
											...
											<tr>
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Sl No:- <c:out value="${count + 1}"/></b></div></td>
												<logic:equal value="true" name="empCasesNotesWorking" property="isCasesNoteWorking">
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Submitted Date:- 
													...
													<td><FONT color="red"><b>Rejected</b></FONT></td> 
													<td><div style="border: none; font-size: 10px; color: red"><b>Rejected Date:- 
													<bean:write name="empCasesNotesWorking" property="entryRejectedDate" /></b></div></td>
													</logic:equal>
							...
							<logic:equal value="false" name="empCasesNotesWorking" property="isApproved">
											...
											<tr>
													<td class="row-even" colspan="4">
														...
														<tr>
															<td height="25" align="right">
															<input type="button" style="formbutton" value="Delete" onclick="deleteEmpResPubDetails('<nested:write property="id" name="empCasesNotesWorking"/>','CasesNotesWorking')"/>&nbsp;&nbsp;
															</td>
														</tr>
													</table>
													</td>
								 ...
								 <tr>
										...
										<tr>
											...
											<logic:notEmpty property="empCasesNotesWorkingTO"
										name="EmpResPubDetailsForm">
											<html:button property="" styleClass="formbutton" value="Save" onclick="saveEmpResAdminEdit('CasesNotesWorking')"></html:button>&nbsp;&nbsp;
											</logic:notEmpty>
								...
								<tr class="row-odd">
									<logic:notEmpty property="empPhdMPhilThesisGuidedTO"
										...
										<nested:iterate property="empPhdMPhilThesisGuidedTO"
											...
											<tr>
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Sl No:- <c:out value="${count + 1}"/></b></div></td>
												<logic:equal value="true" name="empPhdMPhilThesisGuided" property="isPhdMPhilThesisGuided">
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Submitted Date:- 
												...
												<logic:equal value="true" name="empPhdMPhilThesisGuided" property="isRejected">
													<td><FONT color="red"><b>Rejected</b></FONT></td> 
													<td><div style="border: none; font-size: 10px; color: red"><b>Rejected Date:- 
													<bean:write name="empPhdMPhilThesisGuided" property="entryRejectedDate" /></b></div></td>
											</logic:equal>
										...
										<%-- 	<tr>
												...
												<tr>
													<td class="row-even" colspan="4">
														...
														<tr>
															<td height="25" align="right">
															<input type="button" style="formbutton" value="Delete" onclick="deleteEmpResPubDetails('<nested:write property="id" name="empPhdMPhilThesisGuided"/>','PhdMPhilThesisGuided')"/>&nbsp;&nbsp;
															</td>
														</tr>
													</table>
													</td>
								 ...
								 <tr>
										...
										<tr>
											...
											<logic:notEmpty property="empPhdMPhilThesisGuidedTO"
										name="EmpResPubDetailsForm">
											<html:button property="" styleClass="formbutton" value="Save" onclick="saveEmpResAdminEdit('PhdMPhilThesisGuided')"></html:button>&nbsp;&nbsp;
											</logic:notEmpty>
								...
								<tr class="row-odd">
									<logic:notEmpty property="empOwnPhdMPilThesisTO"
										...
										<nested:iterate property="empOwnPhdMPilThesisTO"
											...
											<tr>
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Sl No:- <c:out value="${count + 1}"/></b></div></td>
												<logic:equal value="true" name="empOwnPhdMPilThesis" property="isOwnPhdMphilThesis">
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Submitted Date:- 
												...
												<logic:equal value="true" name="empOwnPhdMPilThesis" property="isRejected">
													<td><FONT color="red"><b>Rejected</b></FONT></td> 
													<td><div style="border: none; font-size: 10px; color: red"><b>Rejected Date:- 
													<bean:write name="empOwnPhdMPilThesis" property="entryRejectedDate" /></b></div></td>
												</logic:equal>
											...
											<tr>
												<td width="20%" class="row-odd">
													...
													<td class="row-even" colspan="4">
														...
														<tr>
															<td height="25" align="right">
															<input type="button" style="formbutton" value="Delete" onclick="deleteEmpResPubDetails('<nested:write property="id" name="empOwnPhdMPilThesis"/>','OwnPhdMPilThesis')"/>&nbsp;&nbsp;
															</td>
														</tr>
													</table>
													</td>
								 ...
								 <tr>
										...
										<tr>
											...
											<logic:notEmpty property="empOwnPhdMPilThesisTO"
										name="EmpResPubDetailsForm">
											<html:button property="" styleClass="formbutton" value="Save" onclick="saveEmpResAdminEdit('OwnPhdMPilThesis')"></html:button>&nbsp;&nbsp;
											</logic:notEmpty>
											&nbsp;
								...
								<tr class="data" id="Blog">
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<tr class="row-odd">
											<logic:notEmpty property="empBlogTO"
												...
												<nested:iterate property="empBlogTO"
													...
													<tr>
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Sl No:- <c:out value="${count + 1}"/></b></div></td>
											<logic:equal value="true" name="empBlog" property="isBlog">
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Submitted Date:- 
											...
											<logic:equal value="true" name="empBlog" property="isRejected">
													<td><FONT color="red"><b>Rejected</b></FONT></td> 
													<td><div style="border: none; font-size: 10px; color: red"><b>Rejected Date:- 
													<bean:write name="empBlog" property="entryRejectedDate" /></b></div></td>
											</logic:equal>
										...
										<logic:equal value="false" name="empBlog" property="isApproved">
												...
												<logic:equal value="true" name="empBlog" property="isBlog">
													...
													<td class="row-even" colspan="4">
														...
														<tr>
															<td height="25" align="right">
															<input type="button" style="formbutton" value="Delete" onclick="deleteEmpResPubDetails('<nested:write property="id" name="empBlog"/>','Blog')"/>&nbsp;&nbsp;
															</td>
														</tr>
													</table>
													</td>
										...
										<tr>
											...
											<logic:notEmpty property="empBlogTO"
												name="EmpResPubDetailsForm">
											<html:button property="" styleClass="formbutton" value="Save" onclick="saveEmpResAdminEdit('Blog')"></html:button>&nbsp;&nbsp;
											</logic:notEmpty>
											&nbsp;<html:submit
												property="" styleClass="formbutton" value="Add more"
												styleId="addMore"
								...
								<tr class="row-odd">
									<logic:notEmpty property="empFilmVideosDocTO"
										...
										<nested:iterate property="empFilmVideosDocTO"
											...
											<tr>
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Sl No:- <c:out value="${count + 1}"/></b></div></td>
												<logic:equal value="true" name="empFilmVideosDoc" property="isFilmVideoDoc">
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Submitted Date:- 
												...
												<logic:equal value="true" name="empFilmVideosDoc" property="isRejected">
													<td><FONT color="red"><b>Rejected</b></FONT></td> 
													<td><div style="border: none; font-size: 10px; color: red"><b>Rejected Date:- 
													<bean:write name="empFilmVideosDoc" property="entryRejectedDate" /></b></div></td>
												</logic:equal>
										...
										<tr>
													<td class="row-even" colspan="4">
														...
														<tr>
															<td height="25" align="right">
															<input type="button" style="formbutton" value="Delete" onclick="deleteEmpResPubDetails('<nested:write property="id" name="empFilmVideosDoc"/>','FilmVideosDoc')"/>&nbsp;&nbsp;
															</td>
														</tr>
													</table>
													</td>
								 ...
								 <tr>
										...
										<tr>
											...
											<logic:notEmpty property="empFilmVideosDocTO"
										name="EmpResPubDetailsForm">
											<html:button property="" styleClass="formbutton" value="Save" onclick="saveEmpResAdminEdit('FilmVideosDoc')"></html:button>&nbsp;&nbsp;
											</logic:notEmpty>
								...
								<tr class="row-odd">
									<logic:notEmpty property="empSeminarsOrganizedTO"
										...
										<nested:iterate property="empSeminarsOrganizedTO"
											...
											<tr>
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Sl No:- <c:out value="${count + 1}"/></b></div></td>
											<logic:equal value="true" name="empSeminarsOrganized" property="isSeminarOrganized">
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Submitted Date:- 
											...
											<logic:equal value="true" name="empSeminarsOrganized" property="isRejected">
													<td><FONT color="red"><b>Rejected</b></FONT></td> 
													<td><div style="border: none; font-size: 10px; color: red"><b>Rejected Date:- 
													<bean:write name="empSeminarsOrganized" property="entryRejectedDate" /></b></div></td>
											</logic:equal>
										...
										<logic:equal value="true" name="empSeminarsOrganized" property="isSeminarOrganized">
											<tr>
													<td class="row-even" colspan="4">
														...
														<tr>
															<td height="25" align="right">
															<input type="button" style="formbutton" value="Delete" onclick="deleteEmpResPubDetails('<nested:write property="id" name="empSeminarsOrganized"/>','SeminarsOrganized')"/>&nbsp;&nbsp;
															</td>
														</tr>
													</table>
													</td>
								 ...
								 <tr>
										...
										<tr>
											...
											<logic:notEmpty property="empSeminarsOrganizedTO"
										name="EmpResPubDetailsForm">
											<html:button property="" styleClass="formbutton" value="Save" onclick="saveEmpResAdminEdit('SeminarsOrganized')"></html:button>&nbsp;&nbsp;
											</logic:notEmpty>
								...
								<tr class="row-odd">
									<logic:notEmpty property="empWorkshopsTO"
										...
										<nested:iterate property="empWorkshopsTO"
											...
											<tr>
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Sl No:- <c:out value="${count + 1}"/></b></div></td>
												<logic:equal value="true" name="empWorkshopsAttended" property="isWorkshopTraining">
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Submitted Date:- 
												...
												<logic:equal value="true" name="empWorkshopsAttended" property="isRejected">
													<td><FONT color="red"><b>Rejected</b></FONT></td> 
													<td><div style="border: none; font-size: 10px; color: red"><b>Rejected Date:- 
													<bean:write name="empWorkshopsAttended" property="entryRejectedDate" /></b></div></td>
												</logic:equal>
												<logic:equal value="true" name="empWorkshopsAttended" property="isApproved">
													<td><FONT color="red"><b>Approved</b></FONT></td> 
													<td><div style="border: none; font-size: 10px; color: red"><b>Approved Date:- 
													<bean:write name="empWorkshopsAttended" property="entryApprovedDate" /></b></div></td>
												</logic:equal>
													</tr>
												<logic:equal value="false" name="empWorkshopsAttended" property="isApproved">
													<tr>
														<td height="25" class="row-odd"><div align="left" >Auto Approve </div></td>
                										<td class="row-even"><span class="star">
                 										<nested:radio property="autoApprove" value="1"/>Yes&nbsp; 
											...
											<tr>
												...
												<logic:equal value="true" name="empWorkshopsAttended" property="isWorkshopTraining">
													...
													<td class="row-even" colspan="4">
														...
														<tr>
															<td height="25" align="right">
															<input type="button" style="formbutton" value="Delete" onclick="deleteEmpResPubDetails('<nested:write property="id" name="empWorkshopsAttended"/>','WorkshopsAttended')"/>&nbsp;&nbsp;
															</td>
														</tr>
													</table>
													</td>
								 ...
								 <tr>
										...
										<tr>
											...
											<logic:notEmpty property="empWorkshopsTO"
										name="EmpResPubDetailsForm">
											<html:button property="" styleClass="formbutton" value="Save" onclick="saveEmpResAdminEdit('WorkshopsAttended')"></html:button>&nbsp;&nbsp;
											</logic:notEmpty>
								...
								<tr class="row-odd">
									<logic:notEmpty property="empAwardsAchievementsOthersTO"
										...
										<nested:iterate property="empAwardsAchievementsOthersTO"
											...
											<tr>
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Sl No:- <c:out value="${count + 1}"/></b></div></td>
												<logic:equal value="true" name="empAwardsAchievementsOthers" property="isAwardsAchievementsOthers">
													<td><div style="border: none; font-size: 10px; color: #000000"><b>Submitted Date:- 
												...
												<logic:equal value="true" name="empAwardsAchievementsOthers" property="isRejected">
													<td><FONT color="red"><b>Rejected</b></FONT></td> 
													<td><div style="border: none; font-size: 10px; color: red"><b>Rejected Date:- 
													<bean:write name="empAwardsAchievementsOthers" property="entryRejectedDate" /></b></div></td>
												</logic:equal>
											...
											<tr>
													...
													<td class="row-even" colspan="4">
														...
														<tr>
															<td height="25" align="right">
															<input type="button" style="formbutton" value="Delete" onclick="deleteEmpResPubDetails('<nested:write property="id" name="empAwardsAchievementsOthers"/>','AwardsAchievements')"/>&nbsp;&nbsp;
															</td>
														</tr>
													</table>
													</td>
								 ...
								 <tr>
										...
										<tr>
											...
											<logic:notEmpty property="empAwardsAchievementsOthersTO"
										name="EmpResPubDetailsForm">
											<html:button property="" styleClass="formbutton" value="Save" onclick="saveEmpResAdminEdit('AwardsAchievements')"></html:button>&nbsp;&nbsp;
											</logic:notEmpty>
	  ...
	  <tr>
                <td height="10" class="body" ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <html:submit styleClass="formbutton" property=""  onclick="cancelMe('getSearchedEmployee')" >Close</html:submit>
                      </div>
					  </td>
                      <td width="52%"></td>
                    </tr>
