...
function clarifyEmployeeLeave(buttonValue){
	document.getElementById("status").value=buttonValue.value;
	document.getElementById("status").value=buttonValue.value;
	document.getElementById("method").value="requestDocEmpLeave";
	document.employeeOnlineLeaveForm.submit();
}
function displayReason(buttonValue){
	document.getElementById("status").value=buttonValue.value;
	document.getElementById("displayId").style.display = "block";
	document.getElementById("requestDoc").style.display = "none";
}
function requestDoc(buttonValue){
	document.getElementById("status").value=buttonValue.value;
					...
					<td height="20" colspan="2">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<td height="35" align="center">
								...
								&nbsp;&nbsp;&nbsp;<html:button  value="Return" styleClass="formbutton" property="" onclick="displayReason(this)"></html:button>
								&nbsp;&nbsp;&nbsp;<html:button  value="Request Document" styleClass="formbutton" property="" onclick="requestDoc(this)"></html:button>
								...
								<div id="requestDoc">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
											 <tr>
									          ...
									          <tr>
									          		<td height="35" align="right"> <html:button  value="Submit" styleClass="formbutton" property="" onclick="clarifyEmployeeLeave(this)"></html:button></td>
									          </tr>
									</table>
								</div>
				          	</td>
