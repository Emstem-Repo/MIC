...
function Print()
{
	...
	function saveEmpDetails(){
		document.getElementById("method").value="saveEditEmpDetails";
		document.GuestFacultyInfoForm.submit();
	}
        ...
        <td valign="top" class="news">
              <table width="100%" height="50"  border="0" cellpadding="0" cellspacing="0">
									...
									<table width="100%" height="22" border="0" cellpadding="0">
										<tr class="row-white">
											<td width="50%" height="30" align="center" class="row-even">
												...
												<%} else{%>
													<img src='<%=request.getAttribute("EMP_IMAGE")%>?time=<%=System.currentTimeMillis() %>' height="186Px" width="144Px" />
												<%} %>
											</td>
										</tr>-
									</table>
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
							 ...
							 <tr> 
								...
								<td   class="row-even">
									<html:text name="GuestFacultyInfoForm" property="dateOfBirth" styleId="dateOfBirth" size="10" maxlength="16"  />
										<script
											language="JavaScript">
												new tcal( {
												// form name
				...
				<tr>
					...
					<tr>
									...
									<td class="row-even" width="37%"> 
									<html:text property="bankIfscCode" maxlength="11" onkeyup="caps(this)"></html:text>
								...
								<table width="100%" cellspacing="1" cellpadding="2">
									<logic:equal value="true" name="GuestFacultyInfoForm" property="isCjc">
										...
										<tr>
										 ...
										 <td  class="row-even">
										 	<html:text property="currentZipCode" styleId="currentZipCode" onkeypress="return isNumberKey(event)" size="20" maxlength="10"></html:text>
										 </td>
									  	</tr>
								...
								<table width="100%" cellspacing="1" cellpadding="2">
									<logic:equal value="true" name="GuestFacultyInfoForm" property="isCjc">
										...
										<tr>
										 ...
										 <td  class="row-even" >
										 	<html:text property="permanentZipCode" styleId="permanentZipCode" onkeypress="return isNumberKey(event)" size="20" maxlength="10"></html:text>
										 </td>
									  	</tr>
									   ...
									   <tr>
									     ...
									     <div id="otehrPermState">
									     	<html:text property="otherPermanentState" name="GuestFacultyInfoForm" size="20" maxlength="50"></html:text>
									     </div>
									     </td>
									     </tr></table>
             ...
             <tr >
              ...
              <tr >
                ...
                <td height="25" class="row-even" ><span class="star">
                 <html:text property="subjectSpecilization" styleId="subjectSpecilization"  size="20" maxlength="100"></html:text>
                </span>				
                </td>
              ...
              <td  class="row-odd"><div align="left" ><bean:message key="knowledgepro.guest.working.hour"/></div></td>
                <td height="25" class="row-even" ><span class="star">
                 <html:text property="workingHoursPerWeek" styleId="workingHoursPerWeek" size="20" maxlength="5" onkeypress="return isNumberKey(event)"></html:text>
                </span>				
                </td>
                <td  class="row-odd"><div align="left" ><bean:message key="knowledgepro.guest.Honorarium"/></div></td>
                <td height="25" class="row-even" ><span class="star">
                 <html:text property="honorariumPerHours" styleId="honorariumPerHours" size="20" maxlength="30" ></html:text>
                </span>				
                </td>
              </tr>
              <tr>
          ...
          <tr class="row-odd">
                <td class="row-odd" width="12%"><div align="left" ><bean:message key="knowledgepro.guest.currentdata"/> </div></td>
                <td  class="row-odd" width="12%"><div align="left" ><span class="Mandatory">*</span><bean:message key="knowledgepro.guest.startDate"/> </div></td>
                <td class="row-odd" width="12%"><div align="left" ><span class="Mandatory">*</span><bean:message key="knowledgepro.guest.EndDate"/></div></td>
                <td  class="row-odd" width="8%"><div align="left" ><bean:message key="knowledgepro.guest.Semester"/></div></td>
			...
			<nested:iterate property="employeeInfoTONew.previousworkDetails" name="GuestFacultyInfoForm" id="prevworkDetails" indexId="count">
              ...
              <tr>
              <td class="row-odd" align="center" colspan="9">  <html:submit property="" styleClass="formbutton" value="Add more"  onclick="submitEmployeeInfoAdd('resetPrevWorkEdit','PrevWorkAddMore'); return false;"></html:submit>
                <c:if test="${GuestFacultyInfoForm.prevWorkListSize>0}">
		            <html:submit property="" styleClass="formbutton" value="Remove"  styleId="addMore" onclick="submitEmployeeInfoAdd('removePrevWorkRowEdit','ExpAddMore'); return false;"></html:submit>
		        </c:if>
             </td>
             </tr>
	...
	<tr>
			       ...
			       <tr>
			                         	...
			                         	<!--<html:submit property="" styleClass="formbutton" value="Add more"  styleId="addMore" onclick="getEmployeeTeachingExpAdd('ExpAddMore')"></html:submit>-->
				                        	<html:submit property="" styleClass="formbutton" value="Add more"  styleId="addMore" onclick="submitEmployeeInfoAdd('resetTeachingExperienceInfoEdit','ExpAddMore'); return false;"></html:submit>
										<c:if test="${GuestFacultyInfoForm.teachingExpLength>0}">
				                        		<html:submit property="" styleClass="formbutton" value="Remove"  styleId="addMore" onclick="submitEmployeeInfoAdd('removeTeachingExperienceInfoEdit','ExpAddMore'); return false;"></html:submit>
				                        	</c:if>
										</td> 
						</tr>
			                         <tr>
									...
									<%String industryMonth="industry_month_"+String.valueOf(counter);%>	
			                         ...
			                         <tr>
			                         	<td  class="row-even" align="center" colspan="6">
			                           <html:submit property="" styleClass="formbutton" value="Add more"  onclick="submitEmployeeInfoAdd('resetExperienceInfoEdit','ExpAddMore'); return false;"></html:submit>
										 <c:if test="${GuestFacultyInfoForm.industryExpLength>0}">
				                        	<html:submit property="" styleClass="formbutton" value="Remove"  onclick="submitEmployeeInfoAdd('removeExperienceInfoEdit','ExpAddMore'); return false;"></html:submit>
				                        </c:if>
							...
							<tr>
								...
								<tr>
			                        <td  class="row-even" align="center" colspan="8">
			                         <html:submit property="" styleClass="formbutton" value="Add more"  onclick="submitEmployeeInfoAdd('addQualificationLevelEdit','ExpAddMore'); return false;"></html:submit>
									 <c:if test="${GuestFacultyInfoForm.levelSize>=1}">
			                         	<html:submit property="" styleClass="formbutton" value="Remove"  onclick="submitEmployeeInfoAdd('removeQualificationLevelEdit','ExpAddMore'); return false;"></html:submit>
			                         </c:if>
