...
<SCRIPT type="text/javascript">
	function editBiometric(id){
		document.location.href = "biometricDetails.do?method=editBiometricDetails&id="+id;
	}
	function deleteBiometric(id){
		document.location.href = "biometricDetails.do?method=deleteBiometricDetails&id="+id;
	}
	...
	function resetFormFields(){
		...
		if (document.getElementById("method").value == "updateBiometricDetails") {
			...
			document.getElementById("workLocation").value = document.getElementById("origWorkLocation").value;
		}	
		resetErrMsgs();
	}
</SCRIPT>

<html:form action="/biometricDetails">
	<html:hidden property="formName" value="biometricDetailsForm" />
	<html:hidden property="pageType" value="1" />
	<html:hidden property="origMachineId"	styleId="origMachineId" name="biometricDetailsForm"/>
	<html:hidden property="origMachineIp"	styleId="origMachineIp" name="biometricDetailsForm"/>
	<html:hidden property="origMachineName"	styleId="origMachineName" name="biometricDetailsForm"/>
	<html:hidden property="origWorkLocation"	styleId="origWorkLocation" name="biometricDetailsForm"/>
	<c:choose>
	...
	<table width="100%" border="0">
		<tr>
			...
			<bean:message key="knowledgepro.employee.biometric" /> &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="body"><strong
						...
						key="knowledgepro.employee.biometric" /></strong></td>
								...
								<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										<tr>
											...
											<td class="row-even" width="25%"><html:text name="biometricDetailsForm"
										...
										<tr>
											...
											<td class="row-even" width="25%"><html:text name="biometricDetailsForm"
												...
												<html:text name="biometricDetailsForm"
												property="workLocation" styleId="workLocation"
												styleClass="TextBox" size="16" maxlength="10" />
												</td>
										</tr>
									</table>
									</td>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										<tr>
											...
											<table width="100%" cellspacing="1" cellpadding="2">
												...
												<logic:notEmpty name="biometricDetailsForm" property="biometricList">
												<logic:iterate name="biometricDetailsForm"
