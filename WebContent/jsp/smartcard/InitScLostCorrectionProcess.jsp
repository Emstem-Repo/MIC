...
function getDetails(){
	document.getElementById("method").value = "ScLostCorrectionProcessSearch";
		...
		<td valign="top">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<strong class="boxheader"><bean:message key="knowledgepro.smartcard.lostcorrection.process" /></strong></td>
