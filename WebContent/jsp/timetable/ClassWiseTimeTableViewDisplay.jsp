...
function printTimeTable(){
	var url ="classWiseTimeTableView.do?method=printClassWiseTimeTable";
...
<html:form action="/classWiseTimeTableView" method="post">
	...
	<html:hidden property="method" styleId="method" value="initClassWiseTimeTableView"/>
			...
			<td>
				<span class="heading">
					...
					<span class="Bredcrumbs">
						&gt;&gt;<bean:message key="knowledgepro.viewTimeTable.classWise"/>
				 		&gt;&gt;
				 	</span>
				 </span>
			 </td>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									<td height="25" colspan="6" class="heading">Class Name
									: <bean:write name="ClassWiseTimeTableViewForm"
										property="academicClass" /></td>

								</tr>
								<tr>
									<td width="71" height="25" class="row-odd">Week Day</td>
									<nested:iterate id="val" name="ClassWiseTimeTableViewForm" property="periodList">
