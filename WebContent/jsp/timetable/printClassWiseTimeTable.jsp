		...
		<tr>
			...
			<td valign="top">
				<table width="100%" cellspacing="1" cellpadding="2">
					<tr>
						<td height="25" colspan="6" class="heading">
							Class Name: <bean:write name="ClassWiseTimeTableViewForm" property="academicClass" />
						</td>
					</tr>
					<tr>
					...
					<nested:iterate id="object" property="subTimeList"	indexId="count">
						<c:choose>
							...
							<td height="25"><nested:write name="object"	property="dayName" /></td>
