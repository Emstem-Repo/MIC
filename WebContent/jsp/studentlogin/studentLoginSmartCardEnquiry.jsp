					...
					<table width="70%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<tr>
									...
									<bean:write name="newStudentCertificateCourseForm" property="nameOfStudent"/>
									</td>
								</tr>
								<tr>
									...
									<bean:write name="newStudentCertificateCourseForm" property="regNo"/>
									</td>
								</tr>
								<tr>
								<td class="studentrow-odd" align="right">
									...
									<td class="studentrow-even">
									<bean:write name="newStudentCertificateCourseForm" property="className"/>
									</td>
								</tr>
								<tr>
									<td class="studentrow-odd" align="right" width="50%" >
									...
									<td class="studentrow-even" width="50%" >
									<bean:write name="newStudentCertificateCourseForm" property="certificateCourseName"/> &nbsp;&nbsp;<html:button property=""
								styleClass="btnbg" value="Change Certificate Course"
								...
								<tr>
									...
									<td class="studentrow-even" width="50%" >
									<bean:write name="newStudentCertificateCourseForm" property="feeAmt"/>
									</td>
								</tr>
							</table>
							</td>
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2" align="center">
								...
								<tr>
									...
									<td class="studentrow-even" width="50%">
									<html:text name="newStudentCertificateCourseForm" property="dob" styleId="dob" size="10" maxlength="16"/>
									<script language="JavaScript">
									new tcal( {
										// form name
										'formname' :'newStudentCertificateCourseForm',
										// input name
										'controlname' :'dob'
									});
									</script>
								...
								<tr>
									...
									<td class="studentrow-even" width="50%">XXXXXXXXXXXXXX
										<html:text name="newStudentCertificateCourseForm" property="smartCardNo" styleId="smartCardNo" size="5" maxlength="5"></html:text>									
									</td>
								</tr>
								<tr>
									<td class="studentrow-odd" align="right" width="50%">
									...
									<td class="studentrow-even" width="50%">
										<html:text name="newStudentCertificateCourseForm" property="validThruMonth" styleId="validThruMonth" size="2" maxlength="2" onkeypress="return isNumberKey(event)"></html:text> /
										<html:text name="newStudentCertificateCourseForm" property="validThruYear" styleId="validThruYear" size="2" maxlength="2" onkeypress="return isNumberKey(event)"></html:text>
										&nbsp;&nbsp; mm/yy
									</td>
								</tr>
							</table>
