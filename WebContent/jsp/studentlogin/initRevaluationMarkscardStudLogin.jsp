...
function getHideSuppExam()
{
	...
	document.getElementById("suppExamId").value="";
}
function getHideRegularExam()
{
	...
	document.getElementById("dataRegularLabel").style.display="none";
	 ...
	 document.getElementById("regularExamId").value="";
}
 ...
 function getMarkscard()
{
	...
	if(supp !=null && supp!=""){
		document.getElementById("method").value="revaluationMemoDisplay";
...
function getMarkscard(){
	...
	supp=document.getElementById("suppExamId").value;
	if(supp !=null && supp!=""){
		var url = "StudentLoginAction.do?method=revaluationMemoDisplay&regularExamId="+supp;
		var browserName=navigator.appName; 
			 myRef = window.open(url,"MarksCard","left=20,top=20,width=900,height=900,toolbar=1,resizable=0,scrollbars=1");
	}
	else if(regular !=null && regular!=""){
		var url = "StudentLoginAction.do?method=revaluationMemoDisplay&regularExamId="+regular;
		var browserName=navigator.appName; 
			 myRef = window.open(url,"MarksCard","left=20,top=20,width=900,height=900,toolbar=1,resizable=0,scrollbars=1");
