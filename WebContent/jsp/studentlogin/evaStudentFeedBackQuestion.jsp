...
function editFeedBackQuestion(id) {
	document.location.href = "StudentFeedBackQuestion.do?method=editFeedBackQuestion&id="+id;
	}
...
function reActivate() {
	document.location.href="StudentFeedBackQuestion.do?method=reActivateFeedBackQuestion";
}

function deleteFeedBackQuestion(id) {
	deleteConfirm =confirm("Are you sure to delete this entry?");
	if(deleteConfirm)
	document.location.href = "StudentFeedBackQuestion.do?method=deleteFeedBackQuestion&id="+id;
	}

</script>
</head>
<html:form action="/StudentFeedBackQuestion" method="POST">
...
<html:hidden property="formName" value="studentFeedBackQuestionForm" />
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td background="images/Tcenter.gif" class="heading_white" ><bean:message key="knowledgepro.studentFeedBack.questionn"/> </td>
          ...
          <tr>
            <td height="45" colspan="4" ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <logic:notEmpty name="studentFeedBackQuestionForm" property="feedBackQuestionList">
                <logic:iterate id="CME" name="studentFeedBackQuestionForm" property="feedBackQuestionList" indexId="count">
                <c:choose>
                   <c:when test="${temp == 0}">
                   	<tr>
