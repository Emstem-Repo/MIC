                ...
                <tr>
                  ...
                  <table width="100%" cellspacing="1" cellpadding="2">
					...
					<tr >
                      ...
                      <tr >
                        <td width="20%" height="25" class="studentrow-even" ><bean:message key="knowledgepro.feepays.billno"/>:&nbsp;&nbsp;<bean:write name="loginform" property="billNo"/></td>
                        <td width="20%" height="25" class="studentrow-even" >Date: &nbsp;&nbsp;<bean:write name="loginform" property="challanPrintedDate"/></td>
                        <td width="20%" class="studentrow-even" >Time: &nbsp;&nbsp;<bean:write name="loginform" property="chalanCreatedTime"/></td>
                        <td width="40%" class="studentrow-even">A/c. No.: &nbsp;&nbsp;<font color="blue"><b><bean:write name="feeAccount" property="printAccountName"/></b></font>&nbsp;&nbsp; 
						</td>
                      </tr>
                      <tr >
                        <td width="20%" height="25" class="studentrow-even" >Name: &nbsp;&nbsp;<bean:write name="loginform" property="studentName"/></td>
                        <td width="20%" class="studentrow-even" >Reg No/ App No:&nbsp;&nbsp;<bean:write name="loginform" property="applnNo"/></td>
                        <td width="20%" height="25" class="studentrow-even" >Class: &nbsp;&nbsp;<bean:write name="loginform" property="className"/></td>
                        <td width="40%" class="studentrow-even" >Scheme No: &nbsp;&nbsp;<bean:write name="loginform" property="semister"/>
						&nbsp; &nbsp;<font color="blue"><b><bean:write name = "loginform" property="paymentMode"/></b></font></td>
                      </tr>
                      <tr >
                        ...
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td height="206" valign="top"><table width="100%" border="1" cellpadding="2" cellspacing="1">
                                  <tr class="row-white">
                                    <td width="50%" height="25" colspan="2" rowspan="2" class="studentrow-odd"><div align="center">DESCRIPTIONS</div></td>
                                    <td width="30%" height="25" rowspan="2" class="studentrow-odd"><div align="center">Additional Fees</div></td>
                                    <td width="20%" height="17" class="studentrow-odd"><div align="center">Amount</div></td>
                                  </tr>
                                  <tr class="row-white">
                                    <td height="14" class="studentrow-odd"><div align="center">Rs.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ps.</div></td>
                                  </tr>
                                  <tr class="row-white" >
									<td class="studentrow-even" valign="top" height="160" width="25%">
										<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
									...
									<td class="studentrow-even" valign="top" height="160">
										<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
										<tr><td>&nbsp;</td>
										<tr>
										<tr><td>&nbsp;</td>
								...
								<tr class="row-white">
								<td class="studentrow-even" colspan="3" align="center"><div class="heading">TOTAL</div>
								</td>
								<td class="studentrow-even" align="right"><div class="heading"><bean:write name="feeAccount" property="netAmount"/>&nbsp;&nbsp;</div>
								</td>
								</tr>
								</td>
								</table>
                              ...
                              <tr class="row-white" >
							<td class="studentrow-even" valign="top"  colspan="4">
							<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
							<tr>
								<td class="studentrow-even" align="center">
							 		<bean:write  name="feeAccount" property="bankInfo"/>
								</td>
							</tr>
							<tr class="row-white" >
								 <td height="25" class="studentrow-even" valign="bottom" align="center">Verified: <bean:write name="loginform" property="verifiedBy"/>&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <tr >
                        <td height="25" colspan="4" class="row-white" >Received: &nbsp;&nbsp;<b><bean:write name="feeAccount" property="netAmount"/></b>&nbsp;&nbsp; (IN &nbsp;<bean:write name="loginform" property="currencyCode"/>)</td>
                      </tr>
                      <tr >
