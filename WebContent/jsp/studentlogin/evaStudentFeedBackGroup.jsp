...
function editFeedBackGroup(id) {
	...
	document.location.href = "StudentFeedBackGroup.do?method=editFeedBackGroup&id="+id;
	}
...
function reActivate() {
	...
	document.location.href="StudentFeedBackGroup.do?method=reActivateFeedBackGroup&name="+name;
}
...
function deleteFeedBackGroup(id) {
	...
	document.getElementById("CMID").value=id;
	if(deleteConfirm)
	document.location.href = "StudentFeedBackGroup.do?method=deleteFeedBackGroup&id="+id;
	}

</script>
</head>
<html:form action="/StudentFeedBackGroup" method="POST">
...
<html:hidden property="formName" value="evaStudentFeedBackGroupForm" />
          ...
          <tr>
            <td height="45" colspan="4" ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <logic:notEmpty name="evaStudentFeedBackGroupForm" property="feedBackGroupList">
                <logic:iterate id="CME" name="evaStudentFeedBackGroupForm" property="feedBackGroupList" indexId="count">
                <c:choose>
                   <c:when test="${temp == 0}">
                   	<tr>
