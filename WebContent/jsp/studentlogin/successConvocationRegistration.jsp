...
<link rel="stylesheet" type="text/css" href="css/styles.css"/>
	...
	<html:hidden property="method" styleId="method" value="saveConvocationRegistration" />
	...
	<table width="90%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/st_Tcenter.gif" class="body"><strong
						class="boxheader">SUCCESS CONVOCATION REGISTRATION</strong></td>
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<tr><td colspan="2">
							<div id="errorMessage" class="heading"><FONT color="red"><html:errors /></FONT>
