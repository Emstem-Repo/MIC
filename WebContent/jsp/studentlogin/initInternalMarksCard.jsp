...
{
	document.getElementById("method").value="getInternalMarkDetails";
...
<html:form action="/StudentLoginAction">
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt;Internal Marks card &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader">Internal Marks card</strong></div>
					</td>
					...
					<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<tr>
								...
								<tr class="data">
									<td height="20" class="studentrow-odd" width="50%"  align="left">
										<span class="Mandatory">*</span>Class 	</td>
									<td height="25" class="studentrow-even" width="50%" >
										<html:select property="internalClassId" styleId="internalClassId">
											<html:option value=""><bean:message key="knowledgepro.select"/></html:option>
												<logic:notEmpty property="internalClassesMap" name="loginform">
											  		<html:optionsCollection property="internalClassesMap" label="value" value="key" name="loginform"/>
											   </logic:notEmpty>
										 </html:select> 
