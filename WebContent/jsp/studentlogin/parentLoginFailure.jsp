...
<html:form action="/ParentLoginAction">
	...
	<center>
	<form>
	<p align="center" style="font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 12px;font-weight: bold; color: #636161;">User Name:<html:text property="parentUserName" styleId="username" size="30" maxlength="50" styleClass="text"></html:text></p>
	<p align="center" style="font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 12px;font-weight: bold; color: #636161;">Password:&nbsp;&nbsp;<html:password property="parentPassword" styleId="password" size="30" styleClass="password" maxlength="200"></html:password></p>
