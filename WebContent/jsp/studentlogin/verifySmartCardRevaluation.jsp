		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader">Revaluation/Retotalling Application </strong></div>
					</td>
						...
						<tr>
							...
							<tr>
								...
								<td class="studentrow-odd" align="right">
									...
									<td class="studentrow-even">
									<bean:write name="loginform" property="className"/>
									</td>
								</tr>
								<tr>
									<td class="studentrow-odd" align="right" width="50%" >
									...
									<td class="studentrow-even" width="50%" >
									<bean:write name="loginform" property="totalFees"/>
									</td>
								</tr>
							</table>
							</td>
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2" align="center">
								...
								<tr>
									...
									<td class="studentrow-even" width="50%">
									<html:text name="loginform" property="enteredDob" styleId="enteredDob" size="10" maxlength="16"/>
									<script language="JavaScript">
									new tcal( {
										// form name
										'formname' :'loginform',
										// input name
										'controlname' :'enteredDob'
									});
									</script>
									</td>
								</tr>
