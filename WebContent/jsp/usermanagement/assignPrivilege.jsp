...
<script type="text/javascript">
	function addPrivilege() {
		...
		document.assignPrivilegeForm.submit();
	}
	function deletePrivilege(roleId) {
		deleteConfirm = confirm("Are you sure want to delete this entry?")
		if (deleteConfirm) {
			document.location.href = "AssignPrivilege.do?method=deletePrivilege&roleId="
					+ roleId;
		}
	}
	function reActivate() {
		var roleId = document.getElementById("rId").value;
		document.location.href = "AssignPrivilege.do?method=reActivatePrivilege&roleId="
				+ roleId;
	}

	function viewAllonRole(roleId) {

		var url = "AssignPrivilege.do?method=getModuleMenuOnRole&roleId="
				+ roleId;
		myRef = window
	...
	function displayOnId(roleId){
		document.location.href = "AssignPrivilege.do?method=editPrivilege&roleId="
			+ roleId;
	}
...
<html:form action="/AssignPrivilege" method="post">
	<html:hidden property="method" styleId="method" />
	<html:hidden property="formName" value="assignPrivilegeForm" />
							...
							<table width="100%" height="30" border="0" cellpadding="0"
								...
								<tr class="row-white">
									...
									<td width="50%" class="row-even"><html:select
										name="assignPrivilegeForm" property="roleId"
										styleClass="combo" styleId="rId">
										<html:option value="">- <bean:message
												key="knowledgepro.select" /> -</html:option>
										<logic:notEmpty name="assignPrivilegeForm" property="roleList">		
										<html:optionsCollection name="assignPrivilegeForm"
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<table width="100%" height="79" border="0" cellpadding="0"
								cellspacing="1">
								<logic:notEmpty name="assignPrivilegeForm" property="moduleList">
									<nested:iterate name="assignPrivilegeForm" id="privilege"
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								<logic:notEmpty name="assignPrivilegeForm"
									property="privilegeList">
									<nested:iterate id="prev" name="assignPrivilegeForm"
