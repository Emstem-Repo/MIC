...
<script src="js/menuScreen.js" type="text/javascript"></script>
<style type="text/css">
.highlight{background: #6495ED;}   
</style>
<html:form action="/menuScreen">
	<html:hidden property="method" styleId="method" value="addMenuAssignAggrement"/>
	...
	<table width="100%" border="0">
		<tr>
			...
			<bean:message key="knowledgepro.usermanagement.menuScreenMaster" /> &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<table width="100%" cellspacing="1" cellpadding="2">
						...
						<tr>
						<td height="15" bgcolor="#E6E6FA">Menu Name :- <bean:write name="screenMasterForm" property="menuName"/>
						</td>
						</tr>
					<tr>
					<td>
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								<logic:notEmpty name="screenMasterForm" property="privilegeList">
								<tr>
									<nested:iterate id="prev" name="screenMasterForm" property="privilegeList" indexId="count">
									<%
