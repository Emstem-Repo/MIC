...
function editUserInfo() {
	document.location.href = "EditUserInfo.do?method=editUser";
}
...
function cancelUserInfo() {
	document.location.href = "EditUserInfo.do?method=searchUsers";
}
...
function clearDepartment(){
	var gstId=document.getElementById("guestId");
	var empId=document.getElementById("employeeId");
	if(empId!=null && gstId==null)			
	{
	document.getElementById("departmentId").disabled=true;
	}
	else if(empId == null && gstId!=null)			
	{
		document.getElementById("departmentId").disabled=true;
	}
	else
...
<html:form action="/EditUserInfo" method="post" enctype="multipart/form-data">
							...
							<table width="98%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<td width="28%" height="25" class="row-even"
												...
												<html:radio property="staffType" styleId="employee" value="employee" onchange="getEmployee(this.value)" onclick="getEmployee()">Employee</html:radio>
												<html:radio property="staffType" styleId="guest" value="guest" onchange="getGuest(this.value)" onclick="getGuest">Guest</html:radio>
												<html:radio property="staffType" styleId="others" value="others" onchange="disableBoth(this.value)" onclick="disableBoth()">Others</html:radio>
											</td>
										</tr>
								...
								<td height="25" class="row-odd">
										...
										<div id="ShowEmployee2">
											<html:select property="employeeId" styleId="employeeId" styleClass="comboLarge">
												<html:option value="">
										...
										<div id="ShowGuest2">
											<html:select property="guestId" styleId="guestId" styleClass="comboLarge">
												<html:option value="">
													<bean:message key="knowledgepro.admin.select" />
												</html:option>
										...
										<td height="25" class="row-odd">
											...
											<td height="25" class="row-odd">
											<div align="right"><bean:message key="knowledgepro.employee.already.login"/></div>
											</td>
											<td width="28%" height="25" class="row-even" align="left" colspan="3">
												<html:radio property="alreadyLoggedIn" value="true"><bean:message key="knowledgepro.yes" /></html:radio>
												<html:radio property="alreadyLoggedIn" value="false"><bean:message key="knowledgepro.no" /></html:radio>
											</td>
										</tr>
										<tr>
										<td height="25" class="row-odd" >
								...
								<td   class="row-even"  align="left" width="28%">
									<html:text name="editUserInfoForm" property="tillDate" styleId="tillDate" size="10" maxlength="16"/>
										<script
											language="JavaScript">
												new tcal( {
												// form name
											...
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
												<tr>
													...
													<html:submit property="" styleClass="formbutton" value="Submit"
															onclick="updateUsers()"></html:submit>
													</td>
													<td width="2%"></td>
													<td height="45" align="left" width="2%">
													<html:button property="" styleClass="formbutton" value="Reset"
																onclick="editUserInfo()"></html:button>
													</td>
													<td width="2%"></td>
													 <td height="35" align="left"><html:button property="" styleClass="formbutton" value="Cancel" onclick="cancelUserInfo()"></html:button></td>
