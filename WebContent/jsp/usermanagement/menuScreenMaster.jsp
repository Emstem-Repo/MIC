...
function editMenu(id) {
	...
	document.location.href = "menuScreen.do?method=editMenus&menuId="+id;
}
...
function deleteMenu(id) {
	...
	document.getElementById("MID").value=id;
	if(deleteConfirm)
	document.location.href = "menuScreen.do?method=deleteMenus&menuId="+id;
}
...
function reActivate() {
	...
	document.location.href="menuScreen.do?method=reActivateMenus&sequence="+seq+"&oldModuleId="+oldMID;
}
function assignMenu(menuId,moduleId,menuName) {
	...
	document.getElementById("method").value="assignPrivilegeRole";
	document.screenMasterForm.submit();
}

</script>
<html:form action="/menuScreen" method="POST">
...
<c:choose>
	...
	<html:hidden property="formName" value="screenMasterForm" />
	...
	<table width="100%" border="0">
		<tr>
			<td><span class="Bredcrumbs"><bean:message
				...
				key="knowledgepro.usermanagement.menuScreenMaster" />&gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td valign="top">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td width="954" background="images/Tcenter.gif" class="body"><strong
						...
						key="knowledgepro.usermanagement.menuScreenMaster" /></strong></td>
							...
							<table width="100%" height="53" border="0" cellpadding="0"
								...
								<tr class="row-white">
									...
									<td class="row-even"><html:text property="sequence"
										styleId="seq" maxlength="3"/></td>
									
									<td width="24%" height="25" class="row-odd"><div align="right" ><span class="Mandatory">*</span> New Tab:</div></td>
	                          <td width="26%" class="row-even" colspan="3">
					           <html:radio property="newtab" name="screenMasterForm" value="true" styleId="fixed">Yes</html:radio>
					           <html:radio property="newtab"  name="screenMasterForm" value="false" styleId="fixed">No</html:radio>
					           <td class="row-odd">&nbsp;</td>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								<logic:notEmpty name="screenMasterForm" property="menusList">
								<tr>
								  <logic:iterate id="menu" name="screenMasterForm" property="menusList" indexId="count">
									<c:choose>
										...
										<c:otherwise><tr class="row-white"></c:otherwise>
												...
												<td align="center"><bean:write
													name="menu" property="moduleTO.name" /></td>
												<td align="center"><bean:write
													name="menu" property="name" /></td>
												<td align="center"><bean:write name="menu"
													property="url" /></td>
												<td align="center"><bean:write
													name="menu" property="position" /></td>
												<td align="center">
												<div align="center"><img src="images/AssignPrivilege.jpg" style="cursor:pointer" 
													width="16" height="18" onclick="assignMenu('<bean:write name="menu" property="id"/>','<bean:write name="menu" property="moduleTO.id"/>','<bean:write name="menu" property="name"/>')"></div>
												</td>
												<td align="center">
												<div align="center"><img src="images/edit_icon.gif" style="cursor:pointer" 
													width="16" height="18" onclick="editMenu('<bean:write name="menu" property="id"/>')"></div>
												</td>
												<td align="center">
												<div align="center"><img src="images/delete_icon.gif" style="cursor:pointer" 
													width="16" height="16" onclick="deleteMenu('<bean:write name="menu" property="id"/>')"></div>
												</td>
												</logic:iterate>
											</tr>
								</logic:notEmpty>
