...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td valign="top">
			...
			<tr>
				<td colspan="2">
					<logic:notEmpty property="messageList" name = "documentSubmissionScheduleForm">
											<table width="100%" cellspacing="1" cellpadding="2">
												<logic:iterate id="message" property="messageList" name= "documentSubmissionScheduleForm">
