...
function getDocumentPending(){
		document.getElementById("method").value = "getDocumentPending";
		document.documentSubmissionScheduleForm.submit();
		}
	function SendMailsPendingDocument(){
		document.getElementById("method").value = "SendMailsPendingDocument";
		document.documentSubmissionScheduleForm.submit();
		}
	function Cancel(){
		document.location.href="PhdDocumentPendingSearch.do?method=initPendingDocument";
	}
...
<html:form action="/PhdDocumentPendingSearch" method="post">
	...
	<table width="99%" border="0">
		<tr>
			<td><span class="Bredcrumbs"><bean:message
				...
				Pending Document Search&gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td width="9"><img src="images/Tright_03_01.gif" width="9"
						height="29"></td>
					<td background="images/Tcenter.gif" class="heading_white">Pending Document Search</td>
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<td height="25" class="row-odd" align="center"><div align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.phd.ason.date"/>:</div></td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td height="35" align="center"><html:submit property=""
								...
								onclick="getDocumentPending()"></html:submit></td>
						</tr>
					</table>
					</td>
					<td valign="top" background="images/Tright_3_3.gif"></td>
		 		...
		 		<logic:present name="documentSubmissionScheduleForm" property="studentDetailsList">
					<tr>
						...
						<table width="100%" border="0" align="left" cellpadding="0"
									...
									<tr>
										...
										<table width="100%" cellspacing="1" cellpadding="2">
											<tr>
												...
												<td width="15%" class="row-odd">
												<div align="center"><bean:message
													key="knowledgepro.reports.due.date" /></div>
												</td>
											</tr>
											<tr>
											<nested:iterate id="studentList" property="studentDetailsList" name="documentSubmissionScheduleForm" indexId="count">
											      <c:choose>
													...
													<td ><div align="left"><bean:write property="documentName" name="studentList" /></div></td>
													<td ><div align="center"><bean:write property="assignDate" name="studentList" /></div></td>
											</nested:iterate>
											</tr> 
											</table>
										</td>
							...
							<html:submit property="" styleClass="formbutton" onclick="SendMailsPendingDocument()"> <bean:message key="knowledgepro.phd.due.mail" />
							</html:submit>
