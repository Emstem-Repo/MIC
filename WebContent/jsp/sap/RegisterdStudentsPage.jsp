...
<html:hidden property="method" styleId="method" value="updateKeysInSapRegistration"/>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="5%" height="35" align="right">
								<html:submit property="" value="Assign Key" styleId="assignKey" styleClass="formbutton"></html:submit>
							</td>
