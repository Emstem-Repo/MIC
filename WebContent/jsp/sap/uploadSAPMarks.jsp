			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					key="knowledgepro.mandatoryfields" /></span></div>
						...
						<tr>
						<logic:equal value="true" name="uploadSAPMarksForm" property="emptyStatus">
						 	<c:if test="${uploadSAPMarksForm.emptuStatusRegNum != null && uploadSAPMarksForm.emptuStatusRegNum  != ''}">
							<FONT color="red"><bean:write name="uploadSAPMarksForm" property="emptyStatusMsg"/><br/>
							<bean:write name="uploadSAPMarksForm" property="emptuStatusRegNum"/></FONT><br/></c:if>
						</logic:equal>
						</tr>
								...
								<tr>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										...
										<td class="row-odd" width="25%">
											<div align="right"><span class="Mandatory">*</span>Exam Date:</div></td>
											<td width="25%" height="25" class="row-even"><html:text
										name="uploadSAPMarksForm" property="examDate"
										styleId="examDateID" size="10" maxlength="10" /> <script
										language="JavaScript">
										...
										$(function(){
											 var pickerOpts = {
											  ...
											  $("#examDateID").datepicker(pickerOpts);
											});
										</script>  </td>
