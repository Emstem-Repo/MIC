						...
						<table width="100%">
							...
							<tr>
								...
								<td  height="25"  align="left"><bean:write
									name="examRegDetailsForm" property="receiptNumber" /></td>
								<td  align="right">Date:</td>
								<td   align="left"><bean:write
									name="examRegDetailsForm" property="paidDate" /></td>
								<td  height="25" align="right">Time:</td>
								<td align="left"><bean:write
									name="examRegDetailsForm" property="time" /></td>
							</tr>
							<tr>
								<td  height="25" align="right">Reg No:</td>
								<td  height="25"  align="left"><bean:write
									name="examRegDetailsForm" property="regNo" /></td>
								<td height="25" align="right">&nbsp;&nbsp;&nbsp;&nbsp;Name:</td>
								<td  height="25" colspan="3" align="left"><bean:write
									name="examRegDetailsForm" property="nameOfStudent" /></td>
							...
							<td colspan="6" valign="top">
								<table width="100%" style="border:1px solid #000000">
									...
									<logic:notEmpty name="examRegDetailsForm" property="receiptListSize">
											<tr>
												<td height="25" align="center"><c:out value="${count + 1}" /></td>
												<td height="25" align="left"><bean:write	name="examRegDetailsForm" property="pcAccHead" /></td>
												<td height="25" align="left"><bean:write	name="examRegDetailsForm" property="details" /></td>
												<td height="25" align="right"><bean:write name="examRegDetailsForm" property="total" /></td>
											</tr>
									</logic:notEmpty>
									<tr>
										...
										<bean:write name="examRegDetailsForm" property="total" />
										</td>
									</tr>
								</table>
							...
							<tr> 
							<td colspan="2" align="left"><bean:write property="userName" name="examRegDetailsForm" /></td>
							<td colspan="2" align="left">Rupees:&nbsp;<bean:write name="examRegDetailsForm" property="rupeesInWords" /> ONLY</td>
							<td colspan="2"></td>
							</tr>
						</table>
