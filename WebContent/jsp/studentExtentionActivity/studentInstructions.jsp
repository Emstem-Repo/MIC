...
function addLeaveAppInstructions() {
	document.getElementById("method").value="addStuFeedbackInstructions";
}
...
function deleteInstructions(id) {
	...
	if(deleteConfirm)
		document.location.href = "StudentInstruction.do?method=deleteStuFeedbackInstructions&id="+id;
}
...
function editInstructions(id){
	document.getElementById("NWID").value=id;
	document.location.href = "StudentInstruction.do?method=editStuFeedbackInstructions&id="+id;
}
</script>
<html:form action="/StudentInstruction" method="POST">
<html:hidden property="id" styleId="NWID"/>
<html:hidden property="formName" value="StudentInstructionForm" />
...
<c:choose>
	...
	<c:choose>
		<c:when test="${instructions != null && instructions == 'edit'}">
			<html:hidden property="method" styleId="method" value="updateStuFeedbackInstructions" />
		</c:when>
		<c:otherwise>
			<html:hidden property="method" styleId="method" value="addStuFeedbackInstructions" />
		</c:otherwise>
	</c:choose>
<table width="99%" border="0">
  
  <tr>
    <td><span class="Bredcrumbs"><bean:message key="knowledepro.studentInstruction"/> <span class="Bredcrumbs">&gt;&gt; Student Feedback Instructions &gt;&gt;</span> </span></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="heading_white" >Student Instructions</td>
          ...
          <tr>
			...
			<tr>
				...
				<td colspan="3" class="row-even"><label> 
					<html:textarea property="description" styleId="description" style="width: 83%" cols="80" rows="8" onkeypress="return imposeMaxLength(event,this)"><br/></html:textarea> 
				</label></td>
			</tr>
          ...
          <tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <logic:notEmpty name="StudentInstructionForm" property="stuFeedbackInsToList">
                <logic:iterate id="INS" name="StudentInstructionForm" property="stuFeedbackInsToList" indexId="count">
                <c:choose>
                   <c:when test="${temp == 0}">
                   	<tr>
