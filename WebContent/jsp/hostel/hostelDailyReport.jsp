...
<html:hidden property="method" styleId="method" value="getHostelDailyReportDetails"/>
            ...
            <tr>
              ...
              <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
                  <tr >
                    ...
                    <td height="25" class="row-even" ><html:select property="hostelId" name="hostelDailyReportForm" styleClass="combo" styleId="name">
										<html:option value="">-<bean:message key="knowledgepro.select" />-</html:option>
										<html:optionsCollection name="hostelList" label="name" value="id"/>
									</html:select></td>
                    <td height="25" class="row-even" >&nbsp;</td>
                    <td width="26%" height="25" colspan="2" class="row-even" ><label></label></td>
                  </tr>
                   <tr >
                    <td width="25%" height="25" class="row-odd" ><div align="right">* <bean:message key="knowledgepro.hostel.student.from.date"/></div></td>
                    <td width="25%" class="row-even" ><html:text name="hostelDailyReportForm" property="fromDate" styleId="fromDate"	size="10" maxlength="10" />
                        <script language="JavaScript">
										new tcal ({
													// form name
														'formname': 'hostelDailyReportForm',
													// input name
                    ...
                    <td width="25%" class="row-even" ><html:text name="hostelDailyReportForm" property="toDate" styleId="toDate"	size="10" maxlength="10" />
                        <script language="JavaScript">
								new tcal ({
											// form name
													'formname': 'hostelDailyReportForm',
      ...
      <tr>
        ...
        <td valign="top" ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="3%"></td>
              <td width="48%"><html:button property="" styleClass="formbutton" onclick="resetMessages()"><bean:message key="knowledgepro.admin.reset"/></html:button></td>
            </tr>
        </table></td>
