...
<html:form action="/ResidentStudentInfo">	
	<html:hidden property="method" styleId="method" value="searchResidentStudent" />
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td height="24" class="row-odd" colspan="2"><div align="right"><span class="Mandatory">* </span><bean:message key="knowledgepro.hostel.name"/></div></td>
	                  		<td  class="row-even"  colspan="3"><html:select property="hostelId" styleClass="combo"
											styleId="hostelId" >
											<html:option value="">-<bean:message
													key="knowledgepro.select" />-</html:option>
													<logic:notEmpty property="hostelList" name="residentStudentInfoForm">
											<html:optionsCollection property="hostelList" name="residentStudentInfoForm" label="name" value="id"/>
											</logic:notEmpty>
										</html:select>
							</td>
						</tr>
								...
								<div align="right"><bean:message
									key="knowledgepro.attendance.regrollno" />:</div>
								</td>
								<td width="24%" height="25" class="row-even">
								<html:text property="studentId" styleId="studentId" styleClass="TextBox"
									size="20" maxlength="20" /></td>
								<td class="row-even" align="center" width="4%"><strong>OR</strong></td>
								<td width="24%" class="row-odd">
								<div align="right"><bean:message key="knowledgepro.fee.studentname"/></div>
								</td>
								<td width="24%" class="row-even">
								<html:text property="studentName" styleId="studentName" styleClass="TextBox" maxlength="50" />
								</td>	
								</tr>
							</table>
							</td>
