...
function resetMessages() {
	document.getElementById("roomNoId").value = "";
	document.getElementById("hostel").selectedIndex = 0;
	document.getElementById("floorNamesId").selectedIndex = 0;
	resetErrMsgs();
}
function searchHostelOccupancyRegister(){
	var hostName="";
	document.getElementById("hostelNameId").value=hostName;
	if(document.getElementById("hostel").options[document.getElementById("hostel").selectedIndex].text != "- Select -"){
		//alert("eyah");
		hostName=document.getElementById("hostel").options[document.getElementById("hostel").selectedIndex].text;
		document.getElementById("hostelNameId").value=hostName;
	}
	document.getElementById("method").value = "getHostelOccupancyRegisterPage";
	document.listOfOccupancyRegisterForm.submit();
}
</script>
<html:form action="/listOfOccupancyRegister" method="post">
	<html:hidden property="method" styleId="method" />	
	<html:hidden property="formName" value="listOfOccupancyRegisterForm" />
	<html:hidden property="pageType" value="1" />
	<html:hidden property="hostelName" styleId="hostelNameId" />
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<html:select
										property="hostelId" styleClass="TextBox" styleId="hostel" onchange="getFloors(this.value)">
										<html:option value="">
									...
									<html:select name="listOfOccupancyRegisterForm" property="floorNo" styleId="floorNamesId" styleClass="combo">
										<html:option value=""><bean:message key="knowledgepro.admin.select" /></html:option>
										<c:if test="${listOfOccupancyRegisterForm.hostelId != null && listOfOccupancyRegisterForm.hostelId != ''}">
												<c:set var="floorMap" value="${baseActionForm.collectionMap['floorMap']}" />
								...
								<tr>
									...
									<html:text property="roomNo" styleClass="TextBox" styleId="roomNoId" size="10" maxlength="10" />
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<html:button property="" styleClass="formbutton" value="Submit"
										onclick="searchHostelOccupancyRegister()"></html:button>
							</div>
							</td>
							<td width="2%"></td>
							<td width="49%">
