            ...
            <td height="42" valign="top" class="body" ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td width="100%" height="28" valign="top"><table width="100%" height="30" border="0" cellpadding="2" cellspacing="1">
                      <tr class="row-white">
                        <td  height="28" align="center" class="row-even"><bean:message key="knowledgepro.hostel.hlApplicationByAdmin.requisitionNo"/>&nbsp;<bean:write name="hostelApplicationByAdminForm" property="maxRequisitionNo"/></td>
                        </tr>
                  </table></td>
      ...
      <tr>
        ...
        <td valign="top" class="news"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <html:button property="" value="Back" styleClass="formButton" onclick="goToHostelApplicationInit()"></html:button>
            </td>
            <td width="2%"></td>
            </tr>
        </table></td>
