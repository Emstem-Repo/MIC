...
<html:form action="/hostelLeave" >
	<html:hidden property="method" styleId="method" value="saveOnlineApplication" />
	...
	<table width="90%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/st_Tcenter.gif" class="body"><strong
						class="boxheader">Hostel Application</strong></td>
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td valign="top">
							<logic:equal value="true" property="recordExist" name="hostelLeaveForm">
							...
							<logic:equal value="false" property="recordExist" name="hostelLeaveForm">
							
							<table width="100%" cellspacing="1" cellpadding="2">
								
			                  <tr class="row-white">
				                 <td width="50%" class="studentrow-odd"><div align="right">Room Type:</div></td>
				                 <td height="25" width="50%" class="studentrow-even">
				                 	<html:select property="roomTypeId" styleId="roomTypeId">
											<html:option value=""><bean:message key="knowledgepro.select"/></html:option>
												<logic:notEmpty property="roomTypeMap" name="loginform">
											  		<html:optionsCollection property="roomTypeMap" label="value" value="key" name="loginform"/>
											   </logic:notEmpty>
										 </html:select>
			                 	</td>
			                 </tr>
			                  <tr class="row-white">
				                 <td width="50%" class="studentrow-odd"><div align="right">Year:</div></td>
				                 <td height="25" width="50%" class="studentrow-even">
