...
<html:form action="/studentEdit" method="POST">
	...
	<input type="hidden" name="applicationId"
		value='<bean:write name="residentStudentInfoForm" property="applicantDetails.applicationId" />' />
	<input type="hidden" name="courseId" value='<bean:write	name="residentStudentInfoForm" property="applicantDetails.course.id" />' />
	...
	<table width="98%" border="0">
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<table width="100%" height="22" border="0" cellpadding="0"
										...
										<tr class="row-white">
											...
											<td  height="20" class="row-even" align="center"><img src='<%=request.getContextPath()%>/PhotoServlet'  height="150Px" width="150Px" /></td>
										</tr>
									</table>
									</td>
									<td background="images/right.gif" width="5" height="22"></td>
							...
							<table width="97%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td height="17" class="row-even" align="left">
											<logic:equal name="residentStudentInfoForm" property="applicantDetails.personalData.areaType" value='R'><bean:message key="admissionForm.studentinfo.belongsto.rural.text"/></logic:equal>
											<logic:equal name="residentStudentInfoForm" property="applicantDetails.personalData.areaType" value='U'><bean:message key="admissionForm.studentinfo.belongsto.urban.text"/></logic:equal></td>
										</tr>
										<tr>
											<td height="17" class="row-odd">
											<div align="right"><bean:message
								...
								<td height="17" class="row-even" align="left"><logic:equal name="residentStudentInfoForm" property="applicantDetails.personalData.gender" value="MALE"><bean:message key="admissionForm.studentinfo.sex.male.text"/></logic:equal>
								<logic:equal name="residentStudentInfoForm" property="applicantDetails.personalData.gender" value="FEMALE"><bean:message key="admissionForm.studentinfo.sex.female.text"/></logic:equal></td>
										</tr>
										<tr><%String dynaStyle3="display:none;"; %>
												<logic:equal value="true" property="applicantDetails.personalData.sportsPerson" name="residentStudentInfoForm">
                           					...
                           					<td height="17" class="row-even" align="left"><logic:equal name="residentStudentInfoForm" property="applicantDetails.personalData.sportsPerson" value="true"><bean:message key="knowledgepro.applicationform.yes.label"/></logic:equal>
											<logic:equal name="residentStudentInfoForm" property="applicantDetails.personalData.sportsPerson" value="false"><bean:message key="knowledgepro.applicationform.No.label"/></logic:equal>
 										...
 										<tr><%String dynaStyle4="display:none;"; %>
											<logic:equal value="true" property="applicantDetails.personalData.handicapped" name="residentStudentInfoForm">
											<%dynaStyle4="display:block;"; %>
                           					...
                           					<td height="17" class="row-even" align="left"><logic:equal name="residentStudentInfoForm" property="applicantDetails.personalData.handicapped" value="true"><bean:message key="knowledgepro.applicationform.yes.label"/></logic:equal>
											<logic:equal name="residentStudentInfoForm" property="applicantDetails.personalData.handicapped" value="false"><bean:message key="knowledgepro.applicationform.No.label"/></logic:equal>
										...
										<logic:equal value="true" property="displaySecondLanguage" name="residentStudentInfoForm">
										 <tr >
				...
				<logic:equal value="true" property="displayExtraDetails" name="residentStudentInfoForm">		
				<tr>
                    ...
                    <tr>
                      ...
                      <td valign="top">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="1">
	                          <tr class="row-white">
	                            <logic:equal value="true" property="displayMotherTongue" name="residentStudentInfoForm">
								...
								<logic:equal value="true" property="displayHeightWeight" name="residentStudentInfoForm">
							...
							<logic:equal value="true" property="displayLanguageKnown" name="residentStudentInfoForm">
							<tr class="row-white">
							...
							<logic:equal value="true" property="displayTrainingDetails" name="residentStudentInfoForm">
							<tr class="row-white">
							...
							<logic:equal value="true" property="displayAdditionalInfo" name="residentStudentInfoForm">
							<tr class="row-white">
							...
							<tr class="row-white">
	                            <td height="23" class="row-even" align="left"><bean:message key="knowledgepro.applicationform.addninfo.label1"/> <B><bean:write property="organizationName" name="residentStudentInfoForm"/></B>:</td>
								 <td height="23" class="row-even" align="left">
								...
								<td height="23" class="row-even" align="left"><bean:message key="knowledgepro.applicationform.addninfo.label2"/> <B><bean:write property="applicantDetails.course.name" name="residentStudentInfoForm"/> </B>:</td>
								<td height="23" class="row-even" align="left">
								...
								<td height="23" colspan="3" class="row-even" align="left"><bean:message key="knowledgepro.applicationform.addninfo.label3"/> <B><bean:write property="applicantDetails.course.name" name="residentStudentInfoForm"/></B>:</td>
								<td height="23" class="row-even" align="left">
							...
							<logic:equal value="true" property="displayExtracurricular" name="residentStudentInfoForm">
							<tr class="row-white">
                    ...
                    <tr>
                      ...
                      <td width="100%" height="29" valign="top"><table width="100%" height="24" border="0" cellpadding="0" cellspacing="1">
                          <tr class="row-white">
                            ...
                            <td width="236" height="25" class="row-even" align="left">
								<nested:write property="applicantDetails.admittedThroughName" name="residentStudentInfoForm"/>	
							</td>
                            ...
                            <td width="244" height="25" class="row-even" align="left">
                            	<nested:write property="applicantDetails.subjectGroupNames" name="residentStudentInfoForm"/>	
							</td>
                          </tr>
                           <tr class="row-white">
                            <td width="212" height="25" class="row-odd"><div align="right"><bean:message key="admissionForm.edit.freeship.label"/></div></td>
                            <td width="236" height="25" class="row-even" align="left">
								<logic:equal name="residentStudentInfoForm" property="applicantDetails.isFreeShip" value="true"><bean:message key="knowledgepro.applicationform.yes.label"/></logic:equal>
								<logic:equal name="residentStudentInfoForm" property="applicantDetails.isFreeShip" value="false"><bean:message key="knowledgepro.applicationform.No.label"/></logic:equal>
							</td>
                            <td width="224" height="25" class="row-odd" align="right"><bean:message key="knowledgepro.attendance.class.col"/> </td>
                            <td width="244" height="25" class="row-even" align="left">
								<nested:write property="classSchemeName" name="residentStudentInfoForm"/>	
							</td>
                          </tr>
						<tr class="row-white">
                            <td width="212" height="25" class="row-odd"><div align="right">Is-LIG:</div></td>
                            <td width="236" height="25" class="row-even" align="left">
								<logic:equal name="residentStudentInfoForm" property="applicantDetails.isLIG" value="true"><bean:message key="knowledgepro.applicationform.yes.label"/></logic:equal>
								<logic:equal name="residentStudentInfoForm" property="applicantDetails.isLIG" value="false"><bean:message key="knowledgepro.applicationform.No.label"/></logic:equal>
							</td>
                  ...
                  <td colspan="2" class="heading"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      ...
                      <td width="100%" height="29" valign="top"><table width="100%" height="24" border="0" cellpadding="0" cellspacing="1">
						...
						<logic:iterate id="prereq" property="applicantDetails.prerequisiteTos" name="residentStudentInfoForm">
                          <tr class="row-white">
							...
							<table width="99%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<table width="100%" border="0" cellpadding="0"
										...
										<logic:notEmpty name="residentStudentInfoForm" property="applicantDetails.preference.firstprefCourseName">
										<tr class="row-white">
										...
										<logic:notEmpty name="residentStudentInfoForm" property="applicantDetails.preference.secondprefCourseName">
										<tr class="row-white">
										...
										<logic:notEmpty name="residentStudentInfoForm" property="applicantDetails.preference.thirdprefCourseName">
										<tr class="row-white">
	...
	<logic:equal value="true" property="workExpNeeded" name="residentStudentInfoForm">
				 <tr>
                  ...
                  <td colspan="2" class="heading"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      ...
                      <td height="31" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="1">
						...
						<nested:iterate property="applicantDetails.workExpList" id="exp" name="residentStudentInfoForm" type="com.kp.cms.to.admin.ApplicantWorkExperienceTO" indexId="count">
                          <tr class="row-white">
                    ...
                    <tr>
                      ...
                      <td><img src="images/06.gif" ></td>
						...
						<tr>
							...
							<table width="99%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<logic:equal value="true" property="displayTCDetails" name="residentStudentInfoForm">
									<tr>
											<td height="25" class="row-odd">
							...
							<logic:equal value="true" property="displayLateralTransfer"	name="residentStudentInfoForm">
											<tr>
												<td class="row-even">
						...
						<logic:equal value="true" property="displayEntranceDetails" name="residentStudentInfoForm">
					...
					<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<tr >
											...
											<td height="25" class="row-even"><div align="left">
															...
															<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="residentStudentInfoForm" value="1">JANUARY</logic:equal>
											              	<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="residentStudentInfoForm" value="2">FEBRUARY</logic:equal>
															<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="residentStudentInfoForm" value="3">MARCH</logic:equal>
															<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="residentStudentInfoForm" value="4">APRIL</logic:equal>
															<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="residentStudentInfoForm" value="5">MAY</logic:equal>
															<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="residentStudentInfoForm" value="6">JUNE</logic:equal>
															<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="residentStudentInfoForm" value="7">JULY</logic:equal>
															<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="residentStudentInfoForm" value="8">AUGUST</logic:equal>
															<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="residentStudentInfoForm" value="9">SEPTEMBER</logic:equal>
															<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="residentStudentInfoForm" value="10">OCTOBER</logic:equal>
															<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="residentStudentInfoForm" value="11">NOVEMBER</logic:equal>
															<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="residentStudentInfoForm" value="12">DECEMBER</logic:equal>
						...
						<tr>
							...
							<table width="97%" border="0" align="center" cellpadding="0"
								...
								<logic:equal value="true" property="displayFamilyBackground" name="residentStudentInfoForm">
							<tr>
							<td>
							<table width="97%" border="0" align="center" cellpadding="0"
								cellspacing="0">
							...
							<table width="99%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<c:set var="temp" value="0" />
										<nested:iterate name="residentStudentInfoForm"
						...
						<tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="1%"><div align="center"><html:button
										property="" styleClass="formbutton"
										onclick="javascript:window.close()">
										CLOSE
									</html:button></div></td>
									<td width="51%" height="45" align="left"></td>
								</tr>
							</table>
							</td>
						</tr>
