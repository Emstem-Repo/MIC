...
<html:hidden property="method" styleId="method" value="getHostelCheckoutDetails"/>
<html:hidden property="pageType" value="1" />
  ...
  <tr>
    <td><span class="heading"><bean:message key="knowledgepro.hostel"/>  <span class="Bredcrumbs">&gt;&gt; <bean:message key="knowledgepro.hostel.checkout"/>&gt;&gt;</span> </span></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="heading_white" ><bean:message key="knowledgepro.hostel.checkout"/></td>
          ...
          <tr>
            ...
            <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
                <tr >
                  ...
                  <td class="row-even" ><div align="left"><html:select property="hostelId" name="hostelCheckoutForm" styleClass="combo" styleId="name">
      ...
      <tr>
        ...
        <td class="heading"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
                <tr >
                <td width="12%" class="row-odd" ><div align="right"><strong><bean:message key="knowledgepro.hostel.checkout.applicationno"/></strong></div></td>
                <td width="8%" class="row-even" ><html:text property="appNo"
										styleId="appNoId" size="9" maxlength="9" onkeypress="return isNumberKey(event)" onblur="checkNumber(this)" /></td>
                <td width="2%" class="row-even" ><strong>OR</strong></td>
                <td width="10%" class="row-odd" ><div align="right"><strong><bean:message key="knowledgepro.hostel.checkout.regno"/></strong></div></td>
                ...
                <td width="12%" class="row-odd" ><div align="right"><strong><bean:message key="knowledgepro.hostel.checkout.staffId"/></strong></div></td>
                <td width="13%" class="row-even" ><html:text property="staffId"
										styleId="staffIdId" size="9" maxlength="9" onkeypress="return isNumberKey(event)" onblur="checkNumber(this)" /></td>
                <td width="3%" class="row-even" ><strong>OR</strong></td>
                <td width="7%" class="row-odd"><div align="right"><strong><bean:message key="knowledgepro.hostel.checkout.rollNo"/></strong></div></td>
