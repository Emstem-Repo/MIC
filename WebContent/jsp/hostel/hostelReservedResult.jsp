...
function setAppId(appId,isStaff){
    //alert(roomTypeId); 
...
<html:form action="/hostelAllocation" method="post" >
	...
	<html:hidden property="method" styleId="method" value="getHostelAllocationDetails" />
          ...
          <tr>
            ...
            <td valign="top">
	            <table width="100%" cellspacing="1" cellpadding="2">
	            	...
	            	<nested:iterate property="reservedHostelList" name="hostelAllocationForm" id="hostelList" indexId="index">
	            		<bean:define id="appId" property="id" name="hostelList"></bean:define>
	            		...
	            		<c:choose>
			            	<c:when test="${temp == 0}">
	            				<tr>
									...
									<td class="row-even">
										<input  name="id" type="radio" id="appId" onclick="setAppId('<%=appId %>','<%=staff%>')">		
									</td>
									<td class="row-even">
