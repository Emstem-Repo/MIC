...
{	
	...
	document.getElementById("academicYr").value =resetYear();
	resetErrMsgs();
}
</script>
</head>
<html:form action="/HostelDamageEntry">
<html:hidden property="method" styleId="method" value="getHostelDamageEntryPage"/>
...
<html:hidden property="pageType" value="1" />
 ...
 <table width="99%" border="0">
  <tr>
    ...
    <bean:message key="knowledgepro.hostel.damageEntry"/>&gt;&gt;</span> </span></td>
  </tr>
  <tr>
            ...
            <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
                <tr >
                  ...
                  <td height="25" class="row-even">
					<html:select property="hostelId" styleClass="TextBox" styleId="hostel" name="hostelDamageForm">
						<html:option value=""><bean:message key="knowledgepro.admin.select" /></html:option>
						<logic:notEmpty name="hostelDamageForm" property="hostelTOList">
						<html:optionsCollection property="hostelTOList" name="hostelDamageForm" label="name" value="id" />
						</logic:notEmpty>
					</html:select>
					</td>
					<td class="row-odd">
					...
					<td class="row-even">
					<input type="hidden" id="tempyear" name="tempyear" value="<bean:write name="hostelDamageForm" property="academicYear"/>"/>
					<html:select property="academicYear"  styleClass="TextBox" styleId="academicYr" name="hostelDamageForm">
