...
<body>
<html:form action="hostelReservCancellation" method="post">
<html:hidden property="method" styleId="method" value="cancelResrevation"/>
<html:hidden property="pageType" value="1"/>
<html:hidden property="formName" value="hostelReservationcancellationForm" />
<table width="98%" border="0" cellpadding="2" cellspacing="1">
  <tr>
    <td class="heading"><bean:message key="knowledgepro.hostel"/><span class="Bredcrumbs">&gt;&gt;<bean:message key="knowledgepro.hostel.reservationcancellation"/>&gt;&gt;</span> </td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="10"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td width="100%" background="images/Tcenter.gif" class="body"><strong class="boxheader"> <bean:message key="knowledgepro.hostel.reservationcancellation"/></strong></td>
