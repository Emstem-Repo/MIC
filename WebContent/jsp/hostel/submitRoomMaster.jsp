...
function getBedNo(){
	document.getElementById("method").value="getBedNumbers";
	document.assignRoomMasterForm.submit();
}
</script>
...
<html:form action="/AssignRoom">
	...
	<html:hidden property="method" styleId="method"	value="saveRooms" />
	            ...
	            <tr>
	              ...
	              <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
	                  <tr >
	                    ...
	                    <td width="25%" height="25" class="row-even"><bean:write name ="assignRoomMasterForm" property="hostelName"/></td>
	                  ...
	                  <tr>
	                    ...
	                    <td width="25%" class="row-even"><bean:write name = "assignRoomMasterForm" property="floorNo"/></td>
	                  </tr>
	                  <tr >
	        ...
	        <td colspan="2" valign="top" class="news"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	          ...
	          <tr>
				...
				<logic:notEmpty name= "assignRoomMasterForm" property="roomList" >
					...
					<td  width="70%" height="25" align="center">Bed Number</td>
					</tr>
					<nested:iterate name="assignRoomMasterForm" property="roomList" id="roomList"
						type="com.kp.cms.to.hostel.HlRoomTO" indexId="count">
	               				<c:choose>
					  ...
					  <td  height="25" > <nested:text	property="name"	styleId="name" size="5" maxlength="20"/></td>						
	                  <td height="25" >
	        ...
	        <td colspan="2" valign="top" class="news"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
	          <tr>
				...
				<td width="49%"><html:button property=""
					styleClass="formbutton" value="Cancel" onclick="cancelMe()"/>
				</td>
	          </tr>
	        </table></td>
	        <td valign="top" background="images/Tright_3_3.gif" class="news"></td>
