...
function updateCancelLeave(){
	document.getElementById("method").value = "updateReasonForCancelLeave";
}
...
<html:hidden property="method" styleId="method" value="updateReasonForCancelLeave" />
<table width="100%" border="0">
  <tr>
    <td><span class="Bredcrumbs"><bean:message key="knowledgepro.admin.sec.EmployeeCategory" />
			<span class="Bredcrumbs">&gt;&gt; Reason To cancel Leave &gt;&gt;</span></span></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><strong class="boxheader">Reason To cancel Leave</strong></td>
			...
			<tr>
							<td width="20%" height="25" valign="top" class="row-odd">
									...
									<td width="30%" height="25" class="row-even"><html:textarea
										property="reasons" styleId="reasons" cols="40" rows="2" /></td>
								</tr>	
            </table></td>
        ...
        <td valign="top" class="news">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<div align="right">
									<html:submit property="" styleId="button" styleClass="formbutton" value="Submit" onclick="updateCancelLeave()"></html:submit>
