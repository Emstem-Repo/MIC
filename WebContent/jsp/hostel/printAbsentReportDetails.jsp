...
function printAction(){
	...
	myRef = window.open(url,"print absent","left=20,top=20,width=800,height=500,toolbar=1,resizable=0,scrollbars=1");
 }
function printMe()
{
	window.print();
          ...
          <tr>
            ...
            <td height="54" valign="top"><table width="100%" cellspacing="1" cellpadding="2">
              <tr >
                ...
                <td colspan="2" class="row-odd"><div align="center"><bean:message key="knowledgepro.hostel.absentees.noOfDays"/></div></td>
                </tr>
												...
												<c:choose>
													<c:when test="${temp == 0}">
														<tr>
															...
															<td width="32%" class="row-even" ><bean:write name="absentReportDetails" property="studName" /></td>
															...
															<td width="7%" class="row-even" ><bean:write name="absentReportDetails" property="count" /></td>
														</tr>
													...
													<c:otherwise>
														<tr>
															...
															<td width="32%" class="row-white" ><bean:write name="absentReportDetails" property="studName" /></td>
															...
															<td width="7%" class="row-white" ><bean:write name="absentReportDetails" property="count" /></td>
														</tr>
														<c:set var="temp" value="0" />
													</c:otherwise>
												</c:choose>
