...
function getHostelStudentDetails(id)
{
	document.location.href = "HostelStudentInfo.do?method=getHostelStudentDetails&id="+ id;
}
function cancelMe()
{
...
<table width="98%" border="0">
  <tr>
    <td><span class="Bredcrumbs"><bean:message key="knowledgepro.hostel" /><span class="Bredcrumbs">&gt;&gt; <bean:message key="admissionForm.studentview.main.label"/>&gt;&gt;</span></span></td>
  </tr>
  <tr>
                    ...
                    <tr>
                      ...
                      <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
                          <tr >
                            ...
                            <td height="25" class="row-odd"><bean:message key="knowledgepro.attendance.regno"/></td>
                            ...
                            <td class="row-odd"><bean:message key="knowledgepro.hostel"/></td>
                            <td class="row-odd"><bean:message key="knowledgepro.hostel.units"/></td>
                            <td class="row-odd"><bean:message key="knowledgepro.hostel.roomno"/></td>
                            <td class="row-odd"><bean:message key="knowledgepro.hostel.bedno"/></td>
                          ...
                          <c:set var="temp" value="0" />
							<nested:iterate name="hostelStudentDetailsForm" property="hlAdmissionToList" indexId="count">
								<c:choose>
								<c:when test="${temp == 0}">
                          <tr>
                            ...
                            <td width="13%" height="39" class="row-even">&nbsp;<nested:write property="regNo"/></td>
                            <td width="19%" class="row-even">&nbsp;<nested:write property="studentName"/></td>
                            <td width="8%" class="row-even" >&nbsp;<nested:write property="studentClass"/></td>
                            <td width="12%" class="row-even" >&nbsp;<nested:write property="hostelName"/></td>
                            <td width="12%" class="row-even" >&nbsp;<nested:write property="unitId"/></td>
                            <td width="12%" class="row-even" >&nbsp;<nested:write property="roomName"/></td>
                            <td width="12%" class="row-even" >&nbsp;<nested:write property="bedNo"/></td>
                          ...
                          <td width="11%" class="row-even" align="center"><img src="images/View_icon.gif"
										...
										onclick="getHostelStudentDetails('<nested:write property="id"/>','getHostelStudentDetails')"></td>
              ...
              <tr>
                <td height="10" class="body" ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <html:button styleClass="formbutton" property=""  onclick="cancelMe()" >Close</html:button>
                      </div>
					  </td>
                      <td width="52%"></td>
                    </tr>
