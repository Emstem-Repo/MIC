...
<html:form action="/hostelAllocation" method="post" >
	...
	<html:hidden property="method" styleId="method" value="getReservedHostelDetails"/>
  ...
  <tr>
    <td><span class="heading"><bean:message key="knowledgepro.hostel"/><span class="Bredcrumbs">&gt;&gt; <bean:message key="knowledgepro.hostel.allocation"/>&gt;&gt;</span> </span></td>
  </tr>
  <tr>
          ...
          <tr>
            ...
            <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
                <tr >
                  ...
                  <td class="row-even" >
                  	<html:select property="hostelId" styleClass="combo" styleId="name">
				  ...
				  <td class="row-odd">
					...
					<td class="row-even">
					<input type="hidden" id="tempyear" name="tempyear" value="<bean:write name="hostelAllocationForm" property="academicYr"/>"/>
					<html:select property="academicYr"  styleClass="combo" styleId="academicYr">
      ...
      <tr>
        ...
        <td class="heading"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
                <tr >
                <td width="12%" class="row-odd" ><div align="right"><strong><bean:message key="knowledgepro.hostel.allocation.applicationno"/></strong></div></td>
                <td width="8%" class="row-even" ><html:text property="appNo"
										styleId="appNoId" size="9" maxlength="9" onkeypress="return isNumberKey(event)" /></td>
                <td width="2%" class="row-even" ><strong>OR</strong></td>
                <td width="10%" class="row-odd" ><div align="right"><strong><bean:message key="knowledgepro.hostel.allocation.regno"/></strong></div></td>
                ...
                <td width="12%" class="row-odd" ><div align="right"><strong><bean:message key="knowledgepro.hostel.allocation.staffId"/></strong></div></td>
                <td width="13%" class="row-even" ><html:text property="staffId"
										styleId="staffIdId" size="9" maxlength="9" onkeypress="return isNumberKey(event)"/></td>
                <td width="3%" class="row-even" ><strong>OR</strong></td>
                <td width="7%" class="row-odd"><div align="right"><strong><bean:message key="knowledgepro.hostel.allocation.rollno"/></strong></div></td>
