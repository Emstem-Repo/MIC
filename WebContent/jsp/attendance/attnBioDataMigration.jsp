...
<script language="JavaScript">
	function submitExcel() {
		document.getElementById("method").value = "searchAttnBioData";
	}
	...
	<table width="98%" border="0">
		<tr>
			<td><span class="Bredcrumbs">Data Migration Report <span
				class="Bredcrumbs">&gt;&gt;Attendance BioData Report &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> Attendance BioData Report</strong></div>
					</td>
									...
									<tr>
											...
											<td height="25" class="row-even"><label> <html:select property="courseName" styleId="courseId">
				  							 	<html:option value=""><bean:message key="knowledgepro.select"/></html:option>
													<logic:notEmpty property="courses" name="attendanceDataMigrationForm">
