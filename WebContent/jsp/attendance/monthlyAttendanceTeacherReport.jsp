...
function resetAttReport()	{
	...
	document.getElementById("teacherTypeId").value = "";
	resetErrMsgs();
}
...
<html:hidden property="method" styleId="method" value="submitMonthlyTeacherReport"/>
<html:hidden property="pageType" value="1"/>


<table width="98%" border="0" cellpadding="2" cellspacing="1">
  <tr>
    <td class="heading"><bean:message key="knowledgepro.reports"/><span class="Bredcrumbs">&gt;&gt;<span class="Bredcrumbs">Monthly Attendance Teacher Report&gt;&gt;</span></span> </td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="5"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><strong class="boxheader">Monthly Attendance Teacher Report</strong></td>
          ...
          <tr>
			...
			<tr>
               ...
               <td width="26%" height="25" class="row-even" >
					<html:text name="attendanceTeacherReportForm" property="startDate" styleId="startDateid" size="16" maxlength="16"/>
							<script
							language="JavaScript">
							new tcal( {
								// form name
								'formname' :'attendanceTeacherReportForm',
								// input name
               ...
               <td width="26%" height="25" class="row-even" >
					<html:text name="attendanceTeacherReportForm" property="endDate" styleId="endDateid" size="16" maxlength="16"/>
							<script
							language="JavaScript">
							new tcal( {
								// form name
			...
			<tr>
				<td height="25" class="row-odd" ><div align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.attendanceentry.teacher"/>:</div></td>
				<td height="25" class="row-even" >
					<html:select name="attendanceTeacherReportForm" property="teacherType" styleId="teacherTypeId" style="width: 120px;" multiple="multiple" size="2">						
						<html:optionsCollection name="attendanceTeacherReportForm" property="teachersMap" label="value" value="key"/>
					</html:select>
				</td>
