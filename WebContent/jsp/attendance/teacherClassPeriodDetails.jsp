...
function winOpen(attendanceId,periodDate,periodName,subjectName) {
	var url = "attendTeacherReport.do?method=getAbsentStudents&attendanceId="+attendanceId+"&attendanceDate="+periodDate+"&periodName="+periodName+"&subjectName="+subjectName;
	myRef = window
...
<html:form action="/attendTeacherReport.do">
