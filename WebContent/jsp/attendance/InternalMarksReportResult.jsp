...
<SCRIPT type="text/javascript">
    function cancelAct() {
    	document.getElementById("method").value = "initInternalMarks";
...
<table width="98%" border="0">
  <tr>
    <td class="heading"><bean:message key="knowledgepro.exam.exam"/><span class="Bredcrumbs">&gt;&gt;<bean:message key="knowledgepro.exam.internal.report" /><span class="Bredcrumbs">&gt;&gt;</span></span></td>
  </tr>
  <tr>
    <td valign="top"><table width="98%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="10" ><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td width="100%" background="images/Tcenter.gif" class="body" ><div align="left"><strong class="boxheader"><bean:message key="knowledgepro.exam.internal.report" /></strong></div></td>
...
<div style="overflow: auto; width: 1100px; ">
	<c:set var="temp" value="0" />  
	    ...
	    %>
		<display:table export="true" uid="attnMarksUid"  id = "internalMarks" name="sessionScope.internalMarksToList" requestURI="" defaultorder="ascending" pagesize="10">
			<display:setProperty name="export.excel.filename" value="internalMarks.xls"/>
			<display:setProperty name="export.xml" value="false" />
			<display:setProperty name="export.csv.filename" value="internalMarks.csv"/>
				...
				<display:column style=" width: 200px;" property="academicYear" sortable="true" title="ACADEMIC YEAR" class="row-even" headerClass="row-odd" media="html csv excel"/>
