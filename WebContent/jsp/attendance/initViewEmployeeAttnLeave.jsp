...
<script type="text/javascript"><!--
	function searchAttendanceType() {
		document.getElementById("method").value = "searchEmployeeAttnLeave";
	...
	function printWindow(){
		document.getElementById("method").value = "getDetailsEmpAttnLeaveForPrint";
		document.viewMyAttendanceLeaveForm.submit();
	}
</script>
	...
	<table width="99%" border="0">
		<tr>
			<td><span class="Bredcrumbs"><bean:message
				...
				class="Bredcrumbs">&gt;&gt;View Employee Attendance Slip&gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td width="9"><img src="images/Tright_03_01.gif" width="9"
						height="29"></td>
					<td background="images/Tcenter.gif" class="heading_white">View Employee Attendance Slip</td>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr> <td class="row-odd" width="25%"><div align="right"><span class='MandatoryMark'>*</span>Teachers:</div></td>
								<td class="row-even" width="25%">
									<html:select name="viewMyAttendanceLeaveForm" styleId="teachers" property="teachers" styleClass="comboMediumLarge">
									<html:option value="">--
											<bean:message key="knowledgepro.select" />--</html:option>
                    				<html:optionsCollection name="viewMyAttendanceLeaveForm" property="teachersMap" label="value" value="key"/>
                    				
                 					 </html:select>
								</td>
								 <td class="row-odd" width="20%"><div align="right"><span class='MandatoryMark'>*</span><bean:message key="knowledgepro.attendanceentry.date"/>:</div></td>
								<td class="row-even" width="30%"><html:text name="viewMyAttendanceLeaveForm" styleId="attendancedate" property="attendanceLeaveDate" styleClass="TextBox"/>
