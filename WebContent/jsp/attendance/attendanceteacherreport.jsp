...
<html:hidden property="method" styleId="method" value="submitTeacherReport"/>
<html:hidden property="pageType" value="1"/>


<table width="98%" border="0" cellpadding="2" cellspacing="1">
  <tr>
    <td class="heading"><bean:message key="knowledgepro.reports"/><span class="Bredcrumbs">&gt;&gt;<span class="Bredcrumbs">Attendance Teacher Report&gt;&gt;</span></span> </td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="5"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><strong class="boxheader"> Attendance Teacher Report</strong></td>
          ...
          <tr>
			...
			<tr>
				...
				<td height="25" class="row-even" >
					<html:select name="attendanceTeacherReportForm" property="teacherType" styleId="teacherTypeId" style="width: 250px;" multiple="multiple" size="4">						
