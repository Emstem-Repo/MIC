...
function submitExcel(){
	document.getElementById("method").value ="uploadPucttnAttendance";
	var academicYear=document.getElementById("academicYearId").value;
	document.location.href = "attnMarksUpload.do?method=uploadPucttnAttendance&academicYear=" +academicYear;
}
...
<html:form action="/attnMarksUpload" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="uploadPucttnAttendance" />
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt;Pucttn Attendance Upload &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> Pucttn Attendance Upload</strong></div></td>
