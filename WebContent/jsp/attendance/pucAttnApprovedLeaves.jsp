...
function submitCsv(){
	document.getElementById("method").value ="uploadApprovedLeaves";
...
<html:form action="/pucAttedance" method="POST" enctype="multipart/form-data">
	...
	<html:hidden property="method" value="uploadApprovedLeaves" />
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt; Approved Leaves Upload &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> Approved Leaves Upload</strong></div></td>
						...
						<tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<html:button property="" styleClass="formbutton" onclick="resetLeaves();">
