...
<script language="JavaScript">
	function submitExcel() {
		document.getElementById("method").value = "uploadAttnBioData";
		var academicYear = document.getElementById("academicYearId").value;
		document.location.href = "attnBioData.do?method=uploadAttnBioData&academicYear="
				+ academicYear;
	}
...
<html:form action="/attnBioData" method="POST"
	enctype="multipart/form-data">
	<html:hidden property="method" styleId="method"
		value="uploadAttnBioData" />
	<html:hidden property="formName" value="attnBiodataPucForm" />
	<html:hidden property="pageType" styleId="pageType" value="1" />
	<table width="98%" border="0">
		<tr>
			<td><span class="Bredcrumbs">Data Migration <span
				class="Bredcrumbs">&gt;&gt;Attn BioData &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> Attn BioData</strong></div>
					</td>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										<tr>
											...
											<td height="25" class="row-even"><label> <html:file
												...
												maxlength="30" name="attnBiodataPucForm" /></label></td>
										</tr>
									</table>
									</td>
