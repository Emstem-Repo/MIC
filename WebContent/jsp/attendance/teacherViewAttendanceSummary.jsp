...
function getClasses(year) {
	...
	getClassByYearUserId("classMap", year, "classesName", updateClasses);
}
...
<html:hidden property="method" styleId="method" value="submitTeacherViewClassAttendance"/>
            ...
            <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
              ...
              <tr >
                ...
                <td height="26%" height="25" class="row-even" >
                 <html:select property="academicYear" styleId="academicYear" styleClass="combo" disabled="">
  	   				  <html:option value="">
  	   				  <bean:write name="attendanceSummaryReportForm" property="academicYear1" />
  	   				  </html:option>
				...
				<td height="26%" height="25" class="row-even" >
                    <html:select property="subjects" styleId="subjects" size="5" style="width: 650px;" multiple="multiple">
