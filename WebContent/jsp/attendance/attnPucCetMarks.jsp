...
function submitExcel(){
	document.getElementById("method").value ="uploadAttnPucCetMarks";
	var academicYear=document.getElementById("academicYearId").value;
	document.location.href = "attnSubjectsUpload.do?method=uploadAttnPucCetMarks&academicYear=" +academicYear;
}
...
<html:form action="/attnSubjectsUpload" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="uploadAttnPucCetMarks" />
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt;PucAttn CET Marks Upload &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> PucAttn CET Marks Upload</strong></div></td>
