...
function submitExcel(){
	document.getElementById("method").value ="uploadAttnMarks";
	var academicYear=document.getElementById("academicYearId").value;
	document.location.href = "attnMarksUpload.do?method=uploadPucAttnInternalMarks&academicYear=" +academicYear;
...
<html:form action="/attnMarksUpload" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="uploadPucAttnInternalMarks" />
	<html:hidden property="formName" value="attnMarksUploadForm" />
	<html:hidden property="pageType" styleId="pageType" value="1" />
	<table width="98%" border="0">
		<tr>
			<td><span class="Bredcrumbs">Data Migration
			<span class="Bredcrumbs">&gt;&gt;PUC Internal Marks Upload &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> PUC Internal Marks Upload</strong></div></td>
								...
								<tr>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										...
										<td height="25" class="row-odd" width="25%">
											...
											<html:file property="theFile" styleId="thefile" size="15" maxlength="30" name="attnMarksUploadForm"/></label></td>
										</tr>
									</table>
									</td>
