  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td >
			<div align="right" style="color:red" class="heading">
      ...
      <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td valign="top">
            <table width="100%" cellspacing="1" cellpadding="1" style="height: 150px">
            	...
            	<tr style="height: 28px">
                 ...
                 <td class="row-odd" colspan="6" align="center">
                  ...
                  <font style="font-size: 12px">	<bean:write name="attendanceEntryForm" property="empName"/></font>
                ...
                <tr style="height: 27px">
                 ...
                 <html:text property="numericCode" styleId="numericCode" onchange="submitForm()"></html:text>
                  ...
                  <td class="row-even" width="16%"><html:text name="attendanceEntryForm" size="15" styleId="attendancedate" property="attendancedate" styleClass="TextBox"/>
                 <script language="JavaScript">
                  ...
                  <td class="row-odd" width="9%"><div align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.fee.academicyear"/>:</div></td>
		          <td class="row-even" align="left" width="16%">
		        	...
		        	<td class="row-odd" width="11%" align="right"><font style="font-size: 11px">Pick From Time Table:</font></td>
					<td class="row-even" width="22%"><html:radio property="timeTableFormat" value="yes" onclick="changeJavaScript(this.value,true);getPeriodsForTeacher();"> Yes</html:radio> 
                ...
                <tr >
                  ...
                  <td colspan="2" id="classDisplayId" >
                  	<table width="100%" height="100%" style="table-layout: auto;border-collapse: collapse" >
                  		<tr>
			                  ...
			                  <td  class="row-even" width="">
			                  <html:select  name="attendanceEntryForm" styleId="classes" style="width:175px" property="classes" size="5" multiple="multiple">
                  ...
                  <table width="100%" height="100%" style="table-layout: auto;border-collapse: collapse">
                  	<tr>
		                  ...
		                  <td  class="row-even"  width="">
		                   <html:select name="attendanceEntryForm" styleId="periods" property="periods" size="5" style="width:175px" multiple="multiple">
                  ...
                  <td  class="row-even" ><label>
                    <html:select style="width:330px" property="subjectId" styleId="subjectId" styleClass="comboMediumBig" onchange="getBatches1(this.value);">
                      <html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
                ...
                <tr style="display: none;">
                   ...
                   <td height="25" class="row-odd" ><div align="right" id="hoursHeld1" style="display: none;"><span class='MandatoryMark'>*</span><bean:message key="knowledgepro.attendanceentry.hoursheld"/>:</div></td>
                  <td class="row-even" ><div id="hoursHeld2" style="display: none;">
                ...
                <tr>
                 ...
                 <td height="25" class="row-odd" width="110" colspan="3">
