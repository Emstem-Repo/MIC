...
function submitCsv(){
	document.getElementById("method").value ="uploadDefineClassSubjects";
	document.pucAttendanceForm.submit();
}

function resetSubjectDefine(){
	document.getElementById("thefile").value="";
	document.getElementById("academicYearId").value="";
	resetErrMsgs();
}
</script>
<html:form action="/pucAttedance" method="POST" enctype="multipart/form-data">
	<html:hidden property="formName" value="pucAttendanceForm" />
	<html:hidden property="method" value="uploadDefineClassSubjects" />
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt; Upload Define ClassSubject &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> Upload Define ClassSubject</strong></div></td>
								...
								<tr>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										...
										<td height="25" class="row-odd" width="25%">
											...
											<html:file property="theFile" styleId="thefile" size="15" maxlength="30" name="pucAttendanceForm"/></label></td>
											<td height="25" class="row-odd" width="25%">
						...
						<tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<html:button property="" styleClass="formbutton" onclick="resetSubjectDefine();">
