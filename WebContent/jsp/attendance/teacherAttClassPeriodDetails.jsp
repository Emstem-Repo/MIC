...
function winOpen(attendanceId,periodDate,periodName,subjectName) {
	var url = "attendTeacherSummaryReport.do?method=getAbsentStudents&attendanceId="+attendanceId+"&attendanceDate="+periodDate+"&periodName="+periodName+"&subjectName="+subjectName;
	myRef = window
