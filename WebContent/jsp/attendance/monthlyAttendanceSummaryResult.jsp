...
<div style="overflow: auto; width: 730px; ">
	<c:set var="temp" value="0" />  
		...
		<%String attendancemonthList ="sessionScope.monthlyattendanceSummaryReport"+(count+1); %>
		 <%String attendancemonthuid = "attendanceid"+(count+1); %>
		<display:table export="true" uid="<%=attendancemonthuid %>" name="<%=attendancemonthList %>" requestURI="" defaultorder="ascending" pagesize="10">
			...
			<display:caption class="heading" media="html csv excel"><bean:write name="attendanceSummaryReportForm" property="organisationName"/>ATTENDANCE REPORT OF <bean:write name="<%=attendancemonthuid %>" property="className"/> STUDENTS FROM <bean:write name="attendanceSummaryReportForm" property="startDate"/> TO <bean:write name="attendanceSummaryReportForm" property="endDate"/></display:caption>
				<display:column style=" padding-left: 40px; padding-right: 40px; " sortable="true" title="Roll No/Registration Number" class="row-even" headerClass="row-odd"><bean:write name="<%=attendancemonthuid %>" property="regNo"/></display:column>
				...
				<logic:notEmpty name="<%=attendancemonthuid %>" property="secondLanguage">
				...
				<logic:notEmpty name="<%=attendancemonthuid %>" property="subjectSummaryList">
			<logic:iterate id="index" name="<%=attendancemonthuid %>"
											...
											<pre class="row-even"> 	<bean:write name="index" property="classesHeld" /><logic:notEmpty name="index" property="classesAttended"><logic:notEqual name="index" property="percentage"  value="-">|</logic:notEqual></logic:notEmpty><bean:write name="index" property="classesAttended" /><logic:notEmpty name="index" property="percentage"><logic:notEqual name="index" property="percentage" value="-">|</logic:notEqual> </logic:notEmpty><bean:write name="index" property="percentage" /></pre>
											</display:column>
											<display:column style=" padding-left: 0px; padding-right: 25px; " media="csv excel" title="<%=title %>" headerClass="row-odd" class="row-even" sortable="true">
													<bean:write name="index" property="classesHeld" /><logic:notEmpty name="index" property="classesAttended"><logic:notEqual name="index" property="percentage"  value="-">|</logic:notEqual> </logic:notEmpty><bean:write name="index" property="classesAttended" /><logic:notEmpty name="index" property="percentage"><logic:notEqual name="index" property="percentage" value="-">|</logic:notEqual> </logic:notEmpty><bean:write name="index" property="percentage" />
											</display:column>
			...
			<display:column style=" padding-left: 40px; padding-right: 40px; " property="aggrigatePercentage" sortable="true" title="Aggregate" class="row-even" headerClass="row-odd"/>
				<logic:notEmpty name="<%=attendancemonthuid %>" property="activitySummaryTOlist">
				...
				<logic:iterate id="index1" name="<%=attendancemonthuid %>" property="activitySummaryTOlist">
				...
				<logic:iterate id="index1" name="<%=attendancemonthuid %>" property="activitySummaryTOlist"> <bean:write name="index1" property="activityName" /> </logic:iterate> </display:column>
				...
				<logic:iterate id="index2" name="<%=attendancemonthuid %>" property="activitySummaryTOlist"> <pre class="row-even"> <bean:write name="index2" property="activityHeld" /> </pre> </logic:iterate> </display:column>
				...
				<logic:iterate id="index2" name="<%=attendancemonthuid %>" property="activitySummaryTOlist"> <bean:write name="index2" property="activityHeld" /> </logic:iterate> </display:column>
				...
				<logic:iterate id="index3" name="<%=attendancemonthuid %>" property="activitySummaryTOlist"> <pre class="row-even"> <bean:write name="index3" property="activityAttended" /> </pre> </logic:iterate> </display:column>
				...
				<logic:iterate id="index3" name="<%=attendancemonthuid %>" property="activitySummaryTOlist"> <bean:write name="index3" property="activityAttended" /> </logic:iterate> </display:column>
				...
				<logic:iterate id="index4" name="<%=attendancemonthuid %>" property="activitySummaryTOlist"> <pre class="row-even"> <bean:write name="index4" property="activityPercentage" /> </pre> </logic:iterate> </display:column>
				...
				<logic:iterate id="index4" name="<%=attendancemonthuid %>" property="activitySummaryTOlist"> <bean:write name="index4" property="activityPercentage" /> </logic:iterate> </display:column>
				</logic:notEmpty>
