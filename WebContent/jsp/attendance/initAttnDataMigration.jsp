...
<script language="JavaScript">
	...
	function goSearch(form){
		...
		if(form == "Attendance Marks"){
			document.location.href = "attnDataMigrationReport.do?method=initAttendanceMarks";
			}
		if(form == "AttnPuc Cet Marks"){
			document.location.href = "attnSubjectsUpload.do?method=initAttnCetMarksReport";
			}
	    if(form == "Internal Marks"){
			document.location.href = "attnDataMigrationReport.do?method=initInternalMarks";
		   }
	}
	function cancel(){
									...
									<tr>
										<td height="25" class="row-odd" width="25%">
											...
											<td height="25"  width="25%" class="row-even"><select class="combo"  name="JumpList" onChange="goSearch(this.value)">
												...
												<option >Attendance Marks</option>
												<option >AttnPuc Cet Marks</option>
