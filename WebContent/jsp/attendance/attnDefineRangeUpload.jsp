...
function submitExcel(){
	document.getElementById("method").value ="uploadAttnDefineRange";
	var academicYear=document.getElementById("academicYearId").value;
	document.location.href = "attnSubjectsUpload.do?method=uploadAttnDefineRange&academicYear=" +academicYear;
}
...
<html:form action="/attnSubjectsUpload" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="uploadAttnDefineRange" />
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt;Attendance Define Range Upload &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> Attendance Define Range Upload</strong></div></td>
								...
								<tr>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										...
										<td height="25" class="row-odd" width="25%">
											...
											<html:file property="theFile" styleId="thefile" size="15" maxlength="30" name="attnPucSubjectForm"/></label></td>
										</tr>
									</table>
									</td>
