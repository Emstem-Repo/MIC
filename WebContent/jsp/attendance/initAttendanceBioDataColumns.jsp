...
<script type="text/javascript" language="javascript">
	...
	function cancelAction() {
    	document.location.href = "attnDataMigrationReport.do?method=searchAttnBioData";
    }
</script>
...
<table width="100%" border="0">
  <tr>
    ...
    Attendance BioData Column Config&gt;&gt;</span></span></td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><strong class="boxheader"> Attendance BioData Column Config</strong></td>
                  ...
                  <tr>
                   ...
                   <tr> 
                    ...
                    <td width="50%">
						...
						<html:option value="Off Remark" styleClass="comboBig"></html:option>
						...
						<html:option value="Failed" styleClass="comboBig"></html:option>
						<html:option value="Blood Group" styleClass="comboBig"></html:option>
						<html:option value="Cet FeePaid" styleClass="comboBig"></html:option>
						<html:option value="Aieee FeePaid" styleClass="comboBig"></html:option>
						<html:option value="User Code" styleClass="comboBig"></html:option>
