	...
	<table width="100%" cellspacing="0" cellpadding="0" class="row-white"   style="background-repeat:no-repeat; background-position: center; padding-bottom: 30px;">
								...
								<tr>
									<td>
										...
										<tr align="center">
											...
											<td width="30%" class="styleimport"><div align="left" ><bean:write name="studentWiseAttendanceSummaryForm" property="studentName"/></div></td>
											<td class="row-print"  width="15%"><div align="right"><b>Class & Sem </b></div></td>
											<td class="row-print" width="1%"><b>:</b></td> 
											<td width="12%" class="styleimport"><div align="left" ><bean:write name="studentWiseAttendanceSummaryForm" property="className"/>&nbsp;&nbsp;&nbsp;<bean:write name="studentWiseAttendanceSummaryForm" property="termNo"/></div></td>
											<td width="15%" class="row-print" ><div align="right"><b>Register No</b></div></td>
											<td class="row-print" width="1%"><b>:</b></td> 
											<td width="15%" class="styleimport"><div align="left" ><bean:write name="studentWiseAttendanceSummaryForm" property="registerNo"/></div></td>
										</tr>
										</table>
									</td>
								</tr>
								<tr>
									<td>
										...
										<td width="15%" height="2px" class="styleimport"><bean:write name="studentWiseAttendanceSummaryForm" property="workingHours"/></td>
										<td width="40%" class="styleimport" height="2px"><div align="center" >Total Co Curricular Leave Availed &nbsp;  :</div></td>
										<td width="15" height="2px" class="styleimport"><bean:write name="studentWiseAttendanceSummaryForm" property="approvedLeaveHrs"/>&nbsp;Hrs</td>
										</tr>
										<tr>
										<td width="20%" class="styleimport" height="2px" ><div align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total Present Hours :</div></td>
										<td width="15%" height="2px" class="styleimport"><bean:write name="studentWiseAttendanceSummaryForm" property="presentHours"/></td>
										<td  class="styleimport" width="35%" height="2px"><div align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Attendance Required for 75  :</div></td>
										<td width="15%" height="2px" class="styleimport"><bean:write name="studentWiseAttendanceSummaryForm" property="requiredHrs"/>Hrs</td>
										</tr>
										</table>
									</td>
								</tr> 
								...
								<tr>	
										...
										<td width="15%" height="2px" class="styleimport"><bean:write name="studentWiseAttendanceSummaryForm" property="percentage"/>%</td>
										
										<td  width="35%" class="tds" height="2px"><div align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Shortage of Attendance :</div>
										</td>
										<td width="15%" height="2px" class="styleimport"><bean:write name="studentWiseAttendanceSummaryForm" property="shortageOfAttendance"/>Hrs</td>
										</tr>
								</table>
								</td>
								</tr>
