...
<SCRIPT type="text/javascript">
	...
	function setTextValues(field,value) {
...
function cancelAction() {
	document.location.href = "MonthlyAttendanceEntry.do?method=initMonthlyAttendanceEntry&operation=cancelAttendance";
}
...
<html:form action="/MonthlyAttendanceEntry" method="post">
	...
	<html:hidden property="method" styleId="method"
		value="cancelMonthlyAttendanceList" />
	...
	<table width="99%" border="0">
		...
		<tr>
			<td><span class="heading"><bean:message
				...
				key="knowledgepro.attendanceentry.cancelmonthlyattendance" /></span></span></td>
		</tr>
		<tr>
			<td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="heading_white"><bean:message
						key="knowledgepro.attendanceentry.cancelmonthlyattendance" /></td>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										<tr>
											...
											<nested:iterate name="monthlyAttendanceEntryForm"
												...
												<div align="center">
												<%String style =  String.valueOf(count);%> <logic:empty
													name="id" property="hoursHeld">

													<nested:text property="hoursHeld" styleId="<%=style %>"
														styleClass="TextBox" style="width: 10px"  maxlength="1"
														onblur="setTextValues(this)">
													</nested:text>
												</logic:empty> <logic:notEmpty name="id" property="hoursHeld">
													<nested:text property="hoursHeld" styleId="<%=style %>"
														styleClass="TextBox" style="width: 10px"  maxlength="1"
														...
														<nested:iterate property="hoursHeldTOList"
															...
															<logic:empty name="hoursHeldTOList" property="hourseHeld">
																...
																<nested:text property="hourseHeld" styleId="<%=abc %>"
																	styleClass="TextBox" style="width: 10px"  maxlength="1" disabled="true"
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td height="35" align="center"><html:submit
								...
								<bean:message key="knowledgepro.attendance.cancelattendance" />
