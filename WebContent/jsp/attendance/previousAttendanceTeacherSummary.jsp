...
<SCRIPT type="text/javascript">
    ...
    function printAreport(){
    	var url ="attendTeacherSummaryReport.do?method=printPreviousTeacherReport";
    ...
    function winOpen(userId, classId, subjectId , batch) {
		var url = "attendTeacherSummaryReport.do?method=getPreviousPeriodDetails&userId="+userId+"&classId="+classId+"&subjectId="+subjectId+"&batchName="+batch;
		myRef = window
				.open(url, "viewPrivileges",
						"left=20,top=20,width=800,height=500,toolbar=1,resizable=0,scrollbars=1");
	}
</SCRIPT>
<body>
...
<table width="100%" border="0">
  ...
  <tr>
        ...
        <td height="8" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
             ...
             <div style="text-align: center; ">
		        <logic:notEmpty name="attendanceTeacherReportForm" property="previousStartDate">
    				<logic:notEmpty name="attendanceTeacherReportForm" property="previousEndDate">
						
							   <bean:write name="attendanceTeacherReportForm" property="previousStartDate"/> - <bean:write name="attendanceTeacherReportForm" property="previousEndDate"/>
	...
	<c:set var="temp" value="0" />  
		...
		<display:table export="true" uid="attendanceid"  id = "teacherList" name="sessionScope.attendanceTeacherPreviousReport" requestURI="" defaultorder="ascending" pagesize="10">
