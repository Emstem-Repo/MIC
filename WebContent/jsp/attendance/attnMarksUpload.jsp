...
function submitExcel(){
	...
	document.location.href = "attnMarksUpload.do?method=uploadAttnMarks&academicYear=" +academicYear;
...
<html:form action="/attnMarksUpload" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="uploadAttnMarks" />
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt;PUC AttnMarks Upload &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> PUC AttnMarks Upload</strong></div></td>
