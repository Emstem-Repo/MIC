...
function submitExcel(){
	document.getElementById("method").value ="uploadAttnPucSubject";
	var academicYear=document.getElementById("academicYearId").value;
	document.location.href = "attnSubjectsUpload.do?method=uploadAttnPucSubject&academicYear=" +academicYear;
}
...
<html:form action="/attnSubjectsUpload" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="uploadAttnPucSubject" />
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt;PucAttn Subjects Upload &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> PucAttn Subjects Upload</strong></div></td>
