  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        &nbsp; &nbsp;
         <label ><span style="background-color: green;"></span><input type='checkbox'></label> is for Present
        &nbsp; &nbsp;
        <label ><span style="background-color: red;"></span><input type='checkbox'></label> is for Absent
       &nbsp; &nbsp;
        <br/>
            ...
            <td colspan="2"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <table width="100%" cellspacing="1" cellpadding="2">
					 ...
					 <td  height="25" align="center"><c:out value="${count2+1}"/></td>
					   
                        
                        <td width="300" height="25" align="center"><nested:write name="student" property="studentName"/></td>
                     ...
                     <logic:notEmpty name="attendanceEntryForm" property="studentsList">
                      ...
                      <nested:iterate id="student"  name="lists" indexId="count1">
                       ...
                       <td height="25" align="center" onclick="showInfo('<nested:write name="student" property="teacherName"/>','<nested:write name="student" property="className"/>','<nested:write name="student" property="subjectName"/>');">
                      <label ><span style="background-color: green;"></span><input type='checkbox'></label>
                      <%-- 	<img width="15" height="15" title="" onclick="showInfo('<nested:write name="student" property="teacherName"/>','<nested:write name="student" property="className"/>','<nested:write name="student" property="subjectName"/>');" style="cursor:pointer" src="images/questionMark.jpg">--%>
                        ...
                        <c:otherwise>
                        <td height="25" align="center" onclick="showInfo('<nested:write name="student" property="teacherName"/>','<nested:write name="student" property="className"/>','<nested:write name="student" property="subjectName"/>');">
                       <label ><span style="background-color: red;"></span><input type='checkbox'></label>
                       <%-- <img width="15" height="15" title=""  onclick="showInfo('<nested:write name="student" property="teacherName"/>','<nested:write name="student" property="className"/>','<nested:write name="student" property="subjectName"/>');" style="cursor:pointer" src="images/questionMark.jpg">--%>
                        </td>
                        </c:otherwise>
                        </c:choose>
