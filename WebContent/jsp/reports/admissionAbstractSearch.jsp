...
<html:hidden property="method" styleId="method" value="searchAdmAbstract"/>
<html:hidden property="formName" value="admissionAbstractForm" />
  ...
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td background="images/Tcenter.gif" class="body" ><strong class="boxheader"><bean:message key="knowledgepro.reports.admission.abstract"/></strong></td>
              ...
              <tr>
                ...
                <td width="25%" height="25" class="row-even">
			      <html:select property="programId"  styleId="program" styleClass="combo" onchange="getCourses(this.value)">
          		  	<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
      					<c:if test="${admissionAbstractForm.programTypeId != null && admissionAbstractForm.programTypeId != ''}">
