...
function getNames(){
	document.getElementById("method").value="submitSectionWiseReport";		
}
</script>
<html:form action="/sectionWiseReport" method="post">
<html:hidden property="method" styleId="method" value="submitSectionWiseReport"/>
<html:hidden property="pageType" value="1"/>
<html:hidden property="formName" value="sectionWiseForm" />

<table width="98%" border="0" cellpadding="2" cellspacing="1">
  <tr>
    <td class="heading"><bean:message key="knowledgepro.reports"/><span class="Bredcrumbs">&gt;&gt;<bean:message key="knowledgepro.reports.sectionwisereport.label"/> &gt;&gt;</span> </td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="5"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><strong class="boxheader"><bean:message key="knowledgepro.reports.sectionwisereport.label"/></strong></td>
        ...
        <td valign="top" class="news"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td width="22%" height="25" class="row-odd" ><div align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.admin.program.type" /></div></td>
				 <input type="hidden" name="programTId" id="programTId" value='<bean:write name="sectionWiseForm" property="programTypeId"/>'/>
                ...
                <td width="26%" height="25" class="row-even" >
			      <html:select property="programId"  styleId="program" styleClass="comboLarge" onchange="getCourses(this.value)">
          		   		<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
        			    	<c:if test="${sectionWiseForm.programTypeId != null && sectionWiseForm.programTypeId != ''}">
            ...
            <td height="25" class="row-odd" ><div align="right"><bean:message key="knowledgepro.admin.course.with.col" /></div></td>
                ...
                <input type="hidden"
								...
								value='<bean:write name="sectionWiseForm" property="semister"/>' />
			...
			<div align="right"><span class="Mandatory">*</span>
				<bean:message key="knowledgepro.admin.academicyear"/>:</div>
			</td>
			<td class="row-even" valign="top">
			<input type="hidden" id="tempyear" name="tempyear"
										value="<bean:write name="sectionWiseForm" property="year"/>" />
			<html:select
