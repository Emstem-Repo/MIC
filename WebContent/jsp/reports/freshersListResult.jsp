...
<SCRIPT type="text/javascript">
    function cancelAction() {
    	document.location.href = "freshersList.do?method=initFreshersList";
    }
</SCRIPT>
...
<table width="98%" border="0">
  <tr>
    <td><span class="heading"><bean:message key="knowledgepro.reports"/> <span class="Bredcrumbs">&gt;&gt;<bean:message key="knowledgepro.reports.freshers.list"/> &gt;&gt;</span></span></td>
  </tr>
  <tr>
    <td valign="top"><table width="98%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="10" ><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td width="100%" background="images/Tcenter.gif" class="body" ><div align="left"><strong class="boxheader"><bean:message key="knowledgepro.freshers.list"/> </strong></div></td>
        ...
        <td height="8" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td width="5"  background="images/left.gif"></td>
      		  <td align="center" class="heading"><bean:write property="organizationName" name="freshersListForm"/> </td>
              <td width="5" height="30"  background="images/right.gif"></td>
            </tr>
			<tr>
              <td width="5"  background="images/left.gif"></td>
      		  <td align="center"> <span class="heading">
             <bean:message key="knowledgepro.reports.students.of.the.year"/> <bean:write property="year" name="freshersListForm"/>-<bean:write property="nextYear" name="freshersListForm"/>&nbsp;
             <bean:message key="knowledgepro.reports.students.section.wise"/></span> </td>
              <td width="5" height="30"  background="images/right.gif"></td>
            </tr>
          <tr>
              <td width="5"  background="images/left.gif"></td>
...
<div style="overflow: auto; width: 914px; ">
	<c:set var="temp" value="0" />  
		<display:table export="true" uid="due" name="sessionScope.fresherList" requestURI="" defaultorder="ascending" pagesize="10" style="width:100%">
			<display:setProperty name="export.excel.filename" value="fresherList.xls"/>
			<display:setProperty name="export.xml" value="false" />
			<display:setProperty name="export.csv.filename" value="fresherList.csv"/>
				<display:column media="html" style="padding-right: 80px;" sortable="true" title="Class" property="className" class="row-even" headerClass="row-odd" group="1"></display:column>
				...
				<display:column media="html" style="padding-right: 80px;" sortable="true" title="% of Marks" property="percentageOfMarks" class="row-even" headerClass="row-odd"></display:column>
		</display:table>
	</div>	
		</td>
              <td width="5" height="30"  background="images/right.gif"></td>
