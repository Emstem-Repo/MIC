...
<SCRIPT type="text/javascript">
    function cancelAction() {
    	document.location.href = "SecondLanguage.do?method=initSecondLanguage";
    }
</SCRIPT>
...
<table width="98%" border="0">
  <tr>
    <td><span class="heading"><bean:message key="knowledgepro.reports"/> <span class="Bredcrumbs">&gt;&gt;<bean:message key="knowledgepro.reports.secondlanguage/admitted"/>&gt;&gt;</span></span> </td>
  </tr>
  <tr>
    <td valign="top"><table width="98%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="10" ><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td width="100%" background="images/Tcenter.gif" class="body" ><div align="left"><strong class="boxheader"><bean:message key="knowledgepro.reports.secondlanguage/admitted"/></strong></div></td>
      ...
      <tr>
		...
		<tr>
              <td width="5"  background="images/left.gif"></td>
      		  <td align="center" class="heading"><bean:write property="organizationName" name="secondLanguageForm"/> </td>
              <td width="5" height="30"  background="images/right.gif"></td>
            </tr>
			<tr>
              <td width="5"  background="images/left.gif"></td>
              <c:choose>
	           <c:when test="${secondLanguageForm.secondLanguage == 'All'}">  
      		  	<td align="center"> <span class="heading">
           		<bean:message key="knowledgepro.reports.secondlanguage.list"/> &nbsp; <bean:write name="secondLanguageForm" property="semister"/> &nbsp; <bean:write name="secondLanguageForm" property="programTypeName"/>&nbsp;<bean:message key="knowledgepro.reports.secondlanguage.students"/> </span>
           		</td>
            	</c:when>
            	<c:otherwise>
            	<td align="center"> <span class="heading">
           		<bean:message key="knowledgepro.reports.secondlanguage.scheme"/> &nbsp; <bean:write name="secondLanguageForm" property="semister"/>&nbsp; <bean:write name="secondLanguageForm" property="programTypeName"/> &nbsp; <bean:message key="knowledgepro.reports.secondlanguage.candidates"/>  &nbsp; <bean:write name="secondLanguageForm" property="secondLanguage"/> </span>
				<c:if test="${secondLanguageForm.semister == null && secondLanguageForm.semister == ''}">
					<bean:write name="secondLanguageForm" property="programTypeName"/> &nbsp; <bean:message key="knowledgepro.reports.secondlanguage.candidates"/>  &nbsp; <bean:write name="secondLanguageForm" property="secondLanguage"/> </span>
				</c:if>           		
            	</td>
            	</c:otherwise>
            	</c:choose>
            ...
            <tr>
              <td width="5"  background="images/left.gif"></td>            
      		  <td valign="top">
					<logic:notEmpty name="secondLanguageForm" property="studentList">
						<logic:iterate id="Studentlist" name="secondLanguageForm" property="studentList" indexId="count">
						<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
						<tr>
							<td width="5"  background="images/left.gif"></td>
							<td align="center" class="heading">
								<bean:write property="courseName" name="Studentlist"/>
							</td>
							<td width="5" height="30"  background="images/right.gif"></td>
						</tr>
						<tr>
					...
					<bean:define id="studList" property="students" name="Studentlist"></bean:define>				
							<c:set var="temp" value="0" />  
								<display:table export="false" uid="categoryid" name="<%=studList %>" requestURI="" defaultorder="ascending" pagesize="10">
										...
										<c:choose>
	           							<c:when test="${secondLanguageForm.searchBy == '1'}">  
										...
										<c:when test="${secondLanguageForm.searchBy == '2'}">  
										...
										<c:when test="${secondLanguageForm.searchBy == '3'}"> 
										<display:column media="html" style="padding-right: 80px;" sortable="true" title="Reg No." property="registerNo" class="row-even" headerClass="row-odd"></display:column>
										</c:when>
										</c:choose>
              ...
              <td width="5"  background="images/left.gif"></td>
				...
				<div style="overflow: auto; width: 914px; ">
						<display:table export="true" uid="totalid" name="sessionScope.totalStudentList" requestURI="" defaultorder="ascending" pagesize="20" style="width:100%">
							<display:setProperty name="export.excel.filename" value="secondLanguageStudent.xls" />
							<display:setProperty name="export.csv.filename" value="secondLanguageStudent.csv" />
							...
							<c:when test="${secondLanguageForm.searchBy == '3'}">  
							<display:column title="Reg No." media="excel csv" property="registerNo" headerClass="row-odd" class="row-even" sortable="true" style="width:20%"></display:column>
							</c:when>
							</c:choose>
