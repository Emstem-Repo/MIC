...
<SCRIPT type="text/javascript">
    function cancelAction() {
    	document.location.href = "sectionWiseReport.do?method=initSectionWiseReport";
    }
</SCRIPT>
...
<div style="overflow: auto; width: 914px; ">
		...
		<display:table export="true" uid="<%=sectionuid %>" name="<%=sectionList %>" requestURI="" defaultorder="ascending" pagesize="10">
			...
			<display:setProperty name="export.csv.filename" value="SectionWiseReport.csv"/>
				...
				<display:column style=" padding-right: 40px; padding-left: 70px; width:80px;" sortable="true" title="Application Number" property="applnNumber" class="row-even" headerClass="row-odd"/>
	
				<display:column style=" padding-right: 40px; padding-left: 40px; width:100px;" sortable="true" title="RegNo." property="regNo" class="row-even" headerClass="row-odd"/>
				...
				<display:column style=" padding-right: 40px; padding-left: 40px; width:80px;" sortable="true" title="Gender" property="gender" class="row-even" headerClass="row-odd"/>
				...
				<display:column style=" padding-right: 40px; padding-left: 40px; width:60px;" sortable="true" title="Percentage(%)" property="percentage" class="row-even" headerClass="row-odd"/>
