  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="935" colspan="2" background="images/Tcenter.gif" class="body" ><div align="left"><span class="boxheader"><bean:message key="knowledgepro.admission"/> &gt;&gt; <bean:message key="knowledgepro.report.studentcategory.title"/> &gt;&gt;</span></div></td>
	...
	<tr>
        ...
        <td height="24" colspan="2" class="heading">&nbsp;&nbsp;<bean:message key="knowledgepro.report.studentcategory.title"/> </td>
        <td valign="top" background="images/Tright_3_3.gif" class="news"></td>
      </tr>
      <tr>
          ...
          <tr>
            ...
            <td height="30" valign="top"><table width="100%" height="30" border="0" cellpadding="0" cellspacing="1">
              <tr class="row-white" >
                ...
                <input type="hidden" id="programType" name="programType" value='<bean:write name="studentAdmittedCategoryForm" property="programTypeId"/>'/>
                ...
                <html:select property="programId" styleClass="combo" styleId="progPref1">
						<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
						<c:if test="${studentAdmittedCategoryForm.programTypeId != null && studentAdmittedCategoryForm.programTypeId != ''}">
                ...
                <td width="16%" class="row-odd"><div align="right"><span class="Mandatory">*</span>Caste Category: </div></td>
                <td width="16%" class="row-even">
				
                <html:select property="castCategory" styleClass="comboLarge">
					<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
					<html:optionsCollection property="casteList" name="studentAdmittedCategoryForm" value="casteId" label="casteName"/>
              ...
              <table width="100%" height="27"  border="0" cellpadding="1" cellspacing="2">
                <tr>
                  <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="48%" height="21"><div align="right"><html:button property="" onclick="submitMe('loadStudentReport')" styleClass="formbutton" value="Continue"></html:button> </div></td>
                      <td width="1%"></td>
                      <td width="51%" height="45"><div align="left"><html:button property=""  styleClass="formbutton" value="Reset" onclick="submitMe('initStudentReport')"></html:button></div></td>
                    </tr>
                  </table></td>
                </tr>
              </table>
