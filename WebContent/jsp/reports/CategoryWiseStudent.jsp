...
function getNames(){
	document.getElementById("method").value="submitCategoryWiseStudent";		
}
</script>
<html:form action="/categoryWiseStudent" method="post">
<html:hidden property="method" styleId="method" value="submitCategoryWiseStudent"/>
<html:hidden property="pageType" value="1"/>
<html:hidden property="formName" value="categoryWiseStudentForm" />

<table width="98%" border="0" cellpadding="2" cellspacing="1">
  <tr>
    <td class="heading"><bean:message key="knowledgepro.reports"/><span class="Bredcrumbs">&gt;&gt;<bean:message key="knowledgepro.reports.students.categorywise"/> &gt;&gt;</span> </td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="5"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><strong class="boxheader"><bean:message key="knowledgepro.reports.students.categorywise"/></strong></td>
        ...
        <td valign="top" class="news"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td width="22%" height="25" class="row-odd" ><div align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.admin.program.type" /></div></td>
				 <input type="hidden" name="programTId" id="programTId" value='<bean:write name="categoryWiseStudentForm" property="programTypeId"/>'/>
                ...
                <td width="26%" height="25" class="row-even" >
			      <html:select property="programId"  styleId="program" styleClass="comboLarge" onchange="getCourses(this.value)">
          		   		<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
        			    	<c:if test="${categoryWiseStudentForm.programTypeId != null && categoryWiseStudentForm.programTypeId != ''}">
            ...
            <td height="25" class="row-odd" ><div align="right"><bean:message key="knowledgepro.admin.course.with.col" /></div></td>
                ...
                <td width="19%" height="25" class="row-odd" ><div align="right"><bean:message key="curriculumSchemeForm.schemeId" />:</div></td>
                <td width="26%" height="25" class="row-even" >
                <input type="hidden"
								id="scheme" name="scheme"
								value='<bean:write name="categoryWiseStudentForm" property="semister"/>' />
            ...
            <tr> 
            	<td   class="row-odd" ><div align="right"> Year:</div></td>
                <td  class="row-even">
                <input type="hidden" id="tempYear" name="tempYear" value="<bean:write name="categoryWiseStudentForm" property="academicYear"/>"/>
                     <html:select name="categoryWiseStudentForm" property="academicYear" styleId="academicYear" styleClass="combo" > 
                     <html:option value=" ">
