...
<html:hidden property="method" styleId="method" value="getMonthlyAttendanceFinalSummary"/>
...
<table width="98%" border="0" cellpadding="2" cellspacing="1">
  <tr>
    ...
    <span class="Bredcrumbs"><bean:message key="knowledgepro.monthlyattendance.finalsummaryreport" />&gt;&gt;</span></span></td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="5"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><strong class="boxheader"> <bean:message key="knowledgepro.monthlyattendance.finalsummaryreport" /></strong></td>
          ...
          <tr>
            ...
            <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
              <tr >
                ...
                <td width="26%" height="25" class="row-even" >
			      <html:select property="programId"  styleId="program" styleClass="combo" onchange="getCourses(this.value)">
          		   		<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
        			    	<c:if test="${attendanceFinalSummaryForm.programTypeId != null && attendanceFinalSummaryForm.programTypeId != ''}">
             ...
             <html:select property="courseId"  styleId="course" styleClass="combo" onchange="getSemisters(this.value)">
           				<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
         				   		<c:if test="${attendanceFinalSummaryForm.programId != null && attendanceFinalSummaryForm.programId != ''}">
              ...
              <tr >
                ...
                <td height="25" class="row-even" >
                 <html:select property="semister" styleId="semister" styleClass="combo">
         	   				 <html:option value="">- Select -</html:option>
           				    	<c:if test="${attendanceFinalSummaryForm.academicYear != null && attendanceFinalSummaryForm.academicYear != ''}">
