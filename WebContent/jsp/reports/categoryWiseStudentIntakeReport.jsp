...
function getNames(){
	document.getElementById("method").value="submitCategoryWiseIntake";
}
</script>
<html:form action="/categoryWiseIntake" method="post">
<html:hidden property="method" styleId="method" value="submitCategoryWiseIntake"/>
<html:hidden property="pageType" value="1"/>
<html:hidden property="formName" value="categoryWiseIntakeForm" />


<table width="98%" border="0" cellpadding="2" cellspacing="1">
  <tr>
    <td class="heading"><bean:message key="knowledgepro.reports"/><span class="Bredcrumbs">&gt;&gt;<bean:message key="knowledgepro.report.categorywisestudentintakereport"/>&gt;&gt;</span> </td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="5"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><strong class="boxheader"><bean:message key="knowledgepro.report.categorywisestudentintakereport"/></strong></td>
        ...
        <td valign="top" class="news"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td width="22%" height="25" class="row-odd" ><div align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.admin.program.type" /></div></td>
				 <input type="hidden" name="programTId" id="programTId" value='<bean:write name="categoryWiseIntakeForm" property="programTypeId"/>'/>
                ...
                <td width="26%" height="25" class="row-even" >
			      <html:select property="programId"  styleId="program" styleClass="comboLarge">
          		   		<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
        			    	<c:if test="${categoryWiseIntakeForm.programTypeId != null && categoryWiseIntakeForm.programTypeId != ''}">
