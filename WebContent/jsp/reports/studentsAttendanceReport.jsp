...
function getClassesBySem(semester) {
	var year=document.getElementById("academicYear").value;
	getClassesBySemester("classMap",year, semester, "classesName", updateClasses);
}
...
<html:hidden property="method" styleId="method" value="submitStudentAttendanceReport"/>
<html:hidden property="formName" value="studentsAttendanceReportForm" />
<html:hidden property="pageType" value="1"/>

<table width="98%" border="0" cellpadding="2" cellspacing="1">
  <tr>
    <td class="heading"><bean:message key="knowledgepro.reports"/><span class="Bredcrumbs">&gt;&gt;<bean:message key="knowledgepro.report.studentattendancereport" />&gt;&gt;</span> </td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="5"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><strong class="boxheader"><bean:message key="knowledgepro.report.studentattendancereport" /></strong></td>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <table width="100%" cellspacing="1" cellpadding="2">
               ...
               <tr>
              	<td class="row-odd" ><div align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.fee.academicyear.col" /></div></td>
                <td colspan="1" class="row-even" >
              ...
              <tr>
             	 <td class="row-odd" ><div align="right"><span class="Mandatory"></span><bean:message key="admissionForm.detailmark.semester.label" /></div></td>
              	 <td colspan="3" height="25" class="row-even" >
					<html:radio styleId="oddSemester" property="semister" value="odd" onchange="getClassesBySem(this.value)">Odd</html:radio>
					<html:radio property="semister" value="even" styleId="evenSemester" onchange="getClassesBySem(this.value)">Even</html:radio>
				 </td>
              </tr>
              ...
              <tr>
                ...
                <td class="row-odd" ><div align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.attn.activity.att.type" /></div></td>
				<td class="row-even" >
              ...
              <tr>
              	<td height="25" class="row-odd" ><div align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.admission.percentagefrom" />:</div></td>
               	<td class="row-even">
					<html:text name="studentsAttendanceReportForm" property="fromPercentage" styleId="fromPercentage" size="3" maxlength="5"/>
					&nbsp;To&nbsp;
					<html:text name="studentsAttendanceReportForm" property="toPercentage" styleId="toPercentage" size="3" maxlength="5"/> 
			   	</td>
              	<td class="row-odd"><div align="right"><bean:message key="knowledgepro.attendanceentry.leavestatus" /></div></td>
				<td class="row-even">
					<html:radio property="leaveType" value="false"><bean:message key="knowledgepro.attendanceentry.leavewithout" /></html:radio>
					<html:radio property="leaveType" value="true"><bean:message key="knowledgepro.attendanceentry.leavewith" /></html:radio>
				</td>
			</tr>
			<tr>
