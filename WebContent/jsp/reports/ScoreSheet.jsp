...
function getExamCenters(programId) {
	var url = "ScoreSheet.do";
	var args = "method=getExamCentersByProgramId&programid=" + programId;
	requestOperationProgram(url,args,updateExamCenter);
	
	//getExamCentersByProgram("examCenterMap",programId,"examCenterId",updateExamCenter);	
}
...
<html:form action="/ScoreSheet" focus="programType">
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt; <bean:message key="knowledgepro.reports.scoresheetentry" /> &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"><bean:message key="knowledgepro.reports.scoresheetentry" /></strong></div>
					</td>
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<html:select property="programId"  styleId="program"  onchange="getCourses(this.value),getinterviewTypeByProgram(),getExamCenters(this.value)" styleClass="combo">
										<html:option value=""><bean:message key="knowledgepro.admin.select" /></html:option>
										<c:if test="${scoreSheetForm.programTypeId != null && scoreSheetForm.programTypeId != ''}">
								...
								<tr>
									...
									<td class="row-even">
									<html:text name="scoreSheetForm" property="interviewStartDate" styleId="interviewStartDate" size="10" maxlength="16"/>
							<script
							language="JavaScript">
							new tcal( {
								// form name
								'formname' :'scoreSheetForm',
								// input name
								...
								<tr>
									...
									<td class="row-even">
									<html:text name="scoreSheetForm" property="startingTimeHours" styleClass="Timings" value="00" styleId="startingTimeHours" size="2" maxlength="2"  onfocus="clearField(this)" onblur="checkForEmpty(this)" onkeypress="return isNumberKey(event)"/>:
									<html:text name="scoreSheetForm" property="startingTimeMins" styleClass="Timings" value="00" styleId="startingTimeMins" size="2" maxlength="2"  onfocus="clearField(this)" onblur="checkForEmpty(this)" onkeypress="return isNumberKey(event)"/>
									</td>
									<td class="row-odd">
									<div align="right">&nbsp;<bean:message key="knowledgepro.interview.EndTime" /></div>
									</td>
									<td class="row-even">
									<html:text name="scoreSheetForm" property="endingTimeHours" styleClass="Timings" value="00" styleId="endingTimeHours" size="2" maxlength="2"  onfocus="clearField(this)" onblur="checkForEmpty(this)" onkeypress="return isNumberKey(event)"/>:
									<html:text name="scoreSheetForm" property="endingTimeMins" styleClass="Timings" value="00" styleId="endingTimeMins" size="2" maxlength="2"  onfocus="clearField(this)" onblur="checkForEmpty(this)" onkeypress="return isNumberKey(event)"/>
									</td>
								...
								<tr>
									<td class="row-odd">
									<div align="right"><span class="Mandatory">*</span>&nbsp;<bean:message key="knowledgepro.report.scoresheet.studentsPerGroup"/></div>
									</td>	
									<td class="row-even">
									<div align="right">
									<html:text name="scoreSheetForm" property="studentPerGroup" styleId="studentPerGroup" maxlength="3" onkeypress="return isNumberKey(event)"/>
									</div>
									</td>
									<td class="row-odd">
									<div align="right"><bean:message key="knowledgepro.admission.examCenter.displayName"/>:</div>
									</td>
									<td width="16%" height="25" class="row-even"><label>
									<html:select property="examCenterId" styleId="examCenterId"  styleClass="combo">
										<html:option value=""><bean:message key="knowledgepro.admin.select" /></html:option>
										<logic:notEmpty name="scoreSheetForm" property="examCenterMap">
										<html:optionsCollection name="scoreSheetForm" property="examCenterMap" label="value" value="key" />
										</logic:notEmpty>
									</html:select> 
									</label></td>
