...
<SCRIPT type="text/javascript">
	function cancelAction() {
		document.location.href = "attendanceFinalSummary.do?method=initMonthlyAttendanceFinalSummary";
	}
</SCRIPT>
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs"><bean:message
				key="knowledgepro.monthlyattendance.finalsummaryreport" /><span
			...
			<table width="98%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"><bean:message
						key="knowledgepro.monthlyattendance.finalsummaryreport" /></strong></div>
					</td>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<div style="overflow: auto; width: 730px;"><c:set
								...
								uid="attendanceid"
								name="sessionScope.monthlyAttendanceFinalSummaryReport" requestURI=""
