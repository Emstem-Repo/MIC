  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td background="images/st_Tcenter.gif" class="heading_white" >DOWNLOAD SUPLEMENTARY HALL TICKET</td>
      ...
      <tr>
        ...
        <td valign="top" class="news"><table width="100%" cellspacing="1" cellpadding="2">
          		<iframe src="<%=CMSConstants.birtLink +"/birtFeeReport.do?method=supMarksCardForStudent&reportName="+request.getAttribute("reportName")+
".rptdesign&sample=my+parameter&FromRegisterNumber="+session.getAttribute("stuRegNo") +
"&ToRegisterNumber="+session.getAttribute("stuRegNo") +
"&ExamID=" + session.getAttribute("supHallTicketexamID")%>" WIDTH=100% HEIGHT="600px;">
