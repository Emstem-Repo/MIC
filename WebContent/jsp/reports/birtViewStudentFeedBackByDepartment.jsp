	...
	path = path + "/birtFeeReport.do?method=initBirtViewStudentFeedBackByDepartment&reportName=hodGraphFacultyEval";
	path = path + "&department=";
	path = path + session.getAttribute("department").toString();
	%>
