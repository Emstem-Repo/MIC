...
<iframe src="<%=CMSConstants.birtLink %>/birtFeeReport.do?method=initBirtExamReport&cjc=true&issue=<%= session.getAttribute("username")%>" width="100%" height="700" frameborder="0">
