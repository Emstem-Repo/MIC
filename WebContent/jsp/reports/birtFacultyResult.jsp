...
<table width="99%" border="0"> 
  <tr>
    <td><span class="heading">Faculty Reports<span class="Bredcrumbs">&gt;&gt;Faculty Reports &gt;&gt;</span> </span></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="heading_white" >Faculty Reports</td>
