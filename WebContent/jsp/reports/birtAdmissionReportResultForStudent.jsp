  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td background="images/st_Tcenter.gif" class="heading_white" >DOWNLOAD HALL TICKET</td>
      ...
      <tr>
        ...
        <td valign="top" class="news"><table width="100%" cellspacing="1" cellpadding="2">
          		<IFRAME name="reportName" id="reportName" SRC="<%= request.getContextPath( ) + "/run?__format=PDF&__report=reports/"+request.getAttribute("reportName")+".rptdesign&sample=my+parameter&studentRegisterNo="+session.getAttribute("stuRegNo") + "&ExamID=" + session.getAttribute("examID")%>" WIDTH=100% HEIGHT="600px;">
