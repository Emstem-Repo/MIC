...
<iframe src="<%=CMSConstants.birtLink %>/birtFeeReport.do?method=initBirtAdmissionReport&cjc=true&user=<%= session.getAttribute("username").toString()%>" width="100%" height="700" frameborder="0">
