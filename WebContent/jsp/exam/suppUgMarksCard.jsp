							...
							<tr>
								<td colspan="2">
									...
									<tr>
										...
										<logic:equal value="true" name="loginform" property="isImpReap">
										<td class="row-print" style="border-right:solid thin"><bean:write name="loginform" property="marksCardTo.semNo"/>&nbsp;Improvement</td>
										</logic:equal>
										<logic:equal value="false" name="loginform" property="isImpReap">
										<td class="row-print" style="border-right:solid thin"><bean:write name="loginform" property="marksCardTo.semNo"/>&nbsp;Reappereance</td>
										</logic:equal>			
