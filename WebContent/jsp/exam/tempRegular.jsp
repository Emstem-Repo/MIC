...
<html:form action="/newSupplementaryImpApp" >	
	...
	<html:hidden property="method" styleId="method" value="checkRegularApplicationForStudentLoginTemp" />
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="body"><strong
						class="boxheader">Temp regular application</strong></td>
