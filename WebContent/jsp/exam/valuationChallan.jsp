...
<script type="text/javascript">
	...
	function cancelPage() {
		document.location.href = "valuationChallan.do?method=initValuationChallan";
	...
	function saveDetails(){
		...
		document.valuationChallanForm.submit();
	}
	function ReprintDetails(){
		document.getElementById("method").value = "rePrintDetails";
		document.valuationChallanForm.submit();
	}
	function saveDetailsFromWarningMessage(){
		
		document.getElementById("method").value = "saveDetailsFromWarningMessage";
		document.valuationChallanForm.submit();
	}
...
<html:form action="/valuationChallan">
	...
	<html:hidden property="method" styleId="method" value="searchValuationDetails" />
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td width="9"><img src="images/Tright_03_01.gif" width="9"
						height="29"></td>
					<td background="images/Tcenter.gif" class="heading_white">Exam Valuation</td>
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<logic:equal value="true" name="valuationChallanForm" property="viewFields">
						 <tr height="50px">
						...
						<logic:notEmpty name="valuationChallanForm" property="map">
						 <tr>
		                	...
		                	<!--<logic:iterate id="to" name="valuationChallanForm" property="map">
				                  <tr>
				                    <td height="25" class="row-odd" align="left" colspan="6"><bean:write name="to" property="key"/></td>
				                  </tr>
				               	<logic:iterate id="to1" name="to" property="value" indexId="count">
				                   	<c:choose>
										...
										<td width="10%" height="25" class="row-even" ></td>
				                   		...
				                   		<td width="39%" height="25" class="row-even" align="left"><bean:write name="to1" property="value.subjectName"/></td>
				                   		<td width="10%" height="25" class="row-even" align="center"><bean:write name="to1" property="value.answerScripts"/></td>
				                   		<td width="11%" height="25" class="row-even" align="center"><bean:write name="to1" property="value.totalAmount"/></td>
				                   		<td width="10%" height="25" class="row-even" align="center">
										<input type="hidden" name="value[<c:out value='${tempCount}'/>].isBoardMeetingApplicable"	id="hidden_<bean:write name="to" property="key"/>_<bean:write name="to1" property="key"/>_<bean:write name="to1" property="value.boardMeetingChargePerSub"/>"
																value="<bean:write name="to1"  property='value.isBoardMeetingApplicable'/>" />
													
														<input type="checkbox" name="value[<c:out value='${tempCount}'/>].checked" id="<bean:write name="to" property="key"/>_<bean:write name="to1" property="key"/>_<bean:write name="to1" property="value.boardMeetingChargePerSub"/>"  onclick="checkSameSubject('<bean:write name="to" property="key"/>','<bean:write name="to1" property="key"/>','<bean:write name="to1" property="value.boardMeetingChargePerSub"/>')" />
																<script type="text/javascript">
																var boardMeetingApplicable = document.getElementById("hidden_<bean:write name="to" property="key"/>_<bean:write name="to1" property="key"/>_<bean:write name="to1" property="value.boardMeetingChargePerSub"/>").value;
																if(boardMeetingApplicable == "on") {
																	document.getElementById("<bean:write name="to" property="key"/>_<bean:write name="to1" property="key"/>_<bean:write name="to1" property="value.boardMeetingChargePerSub"/>").checked = true;
																}		
																</script>
										</td>
						...
						<tr>
							<td height="10" colspan="4" >
								<table width="100%" cellspacing="1" cellpadding="3">
					                  	<tr>
											<td align="right" width="66%" class="row-odd" colspan="3">
											Total:
										</td>
										<td height="20" width="11%"  class="row-even" align="center">
											<bean:write name="valuationChallanForm" property="totalScripts"/>
										</td>
										<td height="20" width="12%" class="row-even" align="center">
											<bean:write name="valuationChallanForm" property="totalScriptsAmount"/>
										</td>
										<td height="20" width="11%" class="row-even" >
										</td>
										</tr>
								</table>
							</td>
					 	...
					 	<tr>
							<td width="20%" height="35" align="center">
							<html:button property="" value="Save & Print" styleClass="formbutton" onclick="saveDetails()"></html:button>
										&nbsp;&nbsp;
							<logic:equal value="true" name="valuationChallanForm" property="rePrintDisplay">
							<html:button property="" value="Re Print" styleClass="formbutton" onclick="ReprintDetails()"></html:button>
										&nbsp;&nbsp;</logic:equal>
