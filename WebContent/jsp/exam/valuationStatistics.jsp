...
<script type="text/javascript">
	function getDepartmentWise(streamId,deaneryName){
		document.getElementById("deaneryName").value=deaneryName;
		document.location.href="ValuationStatistics.do?method=getDepartmentWise&deptStreamId="+streamId+"&deaneryName="+deaneryName;
	}
	...
	function cancelAction(){
		document.location.href="ValuationStatistics.do?method=initValuationStatistics";
	}
	function cancelPage(){
		document.location.href="ValuationStatistics.do?method=initValuationStatisticsForUser";
	}
</script>
	...
	<table width="99%" border="0">
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								<logic:notEmpty property="statistics" name="valuationStatisticsForm">
										<tr class="row-even">
											<td height="25" align="center"><nested:write property="statistics.totalSubjects" name="valuationStatisticsForm"/> </td>
											<td height="25" align="center"><nested:write property="statistics.valuationNotStarted" name="valuationStatisticsForm"/></td>
											<td height="25" align="center"><nested:write property="statistics.valuationInProcess" name="valuationStatisticsForm"/></td>
											<td height="25" align="center"><nested:write property="statistics.valuationCompleted" name="valuationStatisticsForm"/></td>
										</tr>
								</logic:notEmpty>
							</table>
							</td>
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<html:submit value="Deanery Wise" styleClass="formbutton"></html:submit>&nbsp;&nbsp;
				...
				<logic:notEmpty property="deaneryWise" name="valuationStatisticsForm">
				<tr>
					<td height="19" valign="top" background="images/Tright_03_03.gif"></td>
					<td class="heading">
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td valign="top">
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr class="row-odd" height="25"><td align="center" colspan="6"><span class="heading">Deanery Wise</span></td></tr>
								<tr class="row-odd">
									<td height="25" align="center">Deanery</td>
									<td height="25" align="center">Total no of papers	</td>
									<td height="25" align="center">Valuation not yet started	</td>
									<td height="25" align="center">Valuation in progress	</td>
									<td height="25" align="center">Valuation Completed </td>
									<td height="25" align="center">Department Wise</td>
								</tr>
									<nested:iterate property="deaneryWise" name="valuationStatisticsForm" indexId="count">
										<c:choose>
											...
											<td height="25">&nbsp;&nbsp;<nested:write property="deaneryName"/> </td>
											...
											<td height="25" align="center"><a href="javascript:void()" onclick="getDepartmentWise('<nested:write property="streamId"/>','<nested:write property="deaneryName"/>')">Department Wise</a></td>
									</nested:iterate>
							</table>
							</td>
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="20%" height="35" align="center">
									<span class="heading">Deanery: <bean:write name="valuationStatisticsForm" property="deaneryName"/></span>						
							</td>
						</tr>
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td valign="top">
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr class="row-odd" height="25"><td align="center" colspan="6"><span class="heading">Department Wise</span></td></tr>
								<tr class="row-odd">
