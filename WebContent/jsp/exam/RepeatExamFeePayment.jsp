...
<html:form action="/MidSemRepeatExamApplication">
	<html:hidden property="method" styleId="method" value="addRepeatExamFeesPayment" />
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader">Mid Semester Repeat Exam Fee Payment</strong></div>
					</td>
