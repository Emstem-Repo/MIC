...
<html:form action="/uploadAddlBioData" method="post" enctype="multipart/form-data">
<html:hidden property="method" styleId="method" value="uploadExportBioDataInfo" />
<html:hidden property="formName" value="uploadBiodataInfoForm" />
