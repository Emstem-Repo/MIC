...
function deleteDocExam(id){
	...
	if (deleteConfirm) {
		document.location.href = "examRevaluationFee.do?method=deleteOrReactivatePublishRevaluation&mode=delete&id="+ id;
	}
}
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<td class="row-even" width="15%"><input type="hidden"
										id="yr" name="yr"
										value='<bean:write name="examRevaluationFeeForm" property="academicYear"/>' />
									...
									<td width="15%" height="15" class="row-even"><html:select
										...
										<html:optionsCollection name="examRevaluationFeeForm"
									...
									<td width="20%" class="row-even"><nested:select
										...
										<c:if test="${examRevaluationFeeForm.courseMap != null}">
											<nested:optionsCollection property="courseMap"
												name="examRevaluationFeeForm" label="value" value="key"
												styleClass="comboBig" />
										</c:if>
								...
								<tr>
									...
									<div align="right"><span class="Mandatory">*</span>&nbsp;Revaluation Fees :</div>
									</td>
									<td class="row-even"><html:text
										name="examRevaluationFeeForm" property="revaluationFees"
										styleId="revaluationFees" size="10" maxlength="16"
										onkeypress="return isNumberKey(event)" /></td>
									<td height="25" class="row-odd">
									<div align="right"><span class="Mandatory">*</span>&nbsp;Scrutiny Fees</div>
									</td>
									<td class="row-even"><html:text
										name="examRevaluationFeeForm" property="scrutinyFees"
										styleId="scrutinyFees" size="10" maxlength="16"
										onkeypress="return isNumberKey(event)" /></td>
									<td height="25" class="row-odd">
									<div align="right"><span class="Mandatory">*</span>&nbsp;Application Fees</div>
									</td>
									<td class="row-even"><html:text
										name="examRevaluationFeeForm" property="applicationFees"
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								<tr>
									...
									<td width="10%" class="row-odd">
									<div align="center">Revaluation fees</div>
									</td>
									<td width="10%" class="row-odd">
									<div align="center">Scrutiny Fees</div>
									</td>
								...
								<logic:notEmpty name="examRevaluationFeeForm"
									property="revaluationExamToList">
									<logic:iterate id="dList" name="examRevaluationFeeForm"
