						...
						<tr>
							...
							<table width="100%" border="0"  cellspacing="1" cellpadding="1">
								<tr>
									...
									<td class="row-even">
									<nested:text name="subjectRuleSettingsForm" property="minimum" styleId="minimum" size="10" maxlength="6" onkeypress='validate(event)'/>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="row-even">
									<nested:text name="subjectRuleSettingsForm" property="maximum" styleId="maximum" size="10" maxlength="6" onkeypress='validate(event)'/>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="row-odd">
									<nested:text name="subjectRuleSettingsForm" property="valuated" styleId="valuated" size="10" maxlength="6" onkeypress='validate(event)'/>
									</td>
								</tr>
