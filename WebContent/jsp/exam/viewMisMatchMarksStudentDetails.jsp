							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr height="25">
									<td class="row-odd" align="center" colspan="4">Subject Name: &nbsp;&nbsp;&nbsp;
										 ...
										 &nbsp;&nbsp;&nbsp; <bean:write name="examValuationStatusForm" property="subjectName"/>
									</td>
								</tr>
								<tr height="25">
									...
									<logic:notEmpty name="examValuationStatusForm" property="students">
										<nested:iterate name="examValuationStatusForm" property="students" id="tos" indexId="count">
											<c:choose>
