...
<html:form action="/uploadPreviousClasses" method="post" enctype="multipart/form-data">
<html:hidden property="method" styleId="method" value="uploadPreviousClassInfo" />
<html:hidden property="formName" value="uploadPreviousClassForm" />
<html:hidden property="thefile"/>
<html:hidden property="pageType" value="1" />
<table width="99%" border="0"> 
  <tr>
    <td><span class="heading">Admission<span class="Bredcrumbs">&gt;&gt;Upload Previous Classes Data &gt;&gt;</span> </span></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td background="images/Tcenter.gif" class="heading_white" >Upload Previous Classes Data</td>
