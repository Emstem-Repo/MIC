...
// Functions for AJAX 
	...
	function updateSubjectGroupEntry(){
		...
		if(document.getElementById('commonSubjectGroup').checked){
						document.getElementById('commonSubjectGroup1').value="on";
		}
		else{
			document.getElementById('commonSubjectGroup1').value="off";
					...
					<table width="100%" border="0" align="center" cellpadding="0"
                       ...
                       <!-- End of Program type -->
								...
								<tr>
									...
									<td class="row-even"><html:checkbox
...
function deleteSubjectGroupEntry(id) {
