...
function editGD(id) {
	document.location.href = "GradePointRange.do?method=editGCD&id="+id;
...
function deleteGD(id,name) {
	...
	if(deleteConfirm)
	{
		document.location.href = "GradePointRange.do?method=deleteGCD&id="+id;
	}
}
					...
					<td valign="top">
						<table width="100%" cellspacing="1" cellpadding="2">
							...
							<c:set var="temp" value="0" />
								<logic:iterate name="gradePointRangeForm" property="listExamCourseGroup" id="listExamCourseGroup" type="com.kp.cms.to.exam.KeyValueTO"	indexId="count">
								<c:choose>
	    							<c:when test="${temp == 0}">
									<tr>
