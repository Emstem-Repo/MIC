				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<tr class="row-odd">
								...
								<td height="25" ><nested:text name="subjectRuleSettingsForm" property="esto.totalMinimummumMarks" styleId="totalMinimummumMarks" size="10" maxlength="6" onkeypress='validate(event)'/></td>
								<td height="25"><nested:text name="subjectRuleSettingsForm" property="esto.totalMaximumMarks" styleId="totalMaximumMarks" size="10" maxlength="6" onkeypress='validate(event)'/></td>
								<td height="25"> <nested:text name="subjectRuleSettingsForm" property="esto.totalentryMaximumMarks" styleId="totalentryMaximumMarks" size="10" maxlength="6" onkeypress='validate(event)'/></td>
							</tr>
							<tr>
					...
					<table width="100%" border="0"  cellspacing="1" cellpadding="1">
						...
						<logic:notEmpty name="subjectRuleSettingsForm" property="esto.assignmentList">
								...
								<td height="25" ><nested:text property="minimumAssignMarks" styleId="minimumAssignMarks" size="10" maxlength="6" onkeypress='validate(event)'/></td>
								<td height="25"><nested:text property="maximumAssignMarks" styleId="maximumAssignMarks" size="10" maxlength="6" onkeypress='validate(event)'/></td>
								</tr>
								</nested:iterate>
						</logic:notEmpty>
					</table>
					...
					<table width="100%" border="0"  cellspacing="1" cellpadding="1">
						...
						<tr height="25">
							...
							<td class="row-even">
							<nested:text name="subjectRuleSettingsForm" property="esto.finalInternalMinimumMarks" styleId="finalInternalMinimumMarks" size="10" maxlength="6" onkeypress='validate(event)'/>
							</td>
							<td class="row-odd" align="right">(Marks entered in)Entry Maximum mark :</td>
							<td class="row-even" > 
							<nested:text name="subjectRuleSettingsForm" property="esto.finalEntryMaximumMarks" styleId="finalEntryMaximumMarks" size="10" maxlength="6" onkeypress='validate(event)'/>
							</td>
							<td class="row-odd" align="right">Maximum Mark:</td>
							<td class="row-even">
							<nested:text name="subjectRuleSettingsForm" property="esto.finalInternalMaximumMarks" styleId="finalInternalMaximumMarks" size="10" maxlength="6" onkeypress='validate(event)'/>
							</td>
						</tr>
					</table>
					</td>
