...
<script type="text/javascript">
	...
	function getPracticalBatch() {
		...
		document.specialPromotionForm.submit();
	}
</script>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<td  class="row-even"><input type="hidden"
										id="yr" name="yr"
										value='<bean:write name="specialPromotionForm" property="year"/>' />
									...
									<td   class="row-even"><input type="hidden"
										name="c1" id="c1"
										value='<bean:write name="specialPromotionForm" property="classId"/>' />
									<html:select property="classId" styleClass="comboLarge"
										...
										<c:choose>
											...
											<c:otherwise>
												<c:if
													test="${specialPromotionForm.classId != null && specialPromotionForm.classId != ''}">
													<c:set var="classMap"
