...
function payOnline(){
	document.newSupplementaryImpApplicationForm.method.value="redirectToSupplementaryExamApplicationPGI";
...
{
	document.getElementById("method").value="submitSupplementaryExamApplicationChallan";
    document.newSupplementaryImpApplicationForm.submit();	
}	
...
<title>Supplementary Exam Application Form</title>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/st_Tcenter.gif" class="body"><strong
						class="boxheader">Exam Supplementary Application Payment</strong></td>
