...
function goToHomePage() {
	document.location.href = "ParentLoginAction.do?method=initMarksCard";
}
function resetErrorMsgs() {	
	resetFieldAndErrMsgs();
}
function printPass(){
	var url = "ParentLoginAction.do?method=printMarksCard";
	myRef = window
			.open(url, "MarksCard",
								...
								<td colspan="2">
						            ...
						            <c:set var="slnocount" value="0" />
										...
										<tr height="25px">
											...
											<td colspan="4" align="center" style="font-size: 12px"><b>Grand Total: <bean:write name="loginform" property="marksCardTo.totalMarksAwarded"/></b></td>
										</tr>
									</table>
								</td>
							</tr>
