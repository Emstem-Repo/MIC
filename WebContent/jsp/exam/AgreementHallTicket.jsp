...
<link rel="stylesheet" type="text/css" href="css/styles.css"/>
	...
	//function openReport(){
//document.location.href = "birtFeeReport.do?method=admissionBirtReportResultForStudent&reportName=hallTicket-Single&studentRegisterNo=<%= session.getAttribute("stuRegNo")%>&ExamID=<%= session.getAttribute("examID")%>";
	//}
	</script>
								...
								<tr>
									...
									<td width="10%" height="25" align="center"  colspan="5">
									 <table width="100%" cellspacing="0" cellpadding="0" border="0" >
										...
										<FONT face="Verdana" size="1"><c:out value="${agreement}" escapeXml="false"></c:out></FONT>
										</td>
										</tr>
									</table>
									</td>
