...
<html:form action="/uploadExaminternalMark" method="post" enctype="multipart/form-data">
<html:hidden property="method" styleId="method" value="saveInternalMarkSupplementary" />
<html:hidden property="formName" value="uploadExamInternalMarkSupplementaryForm" />
<html:hidden property="thefile"/>
<html:hidden property="pageType" value="1" />
<table width="99%" border="0"> 
  <tr>
    <td><span class="heading">Admission<span class="Bredcrumbs">&gt;&gt;Upload Exam Internal Mark Supplementary Data &gt;&gt;</span> </span></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td background="images/Tcenter.gif" class="heading_white" >Upload Exam Internal Mark Supplementary Data</td>
