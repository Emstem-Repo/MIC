...
function editFee(id){
	...
	if (deleteConfirm) {
		document.location.href = "SupplementaryFees.do?method=editOrUpdatePublish&mode=edit&id="+ id;
	}
}
function caancelOp(){
		document.location.href = "SupplementaryFees.do?method=initSupplementaryFees";
}
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="body"><strong
						class="boxheader"> Supplementary Fees</strong></td>
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
									...
									<td width="16%" class="row-even"><nested:select
										...
										style="width:300px" disabled="true">
											<c:if test="${supplementaryFeesForm.courseMap != null}">
												<nested:optionsCollection property="courseMap" name="supplementaryFeesForm"
								...
								<td height="25" class="row-odd">
									...
									<td height="25" class="row-odd">
									<div align="right"><span class="Mandatory">*</span>&nbsp;<bean:message key="knowledgepro.supplementary.practical.fees"/></div>
									</td>
									<td class="row-even">
									...
									<td height="25" class="row-odd">
									<div align="right">Additional Theory Paper fees :</div>
									</td>
									<td class="row-even">
							        ...
							        <td height="25" class="row-odd">
									<div align="right">Additional Practical Paper fees :</div>
									</td>
									<td class="row-even">
									...
									<td height="25" class="row-odd">
									<div align="right">Project fees :</div>
									</td>
									<td class="row-even">
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							onclick="caancelOp()"></html:button></c:when>
							<c:otherwise>
								<td width="45%" height="35">
							<div align="right">
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<tr>
											...
											<div align="center">Practical Fees</div>
													...
													<td width="10%" class="row-odd">
											<div align="center">Additional Theory Paper  Fees</div>
											</td>
													<td width="10%" class="row-odd">
											<div align="center">Additional Practical Paper Fees</div>
											</td>
											<td width="15%" class="row-odd">
											<div align="center">Project Fees</div>
											</td>
											<td width="15%" class="row-odd">
										...
										<tr>
											...
											<td align="center"><bean:write name="dList" property="courseName" /></td>
