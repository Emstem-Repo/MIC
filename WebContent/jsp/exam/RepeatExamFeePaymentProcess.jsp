...
function cancelAction(){
	document.location.href="MidSemRepeatExamApplication.do?method=initRepeatExamFeePayment";
}
	function saveMidSemFeesPaymentCourse(){
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader">FeePayment For Mid Semester Repeat Exam</strong></div>
					</td>
				...
				<tr>
					...
					<table width="70%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<tr>
									...
									<bean:write name="loginform" property="midSemStudentName"/>
									</td>
								</tr>
								<tr>
									...
									<bean:write name="loginform" property="midSemRepeatRegNo"/>
									</td>
								</tr>
								<tr>
								<td class="studentrow-odd" align="right">
									...
									<td class="studentrow-even">
									<bean:write name="loginform" property="midSemClassName"/>
									</td>
								</tr>
								<tr>
									<td class="studentrow-odd" align="right" width="50%" >
									...
									<td class="studentrow-even" width="50%" >
									<bean:write name="loginform" property="midSemTotalAmount"/>
									</td>
								</tr>
							</table>
							</td>
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2" align="center">
								...
								<tr>
									...
									<td class="studentrow-even" width="50%">
									<html:text name="loginform" property="dob" styleId="dob" size="10" maxlength="16"/>
								...
								<tr>
									...
									<td class="studentrow-even" width="50%">XXXXXXXXXXXXXX
										<html:text name="loginform" property="smartCardNo" styleId="smartCardNo" size="5" maxlength="5"></html:text>									
									</td>
								</tr>
								<tr>
									<td class="studentrow-odd" align="right" width="50%">
									...
									<td class="studentrow-even" width="50%">
										<html:text name="loginform" property="validThruMonth" styleId="validThruMonth" size="2" maxlength="2" onkeypress="return isNumberKey(event)"></html:text> /
										<html:text name="loginform" property="validThruYear" styleId="validThruYear" size="2" maxlength="2" onkeypress="return isNumberKey(event)"></html:text>
										&nbsp;&nbsp; mm/yy
									</td>
								</tr>
							</table>
                   ...
                   <td colspan="2"><div align="center">
					<html:button property=""
								...
								onclick="saveMidSemFeesPaymentCourse()"></html:button>	&nbsp; <html:button property=""
