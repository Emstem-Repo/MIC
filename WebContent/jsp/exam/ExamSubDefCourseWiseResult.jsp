...
<body>
<form action="subject_deinition_coursewise1.html">
          ...
          <tr>
            ...
            <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
              <tr >
                ...
                <td width="13%" class="row-odd" >Subject Code</td>
                <td width="13%" class="row-odd" >Subject Name</td>
                <td class="row-odd"><div align="center">Edit </div></td>
                </tr>
              <tr >
                <td width="5%" height="25" class="row-even"><div align="center">1</div></td>
                <td class="row-even" >BCom01</td>
                <td class="row-even" >Computing</td>
                <td width="4%" height="25" class="row-even" ><div align="center"><a href="subject_deinition_coursewise2.html"><img src="../images/edit_icon.gif" width="16" height="18" border="0"></a></div></td>
                </tr>
              <tr >
                <td height="25" class="row-white"><div align="center">2</div></td>
                <td class="row-white" >BCom02</td>
                <td class="row-white" >Statistics</td>
                <td height="25" class="row-white" ><div align="center"><a href="subject_deinition_coursewise2.html"><img src="../images/edit_icon.gif" alt="" width="16" height="18" border="0"></a></div></td>
                </tr>
            </table></td>
            <td width="5" height="30"  background="images/right.gif"></td>
          </tr>
