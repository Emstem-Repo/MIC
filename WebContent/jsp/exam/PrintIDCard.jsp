	...
	<html:hidden property="pageType" value="3"/>
		<table  border="0"  align="center">
			...
			<tr>
				<td style=" line-height: 350%">
					<table align="center">
						<tr >
							<td ><font style="bold" size="5"><u>TEMPORARY ID CARD</u></font></td>
						</tr>
					</table>
				</td>
			</tr>
		...
		<tr>
			<td align="left" style="padding-left: 20px; padding-right: 20px;">
      			<table >
      				<tr>
      					<td align="left" style=" line-height: 250%"><font style="bold" >This is a temporary Id card issued to:&nbsp;</font><bean:write name="tempHallTicketOrIDCardForm" property="nameOfStudent"/></td>
					</tr>
					<tr>	
