...
<script type="text/javascript">
	...
	function cancelAction() {
		document.location.href = "valuationStatus.do?method=initNewValuationStatus";
	}
	function disableFields(finalYears){
		if(finalYears=='true'){
			...
			document.getElementById("termNumber").disabled=true;
			...
			document.getElementById("termNumber").disabled=false;
	...
	function resetFields() {
		document.getElementById("method").value="resetForNewValuationStatus";
...
<html:form action="/valuationStatus">
	...
	<html:hidden property="method" styleId="method" value="newDisplayValuationStatus" />
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								<tr>
									<td  width="25%"  height="25"  class="row-odd"><div align="right"><bean:message key="knowledgepro.exam.valuationStatus.finalyears"/></div> </td>
									<td  width="25%" height="25"  class="row-even">
									<div align="Center"><html:radio property="finalYears"
										styleId="finalYears_Yes" value="true"
										onclick="disableFields(this.value)"></html:radio>
									Yes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<html:radio property="finalYears" value="false"
										styleId="finalYears_No"
										onclick="disableFields(this.value)"></html:radio>
									No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									</div>
									</td>
								...
								<tr>
									<td width="25%" class="row-odd"><div align="right"><bean:message key="knowledgepro.fee.academicyear"/>:</div></td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<html:submit value="Submit" styleClass="formbutton"></html:submit>
										&nbsp;&nbsp;
							<html:button property="" styleClass="formbutton" value="Reset" onclick="resetFields()" />
