...
<html:form action="/consolidateMarksCard">	
		<html:hidden property="method" styleId="method" value="saveConsolidateMarksCardDetails" />
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								name="cId" id="cId"
								value='<bean:write name="consolidateMarksCardForm" property="courseId"/>' />
							<html:select property="courseId" styleClass="comboLarge"
								...
								<logic:notEmpty name="consolidateMarksCardForm" property="courseList">
