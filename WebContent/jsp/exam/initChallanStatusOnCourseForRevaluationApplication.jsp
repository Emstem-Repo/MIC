...
function getStudentsDetails(){
	...
	document.getElementById("method").value = "getStudentsChallanStatusOnCourseForRevaluationApplication";
	document.dDStatusForm.submit();
}


function cancelPage(){
	document.location.href="ddStatus.do?method=initChallanStatusOnCourseForRevaluationApplication";
}



function updateChallanStatusOnCourse() {
	document.getElementById("method").value = "updateChallanStatusOnCourseForRevaluationApplication";
	document.dDStatusForm.submit();
		...
		<tr>
            ...
            <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
              <tr >
               ...
               <td height="25" class="row-odd" ><div align="right"><span class="Mandatory">*</span>Academic Year</div></td>
              ...
              <td height="25" class="row-odd" width="25%">
											...
											<td height="25" class="row-even" width="14%">
											<html:select
              ...
              <td width="25%" height="25" class="row-odd" ><div id ="classes1" align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.attendanceentry.class" /> </div></td><!--
                             <td width="25%" height="25" class="row-even" align="left" >
                              <html:select
								...
								<td height="25" class="row-even" width="14%">
									<html:select
											property="classes" styleClass="body" styleId="classes"  style="width:200px">
											<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
											<logic:notEmpty name="dDStatusForm" property="classMap">
												<html:optionsCollection property="classMap" name="dDStatusForm" label="value" value="key" />
											</logic:notEmpty>
									</html:select></td>
             ...
             <tr >
               ...
               <td height="25" class="row-odd" ><div align="right"><span class="Mandatory">*</span>Revaluation Type</div></td>
				<td height="25" colspan="2" class="row-even">
									<div align="Center">
									<html:radio property="revaluationType"
										styleId="revalution" value="revalution"></html:radio>
									Revaluation&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<html:radio property="revaluationType" value="scrutiny"
										styleId="scrutiny" ></html:radio>
									Scrutiny									
									</div>
									</td>
			...
			<tr>
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
										...
										<td align="center" class="row-odd">Register No</td>
										<td align="center" class="row-odd"><input type="checkbox" id="checkAll" onclick="selectAll(this)"/> Select</td>
										<td align="center" class="row-odd">Amount</td>
										<td align="center" class="row-odd">Remark</td>
										</tr>
											<nested:iterate id="to" property="ddStatusList"	name="dDStatusForm" indexId="count">
												<tr>
													...
													<td align="center" class="row-even">
														<nested:text property="fees" styleId="fees" styleClass="TextBox" onkeypress='return isNumberKey(event)'
															size="20" maxlength="30"> </nested:text>
													</td>
													
													<td align="center" class="row-even">
														<nested:text property="remarks" styleId="remarks" styleClass="TextBox"
															size="20" maxlength="30"> </nested:text>
													</td>
