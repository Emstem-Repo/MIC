...
<SCRIPT type="text/javascript">
    function cancelAct() {
    	document.getElementById("method").value = "initPromoteSuplyMarksReport";
...
<table width="98%" border="0">
  <tr>
    <td class="heading"><bean:message key="knowledgepro.exam.exam"/><span class="Bredcrumbs">&gt;&gt;<bean:message key="knowledgepro.exam.promotesuplimarks.report" /><span class="Bredcrumbs">&gt;&gt;</span></span></td>
  </tr>
  <tr>
    <td valign="top"><table width="98%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="10" ><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td width="100%" background="images/Tcenter.gif" class="body" ><div align="left"><strong class="boxheader"><bean:message key="knowledgepro.exam.promotesuplimarks.report" /></strong></div></td>
...
<div style="overflow: auto; width: 1100px; ">
	<c:set var="temp" value="0" />  
		<% String subj1 = session.getAttribute("subject1").toString();
	       ...
	       String supliSub1 = session.getAttribute("suplSubj1").toString();
	       //String supliSub2 = session.getAttribute("suplSubj2").toString();
	       String supliSub3 = session.getAttribute("suplSubj3").toString();
	       String supliSub4 = session.getAttribute("suplSubj4").toString();
	       String supliSub5 = session.getAttribute("suplSubj5").toString();
	       String supliSub6 = session.getAttribute("suplSubj6").toString();
	       String supliSub7 = session.getAttribute("suplSubj7").toString();
		%>
		<display:table export="true" uid="promoteSupliMarksUid"  id = "promoteSupliMarks" name="sessionScope.promoteSupliMarksToList" requestURI="" defaultorder="ascending" pagesize="10">
			<display:setProperty name="export.excel.filename" value="promoteSupliMarks.xls"/>
			<display:setProperty name="export.xml" value="false" />
			<display:setProperty name="export.csv.filename" value="promoteSupliMarks.csv"/>
				...
				<display:column style=" width: 130px;" property="markSub1" sortable="true" title='<%=subj1 %>'  class="row-even" headerClass="row-odd" media="html csv excel"/>
				<display:column style=" width: 130px;" property="markSub2" sortable="true" title="SECOND LANG" class="row-even" headerClass="row-odd" media="html csv excel"/>
				<display:column style=" width: 130px;" property="markSub3" sortable="true" title='<%=subj3 %>' class="row-even" headerClass="row-odd" media="html csv excel"/>
				<display:column style=" width: 130px;" property="markSub4" sortable="true" title='<%=subj4 %>' class="row-even" headerClass="row-odd" media="html csv excel"/>
				<display:column style=" width: 130px;" property="markSub5" sortable="true" title='<%=subj5 %>' class="row-even" headerClass="row-odd" media="html csv excel"/>
				<display:column style=" width: 130px;" property="markSub6" sortable="true" title='<%=subj6 %>' class="row-even" headerClass="row-odd" media="html csv excel"/>
				<display:column style=" width: 130px;" property="markSub7" sortable="true" title='<%=subj7 %>' class="row-even" headerClass="row-odd" media="html csv excel"/>
				...
				<display:column style=" width: 130px;" property="suplSub1" sortable="true" title='<%=supliSub1 %>' class="row-even" headerClass="row-odd" media="html csv excel"/>
				<display:column style=" width: 130px;" property="suplSub2" sortable="true" title="SUPLI-SECONDLANG" class="row-even" headerClass="row-odd" media="html csv excel"/>
				<display:column style=" width: 130px;" property="suplSub3" sortable="true" title='<%=supliSub3 %>' class="row-even" headerClass="row-odd" media="html csv excel"/>
				<display:column style=" width: 130px;" property="suplSub4" sortable="true" title='<%=supliSub4 %>' class="row-even" headerClass="row-odd" media="html csv excel"/>
				<display:column style=" width: 130px;" property="suplSub5" sortable="true" title='<%=supliSub5 %>' class="row-even" headerClass="row-odd" media="html csv excel"/>
				<display:column style=" width: 130px;" property="suplSub6" sortable="true" title='<%=supliSub6 %>' class="row-even" headerClass="row-odd" media="html csv excel"/>
				<display:column style=" width: 130px;" property="suplSub7" sortable="true" title='<%=supliSub7 %>' class="row-even" headerClass="row-odd" media="html csv excel"/>
