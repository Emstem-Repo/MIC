						...
						<tr>
							...
							<table width="100%" border="0"  cellspacing="1" cellpadding="1">
								...
								<tr>
									...
									<td class="row-even"> <nested:text name="subjectRuleSettingsForm" property="peseTo.supplementaryMinMarks" styleId="supplementaryMinMarks" size="10" maxlength="6" onkeypress='validate(event)'/></td>
									<td class="row-odd">Supplementary Maximum Marks:</td>
									<td class="row-even"><nested:text name="subjectRuleSettingsForm" property="peseTo.supplementaryMaxMarks" styleId="supplementaryMaxMarks" size="10" maxlength="6" onkeypress='validate(event)'/> </td>
								</tr>
						...
						<tr>
							...
							<table width="100%" border="0" cellspacing="1" cellpadding="1">
								<tr>
									...
									<td class="row-even">
									<nested:text name="subjectRuleSettingsForm" property="peseTo.minimumMarksPracticalESE" styleId="minimumMarksPracticalESE" size="10" maxlength="6" onkeypress='validate(event)'/>
									</td>
									<td class="row-odd">(Marks entered in)Entry Maximum mark :</td>
									<td class="row-even">
									<nested:text name="subjectRuleSettingsForm" property="peseTo.maximumEntryMarksPracticalESE" styleId="maximumEntryMarksPracticalESE" size="10" maxlength="6" onkeypress='validate(event)'/>
									</td>
									<td class="row-odd">Maximum Mark:</td>
									<td class="row-even">
									<nested:text name="subjectRuleSettingsForm" property="peseTo.maximumMarksPracticalESE" styleId="maximumMarksPracticalESE" size="10" maxlength="6" onkeypress='validate(event)'/>
									</td>
								</tr>
							</table>
							</td>
					...
					<table width="100%" border="0"  cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<table width="100%" border="0"  cellspacing="1" cellpadding="1">
								...
								<td class="row-even"> <nested:text name="subjectRuleSettingsForm" property="peseTo.minimumTheoryFinalMarksPracticalESE" styleId="minimumTheoryFinalMarksPracticalESE" size="10" maxlength="6" onkeypress='validate(event)'/></td>
								<td class="row-odd">Maximum Marks:</td>
								<td class="row-even"><nested:text name="subjectRuleSettingsForm" property="peseTo.maximumTheoryFinalMarksPracticalESE" styleId="maximumTheoryFinalMarksPracticalESE" size="10" maxlength="6" onkeypress='validate(event)'/> </td>
								</tr>
							</table>
							</td>
							<td width="5" height="30" background="images/right.gif"></td>
