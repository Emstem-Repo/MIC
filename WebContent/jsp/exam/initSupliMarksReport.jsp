...
<script type="text/javascript">
	function getCourses(year) {
		...
		getClassesByCourseAndYear("courseMap", year, "course", updateClasses);
		resetOption("subject");
	}
	...
	function getPracticalBatch() {
		...
		document.getElementById("method").value = "getPromoteSupliMarks";
...
<html:form action="/promotemarks" method="post">
	<html:hidden property="method" styleId="method" value="getPromoteSupliMarks" />
	...
	<table width="99%" border="0">
		<tr>
			<td><span class="Bredcrumbs"><bean:message
				...
				key="knowledgepro.exam.promotemarks" />&gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="heading_white"><bean:message
						key="knowledgepro.exam.promotemarks" /></td>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<td class="row-even"><input type="hidden"
										name="cId" id="cId"
										value='<bean:write name="promoteMarksUploadForm" property="courseId"/>' />
									<html:select property="courseId" styleClass="combo"
										styleId="course" >
										<html:option value="">
											-<bean:message key="knowledgepro.select" />-</html:option>
											<logic:notEmpty name="promoteMarksUploadForm" property="courses">
										<html:optionsCollection name="promoteMarksUploadForm" label="value" value="key" property="courses"/>
										</logic:notEmpty>
									</html:select></td>
									</tr>
							</table>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td height="35" align="center"><html:button property=""
								styleClass="formbutton" value="Search" onclick="getPracticalBatch()"></html:button>
