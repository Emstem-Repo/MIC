						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="0">
								...
								<tr class="row-white">
										...
										<logic:equal value="true" property="controller" name="newExamMarksEntryForm">
										<logic:equal value="true" property="isTheory" name="examMarksEntryStudentTO">
											...
											-->
											<nested:text property="theoryMarks" maxlength="6" styleId= '<%=id %>' onkeydown="movenext(this.name, event, this.id)" /></logic:equal>
										...
										<td height="35" width="18%" class="row-even">
											...
											-->
											<nested:text property="practicalMarks" maxlength="6" styleId= '<%=id %>' onkeydown="movenext(this.name, event, this.id)"/></logic:equal>
										...
										<logic:equal value="true" property="teacher" name="newExamMarksEntryForm">
										<logic:equal value="false" property="marksEntryExist" name="newExamMarksEntryForm">
										<logic:equal value="true" property="isTheory" name="examMarksEntryStudentTO">
											<td height="35" width="18%" class="row-even">
											<logic:equal value="true" property="isTheorySecured" name="examMarksEntryStudentTO">												
											<nested:text property="theoryMarks" maxlength="6" styleId= '<%=id %>' onkeydown="movenext(this.name, event, this.id)" /></logic:equal>
										...
										<logic:equal value="true" property="marksEntryExist" name="newExamMarksEntryForm">
										<logic:equal value="true" property="isTheory" name="examMarksEntryStudentTO">
											<td height="35" width="18%" class="row-even">
											<logic:equal value="true" property="isTheorySecured" name="examMarksEntryStudentTO">	
										...
										<td height="35" width="18%" class="row-even">
											<logic:equal value="true" property="isPracticalSecured" name="examMarksEntryStudentTO">	
											<nested:text  disabled="true" property="practicalMarks" maxlength="6" styleId= '<%=id %>' onkeydown="movenext(this.name, event, this.id)"/></logic:equal>
											<logic:equal value="false" property="isPracticalSecured" name="examMarksEntryStudentTO">	
												<nested:text  disabled="true" property="practicalMarks" maxlength="6" styleId= '<%=id %>' onkeydown="movenext(this.name, event, this.id)"/>
											</logic:equal>
										</td>
										</logic:equal>
										</logic:equal>
										...
										<logic:equal value="false" property="controller" name="newExamMarksEntryForm">
										<logic:equal value="false" property="teacher" name="newExamMarksEntryForm">
										<logic:equal value="true" property="isTheory" name="examMarksEntryStudentTO">
											<td height="35" width="18%" class="row-even">
											<logic:equal value="true" property="isTheorySecured" name="examMarksEntryStudentTO">	
											<nested:text disabled="true" property="theoryMarks" maxlength="6" styleId= '<%=id %>' onkeydown="movenext(this.name, event, this.id)" /></logic:equal>
