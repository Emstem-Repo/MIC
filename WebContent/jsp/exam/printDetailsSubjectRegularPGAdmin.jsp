...
<table width="100%" cellspacing="1" cellpadding="2" style='font-family: "Times New Roman", Times, serif;font-size: 9pt;'>
		...
		<tr><td align="center">
		<b> EXAM REGISTRATION FORM <br><bean:write name="examStudentTokenRegisteredForm" property="examName" />, <bean:write name="examStudentTokenRegisteredForm" property="courseName" /></b>
		</td></tr>
		<tr>
		 <td align="center" style="padding-left: 70px;" colspan="2" width="40%"><b>Permanent Register Number</b>
		 : <html:text property="regNo" name="examStudentTokenRegisteredForm" readonly="true" style="border-color:black;text-align: center;"></html:text>			
		 </td>
		 </tr>
		</table>
<!--		,<bean:write name="examStudentTokenRegisteredForm" property="month" />-<bean:write name="examStudentTokenRegisteredForm" property="year" /> -->
		</td>
		...
		<td colspan="3"></td>
		 ...
		 <td colspan="3" height="25%" style="text-transform: uppercase;font-size: 8pt;" align="left"><bean:write name="examStudentTokenRegisteredForm" property="nameOfStudent" /></td>
		 </tr>
		  <tr>
		 <td align="center" >2</td>
		 <td align="left">Date of Birth</td>
		 <td align="left"><bean:write name="examStudentTokenRegisteredForm" property="originalDob" /></td>
		 <td align="left">Gender</td>
		 <td align="left" style="font-size: 8pt;" ><bean:write name="examStudentTokenRegisteredForm" property="gender" /></td></tr>
		<tr>
		 <td height="25%" align="center">3</td>
		 <td align="left">Religion and Community													
		 </td>
		 <td align="left" colspan="3" style="font-size: 8pt;" ><bean:write name="examStudentTokenRegisteredForm" property="religion" /></td>
		 </tr>
		 <tr>
		 ...
		 <td align="left" colspan="3" style="font-size: 8pt;" >
		 	<logic:equal value="YES" name="examStudentTokenRegisteredForm" property="feeConcession">Yes</logic:equal>		 	
		 	<logic:equal value="Yes" name="examStudentTokenRegisteredForm" property="feeConcession">Yes</logic:equal>
		 	<logic:equal value="NO" name="examStudentTokenRegisteredForm" property="feeConcession">No</logic:equal>
		 	<logic:equal value="No" name="examStudentTokenRegisteredForm" property="feeConcession">No</logic:equal>
		 </td>
		</tr>
		 <tr>
		 ...
		 <td align="left" colspan="3" style="font-size: 8pt;" ><bean:write name="examStudentTokenRegisteredForm" property="careTaker" /></td>
		 </tr>
		 ...
		 <td colspan="3" style="font-size: 8pt;" ><bean:write name="examStudentTokenRegisteredForm" property="communicationAddress" />
		 Pin Code: <bean:write name="examStudentTokenRegisteredForm" property="communicationAddressZipCode" />
		 , Phone: <bean:write name="examStudentTokenRegisteredForm" property="communicationMobileNo" />
<!--		 , Email: <bean:write name="examStudentTokenRegisteredForm" property="communicationEmail" />-->
		 </td>
		 ...
		 <td colspan="2" style=" padding-left: 10px;"><bean:write name="examStudentTokenRegisteredForm" property="courseDep" /></td>
		 </tr>
		 <tr>
		 <td align="center" >2</td>
		 <td >Name of the Programme</td>
		 <td colspan="2" style=" padding-left: 10px;"><bean:write name="examStudentTokenRegisteredForm" property="courseName" /></td>
		 </tr>
		 <tr>
		 <td align="center" width="5%" >3</td>
		 <td width="35%" >Examination appearing for  (Regular/ Supplementary/ Improvement)</td>
		 <td colspan="2" style=" padding-left: 10px;"><bean:write name="examStudentTokenRegisteredForm" property="examType" /></td>
		 </tr>
		 ...
		 <td height="25%" colspan="2" style=" padding-left: 10px;"><bean:write name="examStudentTokenRegisteredForm" property="address" />
		 <bean:write name="examStudentTokenRegisteredForm" property="mobileNo" />
		  &  <bean:write name="examStudentTokenRegisteredForm" property="email" />
		 </td>
		 </tr>
		 ...
		 <td width="15%" style=" padding-left: 10px;"><bean:write name="examStudentTokenRegisteredForm" property="feeConcession" /></td>
		 <logic:equal value="yes" name="examStudentTokenRegisteredForm" property="feeConcession" >
		 <td  style=" padding-left: 10px;">Category: <bean:write name="examStudentTokenRegisteredForm" property="feeConcessionCategory" /></td>
		 </logic:equal>
		  <logic:notEqual value="yes" name="examStudentTokenRegisteredForm" property="feeConcession" >
		 ...
		 <td width="15%" style="text-align: center;" colspan="4">Course Code & Title</td>		
		 </tr>
		 
		 <nested:notEmpty property="supSubjectList" name="examStudentTokenRegisteredForm">
		 <nested:iterate property="supSubjectList" indexId="count" name="examStudentTokenRegisteredForm">
		...
		<table width="100%" >
							...
							<logic:notEmpty name="examStudentTokenRegisteredForm" property="description">
								<font size="3px"><c:out value="${examStudentTokenRegisteredForm.description}" escapeXml="false"></c:out></font>
							</logic:notEmpty>
							</td>
							</tr>
	</table>	
