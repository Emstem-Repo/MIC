...
<!--		 <td style="text-transform: uppercase; text-align: center;font-size: 8pt;"><nested:write  property="subjectType" /></td>-->
...
<!--		 <td style="text-transform: uppercase; text-align: center;font-size: 8pt;"><nested:write  property="subjectType" /></td>-->
		...
		<tr style="border-collapse: collapse;border:none;">
		 <td style="height: 20px;text-align: left;"><b>Office Superintendent</b></td>
		 <td></td>		 
		 <td style="height: 20px;text-align: right;"><b>Principal</b> </td>
		</tr>
