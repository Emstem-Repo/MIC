...
<html:hidden property="method" value="submitInitPurchaseReturn"/>
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <td valign="top" ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
                <tr >
                  <td height="25" class="row-odd" ><div align="right"><span class="Mandatory">*</span> <bean:message key="inventory.purchaseOrder.orderNo.label"/></div></td>
                  <td class="row-even" ><html:text property="purchaseOrderNo" size="10" maxlength="30"></html:text></td>
                  </tr>
              </table>
            </td>
      ...
      <tr>
        ...
        <td class="heading"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="49%" height="35" align="right"><html:submit styleClass="formbutton" value="Continue" onclick="submitPurchaseReturn('submitInitPurchaseReturn')" /></td>
			<td width="2%" height="35" align="center">&nbsp;</td>
			<td width="49%" height="35" align="left"><html:button property="" styleClass="formbutton" value="Reset" onclick="submitPurchaseReturn('initPurchaseReturn')" /></td>
          </tr>
        </table></td>
        <td valign="top" background="images/Tright_3_3.gif" ></td>
      </tr>
