  ...
  <tr>
	...
	<tr>
      ...
      <tr>
		...
		<display:table export="true" id="row" name="sessionScope.itemList" requestURI="" defaultorder="descending" pagesize="10" style="width:100%" >
		...
		<display:setProperty name="export.csv.filename" value="StockReport.csv"/>
			...
			<display:column style=" padding-left: 50px; padding-right: 50px; " property="name" sortable="false" title="Item Name" class="row-even" headerClass="row-odd"/>
			...
			<display:column style=" padding-left: 50px; padding-right: 50px; " title="Operation" property="operation" class="row-even" headerClass="row-odd">
      ...
      <tr>
        ...
        <td class="heading"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="3" height="35" align="center"><html:button property="" styleClass="formbutton" value="Cancel" onclick="submitStockReport('initStockReportDetail')"/></td>
