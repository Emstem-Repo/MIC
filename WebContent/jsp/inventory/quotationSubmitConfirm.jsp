...
<html:hidden property="method" value="initQuotaion"/>
      ...
      <tr>
        ...
        <td valign="top" ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <logic:equal value="Add" property="mode" name="quotationForm">
            <td valign="middle" class="heading"><bean:message key="inventory.quotation.submit.success"/> The generated Quotation No:
            <bean:write name="quotationForm" property="quotationNo"/>      
              </td></logic:equal>
               <logic:equal value="Edit" property="mode" name="quotationForm">
            <td valign="middle" class="heading"><bean:message key="knowledgepro.inventory.quotation.updated.success"/>         
              </td></logic:equal>
