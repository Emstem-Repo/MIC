...
<html:hidden property="method" value="rePrintpurchaseOrder"/>
<html:hidden property="pageType" value="4"/>
<html:hidden property="formName" value="purchaseOrderForm"/>
<input type="hidden" id="printReceipt" name="printReceipt" value="<bean:write name="purchaseOrderForm" property="print"/>"/>
<table width="99%" border="0">
  
  <tr>
    <td><span class="heading"><span class="Bredcrumbs"> <bean:message key="knowledgepro.inventory"/> &gt;&gt; Reprint Purchase Order &gt;&gt;</span></span></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="heading_white" >Reprint Purchase Order </td>
          ...
          <tr>
            ...
            <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
                <tr >
                  ...
                  <td width="19%" class="row-even" ><html:text property="orderNo" size="10" maxlength="30"></html:text></td>
                  </tr>
              </table>
               </td>
      ...
      <tr>
        ...
        <td class="heading"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td height="35" align="left"><html:button property="" styleClass="formbutton" value="Reset" onclick="resetFieldAndErrMsgs()" /></td>
          </tr>
        </table></td>
        <td valign="top" background="images/Tright_3_3.gif" ></td>
      </tr>
...
<script>
	var print = document.getElementById("printReceipt").value;
