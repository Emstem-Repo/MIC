...
<body>
<html:form action="/stockReportDetail">
...
<table width="99%" border="0">
  ...
  <tr>
    <td><span class="heading"><span class="Bredcrumbs">&gt;&gt; <bean:message key="knowledgepro.inventory"/> </span> <span class="Bredcrumbs">&gt;&gt; <bean:message key="inventory.stockReportDetail"/> </span></span></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="heading_white" ><bean:message key="inventory.stockReportDetail"/>  </td>
	...
	new tcal ({
      ...
      <tr>
        ...
        <td class="heading"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="50%" height="35" align="right"><html:button property="" styleClass="formbutton" value="View" onclick="submitStockReport('submitStockReportDetail')"/></td>
            <td width="3" height="35" align="center">&nbsp;</td>
            <td width="50%" height="35" align="left"><html:button property="" styleClass="formbutton" value="Cancel" onclick="submitStockReport('initStockReportDetail')"/></td>
          </tr>
        </table></td>
        <td valign="top" background="images/Tright_3_3.gif" ></td>
      </tr>
