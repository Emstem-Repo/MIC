...
<html:form action="/AMCDueReport" method="post">
	<html:hidden property="method" styleId="method" value="getWarrantyExpiryDetails" />	
          ...
          <tr>
            ...
            <td width="100%" valign="top"><table width="100%" cellspacing="1" cellpadding="2">
				<tr>
                  ...
                  <tr>
	                  <td width="25%" height="25" class="row-odd" ><div align="right"><bean:message key="knowledgepro.admin.InvLocation" />:</div></td>
