...
<html:hidden property="method" value="initPurchaseReturn"/>
      ...
      <tr>
        ...
        <td valign="top" ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td valign="middle" class="heading"><bean:message key="inventory.purchaseReturn.submit.success"/>         
              </td>
      ...
      <tr>
        ...
        <td class="heading"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="3" height="35" align="center"><html:button property="" styleClass="formbutton" value="Back"  onclick="submitPurchaseReturn('initPurchaseReturn')"/></td>
