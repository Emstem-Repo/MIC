	 ...
	 <tr>
        ...
        <td class="heading"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="100%" valign="top"><table width="100%" cellspacing="1" cellpadding="2">
                <tr >
                  <td class="row-odd" ><div align="right"><bean:message key="inventory.purchaseOrder.orderDt.label"/></div></td>
                  <td class="row-even" ><bean:write property="purchaseDate" name="purchaseOrderForm"/></td>
                  <td height="25" class="row-odd" ><logic:equal value="Edit" property="mode" name="purchaseOrderForm">
                  <div align="right"> <bean:message key="inventory.purchaseOrder.orderNo.label"/></div></logic:equal></td>
                  <td class="row-even" ><logic:equal value="Edit" property="mode" name="purchaseOrderForm"><bean:write property="purchaseOrderNo" name="purchaseOrderForm"/></logic:equal> </td>
                </tr>
                <tr >
                  <td width="18%" height="25" class="row-odd" ><div align="right"><bean:message key="inventory.purchaseOrder.vendorname.label"/></div></td>
                  <td width="19%" class="row-even" ><label> <bean:write property="vendorName" name="purchaseOrderForm"/></label></td>
                  <td width="13%" class="row-odd" ><div align="right"><bean:message key="inventory.purchaseOrder.remark.label"/></div></td>
                  <td width="18%" class="row-even" ><bean:write property="remarks" name="purchaseOrderForm"/></td>
                </tr>
                <tr >
                  <td width="18%" height="25" class="row-odd" ><div align="right"> <bean:message key="inventory.purchaseOrder.t&c.label"/></div></td>
                  <td width="19%" class="row-even" ><c:out value='${purchaseOrderForm.termConditions}' escapeXml="false" /></td>
				  <td width="13%" class="row-odd" ><div align="right"><bean:message key="inventory.purchaseOrder.sitedelivery.label"/></div></td>
                  <td width="18%" class="row-even" ><bean:write property="siteDelivery" name="purchaseOrderForm"/></td>
                </tr>
                <tr>
				  <td height="25" class="row-odd" ><div align="right"> <bean:message key="knowledgepro.inventory.InvCampus"/>:</div></td>
                  <td  class="row-even" ><bean:write property="campusName" name="purchaseOrderForm"/></td>
                  <td height="25" class="row-odd" ><div align="right"> <bean:message key="knowledgepro.admin.InvCompany"/>:</div></td>
                  <td  class="row-even" ><bean:write property="companyName" name="purchaseOrderForm"/></td>
                  </tr>
              </table>
          ...
          <tr>
            ...
            <td width="100%" valign="top">
                ...
                <tr >
                  ...
                  <td width="20%" height="25" class="row-odd"><bean:message key="knowledgepro.inventory.item" /> </td>
				...
				<nested:iterate property="purchaseItemList" name="purchaseOrderForm"  indexId="count">
				<%
				String dynamicStyle="";
				if(count%2!=0){
                ...
                <tr >
                  ...
                  <nested:select  property="selectedItemId" styleClass="combo" style="width: 220px"  styleId="<%=itemId %>" onchange="setUOMNameAndPCost(this.value,this.id);addNewMaster(this.form,this.value,'purchaseOrderSubmit','ItemMaster','getItemMaster');">
                 ...
                 <% String vatCost =  "vatCost_" +slNo;%>
                  ...
                  <td class="<%=dynamicStyle %>" ><nested:notEqual name="purchaseOrderForm" property="countId" value="1">
                  <div align="center"><img src="images/delete_icon.gif" width="16" height="16" onclick="deletePurchaseItem('<nested:write property="countId"/>')"/></div></nested:notEqual></td>
                </tr>
			...
			<tr> <td width="45%" align="center" colspan="8"><html:button property="" styleClass="formbutton" value="AddMore" onclick="submitAdditem()"/></td></tr>
              </table>
      ...
      <tr>
        ...
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="25%" height="25" align="left"><html:text property="additionalCost" size="8" maxlength="8" styleId="addnCost" onkeypress="return isDecimalNumberKey(this.value,event)" onkeyup="onlyTwoFractions(this,event)" onblur="calculateTotalCost()"></html:text></td>
           ...
           <tr>
            ...
            <td height="25" align="left"><html:text property="addnDiscount" size="8" maxlength="8" styleId="addnDiscount" onblur="calculateTotalCost()" onkeypress="return isDecimalNumberKey(this.value,event)" onkeyup="onlyTwoFractions(this,event)" ></html:text>
            </td>
          </tr>
           <tr>
            <td  align="right"><div align="right" class="style1"> <bean:message key="inventory.quotationOrder.total.discount.label"/> </div></td>
            <td class="row-white" ></td>
            <td><html:text property="totalDiscount" size="8" maxlength="8" styleId="totalDiscount" readonly="true" ></html:text></td>
          </tr>
          <tr>
			...
			<logic:notEmpty  property="totalCost" name="purchaseOrderForm">
			<bean:define id="totalPurchaseCost" property="totalCost" name="purchaseOrderForm"></bean:define>
			<input type="hidden" id="totalPurCost" name="totalPurCost" value="<%=totalPurchaseCost %>">
			</logic:notEmpty>
			<logic:notEmpty  property="countId" name="purchaseOrderForm">
			<bean:define id="totalCount" property="countId" name="purchaseOrderForm"></bean:define>
			<input type="hidden" id="totalTOCount" name="totalTOCount" value="<%=totalCount %>">
			</logic:notEmpty>
          <tr>
            <td align="right"><div align="right" class="style2"><bean:message key="inventory.purchaseOrder.totalcost.label"/></div></td>
            <td class="row-white" ></td>
            <td height="25" align="left"><html:text property="totalCost" size="12" maxlength="14" readonly="true" styleId="totCost"> </html:text></td>
          </tr>
        </table></td> 
        <td valign="top" background="images/Tright_3_3.gif" ></td>
      </tr>
      <tr>
        ...
        <td class="heading"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="45%" align="right"><html:button property=""  styleClass="formbutton" value="Submit" onclick="submitPurchaseForm('submitFinalPurchaseOrder')"></html:button></td>
            <td width="2%" height="24" align="center"><html:button property=""  styleClass="formbutton" value="Save & Print" onclick="submitPurchaseForm('printPurchaseOrder')" ></html:button></td>
            <td width="53%" height="24" align="left"><html:button property="" styleClass="formbutton" value="Cancel" onclick="submitPurchaseForm('initPurchaseOrder')"/></td>
          </tr>
        </table>  </td>    
        <td valign="top" background="images/Tright_3_3.gif" ></td>
      </tr>
