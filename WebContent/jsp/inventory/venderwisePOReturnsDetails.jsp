      ...
      <tr>
        ...
        <td colspan="2" valign="top" ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <logic:notEmpty name="vendorWisePOForm" property="itemList" > 
              <tr >
				...
				<logic:notEmpty name="vendorWisePOForm" property="itemList" > 
					<logic:iterate id="itemid" name="vendorWisePOForm" property="itemList" indexId="count">
                <tr >
	                <td width="38%" height="25" class="row-even"><bean:write name="itemid" property="nameWithCode" ></bean:write> </td>
	                <td width="33%" height="25" class="row-even" ><bean:write name="itemid" property="quantityIssued" ></bean:write> </td>
                </tr>
					</logic:iterate>	
				</logic:notEmpty>
            </table></td>
