...
<body>
<html:form action="newSupplementaryImpApp" method="post">
<html:hidden property="method" value="updatePGIDetailsForRevaluationNewSupply"/>
...
<html:hidden property="nameOfStudent" styleId="firstname"/>
