...
<html:hidden property="method" styleId="method" value="submitFeeReport"/>
<html:hidden property="pageType" value="1"/>

<table width="98%" border="0" cellpadding="2" cellspacing="1">
  <tr>
    <td class="heading"><bean:message key="knowledgepro.reports"/><span class="Bredcrumbs">&gt;&gt;<bean:message key="knowledgepro.feereport.feereport" /> &gt;&gt;</span> </td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="5"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><strong class="boxheader"> <bean:message key="knowledgepro.feereport.feereport" /></strong></td>
        ...
        <td valign="top" class="news"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
                <tr >
                  <td width="22%" height="25" class="row-odd" ><div align="right"><bean:message key="knowledgepro.interview.ApplicationNocol" /> </div></td>
                  <td width="24%" height="25" class="row-even" >					
					<html:text name="feeReportForm" property="applicationNo" styleClass="TextBox" styleId="applnnoID" size="12" maxlength="30" onkeypress="return isNumberKey(event)"/>
				  </td>
                  <td width="7%" class="row-even" ><div align="center" class="heading"><bean:message key="knowledgepro.or" /></div></td>
                  ...
                  <td width="26%" height="25" colspan="2" class="row-even" >					
					<html:text name="feeReportForm" property="regNo" styleClass="TextBox" styleId="regNoID" size="12" maxlength="12" onkeypress="return isNumberKey(event)"/>
				  </td>
                </tr>
...
<div align="center" class="heading"><bean:message key="knowledgepro.or" /></div>

          <tr>
            <td width="5"  background="images/left.gif"></td>
            <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
              <tr >
                <td width="22%" height="25" class="row-odd" ><div align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.interview.ProgramType" /></div></td>
                ...
                <td width="26%" height="25" class="row-even" >
			      <html:select property="programId"  styleId="program" styleClass="combo" onchange="getCourses(this.value)">
          		   		<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
        			    	<c:if test="${feeReportForm.programTypeId != null && feeReportForm.programTypeId != ''}">
              ...
              <tr >
                <td height="25" class="row-odd" ><div align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.interview.Course" /></div></td>
                <td class="row-even" >
             <html:select property="courseId"  styleId="course" styleClass="combo" onchange="getSemisters(this.value)">
           				<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
         				   		<c:if test="${feeReportForm.programId != null && feeReportForm.programId != ''}">
                ...
                <td height="25" class="row-odd" ><div align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.interview.Year" /></div></td>
                <td height="25" colspan="4" class="row-even" >
				<input type="hidden" id="tempyear" name="tempyear" value="<bean:write name="feeReportForm" property="academicYear"/>"/>
              ...
              <tr >
                <td height="25" class="row-odd" ><div align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.fee.semister"/>:</div></td>
                <td height="25" class="row-even" >
                 <html:select property="semister" styleId="semister" styleClass="combo" onchange="getSubjectGroupsOnSemister(this.value)">
         	   				 <html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
           				    	<c:if test="${feeReportForm.academicYear != null && feeReportForm.academicYear != ''}">
				...
				<td height="25" class="row-odd" ><div align="right"><bean:message key="knowledgepro.feereport.feereport.feestatus" /></div></td>
				<td height="25" class="row-even" >
				<html:select property="status"	styleId="status" styleClass="combo">
					<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>											
					<html:option value="0"><bean:message key="knowledgepro.fee.paid" /></html:option>
					<html:option value="1"><bean:message key="knowledgepro.admission.report.canceled" /></html:option>
				</html:select>
				</td>
                </tr>
            </table></td>
