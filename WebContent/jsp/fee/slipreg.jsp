...
<html:form action="/slipregister">	
	...
	<table width="100%" border="0">
		<tr>
			...
			<bean:message key="knowledgepro.fee.slipRegister"/>
			 &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td valign="top">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="body"><strong
						class="boxheader"> <bean:message key="knowledgepro.fee.slipRegister"/></strong></td>
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
	                     ...
	                     <tr>
	                       ...
	                       <td width="16%" class="row-odd">
											...
											<td width="28%" height="25" class="row-even" >
											 <input type="hidden" name="programTId" id="programTId" value='<bean:write name="slipRegisterForm" property="programTypeId"/>'/>
									 ...
									 <input type="hidden" id="tempyear" name="tempyear" value="<bean:write name="slipRegisterForm" property="academicYear"/>"/>
	                    ...
	                    <tr >             
	                   	       <td valign="top" class="row-odd"><div align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.fee.feedivision"/>:</div></td>
	                   	       <td class="row-even" align="left">
				                           <html:select property="feeDivisionId" styleId="feeDivisionId" size="5" style="width: 200px;" multiple="multiple" >
		                 			             <html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
		                 			             <html:optionsCollection name="slipRegisterForm" property="feeDivisionMap" label="value" value="key"/>
		                			       </html:select>
				                           </td>         
	                   	           </tr>     
