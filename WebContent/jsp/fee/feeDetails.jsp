...
function submitExcel(){
	document.getElementById("method").value ="uploadFeeDetails";
	var academicYear=document.getElementById("academicYearId").value;
	document.location.href = "additionalFees.do?method=uploadFeeDetails&academicYear=" +academicYear;
}
...
<html:form action="/additionalFees" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="uploadFeeDetails" />
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt;Migration FeeDetails&gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> Migration FeeDetails</strong></div></td>
