...
function submitExcel(){
	document.getElementById("method").value ="additionalFeesUpload";
	var academicYear=document.getElementById("academicYearId").value;
	document.location.href = "additionalFees.do?method=additionalFeesUpload&academicYear=" +academicYear;
}
...
<html:form action="/additionalFees" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="additionalFeesUpload" />
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt;Migration AdditionalFees &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> Migration AdditionalFees</strong></div></td>
