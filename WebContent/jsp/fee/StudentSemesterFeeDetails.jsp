...
<script type="text/javascript" language="javascript">
	function getClasses(){
		...
		getClassByAcademicYearAndSemester("classMap" ,academicYear,"classes",updateClassNames,semester);
	}
...
<html:form action="/studentSemesterFeeDetails" method="post">
	...
	<html:hidden property="method" styleId="method1" value="getStudent"/>
	
	
	
	<table width="100%" border="0">
		<tr>
			<td><span class="heading">Fee<span class="Bredcrumbs">&gt;&gt;
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<FONT color="red" size="1px"><bean:write name="studentSemesterFeeDetailsForm" property="errorMessage"/></FONT>
						...
						<tr>
							...
							<tr>
									...
									<input
										...
										value="<bean:write name="studentSemesterFeeDetailsForm" property="academicYear"/>" />
									<html:select
								...
								<tr>
									...
									<div align="right"><span class="mandatoryfield">*</span>Semester :</div>
									</td>
									<td class="row-even" width="25%"><html:select property="semester"
										styleId="semester" onchange="getClasses()">
										<html:option value="">
								...
								<tr>
									...
									<html:select property="classId"  name="studentSemesterFeeDetailsForm"  styleId="classes">
										<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
										<logic:notEmpty name="studentSemesterFeeDetailsForm" property="classMap">
											<html:optionsCollection property="classMap" name="studentSemesterFeeDetailsForm" label="value" value="key" />
										</logic:notEmpty>
									</html:select></td>
								</tr>
							</table>
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<html:button property="" styleClass="formbutton" value="Submit" onclick="getStudent()"></html:button></td>
