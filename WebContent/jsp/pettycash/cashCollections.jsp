...
function updateStudentName(req) {
	document.getElementById("list").value=null;
	 ...
	 var options;
	 var pos;
		if(responseObj.indexOf('Appl')!= -1)
		   {
	     pos = responseObj.indexOf('Appl');
	      options = responseObj.substr(pos,pos+5);
	      }
	     else
	      {
	      pos = responseObj.indexOf('Regn');
	     options = responseObj.substr(pos,pos+5);
	      }
	     name =responseObj.substring(0,pos);
	     if(options.trim() == "Appl"){
	     document.getElementById("optional_1").checked=true;
	    }else if(options.trim() == "Regn"){
	     document.getElementById("optional_3").checked=true;
	     }else{
	    	 document.getElementById("optional_1").checked=true;
	    	 document.getElementById("optional_3").checked="";
	    	 }
	      var arr = responseObj.trim();
	      if(name.length==0){
	    	 document.getElementById("accountCodeId").value =arr;
			 var u=document.getElementById("list").value=arr;
			 if(arr.length!=0){
			 var args ="method=getAmount&accoId="+arr;
			 var url ="AjaxRequest.do";
			 requestOperation(url,args,updateAmount);
			                }
	         }  
    	
if(responseObj.length-2=='12')
{
	...
	{
		document.getElementById(destId).value=name;
	}
}
...
function updateAmount(req) {
 ...
 if(document.getElementById(amountId))
	{
		document.getElementById("dynaAmount").innerHTML="<input type='text' name='amount' size='7' maxlength='7' value="+amount+" id='amountid' onmouseover='abc()'>";
	}
}
...
function itemSearch(searchValue){
	...
	var accCodeId = document.getElementById("accountCodeId").value;
	var amountId = "amountid";
	if(accCodeId != null && accCodeId !=""){
		getAmount1(accCodeId,amountId);
	}
}
...
function deleteFeeDetails(id) {
	...
	function showPetty(type){
		document.getElementById("pettyDisplay").style.display = "block";
		document.getElementById("applicationDisplay").style.display = "none";

		getAccountsForApplications("accNameWithCode",type,"accountCodeId",updateAccounts);
		
		function updateAccounts(req) {
			updateOptionsFromMapForNonDefaultSelection(req,"accountCodeId");
		}
	}
	function showApplication(type){
		document.getElementById("pettyDisplay").style.display = "none";
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
          ...
          <tr>
            ...
            <td valign="top"><table width="100%" cellspacing="1" cellpadding="2"><tr><td width="34%" class="row-even"><table width="100%" cellspacing="1" cellpadding="2">
              ...
              <tr>
                	<td class="row-even" colspan="7" align="center"> 
                 	<html:radio name="cashCollectionForm" property="isPettyCash" styleId="petty" value="PettyCash" onclick="showPetty(this.value)"/> Petty Cash
                 	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 	<html:radio name="cashCollectionForm" property="isPettyCash" styleId="application" value="ApplicationIssue" onclick="showApplication(this.value)"/> Application Issue
                </td>
              </tr>
          ...
          <tr>
            ...
            <tr><!--
                ...
                <td class="row-even" colspan="3"><html:text name="cashCollectionForm" property="hour" styleId="hourId" size="6" maxlength="6" readonly="true"/> :
                 ...
                 <td width="23%" class="row-odd" colspan="2">
                 <div id="pettyDisplay" align="right"><bean:message key="knowledgepro.petticash.AppReg" /></div>
                 <div id="applicationDisplay" align="right"><span class="Mandatory">*</span>&nbsp;
                 	<bean:message key="knowledgepro.petticash.AppReg" /></div>
                 </td>
              ...
              <tr>
              <td width="23%" class="row-odd"><div align="right">Name:</div></td>
                <td class="row-even">
      ...
      <tr>
        ...
        <td valign="top" class="news"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
                  <tr >
                    <td  height="25" colspan="2" class="row-odd" width="50%">Account Name</td>
                    <td  class="row-odd" align="left" width="25%">Amount:</td>
                    <td  class="row-odd" align="left" width="25%">Details:</td>
                    </tr>
                  <tr >
                    <td height="25" colspan="2" class="row-even" width="50%"><html:text property="fineType" name="cashCollectionForm" styleId="searchItem" size="78" onkeyup="itemSearch(this.value)"/>
                   <br>
                 	<nested:select property="accountId" styleId="accountCodeId" styleClass="body" size="4" onchange="getAmount1(this.value,'amountid')" style="width:497px;">
                    ...
                    <td height="25"  class="row-even" align="left" width="25%">
                  	 ...
                  	 <td height="25" class="row-even" align="left" width="25%">
						<div id="dynaAmount">
                   			 <html:text property="details" name="cashCollectionForm" styleId="details" size="10" maxlength="15"/>
						</div>
                  	 </td>
                    </tr>
                    <tr >
                     ...
                     <tr>
             		 ...
             		 <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
             		  <tr >
             		  <td  height="25" class="row-odd" >Account  Code</td>
                      <td class="row-odd" >Account Name</td>
                      <td class="row-odd" >Details</td>
                      <td  class="row-odd">Amount</td>
       ...
       <tr>
        ...
        <tr>
            <td width="49%" height="35" align="right"><html:button property="" styleClass="formbutton" value="Save & Print" onclick="saveCashCollection()"/>
           </td>
           <td width="2%"></td>
...
var sameAddr= document.getElementById("petty").checked;
if(sameAddr==true){
	document.getElementById("pettyDisplay").style.display = "block";
	document.getElementById("applicationDisplay").style.display = "none";
	showPetty(PettyCash);
...
if(sameAddr==false){
	document.getElementById("pettyDisplay").style.display = "none";
	document.getElementById("applicationDisplay").style.display = "block";
	showApplication(ApplicationIssue);
}
