...
function getCollectionDetails(){
	document.getElementById("method").value = "getCollectionDetails";
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader">Collection Details</strong></div>
					</td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="46%" height="35">
								<div align="right">
								<html:button property="" styleClass="formbutton" onclick="getCollectionDetails()">Search</html:button>
							 	</div>
							</td>
							<td width="2%"></td>
							...
							<td width="2%"></td>
							<td  align="left">
							<html:button property="" styleClass="formbutton" onclick="gotoCollectionDetails()">Back</html:button>
							</td>
						</tr>
					</table>
					</div>
