...
<html:form action="/CollectionLedger">	
	...
	<table width="100%" border="0">
		<tr>
			...
			<bean:message key="knowledgepro.petticash.collectionLedger.displayName"/>
			 &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td valign="top">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="body"><strong
						class="boxheader"> <bean:message key="knowledgepro.petticash.collectionLedger.displayName"/></strong></td>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<tr>
								...
								<html:radio name="collectionLedgerForm" property="account" value="true" styleId="account_1" onclick="showDescription(),hideGroup()">
								<bean:message key="knowledgepro.petticash.collectionLedger.AccountCode"/>
								</html:radio>
								</td>
								<td class="row-even" width="25%">
								<html:radio name="collectionLedgerForm" property="account" value="false" styleId="account_2" onclick="hideDescription(),showGroup()">
								<bean:message key="knowledgepro.petticash.collectionLedger.AccountGroup"/>
						         ...
						         <html:text name="collectionLedgerForm" property="groupCode"
							...
							<tr>
								<td colspan="4">
									<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" id="dynaTable">
										<tr > 
											<td height="25" class="row-odd" width="25%">
											<div align="right">&nbsp;<bean:message key="knowledgepro.petticash.collectionLedger.AccountName" />:</div>
											</td>	                   
							                <td class="row-even" width="25%"><html:text property="accountName" name="collectionLedgerForm" styleId="accountName" size="20" onkeyup="itemSearch(this.value)"/>
							                </td>
							                <td height="25" class="row-odd" width="25%">
							                <div align="right"><span class="Mandatory">*</span>&nbsp;
							                <bean:message key="knowledgepro.petticash.collectionLedger.AccountCode1"/>:</div>
							                </td>
							                <td height="25" class="row-even" width="25%"><html:text property="accountCode" name="collectionLedgerForm" styleId="accountCode" size="20"/>
							                </td>
						                </tr>
						               <tr >
						               <td height="25" class="row-odd" width="25%"></td>
						                  <td class="row-white" width="25%">
						                  <nested:select property="accountId" styleId="accountId" styleClass="body" size="4" style="width:300px;" onchange="getCode(this.value)">
						                  <logic:notEmpty name="collectionLedgerForm" property="accountList">
											<nested:optionsCollection name="collectionLedgerForm" property="accountList" label="accName" value="accCode" styleClass="comboBig"/>
											</logic:notEmpty>
											</nested:select>
						                  </td>
						                  <td height="25" class="row-odd" width="25%"></td>
							...
							<tr>
								...
								<html:text name="collectionLedgerForm" property="startDate" styleId="startDate" size="10" maxlength="16"/>
									<script
									language="JavaScript">
									new tcal( {
										// form name
										'formname' :'collectionLedgerForm',
										// input name
								...
								<html:text name="collectionLedgerForm" property="endDate" styleId="endDate" size="11" maxlength="11"></html:text>
							...
							<tr>
									...
									Name:</div>
									<html:text name="collectionLedgerForm" property="otherName"
