			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<table width="100%" cellspacing="1" cellpadding="2">
						...
						<tr>
           				 <td align="left"><span class="heading">PettyCash</span></td>
							</tr>
						<tr>
								...
								<tr>
									...
									<tr>
										<td height="25" class="row-odd" width="25%">
											<div align="right"><span class="Mandatory"></span>PettyCash:
											</div>
											</td>
											<td height="25"  width="25%" class="row-even"><select class="combo"  name="JumpList" onChange="goSearch(this.value)">
												...
												<option >Collection Details</option>
