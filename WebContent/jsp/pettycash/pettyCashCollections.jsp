...
function submitExcel(){
	document.getElementById("method").value ="uploadPettyCashCollection";
	var academicYear=document.getElementById("academicYearId").value;
	document.location.href = "amountHeads.do?method=uploadPettyCashCollection&academicYear=" +academicYear;
}
...
<html:form action="/amountHeads" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="uploadPettyCashCollection" />
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt;PettyCash Collections &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> PettyCash Collections</strong></div></td>
