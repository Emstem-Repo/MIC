...
function submitExcel(){
	document.getElementById("method").value ="uploadAccountHeads";
	var academicYear=document.getElementById("academicYearId").value;
	document.location.href = "additionalFees.do?method=uploadAccountHeads&academicYear=" +academicYear;
}
...
<html:form action="/amountHeads" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="uploadAccountHeads" />
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt;PettyCash AccountHeads &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> PettyCash AccountHeads</strong></div></td>
