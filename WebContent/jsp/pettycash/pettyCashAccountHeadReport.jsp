...
function getAccountHeads(){
	document.getElementById("method").value = "getAccountHeadsDetails";
	document.pettyCashAccHeadForm.submit();
}
function gotoAccountHeads(){
	document.location.href = "pettyCashAccHeads.do?method=initPettyCash";
}
</script>
<html:form action="/pettyCashAccHeads">	
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt; Account Heads &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader">Account Heads</strong></div>
					</td>
            ...
            <tr>
                ...
                <td  class="row-even" width="25%">
					<input type="hidden" id="tempYear" name="tempYear" value="<bean:write name="pettyCashAccHeadForm" property="academicYear"/>"/>
                    <html:select name="pettyCashAccHeadForm" property="academicYear" styleId="academicYear" styleClass="combo" > 
                ...
                <td  height="25" class="row-even" >
                	<table width="189" border="0" cellspacing="0" cellpadding="0">
                    	<tr>
                      		<td width="40">
                      			<html:text name="pettyCashAccHeadForm" property="startDate" styleId="startDate" size="10" maxlength="16"/> 
                      		</td>
                      		<td >
                      			<script language="JavaScript">
									new tcal ({
										// form name
										'formname': 'pettyCashAccHeadForm',
										// input name
                ...
                <td class="row-even" width="25%">
                	<table width="188" border="0" cellspacing="0" cellpadding="0">
                  		<tr>
                    		<td width="40"><html:text name="pettyCashAccHeadForm" property="endDate" styleId="endDate" size="10" maxlength="16"/> </td>
                    		<td >
                    			<script language="JavaScript">
									new tcal ({
									// form name
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="46%" height="35">
								<div align="right">
								<html:button property="" styleClass="formbutton" onclick="getAccountHeads()">Search</html:button>
							 	</div>
							</td>
							<td width="2%"></td>
							...
							<td width="2%"></td>
							<td  align="left">
							<html:button property="" styleClass="formbutton" onclick="gotoAccountHeads()">Back</html:button>
							</td>
						</tr>
					</table>
					</div>
