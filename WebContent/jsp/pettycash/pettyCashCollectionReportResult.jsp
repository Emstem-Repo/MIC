...
<SCRIPT type="text/javascript">
    function cancelAction() {
    	document.location.href = "pettyCashAccHeads.do?method=initPettyCashCollection";
    }
</SCRIPT>
</head>
              ...
              <td width="5"  background="images/left.gif"></td>
		        ...
		        <logic:notEmpty name="pettyCashAccHeadForm" property="startDate">
    				<logic:notEmpty name="pettyCashAccHeadForm" property="endDate"><div class="row-white" style="text-align: center; padding-bottom: 7px; text-size: 10px;">
							<FONT size="3"><bean:message key="knowledgepro.pettycash.report.collection.details" />  <bean:message key="knowledgepro.hostel.adminmessage.fromName" /> <bean:write name="pettyCashAccHeadForm" property="startDate"/> <bean:message key="knowledgepro.attendance.summaryreportto" /> <bean:write name="pettyCashAccHeadForm" property="endDate"/></FONT>
							</div>
    		    	</logic:notEmpty>	
       		    </logic:notEmpty>
      <td valign="top">       
<div style="overflow: auto; width: 1100px; ">
	<c:set var="temp" value="0" />  
		...
		<display:table export="true" uid="collectionUid"  id = "collectionDetails" name="sessionScope.collectionList" requestURI="" defaultorder="ascending" pagesize="10">
			<display:setProperty name="export.excel.filename" value="CollectionDetails.xls"/>
			<display:setProperty name="export.xml" value="false" />
			<display:setProperty name="export.csv.filename" value="CollectionDetails.csv"/>
				...
				<display:column style=" width: 300px;" property="name" sortable="true" title="Name" class="row-even" headerClass="row-odd" media="html csv excel"/>
				<display:column style=" width: 130px;" property="aplRegNo" sortable="true" title="Application Register No" class="row-even" headerClass="row-odd" media="html csv excel"/>
				<display:column style=" width: 130px;" property="receiptNo" sortable="true" title="ReceiptNo" class="row-even" headerClass="row-odd" media="html csv excel"/>
