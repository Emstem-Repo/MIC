...
<script type="text/javascript">
	function addlastReceiptNumber() {
		document.getElementById("method").value = "addlastReceiptNumber";
	}
	function editLastReceiptNumber(id) {
		document.location.href = "lastReceiptNumber.do?method=editLastReceiptNumber&id="
				+ id;
	}
	function updateLastReceiptNumber() {
			document.getElementById("method").value = "updateLastReceiptNumber";
	}
	function reActivate() {
		var academicyear = document.getElementById("year").value;
		document.location.href = "lastReceiptNumber.do?method=reActivateLastReceiptNumber&academicYear=" + academicyear;
	}
	function deleteLastReceiptNumber(id) {
		deleteConfirm = confirm("Are you sure want to delete this entry?")
		if (deleteConfirm) {
			document.location.href = "lastReceiptNumber.do?method=deleteLastReceiptNumber&id="
					+ id;
		}
	}
	function resetMessages() {	
		document.getElementById("lastRecNoId").value= "";
		document.getElementById("year").value = resetYear();
		resetErrMsgs();
	}	
</script>
<html:form action="/lastReceiptNumber" method="post">
	<html:hidden property="method" styleId="method" />
	<html:hidden property="formName" value="lastReceiptNumberForm" />
	<html:hidden property="id" />
	<html:hidden property="pageType" value="1" />
	<c:choose>
	<c:when test="${operation == 'edit'}">
			<html:hidden property="method" styleId="method"
				value="updateLastReceiptNumber" />
		</c:when>
		</c:choose>
	<table width="99%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt; <bean:message
				key="knowledgepro.petticash.lastReceiptNo" /> &gt;&gt;</span> </span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="heading_white"><bean:message
						key="knowledgepro.petticash.lastReceiptNo" /></td>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<div align="right"><span class="Mandatory">*</span><bean:message
										key="knowledgepro.petticash.begReceiptNo" /></div>
									</td>
									<td width="32%" height="25" class="row-even"><label></label>
									<span class="star"> <html:text property="receiptNo"
										styleId="lastRecNoId" size="10" maxlength="10" /> </span></td>
									...
									<div align="left"><span class="star"> <input
										...
										value='<bean:write name="lastReceiptNumberForm" property="academicYear"/>' />
									...
									<div align="right"><c:choose>
										<c:when test="${operation == 'edit'}">
											<html:submit property="" styleClass="formbutton"
												onclick="updateLastReceiptNumber()">
												<bean:message key="knowledgepro.update" />
											</html:submit>
										</c:when>
										<c:otherwise>
											<html:submit property="" styleClass="formbutton"
												onclick="addlastReceiptNumber()">
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										<tr>
											...
											<td height="25" class="row-odd" align="center"><bean:message
												key="knowledgepro.petticash.startingNo" /></td>
											<td height="25" class="row-odd" align="center"><bean:message
												key="knowledgepro.petticash.financialYear"/></td>
											<td class="row-odd">
											<div align="center"><bean:message
										...
										<logic:notEmpty name="lastReceiptNumberForm"
											property="receiptNumberList">
											<logic:iterate id="receipt" name="lastReceiptNumberForm"
												property="receiptNumberList" indexId="count">
													...
													<c:when test="${temp == 0}">
														<tr>
															...
															<td width="41%" height="25" class="row-even"
																align="center"><bean:write name="receipt" property="receiptNo" /></td>
															<td width="41%" class="row-even" align="center"><bean:write
													name="receipt" property="academicYear" /></td>
															<td width="6%" height="25" class="row-even">
															<div align="center"><img src="images/edit_icon.gif"
																width="16" height="18" style="cursor:pointer"
																onclick="editLastReceiptNumber('<bean:write name="receipt" property="id" />')" /></div>
															</td>
															<td width="6%" height="25" class="row-even">
															<div align="center"><img
																src="images/delete_icon.gif" width="16" height="16" style="cursor:pointer"
																onclick="deleteLastReceiptNumber('<bean:write name="receipt" property="id"/>')"></div>
															</td>
														</tr>
