...
function submitExcel(){
	document.getElementById("method").value ="uploadPettyCashCollectionDetails";
	var academicYear=document.getElementById("academicYearId").value;
	document.location.href = "additionalFees.do?method=uploadPettyCashCollectionDetails&academicYear=" +academicYear;
}
...
<html:form action="/amountHeads" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="uploadPettyCashCollectionDetails" />
	<html:hidden property="formName" value="amountHeadsForm" />
	<html:hidden property="pageType" styleId="pageType" value="1" />
	<table width="98%" border="0">
		<tr>
			<td><span class="Bredcrumbs">Data Migration
			<span class="Bredcrumbs">&gt;&gt;PettyCash Collections Details &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> PettyCash Collections Details</strong></div></td>
								...
								<tr>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										...
										<td height="25" class="row-odd" width="25%">
											...
											<html:file property="theFile" styleId="thefile" size="15" maxlength="30" name="amountHeadsForm"/></label></td>
										</tr>
									</table>
									</td>
