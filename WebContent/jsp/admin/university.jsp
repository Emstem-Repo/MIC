          			...
          			<tr>
            			...
            			<td valign="top">
            				<table width="100%" cellspacing="1" cellpadding="2">
								<tr >
                					<td width="15%" height="25" class="row-odd"><div align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.admission.documenttype"/>:</div></td>
                					...
                					<td width="15%" height="25" class="row-even" >
                    					<span class="star">
                    						<html:text property="university" styleId="university" size="50" maxlength="60"/>
                  						</span>
                  					</td>
                  					<td width="16%" height="25" class="row-odd" ><div align="right"><span class="Mandatory">*</span>Order:</div></td>
                					<td width="15%" height="25" class="row-even" >
                    					<span class="star">
                    						<html:text property="universityOrder" styleId="universityOrder" size="50" maxlength="60"/>
                  						</span>
                  					</td>
              					</tr>
			            	</table>
                									...
                									<c:choose>
                   										<c:when test="${temp == 0}">
                   											<tr>
                   												...
                   												<td width="30%" class="row-even" align="center"><bean:write name="CME" property="docType"/></td>
                   												<td width="30%" class="row-even" align="center"><bean:write name="CME" property="order"/></td>
                    									...
                    									<c:otherwise>
		            										<tr>
										               			...
										               			<td width="30%" class="row-white" align="center"><bean:write name="CME" property="docType"/></td>
										               			<td width="30%" class="row-white" align="center"><bean:write name="CME" property="order"/></td>
