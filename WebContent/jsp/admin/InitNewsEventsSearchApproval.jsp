...
<html:hidden property="method" value="getSearchNewsEvents" styleId="method"/>
  ...
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" >
      <tr>
        ...
        <td width="954" background="images/Tcenter.gif" class="body" ><strong class="boxheader">News-Events Approval Search</strong></td>
