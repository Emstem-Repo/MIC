...
<SCRIPT type="text/javascript">
    ...
    function cancelAction() {
    	document.location.href = "BulkMail.do?method=cancelStudentSearch";
    }

</SCRIPT>
<html:form action="/BulkMail" focus="selectall">

	<%--  html:hidden property="method" styleId="method"
		value="submitSelectedStudentList" />--%>
		<html:hidden property="method" styleId="method"
		value="bulkMailMethod" />
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt;<bean:message
				...
				key="knowledgepro.admin.bulkmail.studentsearchresult" />&gt;&gt;</span></span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> <bean:message
						key="knowledgepro.admin.bulkmail.studentsearchresult" /></strong></div>
					</td>
							...
							<table width="99%" cellspacing="1" cellpadding="2">
								<tbody>
									...
									<tr>
										...
										<input type="checkbox" name="selectall" onclick="checkAll()" /></div>
										</td>
									...
									<c:set var="temp" value="0" />
										<nested:iterate name="bulkMailForm"
											...
											<c:when test="${temp == 0}">
												<tr>
													...
													<div align="center"><input type="checkbox" id="count"
														name="emailAddresses"
														value='<nested:write name="id" property="email"/>'>
													</td>
													...
													<td width="7%" class="row-even"><div align="center"><a
														...
														onclick="getDetails('<nested:write name='id' property='applicationId'/>', '<bean:write name='bulkMailForm' property='year'/>', '<bean:write name='bulkMailForm' property='courseId'/>')"><bean:message
										...
										<tr>
											...
											<table width="100%" border="0" cellspacing="0"
												...
												<tr>
													...
													<bean:message key="knowledgepro.admin.label.mail" />
													</html:submit></div>
													</td>
													<td width="2%"></td>
