...
function addLeaveAppInstructions() {
	document.getElementById("method").value="addPeersInstructions";
}
...
function deleteInstructions(id) {
	...
	if(deleteConfirm)
		document.location.href = "peersFeedbackInstruction.do?method=deletePeersInstructions&id="+id;
}
...
function editInstructions(id){
	document.getElementById("NWID").value=id;
	document.location.href = "peersFeedbackInstruction.do?method=editPeersInstructions&id="+id;
}
</script>
<html:form action="/peersFeedbackInstruction" method="POST">
<html:hidden property="id" styleId="NWID"/>
<html:hidden property="formName" value="peersFeedbackInstructionsForm" />
...
<c:choose>
	...
	<c:choose>
		<c:when test="${instructions != null && instructions == 'edit'}">
			<html:hidden property="method" styleId="method" value="updatePeersInstructions" />
		</c:when>
		<c:otherwise>
			<html:hidden property="method" styleId="method" value="addPeersInstructions" />
		</c:otherwise>
	</c:choose>
<table width="99%" border="0">
  
  <tr>
    <td><span class="Bredcrumbs"><bean:message key="knowledgepro.studentfeedback"/> <span class="Bredcrumbs">&gt;&gt; Peers Feedback Instructions &gt;&gt;</span> </span></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="heading_white" >Peers Feedback Instructions</td>
          ...
          <tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <logic:notEmpty name="peersFeedbackInstructionsForm" property="instructionsTOsList">
                <logic:iterate id="INS" name="peersFeedbackInstructionsForm" property="instructionsTOsList" indexId="count">
                <c:choose>
                   <c:when test="${temp == 0}">
                   	<tr>
