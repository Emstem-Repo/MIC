...
<script type="text/javascript">
	...
	function printPass(){
		document.getElementById("method").value = "getSportsDetails";
                     ...
                     <tr>
                       ...
                       <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
                           ...
                           <td width="25%" height="25" class="row-odd" ><div id = "reFrom" align="right"><span class="Mandatory">*</span>Date:</div></td>
                             ...
                             <td width="25%" height="25" class="row-odd" ><div id = "reFrom" align="right"><span class="Mandatory">*</span>Sports:</div></td>
                             <td width="50%" height="25" class="row-even" align="left">
                            	<html:textarea property="sportsId" styleId="sportsId"	>
							    </html:textarea>
                             </td>
                           </tr>
                       </table></td>
...
<script language="JavaScript" >
	...
	if(print.length != 0 && print == "true"){
		var url = "CommonTemplatePrint.do?method=printSportsDetails";
		myRef = window
				.open(url, "viewNoDues",
