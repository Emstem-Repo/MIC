...
<script type="text/javascript">
	function submitMe(method) {
		document.generatePasswordParentForm.method.value = method;
		document.generatePasswordParentForm.submit();
	}
</script>
<style type="text/css">
<!--
...
<body>
<html:form action="/GeneratePasswordParent">
	<html:hidden property="method" value="" />
	<html:hidden property="pageType" value="1" />
	<html:hidden property="formName" value="generatePasswordParentForm" />

	<table width="98%" border="0">
		<tr>
			<td><span class="Bredcrumbs"><bean:message
				key="knowledgepro.admin" /><span class="Bredcrumbs">&gt;&gt;
			Parent Password Generation &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td width="935" colspan="2" background="images/Tcenter.gif"
						class="body">
					<div align="left"><strong class="boxheader"> Parent Password Generation</strong></div>
					</td>
							...
							<table width="100%" height="30" border="0" cellpadding="0"
								...
								<tr class="row-white">
									...
									<td width="16%" height="20" class="row-even"><input
										...
										value='<bean:write name="generatePasswordParentForm" property="programTypeId"/>' />
									...
									<td width="16%" height="20" class="row-even"><html:select
										...
										<c:choose>
											...
											<c:otherwise>
												<c:if
													test="${generatePasswordParentForm.programTypeId != null && generatePasswordParentForm.programTypeId != ''}">
		...
		document.getElementById("stRoll_1").checked = true;
												...
												<tr>
													...
													<td width="25%" height="25" class="row-even"><input
														type="radio" name="studentResgisterNo" id="stReg_1" value="true" />
													<bean:message key="knowledgepro.yes" /> <input
														type="radio" name="studentResgisterNo" id="stReg_2"
	...
	if (regid == "true") {
		document.getElementById("stRoll_1").checked = true;
													...
													<tr>
													<td width="25%" class="row-odd">
													<div align="center">Send SMS for Parents/Guardian</div>
													</td>
													<td width="25%" class="row-even"><input type="radio"
														name="sendSMS" id="stmail_2" value="parent" checked="checked"/><bean:message key="admin.generatepassword.select.mail.parent"/>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="10">
								<tr>
									...
									<div align="left"><html:button property="" styleClass="formbutton"
										value="Reset" onclick="submitMe('initGeneratePasswordParent')"></html:button></div>
									</td>
								</tr>
							</table>
							</td>
