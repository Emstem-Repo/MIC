...
<script type="text/javascript">
	...
	function printPass(){
		document.getElementById("method").value = "getScholarshipDetails";
...
<table width="98%" border="0">
  <tr>
    <td><span class="heading">
			...
			<span class="Bredcrumbs">&gt;&gt; <bean:message key="knowledgepro.admin.template.scholarship"/>&gt;&gt;</span></span></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="10"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><div align="left"><strong class="boxheader"><bean:message key="knowledgepro.admin.template.scholarship"/></strong></div></td>
...
<script language="JavaScript" >
	...
	if(print.length != 0 && print == "true"){
		var url = "CommonTemplatePrint.do?method=printScholarshipDetails";
		myRef = window
				.open(url, "viewNoDues",
