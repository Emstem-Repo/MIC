...
<script language="JavaScript">
	function submitExcel() {
		document.getElementById("method").value = "uploadAdmBioData";
		var academicYear = document.getElementById("academicYearId").value;
		document.location.href = "admBioData.do?method=uploadAdmBioData&academicYear="
				+ academicYear;
	}
	...
	<table width="98%" border="0">
		<tr>
			<td><span class="Bredcrumbs">Data Migration <span
				class="Bredcrumbs">&gt;&gt;Adm BioData Upload &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> Adm BioData Upload</strong></div>
					</td>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										<tr>
											...
											<td height="25" class="row-even"><label> <html:file
												...
												maxlength="30" name="admBioDataCJCForm" /></label></td>
										</tr>
									</table>
									</td>
