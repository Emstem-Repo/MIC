...
function addLeaveAppInstructions() {
	document.getElementById("method").value="addStuFeedbackSession";
}
...
function resetErrorMsgs(){
	...
	if(document.getElementById("method").value == "updateEvaluationStuFeedbackSession"){
...
function deleteSession(id) {
	...
	if(deleteConfirm)
		document.location.href = "evaStuFeedbackSession.do?method=deleteStuFeedbackSession&id="+id;
}

function editSession(id){
	
	document.getElementById("NWID").value=id;
	document.location.href = "evaStuFeedbackSession.do?method=editStuFeedbackSession&id="+id;
}
</script>
<html:form action="/evaStuFeedbackSession" method="POST">
<html:hidden property="id" styleId="NWID"/>
<html:hidden property="formName" value="evaluationStudentFeedbackSessionForm" />
...
<c:choose>
	...
	<c:choose>
		<c:when test="${sessionList != null && sessionList == 'edit'}">
			<html:hidden property="method" styleId="method" value="updateEvaluationStuFeedbackSession" />
		</c:when>
		<c:otherwise>
			<html:hidden property="method" styleId="method" value="addStuFeedbackSession" />
		</c:otherwise>
	</c:choose>
<table width="99%" border="0">
  
  <tr>
    <td><span class="Bredcrumbs"><bean:message key="knowledgepro.studentfeedback"/> <span class="Bredcrumbs">&gt;&gt; Student Feedback Session &gt;&gt;</span> </span></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="heading_white" >Student Feedback Session</td>
        ...
        <td valign="top" class="news"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
			...
			<td height="25" class="row-odd"><div align="right"><span class="Mandatory">*</span>&nbsp;<bean:message key="knowledgepro.admin.year" />:</div></td>
              <td align="left" height="25" class="row-even"><input type="hidden" id="tempyear" name="tempyear" 	value="<bean:write name="evaluationStudentFeedbackSessionForm" property="academicYear"/>" />
			  ...
			  <cms:renderAcademicYear></cms:renderAcademicYear>
				...
				<td height="25" class="row-even" ><label></label><input type="hidden" id="sessionId" name="sessionId" value='<bean:write name="evaluationStudentFeedbackSessionForm" property="name"/>'>  
									<span class="star"> <html:text property="name" name="evaluationStudentFeedbackSessionForm"
			...
			<tr>
									...
									<td height="25" class="row-even"><input type="hidden"
										...
										value='<bean:write name="evaluationStudentFeedbackSessionForm" property="month"/>' /><html:select
									...
									<td height="25" class="row-even"><input type="hidden"
										id="yr" name="yr"
										value='<bean:write name="evaluationStudentFeedbackSessionForm" property="year"/>' /><html:select
          ...
          <tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <logic:notEmpty name="evaluationStudentFeedbackSessionForm" property="sessionList">
                <logic:iterate id="INS" name="evaluationStudentFeedbackSessionForm" property="sessionList" indexId="count">
                <c:choose>
                   <c:when test="${temp == 0}">
                   	<tr>
