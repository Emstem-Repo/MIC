...
<script type="text/javascript">
	...
	function printPass(){
		document.getElementById("method").value = "printDOB";
		document.dateOfBirthPrintForm.submit();
...
<html:form action="/PrintDOB">
<html:hidden property="method" styleId="method"/>
<html:hidden property="formName" value="dateOfBirthPrintForm"/>
<html:hidden property="pageType" value="1"/>
<table width="98%" border="0">
  <tr>
    <td><span class="heading">
				<bean:message key="knowledgepro.admin" />
			<span class="Bredcrumbs">&gt;&gt; <bean:message key="knowledgepro.admin.print.dob"/>&gt;&gt;</span></span></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="10"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><div align="left"><strong class="boxheader"><bean:message key="knowledgepro.admin.print.dob"/></strong></div></td>
                     ...
                     <tr>
                       ...
                       <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
                           <tr >
                             ...
                             <span class="star">
                               <html:text property="regNoFrom" styleId="regNoFrom" name="dateOfBirthPrintForm"/>
                             </span></td>
							<td width="25%" height="25" class="row-odd" ><div id = "reTo" align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.attendance.regno.to.col" /> </div></td>
                             <td width="50%" height="25" class="row-even" align="left">
                             <span class="star">
                               <html:text property="regNoTo" styleId="regNoTo" name="dateOfBirthPrintForm"/>
                             </span></td>
                           </tr>
                           <tr>
...
<script language="JavaScript" >
	...
	var print = "<c:out value='${dateOfBirthPrintForm.printPage}'/>";
	if(print.length != 0 && print == "true"){
		var url = "PrintDOB.do?method=PrintDOBCertificate&regNoFrom=" +regfrom + "&regNoTo=" + regto+"&date="+date;
		myRef = window
				.open(url, "viewNoDues",
