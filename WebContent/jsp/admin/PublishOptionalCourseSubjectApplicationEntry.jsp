...
function deleteAttendancePercentageDayRange(id,department){
	...
	if(deleteConfirm){
		document.location.href = "PublishOptionalCourseSubjectApplicationEntry.do?method=deletePublishOptionalCourseSubjectApplication&id=" +id + "&name=" +department;
	}
}
function editAttendancePercentageDayRange(id) {
	document.location.href = "PublishOptionalCourseSubjectApplicationEntry.do?method=editPublishOptionalCourseSubjectApplication&id=" +id;
...
<html:form action="/PublishOptionalCourseSubjectApplicationEntry" onsubmit="getClassValues()">

<html:hidden property="formName" value="PublishOptionalCourseSubjectApplicationEntryForm" />
...
<html:hidden property="stayClass" styleId="stayClass" />
	...
	<html:hidden property="dupId" styleId="dupId"/>
      ...
      <c:choose>
		...
		<html:hidden property="method" styleId="method" value="updatePublishOptionalCourseSubjectApplication" />
		</c:when>
		<c:otherwise>
		<html:hidden property="method" styleId="method" value="addPublishOptionalCourseSubjectApplication" />
		</c:otherwise>
	 </c:choose>
...
<table width="98%" border="0">
  <tr>
    <td><span class="heading"><bean:message key="knowledgepro.news.events.sendmail.admin.to.name"/><span class="Bredcrumbs">&gt;&gt;<bean:message key="knowledgepro.admin.publishoptionalsubject"/> &gt;&gt;</span></span></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="10"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><div align="left"><strong class="boxheader"><bean:message key="knowledgepro.admin.publishoptionalsubject"/></strong></div></td>
	                       ...
	                       <table width="100%" cellspacing="1" cellpadding="2">
				        		...
				        		<c:choose>
    								<c:when test="${department != null && department == 'edit'}">
     								 <input type="hidden"  id="tempyear"    name="tempyear" value="<bean:write name="PublishOptionalCourseSubjectApplicationEntryForm" property="year"/>"/>
      									 <html:select disabled="true"  property="year" styleId="academicYear" name="PublishOptionalCourseSubjectApplicationEntryForm" styleClass="combo"  onchange="getClasses(this.value)">
				                           
		                       	   				<!--  <html:option value=""><bean:write name="PublishOptionalCourseSubjectApplicationEntryForm" property="year"/></html:option> -->
		                       	   				<cms:renderAcademicYear></cms:renderAcademicYear>
		                       			   </html:select>
   								 </c:when>
   								 <c:otherwise>
     							 <input type="hidden" id="tempyear"    name="tempyear" value="<bean:write name="PublishOptionalCourseSubjectApplicationEntryForm" property="year"/>"/>
  										 <html:select property="year" styleId="academicYear" name="PublishOptionalCourseSubjectApplicationEntryForm" styleClass="combo"  onchange="getClasses(this.value)">
				                  ...
				                  <td class="row-odd" width="25%">
					                ...
					                <td class="row-even" width="100%">
					                  <html:select styleId="classes" property="classCodeIdsFrom"  multiple="multiple" size="8"  tabindex="1">
					                 	    ...
					                 	    <c:if test="${PublishOptionalCourseSubjectApplicationEntryForm.classMap != null}">
					       		    		<html:optionsCollection property="classMap"  name="PublishOptionalCourseSubjectApplicationEntryForm" label="value" value="key"/>
					       		    		</c:if>
					                  </html:select>
				                  </td>
				                  <td width="49"><c:choose>
											...
											<td width="120"><label> <nested:select
												...
												<logic:notEmpty name="PublishOptionalCourseSubjectApplicationEntryForm"
													property="mapSelectedClass">
													<nested:optionsCollection name="PublishOptionalCourseSubjectApplicationEntryForm"
				                ...
				                <tr>
									...
									<td class="row-even">
									<html:text name="PublishOptionalCourseSubjectApplicationEntryForm" property="fromDate" styleId="fromDate" readonly="true" size="10" maxlength="16"/>
							<script
							language="JavaScript">
							new tcal( {
								// form name
								'formname' :'PublishOptionalCourseSubjectApplicationEntryForm',
								// input name
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<logic:iterate id="attList" property="attendanceList" name="PublishOptionalCourseSubjectApplicationEntryForm"
											 indexId="count">
											 <tr>
											<c:choose>
