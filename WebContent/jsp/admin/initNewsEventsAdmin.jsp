...
<html:hidden property="method" value="getSearchAdminNewsEvents" styleId="method"/>
  ...
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" >
      <tr>
        ...
        <td width="954" background="images/Tcenter.gif" class="body" ><strong class="boxheader"><bean:message key="knowledgepro.admin.mobNewsEventsDetails"/> </strong></td>
      ...
      <tr>
        ...
        <td valign="top" class="news"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <tr>
            	<td class="row-odd"><span class="Mandatory">*</span>Pre-Event/ Post-Event</td> 
            	<td class="row-even">
            		<html:select property="prePostEventAdm" styleId="prePostEventAdm" styleClass="combo">
  	   				 	<html:option value="">- Select -</html:option>
  	   					<html:option value="Pre-Event">Pre-Event</html:option>
  	   					<html:option value="Post-Event">Post-Event</html:option>
  	   		        </html:select>
            	</td>
            	 <td  class="row-odd"><div align="left" >Status</div></td> 
                <td class="row-even">
  	   				 	<html:radio property="status" value="Not Applicable"/>Not Applicable &nbsp; 
				 		<html:radio property="status" value="Publish"/>Published &nbsp;
				 		<html:radio property="status" value="Not Published"/>Not Published
                </td>
			</tr>
