...
function firstPage(){
	document.getElementById("method").value = "initSyllabusEntryForTeacher";
	...
	$.confirm({
		...
		'buttons'	: {
			'Ok'	: {
				...
				'action': function(){
					$.confirm.hide();
					document.getElementById("method").value="teacherSave";
					document.syllabusEntryForm.submit();
				}
			},
	  'Cancel'	:  {
...
function saveDraft(){
	document.getElementById("method").value = "teacherSaveDraft";
	document.syllabusEntryForm.submit();
}
   ...
   buttons: {
 	  Import : function() {
			  ...
			  if(year!=null && year!='' && subject!=null && subject!=''){
					  document.getElementById("method").value = "previousSyllabusEntryBySubjectAndYearForTeacher";
...
<html:hidden property="method" value="teacherSave" styleId="method"/>
									                          	 	 ...
									                          	 	 <tr>
																			...
																			<span class="dropt" title="Select to delete Unit"><nested:checkbox property="checked" onclick="unCheckSelectAll()"></nested:checkbox></span></div>
								                          	 	 	 	...
								                          	 	 	 	<td width="15%" class="tdUnits" onClick="<%=method4 %>;">
								                          	 	 	 		<table>
								                          	 	 	 			<tr>
								                          	 	 	 				<td width="3%" align="right" style="" id="<%=plus %>" ><img  src="images/syllabusEntry_collapse.png" height="20" width="20"/> </td>
								                          	 	 	 				<td width="3%" align="right" style="display: none;" id="<%=minus %>"><img  src="images/syllabusEntry_expand.png" height="20" width="20"/></td>
															...
															<tr>
																...
																<td width="0%"></td>
								                   					<logic:equal value="true" property="unitsFlag" name="syllabusEntryForm">
									                   					<td  align="left" width="95%">
									                   						<html:button property="" styleClass="btn" value="Remove More Units" onclick="removeMoreUnitsAndHrs()"></html:button> (Click the box near unit to mark for deletion)
									                   					</td>
								                 					</logic:equal>
															</tr>
														</table>
