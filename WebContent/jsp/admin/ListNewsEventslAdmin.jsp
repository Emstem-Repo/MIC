		...
		<FONT color="green"> <html:messages id="msg"
			...
			<br>
              ...
              <tr>
                    ...
                    <tr>
                      ...
                      <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
                          ...
                          <c:set var="temp" value="0" />
							<nested:iterate name="NewsEventsEntryForm" property="newsList" indexId="count" id="NEC1">
								<c:choose>
								<c:when test="${temp == 0}">
                    <tr>
                            ...
                            <td width="3%" class="row-even" align="center"><img src="images/edit_icon.gif"
										...
										onclick="getDetailForEdit('<nested:write property="id"/>','loadAdminScreen')"></td>
							</logic:equal>
                            ...
                            <td width="3%" class="row-even" align="center"><img src="images/edit_icon.gif"
										width="16" height="18"  style="cursor:pointer" 
										onclick="getDetailForEdit('<nested:write property="id"/>','editMobNewsEventsDetails')"></td>
							</logic:equal>
               ...
               <logic:notEqual value="Admin" property="screen" name="NewsEventsEntryForm">
              <tr>
              ...
              <tr>
                <td height="10" class="body" ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="47%" ></td>
                      <td width="1%" height="35"><div align="center">
                      <html:button styleClass="formbutton" property=""  onclick="cancelMe('initAdminSearch')" >Cancel</html:button>
                      </div>
					  </td>
                      <td width="52%"></td>
                    </tr>
