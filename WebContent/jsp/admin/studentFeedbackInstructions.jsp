...
function deleteInstructions(id) {
	...
	if(deleteConfirm)
		document.location.href = "stuFeedbackInstruction.do?method=deleteStuFeedbackInstructions&id="+id;
}
...
function editInstructions(id){
	document.getElementById("NWID").value=id;
	document.location.href = "stuFeedbackInstruction.do?method=editStuFeedbackInstructions&id="+id;
}
</script>
<html:form action="/stuFeedbackInstruction" method="POST">
<html:hidden property="id" styleId="NWID"/>
<html:hidden property="formName" value="stuFeedbackInstructionsForm" />
...
<table width="99%" border="0">
  ...
  <tr>
    <td><span class="Bredcrumbs"><bean:message key="knowledgepro.studentfeedback"/> <span class="Bredcrumbs">&gt;&gt; Student Feedback Instructions &gt;&gt;</span> </span></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="heading_white" >Student Feedback Instructions</td>
          ...
          <tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <logic:notEmpty name="stuFeedbackInstructionsForm" property="stuFeedbackInsToList">
                <logic:iterate id="INS" name="stuFeedbackInstructionsForm" property="stuFeedbackInsToList" indexId="count">
                <c:choose>
                   <c:when test="${temp == 0}">
                   	<tr>
