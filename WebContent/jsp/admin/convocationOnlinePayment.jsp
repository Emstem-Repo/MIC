...
function cancelAction(){
	document.location.href="onlineExamSuppApplication.do?method=initConvocationRegistration";
}
...
<html:form action="/onlineExamSuppApplication">
	<html:hidden property="method" styleId="method" value="verifyStudentSmartCardForConvocation" />
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader">CONVOCATION REGISTRATION</strong></div>
					</td>
					...
					<table width="70%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<tr>
									...
									<bean:write name="onlineExamSuppApplicationForm" property="nameOfStudent"/>
									</td>
								</tr>
								<tr>
									...
									<bean:write name="onlineExamSuppApplicationForm" property="regNo"/>
									</td>
								</tr>
								<tr>
								<td class="studentrow-odd" align="right">
									...
									<td class="studentrow-even">
									<bean:write name="onlineExamSuppApplicationForm" property="className"/>
									</td>
								</tr>
								<tr>
									<td class="studentrow-odd" align="right" width="50%" >
									...
									<td class="studentrow-even" width="50%" >
									<bean:write name="onlineExamSuppApplicationForm" property="totalFees"/>
									</td>
								</tr>
							</table>
							</td>
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2" align="center">
								...
								<tr>
									...
									<td class="studentrow-even" width="50%">
									<html:text name="onlineExamSuppApplicationForm" property="dob" styleId="dob" size="10" maxlength="16"/>
									<script language="JavaScript">
									new tcal( {
										// form name
										'formname' :'onlineExamSuppApplicationForm',
										// input name
										'controlname' :'dob'
									});
									</script>
								...
								<tr>
									...
									<td class="studentrow-even" width="50%">XXXXXXXXXXXXXX
										<html:text name="onlineExamSuppApplicationForm" property="smartCardNo" styleId="smartCardNo" size="5" maxlength="5"></html:text>									
									</td>
								</tr>
								<tr>
									<td class="studentrow-odd" align="right" width="50%">
									...
									<td class="studentrow-even" width="50%">
										<html:text name="onlineExamSuppApplicationForm" property="validThruMonth" styleId="validThruMonth" size="2" maxlength="2" onkeypress="return isNumberKey(event)"></html:text> /
										<html:text name="onlineExamSuppApplicationForm" property="validThruYear" styleId="validThruYear" size="2" maxlength="2" onkeypress="return isNumberKey(event)"></html:text>
										&nbsp;&nbsp; mm/yy
									</td>
								</tr>
							</table>
