...
function submitCsv(){
	document.getElementById("method").value ="uploadMeritList";
...
<html:form action="/admMeritUpload" method="POST" enctype="multipart/form-data">
	<html:hidden property="formName" value="admMeritListForm" />
	<html:hidden property="method" value="uploadMeritList" />
	<html:hidden property="pageType" styleId="pageType" value="1" />
	<table width="98%" border="0">
		<tr>
			<td><span class="Bredcrumbs"><bean:message key="knowledgepro.admin"/>
			<span class="Bredcrumbs">&gt;&gt; AdmMeritList Upload &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> AdmMeritList Upload</strong></div></td>
								...
								<tr>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										...
										<td height="25" class="row-odd" width="25%">
											...
											<html:file property="theFile" styleId="thefile" size="15" maxlength="30" name="admMeritListForm"/></label></td>
											<td height="25" class="row-odd" width="25%">
						...
						<tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<html:button property="" styleClass="formbutton" onclick="resetMerit();">
