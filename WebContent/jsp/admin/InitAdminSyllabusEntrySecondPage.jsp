...
<script type="text/javascript">
function firstPage(){
	document.getElementById("method").value = "initAdminSyllabusEntryFirstPage";
	document.getElementById("isFromSecondPageToFirstPage").value = "Yes";
	document.syllabusEntryForm.submit();
}
function sendForApproval(){
	$.confirm({
		'message'	: 'You can not edit once you send for approval.',
		'buttons'	: {
			'Ok'	: {
				'class'	: 'blue',
				'action': function(){
					$.confirm.hide();
					document.getElementById("method").value="adminSave";
					document.syllabusEntryForm.submit();
				}
			},
	  'Cancel'	:  {
...
function saveDraft(){
	document.getElementById("method").value = "adminSaveDraft";
	document.syllabusEntryForm.submit();
}
   ...
   buttons: {
 	  Import : function() {
			  ...
			  if(year!=null && year!='' && subject!=null && subject!=''){
					  document.getElementById("method").value = "previousSyllabusEntryBySubjectAndYearForAdmin";
...
<html:hidden property="method" value="adminSave" styleId="method"/>
...
<html:hidden property="isFromSecondPageToFirstPage" value="" styleId="isFromSecondPageToFirstPage"/>
      ...
      <tr>
        ...
        <td valign="top" class="news"><div align="center">
              <table width="100%" height="50"  border="0" cellpadding="0" cellspacing="0">
                 <tr>
               	    <td height="20" colspan="4" align="left" width="100%">
                     ...
                     <tr>
                       ...
                       <table width="100%" cellspacing="1" cellpadding="2">
                             ...
                             <td width="25%" height="25" class="row-even">
                           		<bean:write property="batchYear" name="syllabusEntryForm"/>
                             </td>
                            <td width="15%" class="row-odd" ><div align="right">
                             ...
                             <td width="40%" height="25" class="row-even">
                           		<bean:write property="subjectCode" name="syllabusEntryForm"/>/<bean:write property="subjectName" name="syllabusEntryForm"/>
                             </td>
                           </tr>
                           <tr>
                           	<td width="20%" class="row-odd" ><div align="right">
                             ...
                             <td width="25%" height="25" class="row-even">
                           		<bean:write property="parentDepartment" name="syllabusEntryForm"/>
                             </td>
                             <td width="15%" class="row-odd" ><div align="right">
                             	Theory/Practical:</div>
                             </td>
                             <td width="40%" height="25" class="row-even">
                           		<bean:write property="theoryOrPractical" name="syllabusEntryForm"/>
                             </td>
                           </tr>
                            <tr>
                             <td width="20%" class="row-odd"><div align="right">
                             ...
                             <td width="25%" height="25" class="row-even">
                           		<bean:write property="questionBankRequired" name="syllabusEntryForm"/>
                             </td>
                           
                            <td  height="25" class="row-odd" colspan="2">
                             	<a href="#" onclick="previousData()"><b><font size="2" color="red">Import Syllabus From Previous Year</font></b></a>
                           		<div id="openDialog">
										<div align="center">
											<table width="100%">
												<tr>
                 ...
                 <tr><td height="10" width="100%"></td></tr>
                  <logic:notEmpty name="syllabusEntryForm" property="rejectReason">
                 <tr>
	                       ...
	                       <table width="100%" cellspacing="1" cellpadding="2">
				                 <tr>
	                          	 ...
	                          	 <tr>
		                             ...
		                             <bean:write property="rejectReason" name="syllabusEntryForm"/>
		                             </td>
		                           </tr>
							                             ...
							                             <td width="100%" height="25" class="row-even" >
															<FCK:editor instanceName="freeText"  toolbarSet="Default">
																<jsp:attribute name="value">
																	<c:out value="${syllabusEntryForm.freeText}" escapeXml="false"></c:out>
																</jsp:attribute>
															</FCK:editor>
							                             </td>
							                           </tr>
								                   ...
								                   <td height="49" class="body" width="100%"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
								                     ...
								                     <tr>
								                       ...
								                       <table width="100%" cellspacing="1" cellpadding="2" id="report">
								                          	 	 <logic:notEmpty name="syllabusEntryForm" property="syllabusEntryUnitsHoursTos">
													                   <nested:iterate id="CME" name="syllabusEntryForm" property="syllabusEntryUnitsHoursTos" indexId="count" type="com.kp.cms.to.admin.SyllabusEntryUnitsHoursTo">
									                          	 	 ...
									                          	 	 <tr>
																			...
																			<span class="dropt" title="Select to delete Unit"><nested:checkbox property="checked" onclick="unCheckSelectAll()"></nested:checkbox></span></div>
																		</td>
																						                     ...
																						                     <tr>
																						                       ...
																						                       <table width="100%" cellspacing="1" cellpadding="2" >
																									                   ...
																									                   <nested:iterate id="CME1" property="syllabusEntryHeadingDescTos" indexId="cnt">
																									                   	...
																									                   	%>
																						                          	 <tr style="" class="tdHeadings" onclick="<%=method2 %>" height="10">
																														<td width="100%">
																															<table width="100%">
																				                          	 	 	 			<tr>
																				                          	 	 	 				<td width="10%" align="right" style="" id="<%=headPlus %>"><img  src="images/syllabusEntry_collapse.png" height="20" width="20"/></td>
								                          	 	 	 																<td width="10%" align="right" style="display: none;" id="<%=headMinus %>"><img  src="images/syllabusEntry_expand.png" height="20" width="20"/></td>
																				                          	 	 	 				<td width="95%" align="left">
													...
													<td  height="25" align="left" width="100%" colspan="3">
														<table width="100%">
															<tr>
																...
																<td width="0%"></td>
								                   					<logic:equal value="true" property="unitsFlag" name="syllabusEntryForm">
									                   					<td  align="left" width="95%">
									                   						<html:button property="" styleClass="btn" value="Remove Unit" onclick="removeMoreUnitsAndHrs()"></html:button> (Click the box near unit to mark for deletion)
									                   					</td>
								                 					</logic:equal>
															</tr>
														</table>
		                  ...
		                  <tr>
		                    <td height="20"><div align="center">
		                    		<html:button property="" styleClass="formbutton" value="Save Draft" onclick="saveDraft()"></html:button>
		                      		<html:button property="" styleClass="formbutton" value="Send For Approval" onclick="sendForApproval()"></html:button>
