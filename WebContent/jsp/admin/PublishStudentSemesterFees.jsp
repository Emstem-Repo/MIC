...
function deleteAttendancePercentageDayRange(id,department){
	...
	if(deleteConfirm){
		document.location.href = "PublishStudentSemesterFeesEntry.do?method=deletePublishStudentSemesterFees&id=" +id + "&name=" +department;
	}
}
function editAttendancePercentageDayRange(id) {
	document.location.href = "PublishStudentSemesterFeesEntry.do?method=editStudentSemesterFees&id=" +id;
...
<html:form action="/PublishStudentSemesterFeesEntry" onsubmit="getClassValues()">

<html:hidden property="formName" value="PublishStudentSemesterFeesForm" />
...
<html:hidden property="stayClass" styleId="stayClass" />
	...
	<html:hidden property="dupId" styleId="dupId"/>
      ...
      <c:choose>
		...
		<html:hidden property="method" styleId="method" value="updateStudentSemesterFees" />
		</c:when>
		<c:otherwise>
		<html:hidden property="method" styleId="method" value="addStudentSemesterFees" />
		</c:otherwise>
	 </c:choose>
...
<table width="98%" border="0">
  <tr>
    <td><span class="heading">Publish Student Semester Fees</span></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="10"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><div align="left"><strong class="boxheader">Publish Student Semester Fees</strong></div></td>
	                       ...
	                       <table width="100%" cellspacing="1" cellpadding="2">
				        		...
				        		<c:choose>
    								<c:when test="${department != null && department == 'edit'}">
     								 <input type="hidden"  id="tempyear"    name="tempyear" value="<bean:write name="PublishStudentSemesterFeesForm" property="year"/>"/>
      									 <html:select disabled="true"  property="year" styleId="academicYear" name="PublishStudentSemesterFeesForm" styleClass="combo"  onchange="getClasses(this.value)">
				                           
		                       	   				<!--  <html:option value=""><bean:write name="PublishStudentSemesterFeesForm" property="year"/></html:option> -->
		                       	   				<cms:renderAcademicYear></cms:renderAcademicYear>
		                       			   </html:select>
   								 </c:when>
   								 <c:otherwise>
     							 <input type="hidden" id="tempyear"    name="tempyear" value="<bean:write name="PublishStudentSemesterFeesForm" property="year"/>"/>
  										 <html:select property="year" styleId="academicYear" name="PublishStudentSemesterFeesForm" styleClass="combo"  onchange="getClasses(this.value)">
				                  ...
				                  <td class="row-odd" width="25%">
					                ...
					                <td class="row-even" width="100%">
					                  <html:select styleId="classes" property="classCodeIdsFrom"  multiple="multiple" size="8"  tabindex="1">
					                 	    ...
					                 	    <c:if test="${PublishStudentSemesterFeesForm.classMap != null}">
					       		    		<html:optionsCollection property="classMap"  name="PublishStudentSemesterFeesForm" label="value" value="key"/>
					       		    		</c:if>
					                  </html:select>
				                  </td>
				                  <td width="49"><c:choose>
											...
											<td width="120"><label> <nested:select
												...
												<logic:notEmpty name="PublishStudentSemesterFeesForm"
													property="mapSelectedClass">
													<nested:optionsCollection name="PublishStudentSemesterFeesForm"
				                ...
				                <tr>
									...
									<td class="row-even">
									<html:text name="PublishStudentSemesterFeesForm" property="fromDate" styleId="fromDate" readonly="true" size="10" maxlength="16"/>
							<script
							language="JavaScript">
							new tcal( {
								// form name
								'formname' :'PublishStudentSemesterFeesForm',
								// input name
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<logic:iterate id="attList" property="attendanceList" name="PublishStudentSemesterFeesForm"
											 indexId="count">
											 <tr>
											<c:choose>
