                   ...
                   <td height="49" class="body" ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                     ...
                     <tr>
                       ...
                       <nested:iterate id="to" name="syllabusEntryForm" property="subjectMapBySem">
		                  <tr class="tdIMG">
		                  	<td >
								<div align="left" style="border: none; font-size: 13px; color: #006600"><b><bean:write name="to" property="key"/> </b></div>
							</td>
		                  		...
		                  		<table width="100%">
		                  			<tr>
		                  				<td width="5%"  height="5%" class="row-odd" ><div align="center"><bean:message key="admissionForm.detailmark.semester.label"/></div></td>
			               				...
			               				<td width="10%" height="30%" class="row-odd" align="center" ><bean:message key="employee.info.job.achievement.status"/></td>
	                  				...
	                  				<nested:iterate id="to1" name="to" property="value" indexId="count">
					                   	<c:choose>
		                  					...
		                  					<td  height="25" ><div align="center"><bean:write name="to1" property="semester"/></div></td>
		                  					<td  height="25" align="left"><bean:write name="to1" property="subjectCode"/></td>
		                  					<logic:notEmpty name="to1" property="display">
		                  						<td  height="25"  align="left"><a href="#" onclick="syllabusEntry('<bean:write name="to1" property="subjId"/>')"><span class="dropt" title="Click here for syllabus entry."><bean:write name="to1" property="subjectName"/></span></a></td>
		                  					</logic:notEmpty>
		                  					<logic:empty name="to1" property="display">
		                  						<td  height="25" align="left"><bean:write name="to1" property="subjectName"/></td>
		                  					</logic:empty>
