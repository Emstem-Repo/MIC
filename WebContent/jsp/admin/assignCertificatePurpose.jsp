...
function saveCertificateDetails(){
	document.getElementById("method").value = "saveCertificateDetailsPurpose";
...
function validateCheckBox() {
    ...
    for(var count1 = 0;count1<inputs.length;count1++) {
        ...
        document.getElementById("err").innerHTML = "Purposes Assigned :"+checkBoxselectedCount;
...
<table width="99%" border="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="5" valign="top" background="images/Tright_03_03.gif"></td>
        <td class="heading"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                ...
                <tr>
                  ...
                  <table width="100%" cellspacing="1" cellpadding="2">
                        ...
                        <td width="80%" class="row-odd" align="center"><bean:message key="knowledgepro.assign.to.purpose"/></td>
                        </tr>
                      <nested:iterate id="name" property="assignPurposeList" name="certificateDetailsForm" indexId="count">
					   <c:choose>
					 ...
					 <td height="25" align="center" >
                        ...
                        <input
							type="hidden"
							name="assignPurposeList[<c:out value='${count}'/>].tempChecked"
							id="hidden_<c:out value='${count}'/>"
							value="<nested:write name='name' property='tempChecked'/>" />
                       
                        <input
							type="checkbox"
							name="assignPurposeList[<c:out value='${count}'/>].checked"
                       ...
                       <td width="212" align="center"><nested:write name="name" property="purposeName"/></td>
                      </tr>
                     </nested:iterate>
                  </table>
