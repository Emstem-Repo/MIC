                 ...
                 <tr>
                   <td height="49" colspan="6" class="body" ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                     ...
                     <tr>
                       ...
                       <logic:notEmpty name="syllabusEntryForm" property="batchYearList">
	                       <c:forEach var="list" items="${syllabusEntryForm.batchYearList}" >
	                       	<logic:equal value="open" name="syllabusEntryOpen" scope="session">
					     		<tr>
					     		<td>
					     		<img src="images/bullet_img.gif" width="13" height="9" />
					    		<blink><a href="#" onclick="syllabusEntry('	<c:out value="${list}"/>','<bean:write name="DepartmentId"/>')"><font color="red"><b>Syllabus Entry for 	<c:out value="${list}"/> Batch</b></font></a></blink><br><br>
					    		</td>
					    		</tr>
					     	</logic:equal>
					     	<logic:equal value="openLanguage" name="syllabusEntryOpenForLanguages" scope="session">
					     		<tr>
					     			<td>
					     			<img src="images/bullet_img.gif" width="13" height="9" />
					    			<blink><a href="#" onclick="syllabusEntryForSecondLanguages('	<c:out value="${list}"/>','<bean:write name="DepartmentId"/>')"><font color="red"><b>Syllabus Entry for Second languages 	<c:out value="${list}"/> Batch</b></font></a></blink><br><br>
					     			</td>
					     		</tr>
					     	</logic:equal>
	                       </c:forEach>
