...
<title>View Terms & Conditions Check List</title>
</head>
<body>
					...
					<tr>
						...
						<table width="100%" cellspacing="1" cellpadding="2">
							<tr>
								...
								<td height="25" class="row-odd" align="center">
								<div align="center"><bean:message key="knowledgepro.attendance.mandatory"/></div>
								</td>
								</tr>
								<logic:iterate id="checkList" name="viewTermsConditionCheckList"
									indexId="count">
									<c:choose>
									...
									<td width="17%" height="25" align="center"><bean:write
										name="checkList"
										property="checklistDescription" /></td>
									<td width="18%" height="25" align="center"><bean:write
										name="checkList" property="isMandatory" /></td>
									</tr>
								</logic:iterate>
						</table>
						<br>
