...
function resetMessages(){
	document.location.href ="syllabusUpload.do?method=initSyllabusUpload";
}

</script>
<html:form action="/syllabusUpload" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="syllabusUpload" />
	<html:hidden property="formName" value="syllabusUploadForm" />
	<html:hidden property="pageType" value="1" />
	<table width="98%" border="0">
		<tr>
			<td><span class="Bredcrumbs">Admin
			<span class="Bredcrumbs">&gt;&gt; Upload Syllabus &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> Upload Syllabus </strong></div></td>
							...
							<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										...
										<html:file property="thefile" name="syllabusUploadForm"/></td>
										</tr>
									</table>
									</td>
