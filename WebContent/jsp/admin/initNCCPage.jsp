...
<script type="text/javascript">
	...
	function printPass(){
		document.getElementById("method").value = "getNCCDetails";
...
<html:hidden property="name" styleId="name" value=""/>
<table width="98%" border="0">
  <tr>
    <td><span class="heading">
				<bean:message key="knowledgepro.admin" />
			<span class="Bredcrumbs">&gt;&gt; <bean:message key="knowledgepro.admin.template.sports"/>&gt;&gt;</span></span></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="10"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><div align="left"><strong class="boxheader"><bean:message key="knowledgepro.admin.template.sports"/></strong></div></td>
                     ...
                     <tr>
                       ...
                       <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
                           ...
                           <td width="25%" height="25" class="row-odd" ><div id = "reFrom" align="right"><span class="Mandatory">*</span>Date:</div></td>
                             ...
                             <td width="25%" height="25" class="row-odd" ><div id = "reFrom" align="right"><span class="Mandatory">*</span>Academic year:</div></td>
                             <td width="50%" height="25" class="row-even" align="left">
                            	<html:text property="campYear" styleId="campYear" name="commonTemplateForm"/>
                             </td>
                           </tr>
                            <tr>
                             <td width="25%" height="25" class="row-odd" ><div id = "reFrom" align="right"><span class="Mandatory">*</span>NCC Camp:</div></td>
                              <td width="50%" height="25" class="row-even" align="left">
                            	<html:textarea property="ncc" styleId="ncc"	>
							    </html:textarea>
                             </td>
                           </tr>
                       </table></td>
...
<script language="JavaScript" >
	...
	if(print.length != 0 && print == "true"){
		var url = "CommonTemplatePrint.do?method=printNCCDetails";
		myRef = window
				.open(url, "viewNoDues",
		...
		document.getElementById("regNoTo").value = "";
		document.getElementById("ncc").value = "";
		document.getElementById("campYear").value = "";
		}
</script>