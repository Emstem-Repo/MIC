...
<script type="text/javascript">
	...
	function printPass(){
		document.getElementById("method").value = "printCharacter";
		document.characterCertificateForm.submit();
...
<html:form action="/CharacterCertificate">
<html:hidden property="method" styleId="method"/>
<html:hidden property="formName" value="characterCertificateForm"/>
<html:hidden property="pageType" value="1"/>
<table width="98%" border="0">
  <tr>
    <td><span class="heading">
				<bean:message key="knowledgepro.admin" />
			<span class="Bredcrumbs">&gt;&gt; <bean:message key="knowledgepro.admin.character.certificate"/>&gt;&gt;</span></span></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="10"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><div align="left"><strong class="boxheader"><bean:message key="knowledgepro.admin.character.certificate"/></strong></div></td>
                     ...
                     <tr>
                       ...
                       <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
                           <tr >
                             ...
                             <span class="star">
                               <html:text property="regNoFrom" styleId="regNoFrom" name="characterCertificateForm"/>
                             </span></td>
							<td width="25%" height="25" class="row-odd" ><div id = "reTo" align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.attendance.regno.to.col" /> </div></td>
                             <td width="50%" height="25" class="row-even" align="left">
                             <span class="star">
                               <html:text property="regNoTo" styleId="regNoTo" name="characterCertificateForm"/>
                             </span></td>
                           </tr>
                           <tr>
                           <td width="25%" height="25" class="row-odd" ><div id = "reFrom" align="right"><span class="Mandatory">*</span>Date:</div></td>
                             ...
                             <html:text property="date" styleId="date" size="11" maxlength="11"></html:text>
									<script language="JavaScript">
										new tcal( {
											// form name
											'formname' :'characterCertificateForm',
											// input name
											'controlname' :'date'
										});
									</script>
                             </td>
                             <td width="25%" height="25" class="row-odd" ><div id = "reFrom" align="right"><span class="Mandatory">*</span>Character:</div></td>
                             <td width="50%" height="25" class="row-even" align="left">
                            	<html:select property="character" styleClass="combo" styleId="character" name="characterCertificateForm">
...
<script language="JavaScript" >
	var print = "<c:out value='${characterCertificateForm.printPage}'/>";
	if(print.length != 0 && print == "true"){
		var url = "CharacterCertificate.do?method=printCharacterCertificate";
		myRef = window
				.open(url, "viewNoDues",
