...
function cancel(){
	document.location.href = "examInvigilationDutyExemption.do?method=initExamInvigilatorsDutyExemption";
}
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="body"><strong
						class="boxheader"> <bean:message key="knowledgepro.exam.allotment.invigilator.exam.exemption" /></strong></td>
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
                 				...
                 				<logic:notEmpty name="examInvigilatorDutyExemptionForm" property="list">
								<nested:iterate id="CME" name="examInvigilatorDutyExemptionForm" property="list" indexId="count" type="com.kp.cms.to.examallotment.ExamInvigilatorDutyExemptionTo">
									<%
