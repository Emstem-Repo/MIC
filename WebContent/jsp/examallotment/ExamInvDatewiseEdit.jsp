...
<script type="text/javascript">
	...
	function cancel(){
		document.location.href = "Login.do?method=loginAction";
	}
	...
	<table width="100%" border="0">
	   ...
	   <tr>
               ...
               <td width="32%" height="25" class="row-even"><label></label>
                    <span class="star">
                    <html:text property="editDate" styleId="editDate" size="20" maxlength="20"/>
                  </span>
                  <script language="JavaScript">
                  					$(function(){
										  ...
										  $("#editDate").datepicker(pickerOpts);
										});
                  </script>
                </td>
              <td width="16%" height="25" class="row-odd"><div align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.admin.mobNewsEventsDetailsDateFrom"/>:</div></td>
               <td width="32%" height="25" class="row-even"><label></label>
                    <span class="star">
                    <html:hidden property="teacherId" name="invExemptionDatewiseForm"/>
                    <bean:write property="teacherName" name="invExemptionDatewiseForm"/>
                  </span>
