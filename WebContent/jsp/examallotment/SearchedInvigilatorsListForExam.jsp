...
<html:hidden property="method" styleId="method"	value="updateInvigilators" />
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<td width="2%"  height="5%" class="row-odd" ><div align="center">
										All<input type="checkbox" id="checkAll" onclick="selectAll(this)" checked="checked"/></div>
									</td>
									<td width="15%"  height="5%" class="row-odd" ><div align="center">Name</div></td>
									<td width="15%"  height="5%" class="row-odd" ><div align="center">Exam</div></td>
									<td width="15%"  height="5%" class="row-odd" ><div align="center">Campus</div></td>
								...
								<nested:iterate id="CME" name="invigilatorsForExamForm" property="list" indexId="count" type="com.kp.cms.to.examallotment.InvigilatorsForExamTo" >
                   				...
                   				<tr>
                   					<td  height="25" class="row-even" align="center"><c:out value="${count + 1}" />
                   						<div id=""></div>
                   					</td>
                   					...
                   					<td  height="25" class="row-even" align="center"><nested:write name="CME" property="examName"/></td>
                   					<td  height="25" class="row-even" align="center"><nested:write name="CME" property="workLocation"/></td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="5%" height="35" align="right">
								<html:submit property="" value="Update" styleId="submit" styleClass="formbutton"></html:submit>
							</td>
