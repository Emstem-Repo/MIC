...
<script type="text/javascript">
	...
	function searchTheInvigilators(){
		...
		document.invigilatorsForExamForm.submit();
		}
</script>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="body"><strong
						...
						key="knowledgepro.exam.allotment.invigilator.for.exam" /></strong></td>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<td width="25%" height="25" class="row-even" align="left">
										...
										<html:select property="academicYear" styleClass="combo"	styleId="academicYear" name="invigilatorsForExamForm" onchange="examMap(this.value)">
									...
									<td width="25%" height="25" class="row-even" align="left">
										 <html:select property="examId" styleId="examId" name="invigilatorsForExamForm">
                    						...
                    						<c:choose>
												...
												<c:otherwise>
	                    							<logic:notEmpty property="examMap" name="invigilatorsForExamForm">
								...
								<tr>
									...
									<td width="25%" height="25" class="row-even" align="left">
										 <html:select property="deanaryId" styleId="deanaryId" name="invigilatorsForExamForm" onchange="departmentMap(this.value)">
                    						<html:option value="">--Select--</html:option>
                    							<logic:notEmpty property="deanaryMap" name="invigilatorsForExamForm">
									...
									<td width="25%" height="25" class="row-even" align="left">
										 <html:select property="deptId" styleId="deptId" name="invigilatorsForExamForm">
                    						<html:option value="">--Select--</html:option>
                    						<c:choose>
												...
												<c:otherwise>
	                    							<logic:notEmpty property="deptMap" name="invigilatorsForExamForm">
								...
								<tr>
									...
									<td width="25%" height="25" class="row-even" align="left">
										 <html:select property="locationId" styleId="locationId" name="invigilatorsForExamForm">
                    						<html:option value="">--Select--</html:option>
                    							<logic:notEmpty property="workLocationMap" name="invigilatorsForExamForm">
						   							<html:optionsCollection property="workLocationMap" label="value" value="key"/>
						   						</logic:notEmpty>
						   					</html:select>
									</td>
									<td align="right" class="row-odd" width="25%"></td>
