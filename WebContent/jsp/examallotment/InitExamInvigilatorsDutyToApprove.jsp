...
<html:hidden property="method" styleId="method"	value="approveTheInvigilatorsDuty" />
	<table width="100%" border="0">
		<tr>
			<td><span class="heading"> <bean:message
				key="knowledgepro.exam.allotment" /> <span class="Bredcrumbs">&gt;&gt;
			Approve Exam Invigilators Duty  &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td valign="top">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="body"><strong
						class="boxheader">Approve Exam Invigilators Duty </strong></td>
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								<tr>
									...
									<td width="25%" height="25" class="row-even" align="left">
										 <html:select property="locationId" styleId="locationId" name="examInvigilatorDutyEditForm">
                    						<html:option value="">--Select--</html:option>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="5%" height="35" align="center">
								<html:submit property="" styleClass="formbutton" value="Approve"	styleId="submitbutton">
								</html:submit>
							</td>
