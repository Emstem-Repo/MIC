...
<script type="text/javascript">
	...
	function getFacultyMap(id){
		var deptId=document.getElementById("deptId").value;
		var deaneryId=document.getElementById("deanaryId").value;
		facultyByCampusDeptAndDeanery("facultyMap", id,deptId,deaneryId, "facultyId", updateFaculty);
		}
...
<html:form action="/teacherwiseExemption">
<html:hidden property="formName" value="teacherwiseExemptionForm" />
<html:hidden property="pageType" value="1" />
<html:hidden property="method" styleId="method"	value="getTeachersList" />
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<td width="25%" height="25" class="row-even" align="left">
										...
										<html:select property="academicYear" styleClass="combo"	styleId="academicYear" name="teacherwiseExemptionForm" onchange="examMap(this.value)">
									...
									<td width="25%" height="25" class="row-even" align="left">
										 <html:select property="examId" styleId="examId" name="teacherwiseExemptionForm">
                    						...
                    						<c:choose>
												...
												<c:otherwise>
	                    							<logic:notEmpty property="examMap" name="teacherwiseExemptionForm">
								...
								<tr>
									...
									<td width="25%" height="25" class="row-even" align="left">
										 <html:select property="deanaryId" styleId="deanaryId" name="teacherwiseExemptionForm" onchange="departmentMap(this.value)">
                    						<html:option value="">--Select--</html:option>
                    							<logic:notEmpty property="deanaryMap" name="teacherwiseExemptionForm">
									...
									<td width="25%" height="25" class="row-even" align="left">
										 <html:select property="deptId" styleId="deptId" name="teacherwiseExemptionForm">
                    						<html:option value="">--Select--</html:option>
                    						<c:choose>
												...
												<c:otherwise>
	                    							<logic:notEmpty property="deptMap" name="teacherwiseExemptionForm">
								...
								<tr>
									...
									<td width="25%" height="25" class="row-even" align="left">
										 <html:select property="locationId" styleId="locationId" name="teacherwiseExemptionForm" onchange="getFacultyMap(this.value)">
                    						<html:option value="">--Select--</html:option>
                    							<logic:notEmpty property="workLocationMap" name="teacherwiseExemptionForm">
									...
									<td width="25%" height="25" class="row-even" align="left">
										 <html:select property="facultyId" styleId="facultyId" name="teacherwiseExemptionForm" styleClass="comboMediumBig">
                    						<html:option value="">--Select--</html:option>
                    						<c:choose>
												...
												<c:otherwise>
													<logic:notEmpty property="facultyMap" name="teacherwiseExemptionForm">
