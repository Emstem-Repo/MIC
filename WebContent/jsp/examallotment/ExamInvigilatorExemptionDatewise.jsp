			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
						<td width="5" background="images/left.gif"></td>
							...
							<tr>
								<td  width="20%"  height="25" class="row-odd"><div align="left">From Date</div></td>
								<td  width="20%"  height="25" class="row-even"><bean:write name="invExemptionDatewiseForm" property="fromDate"/></td>
								<td  width="20%"  height="25" class="row-odd"><div align="left">To Date</div></td>
								<td  width="20%"  height="25" class="row-even"><bean:write name="invExemptionDatewiseForm" property="toDate"/></td>
							</tr>
							<tr>
								<td  width="20%"  height="25" class="row-odd"><div align="left">Session</div></td>
								<td  width="20%"  height="25" class="row-even"><bean:write name="invExemptionDatewiseForm" property="session"/></td>
								<td  width="20%"  height="25" class="row-odd"><div align="left">Exam Name</div></td>
								<td  width="20%"  height="25" class="row-even"><bean:write name="invExemptionDatewiseForm" property="examName"/></td>
							</tr>
					</table>
					</td>
