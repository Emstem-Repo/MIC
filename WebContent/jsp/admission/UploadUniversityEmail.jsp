...
<html:form action="/uploadUniversityEmail" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="uploadUniversityEmail" />
	<html:hidden property="formName" value="uploadUniversityEmailForm" />
	<html:hidden property="pageType" value="1" />
	<table width="98%" border="0">
		<tr>
			<td><span class="Bredcrumbs"><bean:message key="knowledgepro.admission" />
			<span class="Bredcrumbs">&gt;&gt; Upload University Email &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> Upload University Email </strong></div></td>
								...
								<tr>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										<tr class="row-white">
											...
											<div align="right"><span class="Mandatory">*</span>Upload CSV:</div></td>
