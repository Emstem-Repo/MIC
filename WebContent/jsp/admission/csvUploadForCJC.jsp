...
function submitCsv(){
	document.getElementById("method").value = "updateCSVForCJC";
	document.admissionFormForm.submit();
}
function resetCsv(){
	document.getElementById("method").value = "initCSVUploadForCJC";
	document.admissionFormForm.submit();
}
function reset(){
...
<html:form action="/admissionFormSubmit" method="POST" enctype="multipart/form-data">
	<html:hidden property="formName" value="admissionFormForm" />
	<html:hidden property="method" styleId="method" value="updateCSVForCJC" />
	<html:hidden property="pageType" styleId="pageType" value="4" />
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> <bean:message key="admissionForm.omrupload.main.label" /></strong></div></td>
							...
							<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<input type="hidden" id="tempyear" name="appliedYear"
										value="<bean:write name="admissionFormForm" property="year"/>" />
									<html:select property="year" styleId="year"	styleClass="combo" >
										...
										<td height="25" class="row-odd" width="25%">
											...
											<html:file property="csvFile" styleId="csvFile" size="15" maxlength="30"/></label></td>
										</tr>
									</table>
									</td>
