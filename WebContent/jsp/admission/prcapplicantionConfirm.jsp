...
<html:form action="/presidanceadmissionFormSubmit" enctype="multipart/form-data" method="POST">
	<html:hidden property="method" value="saveConfirmedApplication" />
...
<div style="overflow: auto; width: 800px;">
										...
										<tr>
											...
											<td height="20" class="row-even" align="left"><table width="100%" border="0" cellpadding="0" cellspacing="0">
												...
												<logic:notEqual value="Other" property="applicantDetails.personalData.religionId" name="admissionFormForm">
													<%dynastyle="display:none;"; %>
												<nested:select property="applicantDetails.personalData.religionId" styleClass="combo" styleId="religions" onchange="getSubReligion(this.value,'Subreligions');funcOtherShowHide('religions','otherReligion')">
													<option value=""><bean:message key="knowledgepro.admin.select"/></option>
								...
								<tr>
									...
									<table width="100%" height="57" border="0" cellpadding="0"
										...
										<tr class="row-white">
											...
											<td width="236" height="23" class="row-even" align="left"><nested:text property="applicantDetails.personalData.passportNo" maxlength="10"></nested:text></td>
                    ...
                    <tr>
                      ...
                      <td height="31" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="1">
                          <tr class="row-white">
                            ...
                            <td class="row-odd" width="15%"><div align="center"> <bean:message key="knowledgepro.applicationform.fromdt.label"/><bean:message key="admissionForm.application.dateformat.label"/></div></td>
                            <td class="row-odd" width="15%"><div align="center"><bean:message key="knowledgepro.applicationform.todt.label"/><bean:message key="admissionForm.application.dateformat.label"/></div></td>
									...
									<table width="100%" height="90" border="0" cellpadding="0"
										...
										<tr class="row-white">
											...
											<td width="236" height="20" class="row-even" align="left">&nbsp;
												<nested:text property="applicantDetails.personalData.currentAddressLine1"></nested:text>
											</td>
											<td width="224" class="row-odd">
											<div align="right"><bean:message
											...
											<td width="244" class="row-even" align="left">&nbsp;
												<nested:text property="applicantDetails.personalData.currentAddressLine2"></nested:text>
											</td>
										</tr>
										<tr class="row-even">
											<td height="20" class="row-odd">
							...
							<table width="99%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<tr>
											...
											<td class="row-odd"><span class="Mandatory">*</span>Percentage</td>
										</tr>
											...
											<c:choose>
												<c:when test="${temp == 0}">
													<tr>
														...
														<tr><td><nested:text property="otherInstitute" size="10" maxlength="10" styleId="<%=otherinstituteid %>" style="<%=dynastyle %>"></nested:text></td></tr>
														</table>
														</div>
														</td>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<div align="right"><html:submit styleClass="formbutton">
										<bean:message key="knowledgepro.confirm" />
									</html:submit></div>
									</td>
									...
									<html:button
										...
										onclick="submitAdmissionForm('initApplicationForm')">
	...
	</table><logic:equal value="false" property="onlineApply" name="admissionFormForm"></div></logic:equal>
</html:form>
