...
<html:form action="/uniqueIdRegistration" method="POST">
	...
	<table width="90%" border="0"  cellpadding="3" cellspacing="0" bordercolor="#E0DFDB">		
	 <tr>
		<td align="center">
		  <img width="700" height="100"  src="images/header-logo.jpg" alt="Logo not available">
		</td>
	</tr>
	<tr>
	  <td>
	    <table width="100%">
	      <tr>
	        <td width="60%">
	          ...
	          <tr>
	            <td>Subject Applied For</td><td>: </td><td><bean:write name="uniqueIdRegistrationForm" property="applicantDetails.preference.firstprefCourseName"/></td>
	           </tr>
	          </logic:equal>
	           <tr>
	            <td>Application No</td><td>: </td><td><bean:write name="uniqueIdRegistrationForm" property="applicantDetails.applnNo"/></td>
	           </tr>
	           <tr>
	            <td><bean:write name="uniqueIdRegistrationForm" property="applicantDetails.mode"/> No.</td><td>: </td><td><bean:write name="uniqueIdRegistrationForm" property="applicantDetails.journalNo"/></td>
	           </tr>
	           <tr>
	...
	<tr>
	  <td style="font-size:medium; font-weight: bold" align="center" align="center">APPLICATION FOR ADMISSION TO FIRST DEGREE PROGRAMME - <bean:write name="uniqueIdRegistrationForm" property="applicantDetails.appliedYear"/></td>
	</tr>
	</logic:equal>
	
	<logic:equal value="2" name="uniqueIdRegistrationForm" property="applicantDetails.programType">
	<tr>
	  <td style="font-size:medium; font-weight: bold" align="center" align="center">APPLICATION FOR ADMISSION TO POSTGRADUATE PROGRAMME - <bean:write name="uniqueIdRegistrationForm" property="applicantDetails.appliedYear"/></td>
	</tr>
	</logic:equal>
	...
	<tr>
	 ...
	 <table width="100%" border="0" cellpadding="3" >
	   <tr height="40%">
	     <td>1.</td><td >Name</td><td>: </td><td><bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.firstName"></bean:write>&nbsp;
				                    </td><td></td><td></td><td></td>
		 </tr>
	   
	   <tr height="40%">
	     <td>2.</td><td>Gender</td><td>: </td><td><logic:equal name="uniqueIdRegistrationForm" property="applicantDetails.personalData.gender" value="MALE"><bean:message key="admissionForm.studentinfo.sex.male.text"/></logic:equal>
											<logic:equal name="uniqueIdRegistrationForm" property="applicantDetails.personalData.gender" value="FEMALE"><bean:message key="admissionForm.studentinfo.sex.female.text"/></logic:equal>
											<logic:equal name="uniqueIdRegistrationForm" property="applicantDetails.personalData.gender" value="TRANSGENDER"><bean:message key="admissionForm.studentinfo.sex.transgender.text"/></logic:equal></td><td></td><td></td><td></td>
	   </tr>
	   
	   <tr height="40%">
	     <td>3.</td><td>Date of Birth</td><td>: </td><td><bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.dob"></bean:write></td><td></td><td></td><td></td>
	   </tr>
	   
	   <tr height="40%">
	     <td>4.</td><td>Nationality</td><td>: </td><td><bean:write	name="uniqueIdRegistrationForm" property="applicantDetails.personalData.citizenship" /></td><td></td><td></td><td></td>
	   </tr>
	   
	   <tr height="40%">
	     <td>5.</td><td>Domicile State</td><td>: </td>
	     <td>
	     	<logic:empty property="categoryOther" name="uniqueIdRegistrationForm">
	     		<bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.residentCategoryName" />
	     	</logic:empty>
	     	<logic:notEmpty property="categoryOther" name="uniqueIdRegistrationForm">
	     		<bean:write name="uniqueIdRegistrationForm" property="categoryOther" />
	     	</logic:notEmpty>
	     </td>
	     <td></td><td></td><td></td>
	   </tr >
	   ...
	   <tr height="40%">
	    ...
	    <tr height="40%">
	 	...
	 	<logic:equal value="true" name="uniqueIdRegistrationForm" property="applicantDetails.personalData.isCommunity">	   
	    <tr height="40%">
	     <td>8.</td><td>Malakara Syrian Catholics</td><td>: </td><td>YES,
			<logic:equal value="true" name="uniqueIdRegistrationForm" property="applicantDetails.personalData.isCommunity">
				<bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.parishOthers" /> 
			</logic:equal> 
		</td><td></td><td></td><td></td>
	   </tr></logic:equal>
	   ...
	   <tr height="40%">
	     <td>10.</td><td>Name of Father/Guardian</td><td>: </td><td><bean:write name="uniqueIdRegistrationForm" property="applicantDetails.titleOfFather"/>. 
											<bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.fatherName"></bean:write></td><%--  <td colspan="3">Occupation : 
											<logic:notEmpty name="uniqueIdRegistrationForm"   property="applicantDetails.personalData.fatherOccupation"><bean:write   name="uniqueIdRegistrationForm"   property="applicantDetails.personalData.fatherOccupation" /></logic:notEmpty>
											<logic:notEmpty name="uniqueIdRegistrationForm"   property="applicantDetails.personalData.otherOccupationFather"><bean:write   name="uniqueIdRegistrationForm"   property="applicantDetails.personalData.otherOccupationFather" /></logic:notEmpty></td>--%>
	   </tr>
	   <%--
	   <tr height="40%">
	     <td>10.</td><td>Name of Mother</td><td>: </td><td><nested:write name="uniqueIdRegistrationForm" property="applicantDetails.titleOfMother"/>. 
											<bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.motherName"></bean:write></td><td colspan="3">Occupation : 
											<logic:notEmpty name="uniqueIdRegistrationForm"   property="applicantDetails.personalData.motherOccupation"><bean:write   name="uniqueIdRegistrationForm"   property="applicantDetails.personalData.motherOccupation" /></logic:notEmpty>
											<logic:notEmpty name="uniqueIdRegistrationForm"   property="applicantDetails.personalData.otherOccupationMother"><bean:write   name="uniqueIdRegistrationForm"   property="applicantDetails.personalData.otherOccupationMother" /></logic:notEmpty></td>
	   </tr>
	    
	   <tr height="40%">
	     <td>11.</td><td>Annual Income</td><td>: </td><td><bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.fatherIncome"></bean:write>,
										</td><td></td><td></td><td></td>
	   </tr>
	   --%>
	   <tr height="40%">
	     <td valign="top">11.</td><td valign="top">Permanent Address</td><td valign="top">: </td><td><nested:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.permanentAddressLine1"></nested:write>,
										<nested:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.permanentAddressLine2"></nested:write>,
										<nested:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.permanentCityName"></nested:write>
										</td><td></td><td></td><td></td>
	   </tr>
	   <tr height="40%">
	     <td></td><td></td><td></td><td>
										...
										<nested:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.permanentAddressZipCode"></nested:write></td><td></td><td></td><td></td>
	   </tr>
	   <%--
	   <tr height="40%">
	     <td valign="top">13.</td><td valign="top">Present Address</td><td valign="top">: </td><td><nested:write name="uniqueIdRegistrationForm"  property="applicantDetails.personalData.currentAddressLine1"></nested:write>,
										<nested:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.currentAddressLine2"></nested:write>,
										<nested:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.currentCityName"></nested:write>
										</td><td></td><td></td><td></td>
	   </tr>
	    ...
	    <tr height="40%">
	     <td></td><td></td><td></td><td><bean:write
										...
										<nested:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.currentAddressZipCode"></nested:write></td><td></td><td></td><td></td>
	   </tr>
	   --%>
	   <tr height="40%">
	     <td>12.</td><td>Phone Land</td><td>: </td><td><bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.landlineNo"/></td>
	     <td colspan="3">Mobile : <bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.mobileNo" /></td>
	   </tr>
	   
	   
	   <tr height="40%">
	     <td>13.</td><td>E - Mail</td><td>: </td><td><nested:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.email"></nested:write></td><td></td><td></td><td></td>
	   </tr>
	   
	   <% int num = 13; %>
	    <tr>
	       <td><%=++num%></td><td>Differently abled</td><td>: </td><td>
	   		<logic:equal value="true" name="uniqueIdRegistrationForm" property="applicantDetails.personalData.handicapped">YES, 
	       	<bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.hadnicappedDescription" />(<bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.handicapedPercentage" />%)
	    	</logic:equal>
	    	<logic:equal value="false" name="uniqueIdRegistrationForm" property="applicantDetails.personalData.handicapped">NO
	    	</logic:equal></td>
	    </tr>	    
	                                                      
	   <logic:notEmpty name="uniqueIdRegistrationForm" property="applicantDetails.personalData.sports" >
	   <tr>
	     <td><%=++num%>.</td><td>Participation in Sports</td><td>: </td><td>YES, <bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.sports"/> (<bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.sportsParticipate"/>), <bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.sportsId"/></td>
	  </tr>
	   </logic:notEmpty>
	   <logic:empty name="uniqueIdRegistrationForm" property="applicantDetails.personalData.sports" >
	   <tr>
	     <td><%=++num%>.</td><td>Participation in Sports</td><td>: </td><td>NO</td>
	   </tr>
	   </logic:empty>
	   <logic:notEmpty name="uniqueIdRegistrationForm" property="applicantDetails.personalData.arts" >
	   <tr>
	     <td><%=++num%>.</td><td>Participation in Cultural Activities</td><td>: </td><td>YES, <bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.arts"/> (<bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.artsParticipate"/>)</td>
	   </tr>
	   </logic:notEmpty>
	   <logic:empty name="uniqueIdRegistrationForm" property="applicantDetails.personalData.arts" >
	   ...
	   <logic:notEmpty name="uniqueIdRegistrationForm"  property="applicantDetails.personalData.aadharCardNumber">
	   		<tr>
				<td><%=++num%></td><td>Adhaar card number</td><td>: </td>
			    <td>
		    		<bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.aadharCardNumber"/>
			    </td>
		   </tr>		
	   </logic:notEmpty>
	   
	   <tr>
			<td><%=++num%></td><td>Guardian's name</td><td>: </td>
		    <td>
		    	<logic:notEmpty name="uniqueIdRegistrationForm"  property="applicantDetails.personalData.guardianName">
		    		<bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.guardianName"/>
		    	</logic:notEmpty>		        
		    </td>
	   </tr>
	   <logic:notEmpty name="uniqueIdRegistrationForm"  property="applicantDetails.personalData.guardianRelationShip">
	   		<tr>
				<td><%=++num%></td><td>Guardian's relationship</td><td>: </td>
			    <td>
		    		<bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.guardianRelationShip"/>
			    </td>
		   </tr>
	   </logic:notEmpty>
			    ...
			    <table cellpadding="3" align="center" width="100%" border="1" style="border:1px solid black; border-collapse: collapse ">
			      <tr style="font-size:medium; font-weight: bold">
					<logic:equal value="2" name="uniqueIdRegistrationForm" property="applicantDetails.programType">
						...
						<logic:equal value="true" name="uniqueIdRegistrationForm" property="applicantDetails.isCbscc">
			       ...
			       <logic:equal value="1" name="uniqueIdRegistrationForm" property="applicantDetails.programType">
			          ...
			          <logic:equal value="2" name="uniqueIdRegistrationForm" property="applicantDetails.programType">
			            <logic:iterate id="map" property="applicantDetails.degMap" name="uniqueIdRegistrationForm">
					...
					<tr>
						<logic:equal value="1" name="uniqueIdRegistrationForm" property="applicantDetails.programType">
							<td style="font-size:medium; font-weight: bold" align="right" style="border:1px solid black; border-collapse: collapse ">Total Marks</td>
			          	...
			          	<logic:equal value="2" name="uniqueIdRegistrationForm" property="applicantDetails.programType">
			        		<td colspan="2" style="font-size:medium; font-weight: bold" align="right" style="border:1px solid black; border-collapse: collapse ">Total Marks/CGPA(S)/CCPA(S)</td>
			        		...
			        		<logic:equal value="true" name="uniqueIdRegistrationForm" property="applicantDetails.isCbscc">
					        	<td align="center" style="border:1px solid black; border-collapse: collapse "><bean:write name="uniqueIdRegistrationForm" property="applicantDetails.totalCredit"/></td>
					        </logic:equal>
			         </logic:equal>
		    ...
		    <tr>
			 <td>
			   <table>
			    <logic:equal value="1" name="uniqueIdRegistrationForm" property="applicantDetails.programType">
			     <tr>
			       <td><%=++num%>.</td><td>Second language to be opted for degree</td><td>: </td><td><bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.secondLanguage" /></td>
			     </tr>
			     </logic:equal>
			     <%--
			     <logic:equal value="1" name="uniqueIdRegistrationForm" property="applicantDetails.programType">
			     <tr>
			       <td><%=++num%></td><td> Add-On Course Opted for</td><td>: </td><td><bean:write name="uniqueIdRegistrationForm" property="applicantDetails.addonCourse" /></td>
			    </tr>
			    </logic:equal>
			    --%>
			    <logic:equal value="2" name="uniqueIdRegistrationForm" property="applicantDetails.programType"> 
			     <tr>
			       <td><%=++num%>.</td><td> Course Studied for Degree</td><td>: </td><td><bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.ugcourse" /></td>
			    </tr>
			    </logic:equal>
			   </table>
			    </td>
