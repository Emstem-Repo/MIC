...
<SCRIPT type="text/javascript">
    ...
    function cancelAction() {
    	document.location.href = "StudentSearch.do?method=cancelStudentSearch";
    }
...
<html:form action="/StudentSearch" focus="selectall">
	...
	<html:hidden property="method" styleId="method"
		value="submitSelectedStudentList" />
	...
	<table width="98%" border="0">
		<tr>
			<td><span class="Bredcrumbs"><bean:message
				...
				key="knowledgepro.admission.interviewselectionlist" /> <span
				class="Bredcrumbs">&gt;&gt;<bean:message
				key="knowledgepro.admission.studentsearchresults" />&gt;&gt;</span></span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> <bean:message
						key="knowledgepro.admission.studentsearchresults" /></strong></div>
					</td>
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td height="15" colspan="11" class="row-white">
							...
							<table width="99%" cellspacing="1" cellpadding="2">
								<tbody>
									<tr>
										...
										<div align="right"><a
											href="StudentSearch.do?method=getSelectedCandidatesList"
									...
									<nested:iterate name="studentSearchForm"
										...
										<c:choose>
											<c:when test="${waiting == 3}">
												...
												<tr>
													<td width="1%" class="row-waiting"><%=c %> </td>
													<td width="2%" class="row-waiting">
													<div align="center"><input type="checkbox" id="count"
														name="selectedCandidates" onclick="unCheckSelectAll(this)"
														value='<nested:write name="id" property="admApplnId"/>'></div>
													</td>
													<td width="4%" height="25" class="row-waiting">
													...
													<td width="3%" class="row-waiting">
													<div align="center"><nested:write name="id"
														property="examCenterName" />&nbsp;</div>
													</td>
													<td width="11%" class="row-waiting" align="left"><nested:write name="id" property="shortStatus" /><logic:present name="id" property="shortStatus">  <img src="images/View_icon.gif"
													width="16" height="18"  style="cursor:pointer" 
														onclick="getStatusDetails('<nested:write name='id' property='applicationId'/>', '<bean:write name='studentSearchForm' property='year'/>', '<nested:write name='id' property='selectedCrsId'/>')">
													</logic:present>		
													
													<!-- <div align="center">
													<a href="javascript:void(0)"
														onclick="getStatusDetails('<nested:write name='id' property='applicationId'/>', '<bean:write name='studentSearchForm' property='year'/>', '<nested:write name='id' property='selectedCrsId'/>')">
														<nested:write name="id"	property="shortStatus" /> </a>&nbsp;</div>-->
													</td>	
											...
											<c:otherwise>
												<c:choose>
													<c:when test="${temp == 0}">
														<tr>
														<td width="1%" class="row-even"><%=c %> </td>
															<td width="2%" class="row-even">
													...
													&nbsp;</div>
															...
															<td width="11%" class="row-even" align="left">
															<!-- <div align="center">
													 <a href="javascript:void(0)"
														onclick="getStatusDetails('<nested:write name='id' property='applicationId'/>', '<bean:write name='studentSearchForm' property='year'/>', '<nested:write name='id' property='selectedCrsId'/>')">
														<nested:write name="id"	property="shortStatus" /> </a>&nbsp;</div>-->
															...
															<nested:write name="id" property="shortStatus" />	<logic:present name="id" property="shortStatus"> <img src="images/View_icon.gif"
													width="16" height="18"  style="cursor:pointer" 
														onclick="getStatusDetails('<nested:write name='id' property='applicationId'/>', '<bean:write name='studentSearchForm' property='year'/>', '<nested:write name='id' property='selectedCrsId'/>')">
														</logic:present>							
													</td>
													...
													<a href="javascript:void(0)"
														onclick="getStatusDetails('<nested:write name='id' property='applicationId'/>', '<bean:write name='studentSearchForm' property='year'/>', '<nested:write name='id' property='selectedCrsId'/>')">
														<nested:write name="id"	property="status" /> </a>&nbsp;</div>
															</td>-->
												...
												<img src="images/userIcon.gif"	width="16" height="18"  style="cursor:pointer">
													...
													<c:otherwise>
														<tr>
														<td width="1%" class="row-white"><%=c %> </td>
															<td width="2%" class="row-white">
															<div align="center"><input type="checkbox"
													...
													&nbsp;</div>
															...
															<td width="3%" class="row-white">
															<div align="center"><nested:write name="id"
																property="examCenterName" />&nbsp;</div>
															</td>
													
													<td width="11%" class="row-white" align="left">
