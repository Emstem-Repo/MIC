      ...
      <tr>
        ...
        <td valign="top" class="news"><div align="center">
             ...
             <tr >
              ...
              <logic:iterate property="lateralDetails" id="semId"  type="com.kp.cms.to.admin.ApplicantLateralDetailsTO" name="interviewResultEntryForm" indexId="count">
				<c:choose>
				...
				<tr>
				<td class="row-even" colspan="2" ><div align="center"><bean:write property="lateralUniversityName" name="interviewResultEntryForm" /></div></td>
				<td class="row-even" colspan="2" ><div align="center"><bean:write property="lateralStateName" name="interviewResultEntryForm" /></div></td>
				<td class="row-even" colspan="2" ><div align="center"><bean:write property="lateralInstituteAddress" name="interviewResultEntryForm"/></div></td>
				</tr>  
		         <tr>
