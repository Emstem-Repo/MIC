...
<html:form action="/uncheckGenSmartCard" focus="programType">
	<html:hidden property="method" styleId="method" value="getStudentsDataToUncheck" />	
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt; <bean:message key="knowledgepro.admission.uncheckSmartCardData" /> &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"><bean:message key="knowledgepro.admission.uncheckSmartCardData" /></strong></div>
					</td>
				...
				<tr>
                  ...
                  <tr class="row-white">
                    ...
                    <input type="hidden" id="tempyear" name="tempyear" value="<bean:write name="uncheckGenSmartCardForm" property="academicYear"/>"/>
                <html:select styleId="academicYear"  property="academicYear" name="uncheckGenSmartCardForm" styleClass="combo">
                    ...
                    <td width="20%" class="row-even"> <input type="hidden" id="programType" name="programType" value='<bean:write name="uncheckGenSmartCardForm" property="programTypeId"/>'/>
                <html:select styleId="programTypeId"  property="programTypeId" styleClass="combo" onchange="getPrograms(this.value,'progPref1')">
									...
									<html:optionsCollection name="uncheckGenSmartCardForm" property="programTypeList" label="programTypeName" value="programTypeId"/>
				</html:select></td>
                    ...
                    <td width="30%" class="row-even"><html:select property="programId" styleClass="combo" styleId="progPref1" onchange="getCourse(this.value,'coursePref1')">
									<html:option value="">- Select -</html:option>
									<c:if test="${uncheckGenSmartCardForm.programTypeId != null && uncheckGenSmartCardForm.programTypeId != ''}">
              ...
              <td width="10%" class="row-odd"><div align="right"><bean:message key="knowledgepro.admission.course"/>:</div></td>
                    <td width="20%" class="row-even"><html:select property="courseId" styleClass="comboLarge" styleId="coursePref1">
									<html:option value="">- Select -</html:option>
									<c:if test="${uncheckGenSmartCardForm.programId != null && uncheckGenSmartCardForm.programId != ''}">
                    ...
                    <td width="30%" class="row-even"><html:text	property="regNoTo" styleId="regNoTo" styleClass="TextBox"
								size="20" maxlength="30" /></td>
                  </tr>
              </table>
							</td>
