...
<html:form action="/disciplinaryDetails">
	...
	<html:hidden property="rollRegNo" value="" />
	<html:hidden property="tempApplicationNo" value="" />
                      ...
                      <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
                          <tr >
                            ...
                            <logic:notEmpty name="DisciplinaryDetailsForm" property="displayPercentage">
                            	<td class="row-odd">Attendance Percentage</td>
                            </logic:notEmpty>
                          ...
                          <tr>
                            ...
                            <logic:notEmpty name="DisciplinaryDetailsForm" property="displayPercentage">
                            	<td width="12%" class="row-even" >&nbsp;<nested:write property="totalAggrPer"/>%</td>
                            </logic:notEmpty>
                            ...
                            <td width="11%" class="row-even" align="center"><img src="images/View_icon.gif"
										...
										onclick="getDetailsView('<nested:write property="applicationNo"/>','<nested:write property="registerNo"/>','getDisciplinaryDetails')"></td>
                          	<td width="11%" class="row-even" align="center">
                          	<nested:equal value="true" property="isPhoto">	<img src="images/userIcon.gif"
										width="16" height="18"  style="cursor:pointer">
											</nested:equal></td>
                          </tr>
                          ...
                          <tr >
                            ...
                            <logic:notEmpty name="DisciplinaryDetailsForm" property="displayPercentage">
                            	<td class="row-white" >&nbsp;<nested:write property="totalAggrPer"/>%</td>
                            </logic:notEmpty>
                            <td class="row-white" >&nbsp;<nested:write property="status"/></td>
                            <td width="11%" class="row-white" align="center"><img src="images/View_icon.gif"
										width="16" height="18"  style="cursor:pointer" 
										onclick="getDetailsView('<nested:write property="applicationNo"/>','<nested:write property="registerNo"/>','getDisciplinaryDetails')"></td>
              ...
              <tr>
                <td height="10" class="body" ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <html:submit styleClass="formbutton" property=""  onclick="cancelMe('initDisciplinaryDetails')" >Close</html:submit>
                      </div>
					  </td>
                      <td width="52%"></td>
                    </tr>
