...
<script language="JavaScript">
	function submitExcel() {
		document.getElementById("method").value = "UploadPromoteSubjects";
		var academicYear = document.getElementById("academicYearId").value;
		document.location.href = "promoteSubjects.do?method=UploadPromoteSubjects&academicYear="
				+ academicYear;
	}
...
<html:form action="/promoteSubjects" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method"
		value="UploadPromoteSubjects" />
	<html:hidden property="formName" value="promoteSubjectsUploadForm" />
	<html:hidden property="pageType" styleId="pageType" value="1" />
	<table width="98%" border="0">
		<tr>
			<td><span class="Bredcrumbs">Data Migration <span
				class="Bredcrumbs">&gt;&gt;Promote Subjects &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> Promote Subjects </strong></div>
					</td>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										<tr>
											...
											<td height="25" class="row-even"><label> <html:file
												...
												maxlength="30" name="promoteSubjectsUploadForm" /></label></td>
										</tr>
									</table>
									</td>
