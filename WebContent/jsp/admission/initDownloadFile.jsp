...
<table width="100%" border="0">
  <tr>
    <td><span class="heading"><bean:message	key="knowledgepro.admission" /> <span class="Bredcrumbs">&gt;&gt; Download File &gt;&gt;</span></span></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><strong class="boxheader"> Download File</strong></td>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<tr>
														<td  height="25" class="row-even"
															align=left>Camera Project Files</td>
														<td  height="25" class="row-even"
															align="left"><a href="#" onclick="getDetailForDownload('CameraFilesDownload')"><bean:message key="knowledgepro.reports.submit" /></a></td>
													</tr>
