		  ...
		  <tr>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Remove &nbsp;<img src="images/admission/images/15107-illustration-of-a-red-close-button-pv.png" width="20px"; height="20px"; style="vertical-align:middle;"></a>
						...
						<tr>
                           ...
                           <input type="hidden" id="hiddenHandicaped" name="hiddenHandicaped" value='<bean:write name="applicationEditForm" property="applicantDetails.personalData.handicapped"/>'/>
                           <nested:radio property="applicantDetails.personalData.handicapped" value="true" onclick="showHandicappedDescription()"><bean:message key="knowledgepro.applicationform.yes.label"/></nested:radio>
											...
											<div id="handicapped_description" style="<%=dynaStyle41 %>">
											...
											<div id="handicapped_percentage" style="<%=dynaStyle41 %>">
	                      ...
	                      <td height="35" class="row-even" align="left">
                         <nested:select property="applicantDetails.personalData.sports" styleClass="combo" styleId="sports" onchange="funcSportsShowHide(this.value);">
											<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
                        ...
                        <tr >
                          <td height="20" class="row-odd" ><div align="right">Sports Item</div></td>
	                      <td height="35" class="row-even" align="left">
                        <div align="left">
	          
				<nested:select property="applicantDetails.personalData.sportsId" name="applicationEditForm" styleClass="dropdown" styleId="sportsItem" onchange="showSportsParticipate(this.value);">
				<option value=""><bean:message key="knowledgepro.admin.select"/></option>
				<nested:optionsCollection name="applicationEditForm" property="sportsList" label="name" value="id"/>
				<html:option value="Other">Other</html:option>
				</nested:select>
				<div id="displayOtherSportsItem" style="display: none;">
					&nbsp;<nested:text property="applicantDetails.personalData.otherSportsItem" name="applicationEditForm" size="20" maxlength="20" styleId="otherSportsItem"/>
				</div>
                        ...
                        <tr >
                         ...
                         <nested:select property="applicantDetails.personalData.sportsParticipate" styleClass="combo" styleId="sportsParticipate1">
											<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
											<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
                        ...
                        <tr>		   				
							 <td height="20" class="row-odd" width="40%"><span class="Mandatory">*</span>Apply for Management Quota:
							 </td>
                           	<td height="20" class="row-even" align="left">
           				
             			<nested:radio  property="applicantDetails.personalData.ismgquota"  value="true" ></nested:radio>
							 <label for="mngQuotatrue"><span><span></span></span><bean:message key="knowledgepro.applicationform.yes.label"/></label> 
			
			
			 			<nested:radio  property="applicantDetails.personalData.ismgquota"  value="false" ></nested:radio>
			 			...
			 			<a href="#" title="Enter option for management quota" class="tooltip"><span title="Help"><img alt="" src="images/admission/images/Tooltip_QIcon.png"/></span></a>
							...
							<tr>
							<td  height="20" class="row-odd" width="40%" ><div align="right"><b><font color="red">Do you belong to Malakara Syrian Catholic Church?:<span class="Mandatory">*</span></font></b></div></td>
            			 <td height="20" class="row-even" align="left">
            			 
            			 
           				
           				<fieldset style="border: 0px">
             				<nested:radio styleId="malankara" property="applicantDetails.personalData.isCommunity" name="applicationEditForm" value="true" onclick="enableParish()"></nested:radio>
						  <label for="malankara"><span><span></span></span><bean:message key="knowledgepro.applicationform.yes.label"/></label> 
			
				
			 				<nested:radio styleId="malankara1" property="applicantDetails.personalData.isCommunity" name="applicationEditForm" value="false" onclick="disableParish()"></nested:radio>
						   <label for="malankara1"><span><span></span></span><bean:message key="knowledgepro.applicationform.No.label"/></label> 
			 				<a href="#" title=" Belongs to Malakara catholics" class="tooltip"><span title="Help"><img alt="" src="images/admission/images/Tooltip_QIcon.png"/></span></a>
           				</fieldset>
           				 
						<div align="left" id="parish_description" style="display: none;">
                     			&nbsp;  &nbsp;  Parish:<nested:text property="applicantDetails.personalData.parishOthers" styleClass="textboxmedium"  name="applicationEditForm" size="10" maxlength="30" styleId="otherParish" ></nested:text>
						</div>				
   	...
   	<c:if test="${applicationEditForm.applicantDetails.personalData.religionId != null && applicationEditForm.applicantDetails.personalData.religionId == '3'}">
					 ...
					 <tr id="dioces_description" style="display: block;">
              			 ...
              			 <nested:text property="applicantDetails.personalData.parishOthers" size="10" maxlength="30" styleId="otherDiocese" ></nested:text>
								...
								<nested:radio property="applicantDetails.personalData.gender" value="FEMALE"><bean:message key="admissionForm.studentinfo.sex.female.text"/></nested:radio>
			 					<nested:radio property="applicantDetails.personalData.gender" value="TRANSGENDER"></nested:radio>
								...
								<html:optionsCollection property="secondLanguageList"
									label="value" value="value" />
										...
										<tr>
											<td height="20" class="row-odd">
											<div align="right"><bean:message
												key="admissionForm.studentinfo.aadhaarNumber" /></div>
											</td>
											<td height="20" class="row-even" align="left">
												<nested:text property="applicantDetails.personalData.aadharCardNumber" size="15" maxlength="50"></nested:text> <br />
											</td>
										</tr>
									</table>
									</td>
										...
										%>
											<c:choose>
												<c:when test="${temp == 0}">
													...
													<c:choose>
													<c:when test="${applicationEditForm.applicantDetails.appliedYear>2015}">
													<c:choose>
													...
													<td  class="row-even" ><div align="center" class="body"><span class="Mandatory">*</span><a href="#" onclick="detailSubmitpg('<%=qualId %>')" >Detailed Marks Edit</a></div></td>
													</c:when>
													<c:when test="${ednQualList.docName=='PG'}">
													<td  class="row-even" ><div align="center" class="body"><span class="Mandatory">*</span><a href="#" onclick="detailSubmitpg('<%=qualId %>')" >Detailed Marks Edit</a></div></td>
													</c:when>
													...
													<c:choose>
													<c:when test="${ednQualList.docName=='Class 12'}">
													<td  class="row-even"><div align="center" class="body"><span class="Mandatory">*</span><a href="#" onclick="detailSubmit12('<%=qualId %>')" >Detailed Marks Edit</a></div></td>
													</c:when>
													<c:when test="${ednQualList.docName=='DEG'}">
													<td  class="row-even" ><div align="center" class="body"><span class="Mandatory">*</span><a href="#" onclick="detailSubmitdeg('<%=qualId %>')" >Detailed Marks Edit</a></div></td>
													</c:when>
													<c:when test="${ednQualList.docName=='Class 10'}">
													<td  class="row-even" ><div align="center" class="body"><span class="Mandatory">*</span><a href="#" onclick="detailSubmit('<%=qualId %>')" >Detailed Marks Edit</a></div></td>
													</c:when>
												...
												<c:otherwise>
													...
													<td class="row-white">
														...
														<%String detailMarkLink="applicationEdit.do?method=initDetailMarkEditPage&editcountID="+qualId; %>
														<div align="center"><a href="#" onclick="detailSubmit12('<%=qualId %>')">Detailed Marks Edit</a></div>
														</td>
													...
													<td class="row-white">
														...
														<%String detailMarkLink="applicationEdit.do?method=initDetailMarkEditPage&editcountID="+qualId; %>
														<div align="center"><a href="#" onclick="detailSubmitdeg('<%=qualId %>')">Detailed Marks Edit</a></div>
														</td>
								...
								<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<tr>
											...
											<td height="30" class="row-even" align="left">
												<nested:text styleId="motherMobile" property="applicantDetails.personalData.guardianName"></nested:text>												
                               			  	</td>
										</tr>
										...
										<tr>
											...
											<td height="30" class="row-even" align="left">
												<nested:text styleId="motherMobile" property="applicantDetails.personalData.guardianRelationShip" ></nested:text>												
                               			  	</td>
										</tr>
