...
<html:form action="/studentTranscriptPrint" >
	...
	<logic:equal name="studentTranscriptPrintForm" property="noPrefixFound" value="NO">
	<logic:notEmpty name="studentTranscriptPrintForm" property="semesterList">
	
		<logic:iterate id="MainMap" name="studentTranscriptPrintForm" property="semesterList" indexId="count">
			...
			<table width="100%" cellspacing="1" cellpadding="2" class="row-white">
					...
					<tr>
						<td align="left" valign="top">
							No.: <bean:write name="studentTranscriptPrintForm" property="transcriptNo"/>
						</td>
					</tr>
					<tr>
						<td align="left" valign="top">
					...
					<tr>
						...
						<td colspan="2">
							<table width="98%">
								...
								<tr>
									<td class="score"><B><bean:write name="studentTranscriptPrintForm" property="studentCourse"/></B> Post Graduation Course</td>
								</tr>
								<tr>
						...
						<td colspan="2">
							...
							<tr height="21px">
								...
								<tr height="21px">
									...
									<td align="center" class="score"></td>
									<td align="center" class="score">
									<b><bean:write name="mto" property="totalMaxMarks"/></b>
									</td>
									<td align="center" class="score">
									<b><bean:write name="mto" property="totalMaxMarksAwarded"/></b>
									</td>
									<td align="center" class="score">
									</td>
									<td align="center" class="score">
			...
			<logic:equal name="studentTranscriptPrintForm" property="noPrefixFound" value="YES">
				<table width="100%" height="435px" align="center">
					<tr>
						<td align="center" valign="middle">
