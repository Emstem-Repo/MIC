...
function searchDetails(){		
	document.getElementById("method").value="searchCopyCheckList";
}
...
function copySelected(){
	document.getElementById("method").value="copyCheckList";
}
function cancelAction() {
	document.location.href = "copyCheckList.do?method=initCopyCheckList";
}
</script>
<html:form action="/copyCheckList" method="post">
	<html:hidden property="method" styleId="method" />
	<html:hidden property="formName" value="copyCheckListForm" />
	...
	<table width="100%" border="0">
		<tr>
			...
			<bean:message key="knowledgepro.admission.copyCheckList"/>
			 &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td valign="top">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="body"><strong
						class="boxheader"> <bean:message key="knowledgepro.admission.copyCheckList"/> Entry</strong></td>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<td width="30%" class="row-even"><input type="hidden"
										id="yr" name="yr"
										value='<bean:write name="copyCheckListForm" property="fromYear"/>' />
									<html:select property="fromYear"
										styleId="fromYearId" styleClass="combo" onchange="getCheckList(this.value)">
										<html:option value="">
									...
									<td width="30%" class="row-even"><input type="hidden"
										id="toyrId" name="toyr"
										value='<bean:write name="copyCheckListForm" property="toYear"/>' />
				...
				<logic:notEmpty name="copyCheckListForm" property="displayCheckList">	
				<tr>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<nested:iterate id="cList" name="copyCheckListForm" property="displayCheckList"
											indexId="count">
										<tr>
											<c:choose>
											...
											<td width="6%" height="25" class="row-even">
															...
															<td width="9%" class="row-even">
																<div align="center">
																<nested:checkbox  property="checkListSel" styleId="selectedId" onclick="setSelectedCandidatesCount();unCheckSelectAll(this)"></nested:checkbox>
																</div>
															</td>
															<td width="20%" class="row-even" align="center"><bean:write
																name="cList" property="courseTo.programTo.programTypeTo.programTypeName" /></td>
															<td width="41%" height="25" class="row-even"
																align="center"><bean:write name="cList"
																property="courseTo.programTo.name" /></td>
															<td width="15%" class="row-even" align="center"><bean:write
																name="cList" property="courseTo.code" /></td>	
															<td width="15%" class="row-even" align="center"><bean:write
																name="cList" property="combinedYear" /></td>
											</tr>	
										</nested:iterate>
