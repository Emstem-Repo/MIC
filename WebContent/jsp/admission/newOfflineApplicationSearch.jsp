...
<html:form action="/admissionFormSubmit" method="post" focus="applicationNumber">
	<html:hidden property="method" value="loadInitOfflineApplicationForm" />
	<html:hidden property="formName" value="admissionFormForm" />
	<html:hidden property="pageType" value="23" />
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								<tr>
									...
									<td class="row-even">
										...
										<input type="hidden" id="tempyr" name="tempyr" value='<c:out value="${tempyr}"></c:out>'/>
...
<script type="text/javascript">
	...
	var yr = document.getElementById("tempyr").value;
	if (year.length != 0) {
