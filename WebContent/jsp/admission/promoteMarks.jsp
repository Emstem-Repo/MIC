...
<script language="JavaScript">
	function submitExcel() {
		document.getElementById("method").value = "promoteMarksUpload";
		var academicYear = document.getElementById("academicYearId").value;
		document.location.href = "promotemarks.do?method=promoteMarksUpload&academicYear="
				+ academicYear;
	}
...
<html:form action="/promotemarks" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="promoteMarksUpload" />
	...
	<table width="98%" border="0">
		<tr>
			<td><span class="Bredcrumbs">Data Migration <span
				class="Bredcrumbs">&gt;&gt;Promote Marks &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader">Promote Marks</strong></div>
					</td>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										<tr>
											...
											<td height="25" class="row-even"><label> <html:file
												...
												maxlength="30" name="promoteMarksUploadForm" /></label></td>
										</tr>
									</table>
									</td>
