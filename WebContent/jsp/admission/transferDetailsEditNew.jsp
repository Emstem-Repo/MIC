      ...
      <tr>
        ...
        <td valign="top" class="news"><div align="center">
             ...
             <tr >
              ...
              <nested:iterate property="transferDetails" id="semId"  type="com.kp.cms.to.admin.ApplicantTransferDetailsTO" name="applicationEditForm" indexId="count">
				<%
					String dynaStyle="";
					if(count%2==0)
						dynaStyle="row-even";
				...
				<logic:equal value="false" property="admissionEdit" name="applicationEditForm">
                  ...
                  <tr>
                    <td width="45%" height="35"><div align="right">
                        <html:button property="" onclick="submitAdmissionFormNew('submitTransferEditEntry')" styleClass="formbutton" value="Submit"></html:button>
                    </div></td>
