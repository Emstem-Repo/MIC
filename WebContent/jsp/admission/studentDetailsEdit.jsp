...
function updateParish(req){
	updateOptionsFromMapWithOther(req,"parish","-Select-");
...
function editSubjectGroup(){
	...
	function detailSubmit(count,docname)
	{
		//alert(docname);
...
<html:form action="/studentEdit" enctype="multipart/form-data"
	method="POST">
	<html:hidden property="docname" value="" styleId="docname"/>
	...
	<input type="hidden" name="courseId"
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<table width="100%" height="22" border="0" cellpadding="0"
										...
										<tr class="row-white">
											...
											<td height="20" class="row-even" align="left">&nbsp;<nested:text
												name="studentEditForm" property="regNo" size="20"
										...
										<tr>
											...
											<td height="20" class="row-even" align="left">&nbsp;<nested:text
												...
												<td height="20" class="row-even" align="left">&nbsp;<nested:text
													...
													size="25" maxlength="15"></nested:text> </td>
												<td height="20" class="row-odd">
												<div align="right"><bean:message
										...
										<td height="20" colspan="5" class="row-even" align="left"><div align="left">
										<nested:text
				...
				<nested:select property="applicantDetails.personalData.sportsId" name="studentEditForm" styleClass="dropdown" styleId="sportsItem" onchange="showSportsParticipate(this.value);">
				<option value=""><bean:message key="knowledgepro.admin.select"/></option>
				<nested:optionsCollection name="studentEditForm" property="sportsList" label="name" value="id"/>
				<html:option value="Other">Other</html:option>
				</nested:select>
				<div id="displayOtherSportsItem" style="display: none;">
					&nbsp;<nested:text property="applicantDetails.personalData.otherSportsItem" name="studentEditForm" size="20" maxlength="20" styleId="otherSportsItem"/>
				</div>
						...
						<tr>		   				
							 <td height="20" class="row-odd" align="right" width="40%"><span class="Mandatory">*</span>Apply for Management Quota:
							 </td>
                           	<td height="20" class="row-even" align="left">
            			 ...
            			 <td height="20" class="row-even" align="left">
           				...
           				<fieldset style="border: 0px">
             				<nested:radio styleId="malankara" property="applicantDetails.personalData.isCommunity" name="studentEditForm" value="true" onclick="enableParish()"></nested:radio>
						  <label for="malankara"><span><span></span></span><bean:message key="knowledgepro.applicationform.yes.label"/></label> 
			
				
			 				<nested:radio styleId="malankara1" property="applicantDetails.personalData.isCommunity" name="studentEditForm" value="false" onclick="disableParish()"></nested:radio>
						...
						<div align="left" id="parish_description" style="display: none;">
                     			&nbsp;  &nbsp;  Parish:<nested:text property="applicantDetails.personalData.parishOthers" styleClass="textboxmedium"  name="studentEditForm" size="10" maxlength="30" styleId="otherParish" ></nested:text>
						</div>			
						</td>
							</tr>
                        ...
                        <tr>
                         ...
                         <tr>
                           ...
                           <td height="17" class="row-even" align="left">
                           <input type="hidden" id="hiddenHandicaped" name="hiddenHandicaped" value='<bean:write name="studentEditForm" property="applicantDetails.personalData.handicapped"/>'/>
                           <nested:radio property="applicantDetails.personalData.handicapped" value="true" onclick="showHandicappedDescription()"><bean:message key="knowledgepro.applicationform.yes.label"/></nested:radio>
                         			...
                         			<nested:select property="applicantDetails.personalData.sports" styleClass="combo" styleId="sports">
											<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
											<html:option value="National Level">International Level</html:option>
											<html:option value="National Level">National Level</html:option>
											<html:option value="State Level">State Level</html:option>
											<html:option value="Participated">Inter college Level</html:option>
											<html:option value="District Level">District Level</html:option>
								...
								<tr>
									...
									<table width="99%" cellspacing="1" cellpadding="2">
										<tr>
											...
											<div align="right"><span class="Mandatory">*</span>Student Native_State</div>
											</td>
					...
					<c:if test="${studentEditForm.applicantDetails.personalData.religionId != null && studentEditForm.applicantDetails.personalData.religionId !='Other' && studentEditForm.applicantDetails.personalData.religionId == 3}">
								...
								<tr>
									...
									<table width="100%" height="90" border="0" cellpadding="0"
										...
										<tr class="row-white">
											...
											<div align="right"><span class="Mandatory"></span>House_Name/House_Number</div>
											</td>
											...
											<td width="224" class="row-odd">
											<div align="right">Post Office Name</div>
											</td>
						...
						<tr>
													...
													<tr>
														...
														<logic:equal value="false" property="consolidated"
															...
															<logic:equal value="false" property="semesterWise"
																...
																%>
																<div align="center"><a href="#"
																	onclick="detailSubmit('<%=qualId%>','<bean:write name="ednQualList" property="docName" />')">Detailed
																Marks Edit</a></div>
																</td>
							...
							<nested:select property="applicantDetails.personalData.ugcourse" styleClass="comboLarge" styleId="ugcourse">
									...
									<%-- 	<logic:equal value="false" property="viewextradetails" name="studentEditForm">
										...
										<td class="row-even" colspan="6">
										<html:select name="studentEditForm" property="applicantDetails.personalData.groupofStudy">
										 <html:option value="" key="knowledgepro.admin.select"></html:option>
										...
										<tr>
											...
											<nested:select property="applicantDetails.titleOfFather" styleId='titleOfFather' styleClass="comboMedium" style="max-width:15%;">
												<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
								              	...
								              	<html:option value="Mr">Fr.</html:option>
											</nested:select>
											<nested:text
								...
								<tr>
									...
									<table width="100%" height="107" border="0" cellpadding="0"
										...
										<tr class="row-white">
											...
											<div align="right">House Name/House Number:</div>
											</td>
											...
											<td height="20" class="row-white" align="left"></td>
										</tr>
								...
								<tr>
									...
									<table width="100%" border="0" align="center" cellpadding="0"
										...
										<tr>
											...
											<table width="100%" cellspacing="1" cellpadding="2">
												<tr>
													<td colspan="2" class="heading">InActive</td>

													<td colspan="2" class="heading"><html:radio
														property="isInactive" value="true"
														styleId="inactiveRadio"/> Yes<html:radio
														property="isInactive" value="false"
														styleId="inactiveRadio1" onclick="validateInactiveDetails()"/>No</td>
													<td class="heading"></td>
													<td colspan="3" class="heading">
													<div align="right"></div>
													</td>
												...
												<tr>
													...
													<table width="82" border="0" cellspacing="0"
														...
														<tr>
															...
															<div align="left"><html:text
																...
																styleId="inactiveDate" maxlength="10" ></html:text></div>
															</td>
															<td width="40"><script language="JavaScript">
													new tcal( {
														// form name
													...
													<td width="21%" class="row-even"><html:textarea
														property="inactiveReasons"
														styleId="inactiveReasons"
														onkeypress="return imposeMaxLength(event,this.value)" ></html:textarea>
