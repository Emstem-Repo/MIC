...
function cancelAction() {
	document.location.href = "FinalMeritListApprove.do?method=initFinalMeritList";
}
...
<html:form action="/FinalMeritListApprove">

	<html:hidden property="method" styleId="method"
		value="approveSelectedList" />
<div style="overflow: auto; width: 800px;">
	<table width="98%" border="0">
		<tr>
			<td><span class="heading"><a href="AdminHome.do"
				class="Bredcrumbs"><bean:message key="knowledgepro.admission" /></a>
			<span class="Bredcrumbs">&gt;&gt;<bean:message
				key="knowledgepro.admission.finalmeritlist" /> &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
						...
						<tr>
							...
							<table width="99%" cellspacing="1" cellpadding="2">
								...
								<tr>
									...
									<td class="row-even"><bean:write name="finalMeritListForm"
								...
								<tr>
									...
									<div align="center"><bean:message
										key="knowledgepro.admission.approve" /><br>
										...
										<c:when test="${waiting == 3}">
											<tr>
												...
												<div align="center"><input type="checkbox" id="count"
													...
													value='<nested:write name="id" property="finalMeritSetId"/>'></div>
												</td>
												<td width="10%" height="25" class="row-waiting">
												<div align="center">
												<a href="javascript:void(0)"
													onclick="getDetails('<nested:write name='id' property='applicationId'/>', '<bean:write name='finalMeritListForm' property='year'/>' ,'<bean:write name='finalMeritListForm' property='courseId'/>')">
													<nested:write name="id"	property="applicationId" /> </a></div>
												</td>
											...
											<c:choose>
												...
												<c:when test="${temp == 0}">
													...
													<div align="center"><nested:write name="id"
														...
														<td style="width:50px;" class="row-even">
														<div align="center"><nested:write name="id"
															property="preRequisiteType" />&nbsp;</div>
														</td>
														<td style="width:50px;" class="row-even">
												...
												<c:otherwise>
													...
													<div align="center"><nested:write name="id"
														...
														<td style="width:50px;" class="row-white">
														<div align="center"><nested:write name="id"
															property="preRequisiteType" />&nbsp;</div>
														</td>
														<td  style="width:50px;" class="row-white">
