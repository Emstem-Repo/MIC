...
<table width="98%" border="0">
  <tr>
    <td><span class="Bredcrumbs"><bean:message key="knowledgepro.admission"/><span class="Bredcrumbs">&gt;&gt; <bean:message key="knowledgepro.admission.semester"/> &gt;&gt;</span></span></td>
  </tr>
  <tr>
        ...
        <td valign="top" class="news"><div align="center">
              ...
              <tr>
                   <td height="35" colspan="6" class="body" ><table width="100%" cellspacing="1" cellpadding="2">
                     <c:if test="${admissionFormForm.isLanguageWiseMarks == 'false'}">
					 	<tr>
					 		<td colspan="4">
                     ...
                     <tr>
						<td class="row-odd" ><div align="center"><bean:message key="knowledgepro.admission.semestername"/> </div></td>
						<c:if test="${admissionFormForm.isLanguageWiseMarks == 'true'}">
 						...
 						<c:choose>
				 	<c:when test="${admissionFormForm.isLanguageWiseMarks == 'true'}">
                ...
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="45%" height="35"><div align="right">
                        <html:button property="" onclick="submitAdmissionForm('submitSemesterMark')" styleClass="formbutton" value="Submit"></html:button>
                    </div></td>
