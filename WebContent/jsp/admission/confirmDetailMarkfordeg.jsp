                   ...
                   <td height="35" colspan="6" class="body" ><table width="70%" cellspacing="1" cellpadding="2" align="center">
					 ...
					 <tr class="OTHER">
						...
						<%if(count<1){%>
										 ...
										 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=slno%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="2" >Core</font></td>
										  <td width="25%" height="25" class="row-even">
										 <nested:select property="<%=degsub%>" styleId='<%="degsub_"+count%>' name="admissionFormForm">
					 ...
					 <td width="25%" height="25" class="row-even">
										 ...
										 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;6&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="2" >Open Course</font></td>
										  <td width="25%" height="25" class="row-even">
										 <nested:select property="degsubid_14" name="admissionFormForm">
                    						<html:option value="">--Select--</html:option>
                     ...
                     <div align="center"><nested:text property="degmaxcgpa_14" size="6" styleId="degmaxcgpa_14" maxlength="6" name="admissionFormForm" onkeypress='validate(event)' onblur="updateobtainedMarkForRank()" ></nested:text></div></td>
                        	...
                        	<tr class="CBCSS">
										...
										<td width="25%" height="25" class="row-even">
								 <nested:select property="degsubid_4" styleId="degsubid_4" name="admissionFormForm">
                    						<html:option value="">--Select--</html:option>
						   					...
						   					<td width="15%" height="25" class="row-even">
                     <div align="center"><nested:text property="degobtainedmark_4" size="6"  maxlength="6" name="admissionFormForm" onkeypress='validate(event)' onblur="updateobtainedMarkForRank1()" ></nested:text></div></td>
						  <td width="15%" height="25" class="row-even">
						    <div align="center"><nested:text property="degmaxmark_4" size="6"  maxlength="6" name="admissionFormForm" onkeypress='validate(event)' onblur="updatetotalMarkForRank1()" ></nested:text></div></td>
						 
                     
                      <td width="15%" height="25" class="row-even">
                   
                     <div align="center"><nested:text property="degmaxcgpa_4" size="6" styleId="degmaxcgpa_4" maxlength="6" name="admissionFormForm" onkeypress='validate(event)' onblur="updateobtainedMarkForRank()" ></nested:text></div></td>
						...
						<tr class="OTHER">
							...
							%>
										 ...
										 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=slno%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="2" >Main</font></td>
										  <td width="25%" height="25" class="row-even">
										 <nested:select property="<%=degsub%>" styleId='<%="degsub_"+cnt%>' name="admissionFormForm">
                    						<html:option value="">--Select--</html:option>
                    							<logic:notEmpty property="admCoreMap" name="admissionFormForm">
						   							<html:optionsCollection property="admCoreMap" styleClass="comboLarge" label="value" value="key"/>
						   						</logic:notEmpty>
					...
					<td width="25%" height="25" class="row-even">
										...
										<td width="25%" height="25" class="row-even">
								 <nested:select property="degsubid_8" styleId="degsubid_8" name="admissionFormForm">
                    						<html:option value="">--Select--</html:option>
                    							<logic:notEmpty property="admSubMap" name="admissionFormForm">
						   							<html:optionsCollection property="admSubMap" styleClass="comboLarge" label="value" value="key"/>
						   						</logic:notEmpty>
					...
					<td width="15%" height="25" class="row-even">
                     <div align="center"><nested:text property="degobtainedmark_8" size="6" styleId='degobtainedmark_8' maxlength="6" name="admissionFormForm" onkeypress='validate(event)' onblur="updateobtainedMarkForRank1()" ></nested:text></div></td>
						 
                      <td width="15%" height="25" class="row-even">
                     <div align="center"><nested:text property="degmaxmark_8" size="6" styleId="degmaxmark_8" maxlength="6" name="admissionFormForm" onkeypress='validate(event)' onblur="updatetotalMarkForRank1()" ></nested:text></div></td>
