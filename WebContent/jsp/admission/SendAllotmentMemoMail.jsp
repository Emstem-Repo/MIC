...
<html:form action="/sendAllotmentMemoSms">
	<html:hidden property="method" value="SendingAllotmentMemoMail" />
	...
	<table width="98%" border="0">
		<tr>
			...
			Allotment Or Chance Memo Mail &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td width="935" colspan="2" background="images/Tcenter.gif"
						class="body">
					<div align="left"><strong class="boxheader"> Allotment Or Chance Memo Mail</strong></div>
					</td>
