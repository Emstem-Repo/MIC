...
<script type="text/javascript">
	...
	function submitModifyCancelButtonForPUCNew() {
		document.location.href="applicationEdit.do?method=initApplicationEdit&PUCEdit=true";
	}
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="51%" height="45" align="left"><html:button
										...
										onclick="submitModifyCancelButtonForPUCNew()">
