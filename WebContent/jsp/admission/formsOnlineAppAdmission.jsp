...
<html:form action="/admissionFormsOnline" method="post">
	...
	<table  width="100%" border="0"  cellpadding="3" cellspacing="0" bordercolor="#E0DFDB">
		<tr><td align="right" style="padding-right: 85px">Application No.<%-- <bean:write name="admissionFormForm" property="applicantDetails.applnNo" /> --%></td></tr>
		<tr>
			<td>
		...
		<tr>
			<td>
				<table width="100%" border="1"  cellpadding="3" cellspacing="0">
					<tr><td width="5%" rowspan="3"><%=++num%>.</td><td width="35%"> Name</td><td><bean:write name="admissionFormForm" property="applicantDetails.personalData.firstName"/></td></tr>
					<tr><td width="35%">Gender</td><td><bean:write name="admissionFormForm" property="applicantDetails.personalData.gender"/></td></tr>
					...
					<tr><td><%=++num%>.</td><td>Whether child of Ex-service Personnel or Jawan </td><td>
						...
						<logic:equal value="false" name="admissionFormForm" property="applicantDetails.personalData.exservice">
							No
						</logic:equal>
					</td></tr>
					<tr><td><%=++num%>.</td><td>a) If Member of N.C.C., details of Certificate holding<br>
						...
						<logic:notEqual value="true" name="admissionFormForm" property="applicantDetails.personalData.ncccertificate">NA</logic:notEqual>
						<br>
						<logic:equal value="true" name="admissionFormForm" property="applicantDetails.personalData.nsscertificate">Yes </logic:equal>
						<logic:notEqual value="true" name="admissionFormForm" property="applicantDetails.personalData.nsscertificate">NA</logic:notEqual>
						<br>
						<logic:equal value="true" name="admissionFormForm" property="applicantDetails.personalData.spc">Yes</logic:equal>
						<logic:notEqual value="true" name="admissionFormForm" property="applicantDetails.personalData.spc">NA</logic:notEqual>
						<br>
						<logic:equal value="true" name="admissionFormForm" property="applicantDetails.personalData.scouts">Yes</logic:equal>
						<logic:notEqual value="true" name="admissionFormForm" property="applicantDetails.personalData.scouts">No</logic:notEqual>
					</td></tr>
					...
					<tr><td><%=++num%>.</td><td>If sports person, of which level</td><td>
						<logic:notEmpty name="admissionFormForm" property="applicantDetails.personalData.sports" >
						 <bean:write name="admissionFormForm" property="applicantDetails.personalData.sports"/>
						</logic:notEmpty>
					...
					<tr><td><%=++num%>.</td><td>Whether differently abled</td><td>
	    				...
	    				<logic:notEqual value="true" name="admissionFormForm" property="applicantDetails.personalData.handicapped">
	    					No
	    				</logic:notEqual>
					</td></tr>
					...
					<tr><td><%=++num%>.</td><td>Religion & Caste <br>If Catholic, state whether Malankara Catholic <!-- If Catholic, state whether --> </td><td>
						<%-- <bean:write name="admissionFormForm" property="applicantDetails.personalData.casteCategory"/> --%>
						<bean:write name="admissionFormForm" property="applicantDetails.personalData.religionName" />,
						<bean:write name="admissionFormForm" property="applicantDetails.personalData.casteCategory" />	
					...
					<!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
					<!-- <b>Core course (Main Subject)</b><br> -->
					<logic:iterate id="preflist" name="admissionFormForm" property="certicateCoursesPrint" indexId="count">
			...
			<tr>
			    ...
			    <table cellpadding="3" align="center" width="100%" border="1" style="border:1px solid black; border-collapse: collapse ">
			      <tr style="font-size:small; font-weight: bold">
					<logic:equal value="2" name="admissionFormForm" property="applicantDetails.programType">
						...
						<logic:equal value="true" name="admissionFormForm" property="applicantDetails.isCbscc">
					...
					<tr>
						<logic:equal value="1" name="admissionFormForm" property="applicantDetails.programType">
			          	...
			          	<logic:equal value="2" name="admissionFormForm" property="applicantDetails.programType">
			        		...
			        		<logic:equal value="true" name="admissionFormForm" property="applicantDetails.isCbscc">
					        	<td align="center" style="border:1px solid black; border-collapse: collapse "><bean:write name="admissionFormForm" property="applicantDetails.totalCredit"/></td>
					        </logic:equal>
			         </logic:equal>
			  ...
			  <td align="center"><div style="border: 1px solid black;height: 150px;width: 125px;" ><br><br><br>Affix Photograph of the candidate(mandatory)</div></td>
					...
					<tr><td><%=++num%>.</td><td>Name with initials expanded</td><td>
						...
						<bean:write name="admissionFormForm" property="applicantDetails.personalData.nameWithInitial"/>
						<logic:empty  name="admissionFormForm" property="applicantDetails.personalData.nameWithInitial">
							NA
						</logic:empty>
					</td></tr>
					...
					<br>(d) Place of birth, Taluk and District. &nbsp;&nbsp;
					</td><td><bean:write name="admissionFormForm" property="applicantDetails.personalData.dob"/><br>
						<bean:write name="admissionFormForm" property="applicantDetails.personalData.citizenship"/>
						<bean:write name="admissionFormForm" property="applicantDetails.personalData.motherTonge"/>
						<br><html:hidden name="admissionFormForm" styleId="dob" property="applicantDetails.personalData.dob"/>
						<script>
						var date1 = new Date();
						...
						<br><bean:write name="admissionFormForm" property="applicantDetails.personalData.placeOfBirth"/>,
						<bean:write name="admissionFormForm" property="applicantDetails.personalData.thaluk"/>,
						<bean:write name="admissionFormForm" property="applicantDetails.personalData.district"/>
					...
					<tr><td><%=++num%>.</td><td>Reason for break of study, if any</td><td>
						<bean:write name="admissionFormForm" property="applicantDetails.personalData.reasonFrBreakStudy"/>
						<logic:empty name="admissionFormForm" property="applicantDetails.personalData.reasonFrBreakStudy">
							NA
						</logic:empty>
					</td></tr>
					<tr><td width="5%"><%=++num%>.</td><td width="35%">a) If any of the parents of the applicant was a student of this College, give details, including present address.</td><td>
						...
						<bean:write name="admissionFormForm" property="applicantDetails.personalData.parentOldStudent"/>
						<logic:empty name="admissionFormForm" property="applicantDetails.personalData.parentOldStudent">
							NA
						</logic:empty>
					</td></tr>
					...
					<tr><td>b)</td><td>b)Whether the applicant is related to any former student (s) of this College. If so give details including present address.</td><td>
						...
						<bean:write name="admissionFormForm" property="applicantDetails.personalData.relativeOldStudent"/>
						<logic:empty name="admissionFormForm" property="applicantDetails.personalData.relativeOldStudent">
							NA
						</logic:empty>
					</td></tr>
					<tr><td width="5%"><%=++num%>.</td><td width="35%">Does the applicant receive any military or other concession or scholarship - Specify</td><td>
						...
						<bean:write name="admissionFormForm" property="applicantDetails.personalData.scholarship"/>
						<logic:empty name="admissionFormForm" property="applicantDetails.personalData.scholarship">
							NA
						</logic:empty>
					</td></tr>
		...
		<td>
			...
			<tr><td width="10%">1.</td><td>I <bean:write name="admissionFormForm" property="applicantDetails.personalData.firstName"/>  S/o. D/o. of <bean:write name="admissionFormForm" property="applicantDetails.titleOfFather"/>. 
											<bean:write name="admissionFormForm" property="applicantDetails.personalData.fatherName"/> have carefully read and fully understood the law prohibiting ragging and the directions of the Supreme Court and 
			...
			<tr height="15px"></tr>
			<tr><td colspan="2">Name : <bean:write name="admissionFormForm" property="applicantDetails.personalData.firstName"/></td></tr>
			<tr height="15px"></tr>
			<tr><td colspan="2">Address : <bean:write name="admissionFormForm" property="applicantDetails.personalData.permanentAddressLine1"/>,&nbsp;
								<bean:write name="admissionFormForm" property="applicantDetails.personalData.permanentAddressLine2"/>,&nbsp;
								<bean:write name="admissionFormForm" property="applicantDetails.personalData.permanentCityName"/>,&nbsp;
								<bean:write name="admissionFormForm" property="applicantDetails.personalData.permanentAddressZipCode"/>,&nbsp;
								<bean:write name="admissionFormForm" property="applicantDetails.personalData.permanentStateName"/>,&nbsp;
								<bean:write name="admissionFormForm" property="applicantDetails.personalData.permanentCountryName"/>,&nbsp;</td></tr>
			</table>
		...
		<td>
			...
			<tr><td>1.</td>
			<td>I <bean:write name="admissionFormForm" property="applicantDetails.titleOfFather"/>. 
				<bean:write name="admissionFormForm" property="applicantDetails.personalData.fatherName"/>
				F/o. M/o. G/o.<bean:write name="admissionFormForm" property="applicantDetails.personalData.firstName"/>
			...
			<tr><td colspan="2">Signature</td></tr>
			<tr height="15px"></tr>
			<tr><td colspan="2">Name : <bean:write name="admissionFormForm" property="applicantDetails.personalData.fatherName"/></td></tr>
			<tr height="15px"></tr>
			<tr><td colspan="2">Address :<bean:write name="admissionFormForm" property="applicantDetails.personalData.permanentAddressLine1"/>,&nbsp;
								<bean:write name="admissionFormForm" property="applicantDetails.personalData.permanentAddressLine2"/>,&nbsp;
								<bean:write name="admissionFormForm" property="applicantDetails.personalData.permanentCityName"/>,&nbsp;
								<bean:write name="admissionFormForm" property="applicantDetails.personalData.permanentAddressZipCode"/>,&nbsp;
								<bean:write name="admissionFormForm" property="applicantDetails.personalData.permanentStateName"/>,&nbsp;
								<bean:write name="admissionFormForm" property="applicantDetails.personalData.permanentCountryName"/>,&nbsp;</td></tr></td></tr>
			</table>
