			...
			<td>
				<table width="100%" border="1"  cellpadding="3" cellspacing="0">
					...
					<tr><td><%=++num%>.</td><td>a) If Member of N.C.C., details of Certificate holding<br>
						...
						<logic:notEqual value="true" name="admissionStatusForm" property="applicantDetails.personalData.scouts">Yes</logic:notEqual>
					</td></tr>
					...
					<tr><td><%=++num%>.</td><td>Name of qualifying Examination passed</td><td>
						...
						<logic:equal value="DEG" name="ednQualList" property="docName">
							<bean:write name="admissionStatusForm" property="applicantDetails.personalData.ugcourse" />
						</logic:equal>
					</td></tr>
					<logic:equal value="1" name="admissionStatusForm" property="applicantDetails.programType">
