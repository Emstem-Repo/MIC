	...
	<table  width="100%" border="0"  cellpadding="3" cellspacing="0" bordercolor="#E0DFDB">
		...
		<tr>
			<td>
				<table width="100%" border="1"  cellpadding="3" cellspacing="0">
					...
					<tr>
						<td>Admission No. <br><bean:write name="admissionStatusForm" property="applicantDetails.admissionNumber"/></td>
						<td>Year of Admission &nbsp;<%-- <bean:write name="admissionStatusForm" property="applicantDetails.appliedYear" /> --%>
							<script>
								var year='<bean:write name="admissionStatusForm" property="applicantDetails.appliedYear" />'
								var year1=parseInt(year)+1;
								document.writeln(year.toString()+"-"+year1.toString());
								console.log(year1);
							</script>
						</td>
						<td align="center">Programme<br><%-- <bean:write name="admissionStatusForm" property="applicantDetails.course.name" /> --%></td>
						<td>Class No.<br></td>
					</tr>
				</table>
				<hr>
		...
		<tr>
			<td>
				<table width="100%" border="1"  cellpadding="3" cellspacing="0">
					<tr>
						<td colspan="3">Name of the student: <bean:write name="admissionStatusForm" property="applicantDetails.personalData.firstName"/></td>
						<td width="20%" rowspan="4" align="center" valign="middle"><div valign="middle">Affix recent photo of student (mandatory)</div></td>
					</tr>
					<tr>
						<td>Gender : <bean:write name="admissionStatusForm" property="applicantDetails.personalData.gender"/></td>
						<td>Date of Birth : <bean:write name="admissionStatusForm" property="applicantDetails.personalData.dob"/></td>
						<td>Age : 
						
						<html:hidden styleId="dob" name="admissionStatusForm" property="applicantDetails.personalData.dob"/>
							<script>
						var date1 = new Date();
					...
					<tr><td colspan="3">
						<table width="100%" cellpadding="3" cellspacing="0">
							...
							<tr><td style="border-right: 1px solid black;border-bottom: 1px solid black">
								...
								<bean:write name="admissionStatusForm" property="applicantDetails.personalData.currentAddressLine1"/>,&nbsp;
								<bean:write name="admissionStatusForm" property="applicantDetails.personalData.currentAddressLine2"/>,&nbsp;
								<bean:write name="admissionStatusForm" property="applicantDetails.personalData.currentCityName"/>,&nbsp;
								<bean:write name="admissionStatusForm" property="applicantDetails.personalData.currentAddressZipCode"/>,&nbsp;
								<bean:write name="admissionStatusForm" property="applicantDetails.personalData.currentStateName"/>,&nbsp;
								<bean:write name="admissionStatusForm" property="applicantDetails.personalData.currentCountryName"/>,&nbsp;<br>
								Phone : &nbsp;<bean:write name="admissionStatusForm" property="applicantDetails.personalData.mobileNo2"/>&nbsp;
							</td>
							</tr>
							<tr><td style="border-right: 1px solid black;">Religion & Denomination :<bean:write name="admissionStatusForm" property="applicantDetails.personalData.religionName"/>,
							<bean:write name="admissionStatusForm" property="applicantDetails.personalData.casteCategory"/></td>
							<td>Native place <bean:write name="admissionStatusForm" property="applicantDetails.personalData.permanentDistricName"/></td></tr>
						</table>
					</td></tr>
					<tr><td colspan="2">
						Name of Father/Guardian : <bean:write name="admissionStatusForm" property="applicantDetails.titleOfFather"/>. 
						...
						Annual Income <br> <br><bean:write name="admissionStatusForm" property="applicantDetails.personalData.familyAnnualIncome"/>
					</td>
					</tr>
					<tr><td colspan="2">Occupation : 
						<logic:notEmpty name="admissionStatusForm"   property="applicantDetails.personalData.fatherOccupation"><bean:write   name="admissionStatusForm"   property="applicantDetails.personalData.fatherOccupation" /></logic:notEmpty>
											<logic:notEmpty name="admissionStatusForm"   property="applicantDetails.personalData.otherOccupationFather"><bean:write   name="admissionStatusForm"   property="applicantDetails.personalData.otherOccupationFather" /></logic:notEmpty>
					</td>
<td align="center" style="border-bottom: 1px solid black" rowspan="3">
		...
		<tr><td >
			<table width="100%" border="1"  cellpadding="3" cellspacing="0">
				...
				<tr>
					<td ><bean:write name="admissionStatusForm" property="applicantDetails.personalData.parentAddressLine1"/>,&nbsp;
			<bean:write name="admissionStatusForm" property="applicantDetails.personalData.parentAddressLine2"/>,&nbsp;<br>
			<bean:write name="admissionStatusForm" property="applicantDetails.personalData.parentCityName"/>,&nbsp;<br>
			<bean:write name="admissionStatusForm" property="applicantDetails.personalData.parentAddressZipCode"/>,&nbsp;<br>
			<bean:write name="admissionStatusForm" property="applicantDetails.personalData.permanentStateName"/>,&nbsp;
			<bean:write name="admissionStatusForm" property="applicantDetails.personalData.citizenship"/>,&nbsp;</td>
					<td ></td>
					<td>
						<table width="100%" border="0"  cellpadding="3" cellspacing="0">
							<tr><td>Mobile : <bean:write name="admissionStatusForm" property="applicantDetails.personalData.parentMobile"/></td></tr>
							<tr><td>Res :</td></tr>
							<tr><td>Office :</td></tr>
							
							<tr><td>E-mail: <bean:write name="admissionStatusForm" property="applicantDetails.personalData.fatherEmail"/></td></tr>
						</table>
					</td>
				</tr>
			</table>
		...
		<tr>
			<td><table width="100%" border="1"  cellpadding="3" cellspacing="0">
				...
				<tr>
					<td align="center" valign="middle"><%-- <bean:write name="admissionStatusForm" property="applicantDetails.quota"/> --%>
						<table width="100%" border="1"  cellpadding="3" cellspacing="0">
		...
		<tr>
			<td>
			 ...
			 <logic:notEmpty name="admissionStatusForm" property="applicantDetails.ednQualificationList">
			 	<logic:iterate name="admissionStatusForm" property="applicantDetails.ednQualificationList" id="acd">
			 		<table width="100%" border="1"  cellpadding="3" cellspacing="0">
				<tr>
