...
<html:form action="/admissionFormsOnline" method="post">
	<html:hidden property="method" value="getStudentData" />
					...
					<tr>
						<td valign="top">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td colspan="3"><span class="Bredcrumbs"><bean:message
												key="knowledgepro.admission" /><span class="Bredcrumbs">&gt;&gt;
												<bean:message key="admissionForm.approve.init.label" />
												&gt;&gt;
										</span></span></td>
								</tr>
								<tr>
									...
									<td background="images/Tcenter.gif" class="body">
										<div align="left">
											<strong class="boxheader"> <bean:message
													key="admissionForm.approve.init.label" /></strong>
										</div>
									</td>
								...
								<tr>
									...
									<td valign="top" class="news">
										<table width="100%" cellspacing="1" cellpadding="2">
											...
											<tr>
												...
												<td width="20%" class="row-even"><html:text
														property="applicationNumber" styleId="appNo" size="9"
												...
												<td class="row-even"><input type="hidden" id="tempyear"
													name="tempyear"
													value="<bean:write name="admissionFormForm" property="applicationYear"/>" />
													<html:select property="applicationYear" styleId="year"
														styleClass="combo">
														<html:option value=" ">
													...
													<table width="100%" border="0" cellspacing="0"
														...
														<tr>
															<td width="49%" height="35"><div align="right">
																	<html:submit
																		onclick="submitAdmissionForm('getStudentData')"
																		styleClass="formbutton" value="Search"></html:submit>
																</div></td>
															<td width="1%"></td>
										...
										<table width="100%">
											<tr>
												<th>ANNEXURE - VII</th>
												<th>Application Form For Membership</th>
												<th>Bio Data Form For Mar Ivanios College</th>
												<th>Application of Admission First Degree 2020-21</th>
											</tr>
											<tr align="center">
