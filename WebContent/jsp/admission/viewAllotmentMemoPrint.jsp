...
<html:form action="/AdmissionStatus" method="POST">
	...
	<table width="100%" border="0" cellpadding="3" cellspacing="0"
		...
		<logic:notEqual value="GENERAL" name="admissionStatusForm"
			property="admissionStatusTO.altmntcategory">
			<logic:notEqual value="COMMUNITY" name="admissionStatusForm"
				property="admissionStatusTO.altmntcategory">
				<tr>
					<td class="title" align="center" style="text-transform: uppercase">
						ADMISSION MEMO (RESERVATION <bean:write name="admissionStatusForm"
						property="admissionStatusTO.altmntcategory" />)</td>
				</tr>
			</logic:notEqual>
		</logic:notEqual>
		<logic:equal value="GENERAL" name="admissionStatusForm"
			property="admissionStatusTO.altmntcategory">
				<tr>
					<td class="title" align="center" style="text-transform: uppercase">
					ADMISSION MEMO (<bean:write name="admissionStatusForm"
						property="admissionStatusTO.altmntcategory" />)</td>
				</tr>
		</logic:equal>
				...
				<tr>
					...
					<table cellpadding="3" width="100%" align="center" border="1"
						...
						<tr class="title2">
							...
							<td align="center">Admission Date and Time</td>
							<%--<td align="center">Bonus Mark</td><td align="center">Negative Mark</td> --%>
						</tr>
						<tr>
							<td align="center" class="mytabledata"><bean:write
								name="admissionStatusForm" property="admissionStatusTO.pref" /></td>
							<td align="center" class="mytabledata"><bean:write
								name="admissionStatusForm"
								property="admissionStatusTO.currentcourse" /></td>
							<td align="center" class="mytabledata"><bean:write
								name="admissionStatusForm"
								property="admissionStatusTO.altmntcategory" />
								<logic:equal value="true" property="admissionStatusTO.almntCommunity" name="admissionStatusForm">
									(Syro Malankara Catholic)
								</logic:equal>
							</td>
							<td align="center" class="mytabledata"><bean:write
								name="admissionStatusForm"
								property="admissionStatusTO.indexmark" /></td>
							<td align="center" class="mytabledata"><bean:write
								name="admissionStatusForm" property="admissionStatusTO.rank" /></td>
							<%--<td align="center" class="mytabledata"><bean:write name="admissionStatusForm" property="applicantDetails.bonsmark"/></td><td align="center" class="mytabledata"><bean:write name="admissionStatusForm" property="applicantDetails.handicapmark"/></td> --%>
							<td align="center" class="mytabledata"><bean:write
		...
		<table width="100%" border="0" cellpadding="3" cellspacing="0"
			...
			<tr>
				...
				you is based on the details furnished online. The original documents
				relating to the above must be submitted before the Principal at the
				time of admission. Kindly furnish the print copy of the Allotement Memo (Sure / Chance)
				along with the original documents. If any discrepancies are detected at
				the time of admission or course period, your admission will be
				cancelled. Please read the prospectus and admission instructions
				given on the website.<br></br>
				</td>
			</tr>
			<tr>
				<td>
				<table>
					<tr>
						<td class="mytabledatafee"><u>Fees to be paid at the time
						of admission:</u></td>
						<td class="mytabledatafee">Rs.<bean:write
							name="admissionStatusForm"
							property="admissionStatusTO.generalFee" /> + PTA (for General
						Candidates)</td>
					</tr>
					<tr>
						<td></td>
						<td class="mytabledatafee">Rs.<bean:write
							name="admissionStatusForm" property="admissionStatusTO.casteFee" /> + PTA
			...
			<table cellpadding="3" align="center" width="100%" border="1"
				...
				<tr>
					<logic:equal value="1" name="admissionStatusForm"
						...
						Marks</td>
						<td style="border: 1px solid black; border-collapse: collapse"><%=obtained%></td>
			...
			<tr>
				...
				<table width="100%">
...
</b> <b>in the case of students OTHER THAN Kerala HSE/VHSE/CBSE/ISC</b>.</td>
			</tr>
					<tr>
						<td>(i)</td>
					...
					<tr>
						...
						<td class="mytabledatafee">Those candidates who have more than
						one memo (Sure / Chance) should produce all the memos (sure &amp;
						chance), if he/she wants the claim for the concerned subjects.</td>
					</tr><tr></tr>
				<tr>
	...
	-->
			<tr>
				...
				<table width="100%">
					...
					<tr>
						<td colspan="2" align="center">
						<div><span style="color: red;"> <b> The candidate
						should be accompanied by at least one of the parents at the time
						of the interview. This is compulsory. In the case of any
						extraordinary situation where neither of the parents can be
						present, it should be intimated to the principal beforehand either
						through email or in person. </b> </span></div>
						</td>
					</tr>
				</table>
				</td>
