  ...
  <tr>
    <td valign="top"><table width="98%" border="0" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        ...
        <td height="20" valign="top" background="images/Tright_03_03.gif"></td>
        <td class="heading">
			<FONT color="red">you are trying to enter wrong data...Please try again</FONT>
		</td>
        <td valign="top" background="images/Tright_3_3.gif" class="news"></td>
      </tr>
      ...
      <tr>
        ...
        <tr>
        <td width="45%" height="45" align="center"><html:button
          ...
          <!--<tr>
            ...
            <td width="1%"><div align="left">
                <html:button property="" onclick="printPDF()" styleClass="formbutton" value="Save as PDF"></html:button>
            </div></td>
          ...
          <tr>
      	<!--<td colspan="5" align="center" valign="bottom"><b>  <FONT color="red" size="2">
         Please check your spam folder just in case the confirmation email got delivered there instead of your inbox. </FONT></br>
          <FONT color="green" size="2">student should submit the DD within three days in the college</FONT>
         </b>-->
         </td>
         </tr>  
        </table></td>
