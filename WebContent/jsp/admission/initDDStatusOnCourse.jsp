...
function getStudentsDetails(){
	...
	document.getElementById("method").value = "getStudentsDDStatusOnCourse";
	document.dDStatusForm.submit();
}


function cancelPage(){
	document.location.href="ddStatus.do?method=initDDStatusOnCourse";
}



function updateChallanStatusOnCourse() {
	document.getElementById("method").value = "updateDDStatusOnCourse";
	document.dDStatusForm.submit();
...
<html:hidden property="method" styleId="method" value="initDDStatusOnCourse"/>
...
<table width="100%" border="0">
		<tr>
			...
			DD Status On Date Wise &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="body"><strong
						class="boxheader"> DD Status On Date Wise</strong></td>
			...
			<tr>
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
										...
										<td align="center" class="row-odd">DD No</td>
