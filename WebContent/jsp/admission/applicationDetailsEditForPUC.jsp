...
<script type="text/javascript">
	...
	function detailTransferSubmit()
	{
	 ...
	 function submitEditCancelButtonPUC(){
		 	document.location.href="admissionFormSubmit.do?method=initApplicationEdit&PUC=true";
		 }
...
<html:form action="/admissionFormSubmit" enctype="multipart/form-data" method="POST">
	...
	<c:choose>
	<c:when test="${admissionFormForm.pucApplicationEdit}">
						...
						<tr>
							...
							<table width="97%" border="0" align="center" cellpadding="0"
								...
								<tr>
										...
										<tr>
											...
											<td height="20" class="row-even" align="left"><table width="100%" border="0" cellpadding="0" cellspacing="0">
												...
												<logic:notEqual value="Other" property="applicantDetails.personalData.religionId" name="admissionFormForm">
													<%dynastyle="display:none;"; %>
												<nested:select property="applicantDetails.personalData.religionId" styleClass="combo" styleId="religions" onchange="getSubReligion(this.value,'Subreligions');funcOtherShowHide('religions','otherReligion')" disabled="true">
													<option value=""><bean:message key="knowledgepro.admin.select"/></option>
												...
												<tr><td><nested:text property="applicantDetails.personalData.religionOthers" size="10" maxlength="30" styleId="otherReligion" style="<%=dynastyle %>" readonly="true"></nested:text></td></tr>
												</table>
											</td>
										</tr>
										<tr>
											...
											<%dynastyle="display:none;"; %>
											<nested:select property="applicantDetails.personalData.subReligionId" styleClass="combo" styleId="Subreligions"  onchange="funcOtherShowHide('Subreligions','otherSubReligion')" disabled="true">
													<option value=""><bean:message key="knowledgepro.admin.select"/></option>
											...
											<nested:select property="applicantDetails.personalData.subReligionId" styleClass="combo" styleId="Subreligions" onchange="funcOtherShowHide('Subreligions','otherSubReligion')" disabled="true">
												...
												<tr><td><nested:text property="applicantDetails.personalData.religionSectionOthers" size="10" maxlength="30" styleId="otherSubReligion" style="<%=dynastyle %>" readonly="true"></nested:text></td></tr>
												</table>
											</td>
										</tr>
										<tr>
											...
											<td height="20" class="row-even" align="left"><table width="100%" border="0" cellpadding="0" cellspacing="0">
												...
												<%dynastyle="display:none;"; %>
												<nested:select property="applicantDetails.personalData.casteId" styleClass="combo" styleId="castes" onchange="funcOtherShowHide('castes','otherCastCatg')" disabled="true">
													<option value=""><bean:message key="knowledgepro.admin.select"/></option>
												...
												<tr><td><nested:text property="applicantDetails.personalData.casteOthers" size="10" maxlength="30" styleId="otherCastCatg" style="<%=dynastyle %>" readonly="true"></nested:text></td></tr>
												</table>
											</td>
										</tr>
										<tr>
									...
									<td height="17" class="row-even" align="left"><nested:radio property="applicantDetails.personalData.areaType" value='R' disabled="true"><bean:message key="admissionForm.studentinfo.belongsto.rural.text"/></nested:radio>
											<nested:radio property="applicantDetails.personalData.areaType" value='U' disabled="true"><bean:message key="admissionForm.studentinfo.belongsto.urban.text" /></nested:radio></td>
										</tr>
										<tr>
											<td height="17" class="row-odd">
											<div align="right"><span class="Mandatory">*</span><bean:message
								...
								<td height="17" class="row-even" align="left"><nested:radio property="applicantDetails.personalData.gender" value="MALE" disabled="true"><bean:message key="admissionForm.studentinfo.sex.male.text"/></nested:radio>
								<nested:radio property="applicantDetails.personalData.gender" value="FEMALE" disabled="true"><bean:message key="admissionForm.studentinfo.sex.female.text"/></nested:radio></td>
										</tr>
										<tr><%String dynaStyle3="display:none;"; %>
                           					...
                           					<td height="17" class="row-even" align="left"><nested:radio property="applicantDetails.personalData.sportsPerson" value="true" onclick="showSportsDescription()" disabled="true"><bean:message key="knowledgepro.applicationform.yes.label"/></nested:radio>
											<nested:radio property="applicantDetails.personalData.sportsPerson" value="false" onclick="hideSportsDescription()" disabled="true"><bean:message key="knowledgepro.applicationform.No.label"/></nested:radio>
											<div id="sports_description" style="<%=dynaStyle3 %>">
												<nested:text styleId="sportsDescription" property="applicantDetails.personalData.sportsDescription" maxlength="80" size="15" readonly="true"></nested:text>
											</div></td>
                        				</tr>
 										<tr><%String dynaStyle4="display:none;"; %>
											...
											<%dynaStyle4="display:block;"; %>
                           					...
                           					<td height="17" class="row-even" align="left"><nested:radio property="applicantDetails.personalData.handicapped" value="true" onclick="showHandicappedDescription()" disabled="true"><bean:message key="knowledgepro.applicationform.yes.label"/></nested:radio>
											...
											<div id="handicapped_description" style="<%=dynaStyle4 %>">
												<nested:text styleId="hadnicappedDescription" property="applicantDetails.personalData.hadnicappedDescription" maxlength="80" size="15" readonly="true"></nested:text>
											</div>
											</td>
                        				</tr>
										<tr>
                    ...
                    <tr>
                      ...
                      <td width="100%" height="29" valign="top"><table width="100%" height="24" border="0" cellpadding="0" cellspacing="1">
                          <tr class="row-white">
                            ...
                            <td width="236" height="25" class="row-even" align="left">
								<nested:select property="applicantDetails.admittedThroughId" styleId="admittedThroughId" styleClass="combo" disabled="true">
									<html:option value="">-Select-</html:option>
                           ...
                           <tr class="row-white">
                            ...
                            <td width="236" height="25" class="row-even" align="left">
								<nested:radio property="applicantDetails.isFreeShip" value="true" disabled="true"><bean:message key="knowledgepro.applicationform.yes.label" /></nested:radio>
								<nested:radio property="applicantDetails.isFreeShip" value="false" disabled="true"><bean:message key="knowledgepro.applicationform.No.label"/></nested:radio>
							</td>
                            ...
                            <td width="244" height="25" class="row-even" align="left">
								<nested:radio property="applicantDetails.isLIG" value="true" disabled="true"><bean:message key="knowledgepro.applicationform.yes.label"/></nested:radio>
								<nested:radio property="applicantDetails.isLIG" value="false" disabled="true"><bean:message key="knowledgepro.applicationform.No.label"/></nested:radio>
							</td>
                          </tr>
                      </table></td>
                      <td  background="images/right.gif" width="5" height="29"></td>
									...
									<table width="100%" height="90" border="0" cellpadding="0"
										...
										<tr class="row-white">
											...
											<td width="236" height="20" class="row-even" align="left">&nbsp;
												<nested:textarea property="applicantDetails.personalData.currentAddressLine1" cols="15" rows="3" onkeypress="return imposeMaxLength(event,this)"></nested:textarea>
											</td>
											<td width="224" class="row-odd">
											<div align="right"><bean:message
											...
											<td width="244" class="row-even" align="left">&nbsp;
												<nested:textarea property="applicantDetails.personalData.currentAddressLine2" cols="15" rows="3" onkeypress="return imposeMaxLength(event,this)"></nested:textarea>
											</td>
										</tr>
										<tr class="row-even">
											<td height="20" class="row-odd">
								...
								<tr>
									...
									<table width="100%" height="90" border="0" cellpadding="0"
										...
										<tr class="row-white">
											...
											<td width="236" height="20" class="row-even" align="left">&nbsp;
											<nested:textarea property="applicantDetails.personalData.permanentAddressLine1" cols="15" rows="3" onkeypress="return imposeMaxLength(event,this)"></nested:textarea>
											</td>
											<td width="224" class="row-odd">
											<div align="right"><bean:message
												key="admissionForm.studentinfo.addrs2.label" /></div>
											...
											<td width="244" class="row-even" align="left">&nbsp;
											<nested:textarea property="applicantDetails.personalData.permanentAddressLine2" cols="15" rows="3" onkeypress="return imposeMaxLength(event,this)"></nested:textarea>
											</td>
										</tr>
										<tr class="row-even">
											<td height="20" class="row-odd">
								...
								<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										<tr>
											...
											<td class="row-odd" align="center"><bean:message key="knowledgepro.applicationform.prevregno.label"/></td>
										</tr>
											...
											<c:choose>
												<c:when test="${temp == 0}">
													<tr>
														...
														<tr><td><nested:text property="universityOthers" size="10" maxlength="10" styleId="<%=otheruniversityid %>" style="<%=dynastyle %>" readonly="true"></nested:text></td></tr>
														</table>
														</div>
														</td>
														...
														<td class = "row-even">
															<table>
																<tr>
																	<td class="row-even">
																	<div align="center"><nested:text property="marksObtained" size="5" maxlength="9" readonly="true"></nested:text></div>
																	</td>
																</tr>
																<tr>
																	<td class="row-even">
																	<div align="center"><nested:text property="totalMarks" size="5" maxlength="9" readonly="true"></nested:text></div>
																	</td>
																</tr>
															</table>
														</td>
												...
												<c:otherwise>
													<tr>
														...
														<div align="center">
															<logic:equal value="true" name="ednQualList" property="lastExam">
															<nested:text property="previousRegNo" size="10" maxlength="15" readonly="true"/></logic:equal>
														</div>
														</td>
									...
									<tr>
											...
											<td height="25" class="row-even"><nested:text property="applicantDetails.tcNo" size="6" maxlength="10" readonly="true" ></nested:text></td>
											<td class="row-odd">
											<div align="left"><bean:message key="admissionForm.education.TCDate.label"/></div>
											</td>
											<td class="row-even" colspan="2">
											<div align="left"><nested:text property="applicantDetails.tcDate" styleId="tcdate" size="10" maxlength="10" readonly="true"></nested:text><script language="JavaScript">
												new tcal( {
													// form name
													'formname' :'admissionFormForm',
													// input name
											...
											<td class="row-even">
											<div align="center"><nested:text property="applicantDetails.markscardNo" size="6" maxlength="10" readonly="true"></nested:text></div>
											</td>
											<td class="row-odd">
											<div align="center"><bean:message key="admissionForm.education.markcarddate.label"/></div>
											</td>
											<td class="row-even" colspan="2">
											<div align="left"><nested:text property="applicantDetails.markscardDate" styleId="markscardDate" size="10" maxlength="10" readonly="true"></nested:text>
												<script language="JavaScript">
														new tcal( {
															// form name
															'formname' :'admissionFormForm',
								...
								<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<tr>
											...
											<div align="right"><bean:message key="admissionForm.approveview.submitdt.label" /></div>
											</td>
											<td width="20%" height="25" class="row-even" align="left"><nested:text property="submitDate" styleId="submitdate" size="10" maxlength="10"  readonly="true"/>
                              <script language="JavaScript">
								new tcal ({
									// form name
									'formname': 'admissionFormForm',
									...
									'controlname': 'submitdate'
											...
											<td class="row-even"><div align="left"><nested:text property="applicantDetails.remark" styleId="remark" size="25" maxlength="150"/></div></td>
						...
						<tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="45%" height="45" align="left">
								
									<c:choose>
									<c:when test="${admissionFormForm.pucApplicationEdit}">
									<html:button
										property="" styleClass="formbutton"
										onclick="submitEditCancelButtonPUC()">
