...
<html:form action="/StudentSemesterFeeCorrection">
	<html:hidden property="method" value="pendingStudentSemesterFee" />
	<html:hidden property="formName" value="studentSemesterFeeCorrectionForm" />
	...
	<table width="98%" border="0">
		<tr>
			<td>
				...
				<span class="Bredcrumbs">&gt;&gt; Student Semester Fee Correction &gt;&gt;</span></span>
			</td>
		</tr>
		<tr>
			<td>
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<div align="left"><strong class="boxheader"> Student Semester Fee Correction </strong></div>
						</td>
													...
													<table width="100%" cellspacing="1" cellpadding="2">
														<tr>
															...
															<td class="row-even" width=50%>
																<table>
																	<tr>
																		<td>
																			<html:radio property="correctionFor" styleId="onlineAppRadioId" value="SelfFinancing Semester Fee">SelfFinancing Semester Fee</html:radio>
																		
																		</td>
																		<td>
																			<html:radio property="correctionFor" styleId="onlineAppRadioId" value="Regular Semester Fee">Regular Semester Fee</html:radio>
														...
														<tr>
															...
															<td width="30%" class="row-even">
																<html:text property="txnRefNo" styleId="txnRefNo" size="20" maxlength="20" value=""></html:text>
															</td>
														</tr>
														<tr id="dateRow" style="display: none;">
															...
															<td width="30%" class="row-even">
																...
																<script language="JavaScript">
																	new tcal({
																			'formname'    : 'studentSemesterFeeCorrectionForm',
																			'controlname' : 'txnDate'
																	});
																</script>
															</td>
														...
														<tr id="amountRow" style="display: none;">
															...
															<td width="30%" class="row-even">
																<html:text property="txnAmt" styleId="txnAmt" size="20" maxlength="20" value=""></html:text>
															</td>
														</tr>
													</table>
												</td>
