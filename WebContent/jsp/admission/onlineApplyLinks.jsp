...
<table width="100%" border="0">
  ...
  <tr>
	...
	<!-- 
		<tr>
        <td height="20" valign="top" background="images/Tright_03_03.gif"></td>
        <td class="news" height="20" align="center">
        	<table width="98%" border="0" cellpadding="0" cellspacing="0">
        		<tr><td align="right" width="10%"></td>
        			<td align="center" width="90%">
        				<B><FONT face="Verdana" size="2">OR</FONT></B> </td>
        		</tr>
        	</table>
        </td>
        <td valign="top" background="images/Tright_3_3.gif" class="news"></td>
        ...
        <td  valign="top" align="center">
			<table width="98%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<input type="checkbox" id="selected1_<c:out value='${count}'/>" name="guidelineChecklists[<c:out value='${count}'/>].checked" onclick="disableCheckBox('<c:out value='${count}'/>')"/>
														<script type="text/javascript">
					...
					&nbsp;&nbsp;<FONT face="Verdana" size="1"><nested:write property="description" name="desc"/></FONT> </td>
				</tr>
				</nested:iterate>
			</table>
