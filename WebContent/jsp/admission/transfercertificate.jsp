...
function printTc() {
	...
	var searchByR = document.getElementById("searchByR");
	var searchByA = document.getElementById("searchByA");
	var url = "transferCertificate.do?method=printTC&fromUsn="+fromUsn+"&searchBy="+((searchByR.checked == true ? searchByR.value : searchByA.value));		
		                       						...
		                       						<td valign="top">
		                       							<table width="100%" cellspacing="1" cellpadding="2">
					                						<tr>
																...
																<td class="row-even" width="25%"><html:text property="fromUsn" styleId="fromUsn"></html:text></td>
																<td align="right" class="row-odd" width="25%">Search by:</td>
