									...
									<td valign="top">
										<table width="100%" cellspacing="1" cellpadding="2">
											<tr>
												...
												<td class="row-even"><bean:write name="tCDetailsForm" property="tcDetailsTO.studentName"/></td>
												
												<td align="right" class="row-odd">
													<bean:message key="knowledgepro.hostel.reservation.registerNo" />
												</td>
												<td class="row-even"><bean:write name="tCDetailsForm" property="tcDetailsTO.registerNo"/></td>
											</tr>
											<tr>
												<td height="25" class="row-odd">
													<div align="right"><bean:message key="knowledgepro.admission.admissionno" /></div>
												</td>
												<td class="row-even"><bean:write name="tCDetailsForm" property="tcDetailsTO.admissionNo"/></td>
												
												<td align="right" height="25" class="row-odd"><bean:message key="knowledgepro.admin.dateofbirth"/></td>
												<td class="row-even"><bean:write name="tCDetailsForm" property="tcDetailsTO.dateOfBirth"/></td>
											</tr>
											<tr>
												<td align="right" class="row-odd">
													<span class="Mandatory">*</span><bean:message key="knowledgepro.admission.admissiondate" />
													<%--
														<div align="right">
															<span class="Mandatory">*</span><bean:message key="knowledgepro.admission.tc.details.dateofApplication" />
														</div>
													 --%>
												</td>
												<td class="row-even">
													<html:text name="tCDetailsForm" property="tcDetailsTO.dateOfAdmission" styleId="dateOfAdmission" size="10" maxlength="16"/>
													<script language="JavaScript">
														new tcal( {
															// form name
															'formname' :'tCDetailsForm',
															// input name
															'controlname' :'tcDetailsTO.dateOfAdmission'
														});
													</script>
													<%--
												...
												<td align="right" height="25" class="row-odd">
													<span class="Mandatory">*</span><bean:message key="knowledgepro.admission.tc.details.dateOfLeaving" />
												</td>
												<td height="25" class="row-even">
													<html:text property="tcDetailsTO.dateOfLeaving" name="tCDetailsForm" styleId="dateOfLeaving" size="20"></html:text>
												</td>
											</tr>
											<tr>
												<td align="right" class="row-odd">
													Class of Leaving<br>(Please mention if it is different from above class)
												</td>
												<td class="row-even">
													<nested:text property="tcDetailsTO.classOfLeaving" styleId="classOfLeaving" maxlength="50"/>
												</td>
												...
												<td class="row-even">
													...
													<%--
														<html:text name="tCDetailsForm" property="tcDetailsTO.reasonOfLeaving" styleId="reasonOfLeaving" size="15"/>
													 --%>
												</td>
											</tr>
											<tr>
												<td align="right" class="row-odd">
													<span class="Mandatory">*</span>Promotion-To-Next-Class
													<%-- <div align="right"><bean:message key="knowledgepro.admission.tc.details.characterandConduct" /></div> --%>
												</td>
												<td class="row-even">
													<logic:notEmpty name="tCDetailsForm" property="tcDetailsTO">
														<nested:select property="tcDetailsTO.promotionToNextClass" name="tCDetailsForm">									
															...
															<html:option value="Course Discontinued">Course Discontinued</html:option>
														</nested:select>
													</logic:notEmpty>
													<%--
												...
												<td height="25" class="row-odd">
													<div align="right">
														<span class="Mandatory">*</span><bean:message key="knowledgepro.admission.student.tcDetails.publicExaminationName.label" />
														<%--
															<div align="right">
																<span class="Mandatory">*</span><bean:message key="knowledgepro.admission.tc.details.particular"/>
															</div>
														 --%>
													</div>
												</td>
												<td  class="row-even">
													<html:text property="publicExamName" styleId="publicExamName"></html:text>
											...
											<tr>
												<td height="25" class="row-odd">
													<div align="right">
														<span class="Mandatory">*</span>Exam <bean:message key="knowledgepro.admin.academicyear"/>
													</div>
												</td>
												<td class="row-even">
												...
												<td align="right" height="25" class="row-odd">
													<span class="Mandatory">*</span>Exam <bean:message key="knowledgepro.exam.examDefinition.month" />
												</td>
												<td height="25" class="row-even">
											...
											<tr>
												<td align="right" class="row-odd">
													<span class="Mandatory">*</span><bean:message key="knowledgepro.admission.exam.appeared"/>
												...
												<td class="row-odd">
													<div align="right">
														<span class="Mandatory">*</span><bean:message key="knowledgepro.admission.tc.details.feespaid"/>
														<%--
															<div align="right">
																<span class="Mandatory">*</span>
																<bean:message key="knowledgepro.admission.student.tcDetails.showRegNo.label"/>
															</div>
														 --%>
													</div>
												</td>
											...
											<tr>
												<td height="25" class="row-odd">
													<div align="right">
														<bean:message key="knowledgepro.admission.parts&divisionpass"/>
													</div>
												</td>
												<td height="25" class="row-even">
													<nested:text property="tcDetailsTO.subjectPassed" styleId="subjectPassed" style="width:200px;"/>
												</td>
												
												<td align="right" height="25" class="row-odd">
													<bean:message key="knowledgepro.admission.parts&divisionfail"/>
												</td>
												<td class="row-even">
													<nested:text property="tcDetailsTO.subjectFailed" styleId="subjectFailed" style="width:200px;"/>
												</td>
											</tr>
											<tr>
												<td height="25" class="row-odd">
													<div align="right"><bean:message key="knowledgepro.admission.exam.punished"/></div>
												</td>
												<td height="25" class="row-even">
												...
												<td align="right" height="25" class="row-odd">Class & Subject of Joining</td>
												<td class="row-even">
													<nested:text property="tcDetailsTO.classsubjectOfJoining" name="tCDetailsForm"></nested:text>
												</td>
											</tr>
										</table>
									</td>
