...
function submitCsv(){
	document.getElementById("method").value ="UploadSmartCardNumberNew";
	document.smartCardNumberUploadForm.submit();
}
...
<html:form action="/smartCardNoUpload" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="UploadSmartCardNumberNew" />
	<html:hidden property="formName" value="smartCardNumberUploadForm" />
								...
								<tr>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										...
										<td height="25" class="row-odd" width="25%">
											...
											<html:file property="theFile" styleId="thefile" size="15" maxlength="30" name="smartCardNumberUploadForm"/></label></td>
										</tr>
									</table>
									</td>
