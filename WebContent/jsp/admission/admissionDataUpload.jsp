...
<html:form action="/admissionDataUpload" enctype="multipart/form-data" styleId="admissionDataUploadForm">
	<html:hidden property="method" value="updateCSV" />
	<html:hidden property="formName" value="admissionDataUploadForm" />
	<html:hidden property="pageType" value="1" />
	<table width="98%" border="0">
		<tr>
			<td><span class="Bredcrumbs"><bean:message key="knowledgepro.admission" />
			<span class="Bredcrumbs">&gt;&gt; <bean:message key="admissionForm.admissiondataupload.label" />&gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"><bean:message key="admissionForm.admissiondataupload.label" /></strong></div>
					</td>
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
					                ...
					                <input type="hidden" id="programType" name="programType" value='<bean:write name="admissionDataUploadForm" property="programTypeId"/>'/>
					                ...
					                <td width="20%" class="row-even"><html:select property="programId" styleClass="combo" styleId="progPref1" onchange="getCourse(this.value,'coursePref1')" >
										<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
										<c:if test="${admissionDataUploadForm.programTypeId != null && admissionDataUploadForm.programTypeId != ''}">
									...
									<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
									<c:if test="${admissionDataUploadForm.programId != null && admissionDataUploadForm.programId != ''}">
								...
								<tr>
									...
									<td class="row-even">
									<input type="hidden" id="tempyear" name="tempyear" value="<bean:write name="admissionDataUploadForm" property="applicationYear"/>"/>
