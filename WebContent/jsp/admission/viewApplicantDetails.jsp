								...
								<tr>
									...
									<table width="100%" height="76" border="0" cellpadding="0"
										...
										<tr class="row-even">
											...
											<td>&nbsp;<bean:write
												name="interviewResultEntryForm"
												property="applicantDetails.bankBranch" />
											</td>
											<td class="row-odd">&nbsp;</td>
											<td>&nbsp;</td>
										</tr>
...
<logic:equal  name="interviewResultEntryForm" property="viewParish" value="true">
										...
										<tr><%String dynaStyle3="display:none;"; %>
												<logic:equal value="true" property="applicantDetails.personalData.sportsPerson" name="interviewResultEntryForm">
                           					...
                           					<logic:equal value="true" property="applicantDetails.personalData.sportsPerson" name="interviewResultEntryForm"><bean:message key="knowledgepro.yes" /></logic:equal>
                           					<logic:equal value="false" property="applicantDetails.personalData.sportsPerson" name="interviewResultEntryForm"><bean:message key="knowledgepro.no" /></logic:equal>
                           					<div id="sports_description" style="<%=dynaStyle3 %>">
												<bean:write name="interviewResultEntryForm" property="applicantDetails.personalData.sportsDescription" />
											</div>
											</td>
                        				</tr>
 										<tr><%String dynaStyle4="display:none;"; %>
											<logic:equal value="true" property="applicantDetails.personalData.handicapped" name="interviewResultEntryForm">
											<%dynaStyle4="display:block;"; %>
 											...
 											<td height="17" class="row-odd" width="40%"><div align="right"><bean:message key="admissionForm.edit.handicapped.label" /></div></td>
                           					<td height="17" class="row-even" align="left">
                           					<logic:equal value="true" property="applicantDetails.personalData.handicapped" name="interviewResultEntryForm"><bean:message key="knowledgepro.yes" /></logic:equal>
                           					<logic:equal value="false" property="applicantDetails.personalData.handicapped" name="interviewResultEntryForm"><bean:message key="knowledgepro.no" /></logic:equal>
                           					<div id="handicapped_description" style="<%=dynaStyle4 %>">
												<bean:write name="interviewResultEntryForm" property="applicantDetails.personalData.hadnicappedDescription" />
											</div>
											</td>
                        				</tr>
                        				<logic:equal  name="interviewResultEntryForm" property="viewextradetails" value="true">
                           ...
                           <td height="17" class="row-even" align="left"><logic:equal name="interviewResultEntryForm" property="applicantDetails.personalData.ncccertificate" value="true"><bean:message key="knowledgepro.applicationform.yes.label"/></logic:equal>
											<logic:equal name="interviewResultEntryForm" property="applicantDetails.personalData.ncccertificate" value="false"><bean:message key="knowledgepro.applicationform.No.label"/></logic:equal>
											<logic:equal value="true" property="applicantDetails.personalData.ncccertificate" name="interviewResultEntryForm"><div>grade:
												<bean:write property="applicantDetails.personalData.nccgrades" name="interviewResultEntryForm" ></bean:write></div>
												</logic:equal>
												</td>
                        				 ...
                        				 <tr>
                           					...
                           					<td height="17" class="row-even" align="left"><logic:equal name="interviewResultEntryForm" property="applicantDetails.personalData.nsscertificate" value="true" ><bean:message key="knowledgepro.applicationform.yes.label"/></logic:equal>
											<logic:equal name="interviewResultEntryForm" property="applicantDetails.personalData.nsscertificate" value="false" ><bean:message key="knowledgepro.applicationform.No.label"/></logic:equal>
                        				 ...
                        				 <tr>
                           					...
                           					<td height="17" class="row-even" align="left"><logic:equal  name="interviewResultEntryForm" property="applicantDetails.personalData.exservice" value="true" ><bean:message key="knowledgepro.applicationform.yes.label"/></logic:equal>
											<logic:equal  name="interviewResultEntryForm"  property="applicantDetails.personalData.exservice" value="false" ><bean:message key="knowledgepro.applicationform.No.label"/></logic:equal>
										...
										<logic:equal value="true" property="applicantDetails.displaySecondLanguage" name="interviewResultEntryForm">
										 <tr >
				                          <td height="20" class="row-odd" width="40%"><div align="right"><bean:message
												key="knowledgepro.applicationform.secLang.label" /></div></td>
						...
						<logic:equal value="true" property="applicantDetails.displayExtraDetails" name="interviewResultEntryForm">	
						<tr>
	                    ...
	                    <tr>
	                      ...
	                      <td valign="top">
								<table width="100%" border="0" cellpadding="0" cellspacing="1">
		                          <tr class="row-white">
		                          	<td height="23" width="25%" class="row-even"><div align="center"><bean:message key="knowledgepro.applicationform.mothertongue.label" /></div></td>
		                            <td height="23" width="25%" class="row-even" align="left">&nbsp;<bean:write name="interviewResultEntryForm" property="applicantDetails.personalData.motherTongue" /></td>
		                            <td height="23" width="25%" class="row-even"><bean:message key="knowledgepro.applicationform.height.label" />&nbsp;
									 	<bean:write name="interviewResultEntryForm" property="applicantDetails.personalData.height" />
									</td>
									<td height="23" width="25%" class="row-even"><bean:message key="knowledgepro.applicationform.weight.label" />&nbsp;
										 <bean:write name="interviewResultEntryForm" property="applicantDetails.personalData.weight" />
									</td>
								 </tr>
								 <logic:equal value="true" property="applicantDetails.displayLanguageKnown" name="interviewResultEntryForm">
								 <tr class="row-white">
		                            <td height="23" colspan="4" class="row-odd"><div align="center"><bean:message key="knowledgepro.applicationform.language.label" /></div></td>
		                         </tr>
		                         <tr class="row-white">   
		                            <td height="23" width="33%" class="row-even" align="left"><bean:message key="knowledgepro.applicationform.speaklanguage.label" />:&nbsp;
		                            	<bean:write name="interviewResultEntryForm" property="applicantDetails.personalData.languageByLanguageSpeak" />
									</td>
									<td height="23" width="33%" class="row-even" align="left"><bean:message key="knowledgepro.applicationform.readlanguage.label" />:&nbsp;
										<bean:write name="interviewResultEntryForm" property="applicantDetails.personalData.languageByLanguageRead" />
									</td>
									<td height="23" width="33%" class="row-even" align="left"><bean:message key="knowledgepro.applicationform.writelanguage.label" />:&nbsp;
										<bean:write name="interviewResultEntryForm" property="applicantDetails.personalData.languageByLanguageWrite" />
									</td>
									<td height="23" class="row-even">&nbsp;</td>
		                          </tr>
		                          </logic:equal>
		                          <logic:equal value="true" property="applicantDetails.displayTrainingDetails" name="interviewResultEntryForm">
								<tr class="row-white">
								...
								<tr class="row-white">
		                            <td height="23" width="25%" class="row-even" align="right"><bean:message key="knowledgepro.applicationform.trainingprog.label" /></td>
									<td height="23" width="25%" class="row-even" align="left">&nbsp;
									 	<bean:write name="interviewResultEntryForm" property="applicantDetails.personalData.trainingProgName" />
									</td>
									<td height="23" width="25%" class="row-even" align="right"><bean:message key="knowledgepro.applicationform.trainingduration.label" /></td>
									<td height="23" width="25%" class="row-even" align="left">&nbsp;
										<bean:write name="interviewResultEntryForm" property="applicantDetails.personalData.trainingDuration" />
									</td>
		                        </tr>
								<tr class="row-white">
		                           <td height="23" width="25%" class="row-even" align="right"><bean:message key="knowledgepro.applicationform.traininginst.label" /></td>
								   <td height="23" width="25%" class="row-even" align="left">&nbsp;
								  	 <bean:write name="interviewResultEntryForm" property="applicantDetails.personalData.trainingInstAddress" />
								   </td>
									<td height="23" width="25%" class="row-even" align="right"><bean:message key="knowledgepro.applicationform.trainingpurpose.label" /></td>
									<td height="23" width="25%" class="row-even" align="left">&nbsp;
										<bean:write name="interviewResultEntryForm" property="applicantDetails.personalData.trainingPurpose" />
									</td>
		                       </tr>
		                       </logic:equal>
		                       <logic:equal value="true" property="applicantDetails.displayAdditionalInfo" name="interviewResultEntryForm">
								<tr class="row-white">
								...
								<tr class="row-white">
		                            <td height="23" width="25%" class="row-even" align="right"><bean:message key="knowledgepro.applicationform.addninfo.label1" /></td>
									 <td height="23" width="25%" class="row-even" align="left">&nbsp;
									 	<bean:write name="interviewResultEntryForm" property="applicantDetails.personalData.courseKnownBy" />
									</td>
									<td height="23" width="25%" class="row-even" align="right"><bean:message key="knowledgepro.applicationform.strength.label" /></td>
									<td height="23" width="25%" class="row-even" align="left">&nbsp;
										<bean:write name="interviewResultEntryForm" property="applicantDetails.personalData.strength" />
									</td>
		                          </tr>
									<tr class="row-white">
										<td height="23" width="25%" class="row-even" align="right"><bean:message key="knowledgepro.applicationform.addninfo.label2" /> <B><bean:write property="applicantDetails.course.code" name="interviewResultEntryForm"/>?</B></td>
										<td height="23" width="25%" class="row-even" align="left">&nbsp;
											<bean:write property="applicantDetails.personalData.courseOptReason" name="interviewResultEntryForm"/>
										</td>
										<td height="23" width="25%" class="row-even" align="right"><bean:message key="knowledgepro.applicationform.weakness.label" /></td>
										<td height="23" width="25%" class="row-even" align="left">&nbsp;
											<bean:write property="applicantDetails.personalData.weakness" name="interviewResultEntryForm"/>
										</td>
		                         	</tr>
										<tr class="row-white">
			                           	<td height="23" colspan="3" class="row-even" align="right"><bean:message key="knowledgepro.applicationform.addninfo.label3" /> <B><bean:write property="applicantDetails.course.code" name="interviewResultEntryForm"/>:</B></td>
										<td height="23" class="row-even" align="left">&nbsp;
											<bean:write property="applicantDetails.personalData.otherAddnInfo" name="interviewResultEntryForm"/>
										</td>
									</tr>
									</logic:equal>
									<tr class="row-white">
									...
									<tr class="row-white">
			                        	<td height="23" width="25%"class="row-even" align="right"><bean:message key="knowledgepro.applicationform.selectedextracurr.label" /></td>
								 		<td height="23" width="25%" class="row-even" align="left">&nbsp;
											<bean:write property="applicantDetails.personalData.extracurricularNames" name="interviewResultEntryForm" />
										</td>
                    ...
                    <tr>
                      ...
                      <td><img src="images/06.gif" ></td>
						...
						<c:if test="${interviewResultEntryForm.applicantDetails.vehicleDetail != null}">
						<tr>
		                      ...
		                      <td width="100%" height="29" valign="top"><table width="100%" height="24" border="0" cellpadding="0" cellspacing="1">
		                          <tr class="row-white">
		                            ...
		                            <td width="236" height="25" class="row-even" align="left">&nbsp;
		                            	<bean:write name="interviewResultEntryForm" property="applicantDetails.vehicleDetail.vehicleType" />
									</td>
		                            ...
		                            <td width="244" height="25" class="row-even" align="left">&nbsp;
		                            	<bean:write name="interviewResultEntryForm" property="applicantDetails.vehicleDetail.vehicleNo" />
		                            </td>
		                          </tr>
		                      </table></td>
		                ...
		                <logic:notEmpty name="interviewResultEntryForm" property="applicantDetails.prerequisiteTos">
		                <tr>
		                  <td colspan="2" class="heading" align="left">Pre-requisite Details</td>
		                </tr>
		                <tr>
		                  <td colspan="2" class="heading"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		                    <tr>
		                    ...
		                    <tr>
		                      ...
		                      <td width="100%" height="29" valign="top"><table width="100%" height="24" border="0" cellpadding="0" cellspacing="1">
								<tr class="row-white">
		                            <td height="25" class="row-odd"><div align="center"><bean:message key="knowledgepro.admin.pre.requisite" /></div></td>
		                            <td height="25" class="row-odd" align="center"><bean:message key="knowledgepro.admission.totalmarks" /></td>
								...
								<logic:iterate id="prereq" property="applicantDetails.prerequisiteTos" name="interviewResultEntryForm">
		                          <tr class="row-white">
		                            <td height="25" class="row-even"><div align="center"><bean:write property="prerequisiteName" name="prereq"/> </div></td>
		                            <td height="25" class="row-even" align="center"><bean:write property="prerequisiteMarksObtained" name="prereq"/></td>
									<td height="25" class="row-even" align="center"><bean:write property="rollNo" name="prereq"/></td>
		                            <td height="25" class="row-even"><div align="center">
		                      				<logic:equal name="prereq" property="examMonth" value="1"><bean:message key="knowledgepro.admin.month.january" /></logic:equal>
							              	<logic:equal name="prereq" property="examMonth" value="2"><bean:message key="knowledgepro.admin.month.february" /></logic:equal>
											<logic:equal name="prereq" property="examMonth" value="3"><bean:message key="knowledgepro.admin.month.march" /></logic:equal>
											<logic:equal name="prereq" property="examMonth" value="4"><bean:message key="knowledgepro.admin.month.april" /></logic:equal>
											<logic:equal name="prereq" property="examMonth" value="5"><bean:message key="knowledgepro.admin.month.may" /></logic:equal>
											<logic:equal name="prereq" property="examMonth" value="6"><bean:message key="knowledgepro.admin.month.june" /></logic:equal>
											<logic:equal name="prereq" property="examMonth" value="7"><bean:message key="knowledgepro.admin.month.july" /></logic:equal>
											<logic:equal name="prereq" property="examMonth" value="8"><bean:message key="knowledgepro.admin.month.august" /></logic:equal>
											<logic:equal name="prereq" property="examMonth" value="9"><bean:message key="knowledgepro.admin.month.september" /></logic:equal>
											<logic:equal name="prereq" property="examMonth" value="10"><bean:message key="knowledgepro.admin.month.october" /></logic:equal>
											<logic:equal name="prereq" property="examMonth" value="11"><bean:message key="knowledgepro.admin.month.november" /></logic:equal>
											<logic:equal name="prereq" property="examMonth" value="12"><bean:message key="knowledgepro.admin.month.december" /></logic:equal>
									</div></td>
		                            <td height="25" class="row-even" align="center"><bean:write property="examYear" name="prereq"/></td>
		                          </tr>
		                          </logic:iterate>
		                      </table></td>
		                      <td  background="images/right.gif" width="5" height="29"></td>
									...
									<table width="100%" border="0" cellpadding="0"
										...
										<tr class="row-white">
											...
											<div align="center"><input type="radio"
												...
												value='<bean:write
												name="interviewResultEntryForm"
												property="applicantDetails.preference.firstPrefCourseId" />' checked="checked"/></div>
											</c:when>
											<c:otherwise>
											<div align="center"><input type="radio"
												name="selectedPrefId"
										...
										<tr class="row-white">
											...
											<div align="center"><input type="radio"
												...
												value='<bean:write
												name="interviewResultEntryForm"
												property="applicantDetails.preference.secondPrefCourseId" />' checked="checked" /></div>
											</c:when>
											<c:otherwise>
											<div align="center"><input type="radio"
												name="selectedPrefId"
										...
										<tr class="row-white">
											...
											<div align="center"><input type="radio"
												...
												value='<bean:write
												name="interviewResultEntryForm"
												property="applicantDetails.preference.thirdPrefCourseId" />' checked="checked" /></div>
											</c:when>
											<c:otherwise>
											<div align="center"><input type="radio"
												name="selectedPrefId"
		                    ...
		                    <tr>
		                      ...
		                      <td height="31" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="1">
								...
								<logic:iterate name="interviewResultEntryForm" property="applicantDetails.workExperienceList" id="workExpList" indexId="count">
		                          <tr class="row-white">
		                            <td width="212" height="27" class="row-even"><div align="center">
		                            	<bean:write name="workExpList" property="organization" />
		                            </div>
		                            </td>
		                            <td width="236" height="27" class="row-even"><div align="center">
		                            ...
		                            <td width="244" class="row-even"><div align="center">
						...
						<tr>
							...
							<table width="99%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
											...
											<c:choose>
												<c:when test="${temp == 0}">
													<tr>
														...
														<div align="center"><bean:write name="ednQualList" property="docName" /></div>
														</td>
										...
										<logic:equal value="true" property="applicantDetails.displayTCDetails" name="interviewResultEntryForm">
										<tr>
											<td height="25" class="row-odd">
											<div align="center"><bean:message key="admissionForm.education.TCNO.label" /></div>
											</td>
											<td height="25" class="row-even"><bean:write name="interviewResultEntryForm" property="applicantDetails.tcNo" />
											</td>
											<td class="row-odd">
											...
											<td class="row-even" colspan="2">
											<div align="left">
											<bean:write name="interviewResultEntryForm" property="applicantDetails.tcDate" />
											</div>
											</td>
											
											<td class="row-odd"><bean:message key="admissionForm.education.markcard.label" /></td>
											<td class="row-even">
											<div align="center"><bean:write name="interviewResultEntryForm" property="applicantDetails.markscardNo" /></div>
											</td>
											<td class="row-odd">
											<div align="center"><bean:message key="admissionForm.education.markcarddate.label" /></div>
											</td>
											<td class="row-even" colspan="2">
											<div align="left"><bean:write name="interviewResultEntryForm" property="applicantDetails.markscardDate" />
											</div>
											</td>
										</tr>
										</logic:equal>
										<logic:equal value="true" property="applicantDetails.displayLateralTransfer" name="interviewResultEntryForm">
											<tr>
												<td class="row-even">
												...
												<logic:equal
													value="true" property="applicantDetails.displayLateralDetails"
													name="interviewResultEntryForm">
													<div align="center"><a href="javascript:void(0)" onclick="detailLateralSubmit()"><bean:message key="admissionForm.lateralentry.main.label" /></a></div>
												</logic:equal>
												</td>
												<td height="25" colspan="2" class="row-even">
												<div align="center">&nbsp;</div>
												...
												<td class="row-even" colspan="2">
												<logic:equal
													value="true" property="applicantDetails.displayTransferDetails"
													name="interviewResultEntryForm">
													<div align="center"><a href="javascript:void(0)" onclick="detailTransferSubmit()"><bean:message key="admissionForm.transferentry.main.label" /></a></div>
												</logic:equal>
												</td>
												<td class="row-even" colspan="2">
												<div align="center">&nbsp;</div>
							...
							<c:if test="${interviewResultEntryForm.applicantDetails.entranceDetail != null}">
							<tr>
						...
						<logic:equal value="true" property="applicantDetails.displayFamilyBackground" name="interviewResultEntryForm">
						<tr>
						<td>
						<table width="97%" border="0" align="center" cellpadding="0"
							cellspacing="0">
								...
								<tr>
									...
									<table width="100%" height="107" border="0" cellpadding="0"
										...
										<tr class="row-even">
											...
											<td height="20" class="row-white" align="left">&nbsp;
												<bean:write name="interviewResultEntryForm" property="applicantDetails.personalData.guardianPh1" />
												<bean:write name="interviewResultEntryForm" property="applicantDetails.personalData.guardianPh2" />
												<bean:write name="interviewResultEntryForm" property="applicantDetails.personalData.guardianPh3" />
											</td>
										</tr>
										<tr class="row-even">
											<td height="20" class="row-odd">
											...
											<td height="20" align="left">&nbsp;
												<bean:write name="interviewResultEntryForm" property="applicantDetails.personalData.guardianStateName" />	
											</td>
											<td class="row-odd">
											<div align="right"><bean:message
												key="admissionForm.studentinfo.mobile.label" /></div>
											...
											<td height="20" align="left">&nbsp;
												<bean:write name="interviewResultEntryForm" property="applicantDetails.personalData.guardianMob1" />
												<bean:write name="interviewResultEntryForm" property="applicantDetails.personalData.guardianMob2" />
												<bean:write name="interviewResultEntryForm" property="applicantDetails.personalData.guardianMob3" />
											</td>
										</tr>
									</table>
									</td>
						...
						<logic:notEmpty name="interviewResultEntryForm" property="applicantDetails.interviewResultList">
							<tr>
							<td colspan="2" class="heading" align="left">&nbsp;<bean:message
