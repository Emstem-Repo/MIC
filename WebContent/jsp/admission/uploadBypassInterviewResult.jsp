...
function uploadBypassInResult(){
	document.getElementById("method").value="uploadBypassInterviewResult";
}
...
<html:form action="/uploadBypassInterview" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="uploadBypassInterviewResult" />
	<html:hidden property="formName" value="bypassInterviewForm" />
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt; <bean:message key="knowledgepro.admission.uploadBypassInterviewResult" /> &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> <bean:message key="knowledgepro.admission.uploadBypassInterviewResult" /></strong></div></td>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										<tr class="row-white">
			                				...
			                				<html:select property="programId"  styleId="program" onchange="getCourses(this.value)" styleClass="combo">
												<html:option value=""><bean:message key="knowledgepro.admin.select" /></html:option>
												<c:if test="${bypassInterviewForm.programTypeId != null && bypassInterviewForm.programTypeId != ''}">
										...
										<tr class="row-white">
											...
											<html:select property="courseId" styleId="course" styleClass="combo">
												<html:option value=""><bean:message key="knowledgepro.admin.select" /></html:option>
												<c:if test="${bypassInterviewForm.programId != null && bypassInterviewForm.programId != ''}">
											...
											<td class="row-even">
											<input type="hidden" id="tempyear" name="tempyear" value="<bean:write name="bypassInterviewForm" property="applicationYear"/>" />
											<html:select name="bypassInterviewForm" property="applicationYear" styleId="appliedYear" styleClass="combo">
												<html:option value=" "><bean:message key="knowledgepro.admin.select" /></html:option>
										...
										<tr>
											...
											<td class="row-odd"/>&nbsp;<td class="row-even"/>				
										</tr>
									</table>
									</td>
						...
						<tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<div align="center"><html:submit styleClass="formbutton" onclick="uploadBypassInResult()">
