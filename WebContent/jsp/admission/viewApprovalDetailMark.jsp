...
<table width="98%" border="0">
  <tr>
    <td><span class="Bredcrumbs"><bean:message key="knowledgepro.admission" /> <span class="Bredcrumbs">&gt;&gt; <bean:message key="admissionForm.detailmarkview.main.label"/> &gt;&gt;</span></span></td>
  </tr>
  <tr>
