...
<html:form action="/uniqueIdRegistration" method="POST">
	...
	<input type="hidden" name="courseId" value='<bean:write	name="uniqueIdRegistrationForm" property="applicantDetails.course.id" />' />	
	 ...
	 <tr>
		<td align="center">
		  <img width="700" height="100"  src='<%= request.getRequestURL().toString().replace(request.getRequestURI().substring(0), request.getContextPath()).concat("/LogoServlet") %>' alt="Logo not available">
		</td>
	</tr>
	<tr>
	  <td>
	 ...
	 <table width="100%" border="0" cellpadding="3" >
	   ...
	   <tr height="40%">
	    ...
	    <tr height="40%">
	     ...
	     <td>
	     <logic:equal value="true" name="uniqueIdRegistrationForm" property="applicantDetails.personalData.exservice">YES</logic:equal>
	     <logic:equal value="false" name="uniqueIdRegistrationForm" property="applicantDetails.personalData.exservice">NO</logic:equal>
	     </td>	     
	     <td></td><td></td><td></td>
	   </tr>
	   ...
	   <logic:equal value="true" name="uniqueIdRegistrationForm" property="applicantDetails.personalData.handicapped"> 
	    <tr>
	       <td><%=++num%></td><td>Differently abled</td><td>: </td><td><bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.hadnicappedDescription" />(<bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.handicapedPercentage" />%)</td>
	    </tr>	    
	    </logic:equal>
	                                                      
	   <logic:notEmpty name="uniqueIdRegistrationForm" property="applicantDetails.personalData.sports" >
	   <tr>
	     <td><%=++num%>.</td><td>Participation in Sports</td><td>: </td><td><bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.sports"/> (<bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.sportsParticipate"/>), <bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.sportsId"/></td>
	  </tr>
	   </logic:notEmpty>
	   <logic:notEmpty name="uniqueIdRegistrationForm" property="applicantDetails.personalData.arts" >
	   <tr>
	     <td><%=++num%>.</td><td>Participation in Cultural Activities</td><td>: </td><td><bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.arts"/> (<bean:write name="uniqueIdRegistrationForm" property="applicantDetails.personalData.artsParticipate"/>)</td>
	   </tr>
	   </logic:notEmpty>
	    <tr>
