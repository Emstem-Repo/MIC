...
<script type="text/javascript" language="javascript">
	...
	function cancelAction() {
    	document.location.href = "admMeritUpload.do?method=searchAdmMeritList";
    }
</script>

</head>
<html:form action="/admMeritUpload" method="POST">
...
<table width="100%" border="0">
  <tr>
    ...
    Admission MeritList Column Config&gt;&gt;</span></span></td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><strong class="boxheader">Admission MeritList Column Config</strong></td>
                  ...
                  <tr>
                   ...
                   <tr> 
                    ...
                    <td width="50%">
						...
						<html:option value="Category(sc_st_scbt)" styleClass="comboBig"></html:option>
						...
						<html:option value="Medium Instr" styleClass="comboBig"></html:option>
						<html:option value="Percentage" styleClass="comboBig"></html:option>
						<html:option value="First Preference" styleClass="comboBig"></html:option>
						<html:option value="Total Marks" styleClass="comboBig"></html:option>
						<html:option value="Max Marks" styleClass="comboBig"></html:option>
						<html:option value="Gender" styleClass="comboBig"></html:option>
						<html:option value="Address" styleClass="comboBig"></html:option>
						<html:option value="Weightage" styleClass="comboBig"></html:option>
