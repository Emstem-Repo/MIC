								...
								<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<td height="25" class="row-odd" width="15%">
											...
											<div align="center"><nested:write property="applicantDetails.personalData.recommendedBy"/></div>
											</td>
						...
						<tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="51%" height="45" align="left"><html:button property="" onclick="cancel()" styleClass="formbutton" value="Close"></html:button></td>
