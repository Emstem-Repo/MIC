...
<script type="text/javascript">
	...
	function getSubjectGroupDetails() {
		...
		document.getElementById("method").value = "addAddOnCourse";
	...
	function editSubjectGroup(id){
		document.location.href="addOnCourseDetails.do?method=editAddOnCourse&subjectGroupId="+id;
	}
	function updateSubjectGroupEntry() {
		document.getElementById("subjectGroupName").value = document
		.getElementById("subjectGroup").options[document
		.getElementById("subjectGroup").selectedIndex].text;
			document.getElementById("method").value = "updateAddOnCourse";
			document.subjectGroupDetailsForm.submit();
	}
	...
	function cancelPage(){
		document.location.href="addOnCourseDetails.do?method=initAddOnCourse";
	}
</script>
<html:form action="/addOnCourseDetails" method="post">
	...
	<table width="99%" border="0">
		<tr>
			<td><span class="Bredcrumbs">Admission <span class="Bredcrumbs">&gt;&gt;Add on Courses&gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<logic:present name="subjectGroupDetailsForm" property="addOnCourseList">
					<tr>
						<td valign="top" background="images/Tright_03_03.gif"></td>
						<td valign="top">
								...
								<table width="100%" border="0" align="center" cellpadding="0"
									...
									<tr>
										...
										<table width="100%" cellspacing="1" cellpadding="2">
											...
											<tr>
											<nested:iterate id="studentList" property="addOnCourseList"
												...
												<!-- <tr>-->
													...
													<td class="row-even">
														...
														<td class="row-even">
														<input type="hidden" name="addOnCourseList[<c:out value='${count}'/>].tempChecked"	id="hidden_<c:out value='${count}'/>"
																value="<nested:write name='studentList' property='tempChecked'/>" />
														
														<input type="checkbox" name="addOnCourseList[<c:out value='${count}'/>].checked" id="<c:out value='${count}'/>"  onclick="unCheckSelectAll()" />
																<script type="text/javascript">
				...
				<tr>
				<logic:present  name="subjectGroupDetailsForm" property="certificateMap">
					<tr>
						<td valign="top" background="images/Tright_03_03.gif"></td>
						<td valign="top">
						<table width="100%" border="0" align="center" cellpadding="0"
								...
								<table width="100%" cellspacing="1" cellpadding="2">
									<tr>
										...
										<html:select property="subjectGroupId" styleClass="comboLarge" disabled='<%=disable1%>' 
											...
											<html:option value="">
												<bean:message key="knowledgepro.select" />-</html:option>
															<html:optionsCollection name="subjectGroupDetailsForm" property="certificateMap"
				...
				<tr>
				<logic:present  name="subjectGroupDetailsForm" property="certificateCourseListTo">
                     ...
                     <tr>
                       ...
                       <td valign="top">
	                       ...
	                       <tr >
		                       ...
		                       <td width="10%" height="25" class="row-odd" ><div align="center">Add on Course name</div></td>
		                       <td width="6%" class="row-odd"><div align="center"><bean:message key="knowledgepro.edit"/> </div></td>
	                       </tr>
	                       <c:set var="temp" value="0"/>
	                       <logic:iterate id="subject" name="subjectGroupDetailsForm" property="certificateCourseListTo" indexId="count">
		                       <c:choose>
	                           	 <c:when test="${temp == 0}">
	                           		<tr>
				                       <td height="25" class="row-even"><div align="center"><c:out value="${count + 1}"/></div></td>
				                       
				                       <td class="row-even" ><div align="center"><bean:write name="subject" property="courseName"/></div></td>

				                       <td height="25" class="row-even" ><div align="center"><img src="images/edit_icon.gif" width="16" style="cursor:pointer" height="18" onclick="editSubjectGroup('<nested:write name="subject" property="id"/>')"></img></div></td>
	                               </tr>
	                    	    ...
	                    	    <c:otherwise>
			                     <tr >
			                        <td height="25" class="row-even"><div align="center"><c:out value="${count + 1}"/></div></td>
				                       ...
				                       <td class="row-even" ><div align="center"><bean:write name="subject" property="courseName"/></div></td>
				                       <td height="25" class="row-even" ><div align="center"><img src="images/edit_icon.gif" width="16" style="cursor:pointer" height="18" onclick="editSubjectGroup('<nested:write name="subject" property="id"/>')"></div></td>
			                     </tr>
	                     		 <c:set var="temp" value="0"/>
					  	       </c:otherwise>
	                        </c:choose>
