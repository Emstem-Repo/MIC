...
function showPayOnline(textValue){
	if(textValue=='test'){
		document.getElementById("pay").style.display='block';
	}	
	else document.getElementById("pay").style.display='none';
}
</script>
<body>
...
<table width="98%" border="0">
  ...
  <tr>
	...
	<tr>
          ...
          <tr>
            ...
            <td height="75" valign="top"><table width="100%" height="75" border="0" cellpadding="0" cellspacing="1">
              ...
              <tr class="row-even">
                ...
                <td height="20" class="row-white"><html:text property="challanNo" size="15" maxlength="30" onblur="showPayOnline(this.value)"></html:text></td>
     ...
     <tr>
        <td height="52" valign="top" background="images/Tright_03_03.gif"></td>
        <td colspan="2" valign="top" class="news"><div id="pay"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="5"  background="images/left.gif"></td>
            <td height="75" valign="top"><table width="100%" height="75" border="0" cellpadding="0" cellspacing="1">
                 <tr> <td align="center" class="heading" colspan="6" >OR</td></tr>
                 <tr class="row-even">
                <td height="20" class="row-odd"><div align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.applicationform.candidateName"/></div></td>
                <td height="20" class="row-even"><nested:text property="applicantName" size="30" maxlength="90"></nested:text></td>
                <td class="row-odd"><div align="right"><span class="Mandatory">*</span><bean:message key="admissionForm.studentinfo.dob.label"/><bean:message key="admissionForm.application.dateformat.label"/>
                          <br/><bean:message key="knowledgepro.applicationform.dob.format"/></div></td>
                <td height="20" class="row-even"><nested:text property="applicantDob" styleId="dateOfBirth" size="11" maxlength="11" ></nested:text>
              ...
              <tr><td colspan="2" valign="top" class="news"><div align="center">
              <table width="100%" height="27"  border="0" cellpadding="1" cellspacing="2">
                <tr>
                  <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="50%" height="45" align="right">
                      <html:button property="" onclick="payOnline()" styleClass="formbutton"  value="Pay Online"></html:button></td>
                    </tr>
                  </table></td>
                </tr>
              </table>
