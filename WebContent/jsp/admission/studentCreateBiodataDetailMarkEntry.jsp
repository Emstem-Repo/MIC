...
<body>
<html:form action="/studentBiodata">
<html:hidden property="method" value=""/>
<html:hidden property="pageType" value="15"/>
<html:hidden property="formName" value="StudentBiodataForm"/>
<table width="98%" border="0">
  <tr>
    <td><span class="Bredcrumbs">Admission <span class="Bredcrumbs">&gt;&gt; Detailed Marks Entry &gt;&gt;</span></span></td>
  </tr>
  <tr>
                   ...
                   <td height="35" colspan="6" class="body" ><table width="100%" cellspacing="1" cellpadding="2">
					...
					%>
                     <tr>
						 ...
						 <td  class="row-even" >
						 	<logic:notEmpty property="<%=propertyName %>" name="StudentBiodataForm">
							 	<logic:equal value="true" property="<%=dynaMandatory %>" name="StudentBiodataForm">
							 	<span class="Mandatory">*</span><bean:write property="<%=propertyName %>" name="StudentBiodataForm" ></bean:write>
								</logic:equal>
								<logic:equal value="false" property="<%=dynaMandatory %>" name="StudentBiodataForm">
									<html:text property="<%=propertyName %>" styleId='<%=propertyName %>' name="StudentBiodataForm" size="10" maxlength="20"></html:text>
								</logic:equal>
							</logic:notEmpty>
							<logic:empty property="<%=propertyName %>" name="StudentBiodataForm">
							 	<html:text property="<%=propertyName %>" styleId='<%=propertyName %>' name="StudentBiodataForm" size="10" maxlength="20"></html:text>
							</logic:empty>
						</td>
					...
					<tr>
						...
						<html:hidden property="detailMark.populated" name="StudentBiodataForm" value="true"/>
					</tr>
                   </table></td>
                 </tr>
                ...
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="45%" height="35"><div align="right">
                        <html:button property="" onclick="submitMe('submitDetailMark')" styleClass="formbutton" value="Submit"></html:button>
                    </div></td>
                    <td width="2%"><html:button property=""  styleClass="formbutton" value="Reset" onclick='<%=resetmethod %>'></html:button></td>
                    <td width="53%"><html:button property=""  styleClass="formbutton" value="Cancel" onclick="cancelCreateStudentMarkWindow()"></html:button></td>
                  </tr>
                </table>
                            </td>
                 </tr>
