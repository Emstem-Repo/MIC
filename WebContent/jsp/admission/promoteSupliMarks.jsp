...
function submitCsv(){
	document.getElementById("method").value ="uploadSupliMarks";
	document.admissionPromoteForm.submit();
}

function resetSupliMarks(){
	document.getElementById("thefile").value="";
	document.getElementById("academicYearId").value="";
	resetErrMsgs();
}
</script>
<html:form action="/admissionPromote" method="POST" enctype="multipart/form-data">
	<html:hidden property="formName" value="admissionPromoteForm" />
	<html:hidden property="method" value="uploadSupliMarks" />
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt; SupliMarks Upload &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> SupliMarks Upload</strong></div></td>
								...
								<tr>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										...
										<td height="25" class="row-odd" width="25%">
											...
											<html:file property="theFile" styleId="thefile" size="15" maxlength="30" name="admissionPromoteForm"/></label></td>
											<td height="25" class="row-odd" width="25%">
						...
						<tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<html:button property="" styleClass="formbutton" onclick="resetSupliMarks();">
