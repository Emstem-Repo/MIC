...
<html:form action="/disciplinaryDetails" method="POST">
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td valign="top" class="news"><div align="center">
             ...
             <c:if test="${disciplinaryDetailsForm.isLanguageWiseMarks == 'false'}">
			 	<tr>
			 		<td colspan="4">
             ...
             <tr >
	            ...
	            <c:if test="${disciplinaryDetailsForm.isLanguageWiseMarks == 'true'}">
					...
					<td height="25" class="row-odd" ><div align="left"><bean:message key="admissionForm.semmark.withlangtotal.label"/></div></td>
 					...
 					<c:choose>
				 	<c:when test="${disciplinaryDetailsForm.isLanguageWiseMarks == 'true'}">
              ...
              <nested:iterate property="semesterList" id="semId"  type="com.kp.cms.to.admin.ApplicantMarkDetailsTO" name="disciplinaryDetailsForm" indexId="count">
				<%
					String dynaStyle="";
					if(count%2==0)
						dynaStyle="row-even";
