...
<%@taglib uri="/WEB-INF/struts-tld/c.tld" prefix="c"%>
	...
	$(document).ready(function() {
	 $('#submit').click(function(e){
		 ...
		 if(regNo!=""){
			var url = "migrationCertificate.do?method=migrationCertificateSearch&regNo="+ regNo;
			myRef = window.open(url,"MC","left=20,top=20,width=600,height=700,toolbar=2,resizable=0,scrollbars=1");
		 }else{
...
<html:form action="/migrationCertificate" method="post">
...
<tr>
		<td><span class="Bredcrumbs"><bean:message key="knowledgepro.admission" /> <span class="Bredcrumbs">&gt;&gt;
			<bean:message key="knowledgepro.admission.migrationcertificate"/></span></span></td>
		</tr>
		<tr>
		<td valign="top">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="body"><strong
						class="boxheader"> Print <bean:message
						key="knowledgepro.admission.migrationcertificate" /></strong></td>
				...
				<tr>
					...
					<tr>
							...
							<div align="right">
							<html:submit property="" styleClass="formbutton" value="Print Migration Certificate"
