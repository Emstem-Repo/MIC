...
<script language="JavaScript">
	function submitExcel() {
		document.getElementById("method").value = "searchAdmissionBioData";
	}
	...
	<table width="98%" border="0">
		<tr>
			<td><span class="Bredcrumbs">Data Migration Report <span
				class="Bredcrumbs">&gt;&gt;Admission BioData Report &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
									...
									<tr>
											...
											<td height="25" class="row-even"><label> <html:select property="courseName" styleId="courseId">
				  							 	<html:option value=""><bean:message key="knowledgepro.select"/></html:option>
													<logic:notEmpty property="courses" name="dataMigrationForm">
