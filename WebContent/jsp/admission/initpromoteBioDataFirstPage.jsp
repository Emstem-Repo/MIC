...
<script language="JavaScript">
	function submitExcel() {
		document.getElementById("method").value = "searchPromoteBiodata";
	}
...
<html:form action="/promoteDataMigration" method="POST">
	<html:hidden property="method" styleId="method"
		value="searchPromoteBiodata" />
	<html:hidden property="formName" value="promoteBioDataUploadForm" />
	<html:hidden property="pageType" styleId="pageType" value="1" />
	<table width="98%" border="0">
		<tr>
			<td><span class="Bredcrumbs">Data Migration Report <span
				class="Bredcrumbs">&gt;&gt;Promote BioData Report &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> Promote BioData Report</strong></div>
					</td>
							...
							<table width="99%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<tr>
											...
											<td  height="25" class="row-even"><LABEL><html:select property="courseName" styleClass="combo" styleId="course" >
										<html:option value="">-<bean:message key="knowledgepro.select" />-</html:option>
											<logic:notEmpty name="promoteBioDataUploadForm" property="courses">
										<html:optionsCollection label="value" value="value" property="courses"/>
										</logic:notEmpty>
