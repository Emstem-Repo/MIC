        ...
        <td valign="top" class="news"><div align="center">
			 ...
			 <tr >
	           ...
	           <nested:select property="yearPass" styleClass="comboSmall" styleId='<%=dynayearId %>'>
				...
				<tr>
				<td class="row-even" colspan="1" ><div align="center"><html:text property="transUnvrAppNo" size="20" maxlength="50" ></html:text> </div></td>
				<td class="row-even" colspan="1" ><div align="center"><html:text property="transRegistationNo" size="20" maxlength="20" ></html:text> </div></td>
				<td class="row-even" colspan="2" ><div align="left"><html:textarea property="transArrearDetail" rows="4" cols="25"></html:textarea> </div></td>
				<td class="row-even" colspan="2" ><div align="left"><html:textarea property="transInstituteAddr" rows="4" cols="25"></html:textarea> </div></td>
				</tr>  
		         <tr>
                ...
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="45%" height="35"><div align="right">
                        <html:button property="" onclick="submitAdmissionForm('submitTransferEntry')" styleClass="formbutton" value="Submit"></html:button>
                    </div></td>
