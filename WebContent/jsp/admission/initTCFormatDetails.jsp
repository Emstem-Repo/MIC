...
<script type="text/javascript">
	...
	function getPracticalBatch() {
		...
		document.tCFormatDetailsForm.submit();
	}
</script>
<html:form action="/tcFormatDetails" method="post">
	...
	<table width="99%" border="0">
		<tr>
			<td><span class="Bredcrumbs"><bean:message key="knowledgepro.admission" /> <span class="Bredcrumbs">&gt;&gt;<bean:message
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<td  class="row-even"><input type="hidden"
										id="yr" name="yr"
										value='<bean:write name="tCFormatDetailsForm" property="academicYear"/>' />
									...
									<td   class="row-even"><input type="hidden"
										name="c1" id="c1"
										value='<bean:write name="tCFormatDetailsForm" property="classId"/>' />
									<html:select property="classId" styleClass="comboLarge"
										...
										<c:choose>
											...
											<c:otherwise>
												<c:if
													test="${tCFormatDetailsForm.classId != null && tCFormatDetailsForm.classId != ''}">
													<c:set var="classMap"
								...
								<tr>
									...
									<input type="hidden"
										id="yr1" name="yr1"
										value='<bean:write name="tCFormatDetailsForm" property="year"/>' />
