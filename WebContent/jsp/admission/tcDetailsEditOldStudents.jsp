						...
						<tr>
							...
							<%String dynastyle=""; %>
								...
								<tr>
									...
									<td   class="row-even">
									<html:text name="tcDetailsOldStudentsForm" property="registerNo" styleId="registerNo" size="10" maxlength="16"/>
									</td>
								</tr>
								...
								<tr>
									...
									<td   class="row-even">
									<html:text name="tcDetailsOldStudentsForm" property="name" styleId="name" size="30" maxlength="30"/>
									</td>
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<html:submit styleClass="formbutton" styleId="edit" value="Update" onclick="addStudent()"></html:submit> &nbsp;
							<html:button property="" styleId="sap" styleClass="formbutton" value="Update And Print" onclick="submitAndPrint()"></html:button>
