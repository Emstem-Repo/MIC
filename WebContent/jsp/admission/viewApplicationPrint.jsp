...
<html:form action="/AdmissionStatus" method="POST">
	    ...
	    <table width="100%">
	      <tr>
	        <td width="40%">
	          ...
	          <tr>
	            <td>Subject Applied For</td><td>: </td><td><bean:write name="admissionStatusForm" property="applicantDetails.preference.firstprefCourseName"/></td>
	           </tr>
	          </logic:equal> 
	           <tr>
	            <td>Application No</td><td>: </td><td><bean:write name="admissionStatusForm" property="applicantDetails.applnNo"/></td>
	           </tr>
	           <tr>
	            <td><bean:write name="admissionStatusForm" property="applicantDetails.mode"/> No.</td><td>: </td><td><bean:write name="admissionStatusForm" property="applicantDetails.journalNo"/></td>
	           </tr>
	           <tr>
	...
	<tr>
	  <td style="font-size:medium; font-weight: bold" align="center" align="center">APPLICATION FOR ADMISSION TO BACHELOR'S PROGRAMME - 2015</td>
	</tr>
	</logic:equal>
	
	<logic:equal value="2" name="admissionStatusForm" property="applicantDetails.programType">
	<tr>
	  <td style="font-size:medium; font-weight: bold" align="center" align="center">APPLICATION FOR ADMISSION TO POSTGRADUATE PROGRAMME - 2015</td>
	</tr>
	</logic:equal>
	...
	<tr>
	 ...
	 <table width="100%" border="0" cellpadding="3" >
	   <tr height="40%">
	     <td>1.</td><td >Name</td><td>: </td><td><bean:write name="admissionStatusForm" property="applicantDetails.personalData.firstName"></bean:write>&nbsp;
				                    </td><td></td><td></td><td></td>
		 </tr>
	   
	   <tr height="40%">
	     <td>2.</td><td>Gender</td><td>: </td><td><logic:equal name="admissionStatusForm" property="applicantDetails.personalData.gender" value="MALE"><bean:message key="admissionForm.studentinfo.sex.male.text"/></logic:equal>
											<logic:equal name="admissionStatusForm" property="applicantDetails.personalData.gender" value="FEMALE"><bean:message key="admissionForm.studentinfo.sex.female.text"/></logic:equal></td><td></td><td></td><td></td>
	   </tr>
	   
	   <tr height="40%">
	     <td>3.</td><td>Date of Birth</td><td>: </td><td><bean:write name="admissionStatusForm" property="applicantDetails.personalData.dob"></bean:write></td><td></td><td></td><td></td>
	   </tr>
	   
	   <tr height="40%">
	     <td>4.</td><td>Nationality</td><td>: </td><td><bean:write	name="admissionStatusForm" property="applicantDetails.personalData.citizenship" /></td><td></td><td></td><td></td>
	   </tr>
	   
	   <tr height="40%">
	     <td>5.</td><td>Domicile State</td><td>: </td><td><bean:write name="admissionStatusForm" property="applicantDetails.personalData.residentCategoryName" /></td><td></td><td></td><td></td>
	   </tr >
	   ...
	   <tr height="40%">
	    ...
	    <tr height="40%">
	     <td>7.</td><td>Caste</td><td>: </td><td>
	     <bean:write name="admissionStatusForm" property="applicantDetails.personalData.casteCategory" /></td><td></td><td></td><td></td>
	   </tr>
	   
	   <tr height="40%">
	     <td>8.</td><td>Category</td><td>: </td><td><bean:write
												name="admissionStatusForm"
												property="applicantDetails.personalData.subregligionName" /></td>
	   </tr>
	   
	   <tr height="40%">
	     <td>9.</td><td>Name of Father</td><td>: </td><td><bean:write name="admissionStatusForm" property="applicantDetails.titleOfFather"/>. 
											<bean:write name="admissionStatusForm" property="applicantDetails.personalData.fatherName"></bean:write></td><%--<td colspan="3">Occupation : 
	   ...
	   <%--
	   <tr height="40%">
	     <td>10.</td><td>Name of Mother</td><td>: </td><td><nested:write name="admissionStatusForm" property="applicantDetails.titleOfMother"/>. 
											<bean:write name="admissionStatusForm" property="applicantDetails.personalData.motherName"></bean:write></td><td colspan="3">Occupation : 
											
											<logic:notEmpty name="admissionStatusForm"   property="applicantDetails.personalData.motherOccupation"><bean:write   name="admissionStatusForm"   property="applicantDetails.personalData.motherOccupation" /></logic:notEmpty>
											<logic:notEmpty name="admissionStatusForm"   property="applicantDetails.personalData.otherOccupationMother"><bean:write   name="admissionStatusForm"   property="applicantDetails.personalData.otherOccupationMother" /></logic:notEmpty></td>
											
											
	   </tr>
	    
	   <tr height="40%">
	     <td>11.</td><td>Annual Income</td><td>: </td><td><bean:write name="admissionStatusForm" property="applicantDetails.personalData.fatherIncome"></bean:write>,
										</td><td></td><td></td><td></td>
	   </tr>
	   --%>
	   <tr height="40%">
	     <td valign="top">12.</td><td valign="top">Permanent Address</td><td valign="top">: </td><td><nested:write name="admissionStatusForm" property="applicantDetails.personalData.permanentAddressLine1"></nested:write>,
										<nested:write name="admissionStatusForm" property="applicantDetails.personalData.permanentAddressLine2"></nested:write>,
										<nested:write name="admissionStatusForm" property="applicantDetails.personalData.permanentCityName"></nested:write>
										</td><td></td><td></td><td></td>
	   </tr>
	   <tr height="40%">
	     <td></td><td></td><td></td><td>
										...
										<nested:write name="admissionStatusForm" property="applicantDetails.personalData.permanentAddressZipCode"></nested:write></td><td></td><td></td><td></td>
	   </tr>
	   <%-- 
	   <tr height="40%">
	     <td valign="top">13.</td><td valign="top">Present Address</td><td valign="top">: </td><td><nested:write name="admissionStatusForm"  property="applicantDetails.personalData.currentAddressLine1"></nested:write>,
										<nested:write name="admissionStatusForm" property="applicantDetails.personalData.currentAddressLine2"></nested:write>,
										<nested:write name="admissionStatusForm" property="applicantDetails.personalData.currentCityName"></nested:write>
										</td><td></td><td></td><td></td>
	   </tr>
	    <tr height="40%">
	     <td></td><td></td><td></td><td><bean:write
										...
										<nested:write name="admissionStatusForm" property="applicantDetails.personalData.currentAddressZipCode"></nested:write></td><td></td><td></td><td></td>
	   </tr>
	   --%>
	   <tr height="40%">
	     <td>14.</td><td>Phone Land</td><td>: </td><td><bean:write name="admissionStatusForm" property="applicantDetails.personalData.landlineNo"/></td>
	     <td colspan="3">Mobile : <bean:write name="admissionStatusForm" property="applicantDetails.personalData.mobileNo" /></td>
	   </tr>
	  
	   
	   <tr height="40%">
	     <td>15.</td><td>E - Mail</td><td>: </td><td><nested:write name="admissionStatusForm" property="applicantDetails.personalData.email"></nested:write></td><td></td><td></td><td></td>
	   </tr>
	    <% int num = 15; %>
	   <logic:notEmpty name="admissionStatusForm" property="applicantDetails.personalData.sports" >
	   <tr>
	     <td><%=++num%></td><td>Participation in Sports</td><td>: </td><td><bean:write name="admissionStatusForm" property="applicantDetails.personalData.sports"/> (<bean:write name="admissionStatusForm" property="applicantDetails.personalData.sportsParticipate"/>)</td>
	   </tr>
	   </logic:notEmpty>
	   <logic:notEmpty name="admissionStatusForm" property="applicantDetails.personalData.arts" >
	   <tr>
	     <td><%=++num%></td><td>Participation in Cultural Activities</td><td>: </td><td><bean:write name="admissionStatusForm" property="applicantDetails.personalData.arts"/> (<bean:write name="admissionStatusForm" property="applicantDetails.personalData.artsParticipate"/>)</td>
	   </tr>
	   </logic:notEmpty>
	  ...
	  <td colspan="7">
	    <table border='1' width="800" height='100' cellpadding="3" style="border-collapse: collapse; border: 1px solid #0000;">
           <tr style="font-size:small; font-weight: bold">
             ...
             <td align="center" rowspan='2' style="border:1px solid black; border-collapse: collapse ">Name of Institution</td>
             <td align="center" colspan='3' style="border:1px solid black; border-collapse: collapse ">Marks/CGPA</td>
           </tr>
           <tr style="font-size:small; font-weight: bold">
          ...
          <tr>
             <td style="border:1px solid black; border-collapse: collapse ">
											    ...
											    <logic:notEmpty name="ednQualList" property="totalMarks">
											    ...
											    <logic:notEmpty name="ednQualList" property="marksObtained">
	...
	<tr >
	 <logic:equal value="1" name="admissionStatusForm" property="applicantDetails.programType">
	  <td align="center" align="center" style="font-size:small; font-weight: bold">Statement of Plus Two Marks</td>
	  </logic:equal>
	   <logic:equal value="2" name="admissionStatusForm" property="applicantDetails.programType">
	  <td align="center" align="center" style="font-size:small; font-weight: bold">Statement of Degree Marks</td>
	  </logic:equal>
	</tr>
	<tr>
	  <td>
	    <table cellpadding="3" align="center" width="100%" border="1" style="border:1px solid black; border-collapse: collapse ">
	      ...
	      <tr>
	        ...
	        <td style="font-size:small; font-weight: bold" align="right" style="border:1px solid black; border-collapse: collapse ">Total Marks</td><td style="border:1px solid black; border-collapse: collapse "><%=obtained%></td><td style="border:1px solid black; border-collapse: collapse "><%=total%></td>
	          ...
	          <logic:equal value="2" name="admissionStatusForm" property="applicantDetails.programType">
	        <td colspan="2" style="font-size:small; font-weight: bold" align="right" style="border:1px solid black; border-collapse: collapse ">Total Marks/CGPA</td><td style="border:1px solid black; border-collapse: collapse "><%=obtainedpg%></td><td style="border:1px solid black; border-collapse: collapse "><%=totalpg%></td>
	         </logic:equal>
	...
	<tr>
	 <td>
	   ...
	   <logic:equal value="1" name="admissionStatusForm" property="applicantDetails.programType">
	     <tr>
	       <td><%=++num%></td><td>No. of chances taken to pass plus two</td><td>: </td><td><%=noofattempt %></td>
	     </tr>
	   </logic:equal>
    ...
    <tr>
	 <td>
	   <table>
	     <logic:equal value="1" name="admissionStatusForm" property="applicantDetails.programType">
	     <tr>
	     <td><%=++num%></td><td>Second Language Opted for </td><td>: </td><td><bean:write name="admissionStatusForm" property="applicantDetails.personalData.secondLanguage" /></td>
	     </tr>
	     </logic:equal>
	
	     <logic:equal value="1" name="admissionStatusForm" property="applicantDetails.programType"> 
	     <tr>
	       <td><%=++num%></td><td> Add-On Course Opted for</td><td>: </td><td><bean:write name="admissionStatusForm" property="applicantDetails.addonCourse" /></td>
	    </tr>
	    </logic:equal>
	    <logic:equal value="2" name="admissionStatusForm" property="applicantDetails.programType"> 
	     <tr>
	       <td><%=++num%></td><td> Course Studied for Degree</td><td>: </td><td><bean:write name="admissionStatusForm" property="applicantDetails.personalData.ugcourse" /></td>
	    </tr>
	    </logic:equal>
	    
	    <logic:equal value="true" name="admissionStatusForm" property="applicantDetails.personalData.handicapped"> 
	    <tr>
	       <td><%=++num%></td><td>Differently abled</td><td>: </td><td><bean:write name="admissionStatusForm" property="applicantDetails.personalData.hadnicappedDescription" /></td>
	    </tr>
	    
	    </logic:equal>
	    <%--
	     <tr>
	     <td><%=++num%></td><td>Eligibility for Bonus Marks</td><td>: </td><td>
    ...
    <table>
	 ...
	 <tr>
	  <td align="left">The above information is true to the best of my knowledge and I shall abide by the rules and regulations of the college currently prevailing/Which may be amended from time to time.<br></br></td>
	</tr>
	 ...
	 <tr>
	  <td align="center" align="center" style="font-size:medium; font-weight: bold"><font style="text-decoration: underline"><br></br>FOR OFFICE USE ONLY<br></br></font></td>
	</tr>
	 <tr><td><p></p></td></tr>
	<tr>
	  <td>
	    <table width="100%">
	        ...
	        <tr><td width="20%">Programme</td><td>: </td><td>..................................................................................................</td> </tr>
	        <tr><td>Date of Admission</td><td>: </td><td>..................................................................................................</td></tr>
	        <tr><td>Admitted Quota </td><td>: </td><td>..................................................................................................</td></tr> 
	        <tr><td>Whether Eligible for concession (Specify Category)</td><td>: </td><td>..................................................................................................</td></tr>  
	       </table>
	  </td>
	 </tr>
	 <tr>
	    <td>
	      <table width="100%">
	        <tr style="font-size:small; font-weight: bold">
	         <td align="left">Date: </td><td align="center">Signature of the Officer </td><td align="right">Principal</td>
	        </tr>
	      </table>
	    </td>
	  </tr>  
