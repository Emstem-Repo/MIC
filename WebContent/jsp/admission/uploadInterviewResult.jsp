...
function uploadINResult(){
	...
	document.getElementById("method").value="uploadInterviewResultEntry";
}
...
function downloadINResult(){
	document.getElementById("pageType").value="4";
	document.getElementById("method").value="downloadInterviewResultEntry";
	document.interviewResultEntryForm.submit();
}
</script>
<html:form action="/uploadInterviewResult" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="uploadInterviewResultEntry" />
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt; <bean:message key="knowledgepro.admission.uploadInterviewResult" /> &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> <bean:message key="knowledgepro.admission.uploadInterviewResult" /></strong></div></td>
										...
										<tr>
											...
											<html:select property="interviewTypeId" name="interviewResultEntryForm" styleId="interviewType" onchange="getinterviewSubrounds(this.value)" styleClass="combo">
													...
													<c:if test="${interviewMap != null}">
														<html:optionsCollection name="interviewMap" label="value" value="value" />
													</c:if>
											</html:select>
											</td>
										</tr>
						...
						<tr>
							...
							<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<div align="right">&nbsp;<span class="Mandatory">*</span><bean:message key="knowledgepro.interview.interviewdate" />:</div>
									</td>
									<td height="25" class="row-even">
									...
									<script language="JavaScript">
										new tcal( {
											// form name
											'formname' :'interviewResultEntryForm',
											// input name
									...
									<td class="row-even">
									<html:text name="interviewResultEntryForm" property="startingTimeHours" styleClass="Timings" value="00" styleId="startingTimeHours" size="2" maxlength="2"  onfocus="clearField(this)" onblur="checkForEmpty(this)" onkeypress="return isNumberKey(event)"/>							
									:
									<html:text name="interviewResultEntryForm" property="startingTimeMins" styleClass="Timings" value="00" styleId="startingTimeMins" size="2" maxlength="2"  onfocus="clearField(this)" onblur="checkForEmpty(this)" onkeypress="return isNumberKey(event)"/>
									</td>
									<td class="row-odd">
									<div align="right">&nbsp;<bean:message key="knowledgepro.interview.EndTime" /></div>
									</td>
									<td class="row-even">
									<html:text name="interviewResultEntryForm" property="endingTimeHours" styleClass="Timings" value="00" styleId="endingTimeHours" size="2" maxlength="2"  onfocus="clearField(this)" onblur="checkForEmpty(this)" onkeypress="return isNumberKey(event)"/>							
									:
									<html:text name="interviewResultEntryForm" property="endingTimeMins" styleClass="Timings" value="00" styleId="endingTimeMins" size="2" maxlength="2"  onfocus="clearField(this)" onblur="checkForEmpty(this)" onkeypress="return isNumberKey(event)"/>
									</td>
								</tr>
									</table>
									</td>
					...
					<table width="100%" height="106" border="0" cellpadding="1" cellspacing="2">
						<tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="45%" height="35">
									<div align="center"><html:button property="" styleClass="formbutton" onclick="downloadINResult()">
									Dowload File</html:button>
...
var print = "<c:out value='${interviewResultEntryForm.export}'/>";
