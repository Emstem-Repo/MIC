...
function updateCourses(req) {
	...
	getCentersByProgram("centerMap",programId,"center",updateCenters);
}

function updateCenters(req) {
	updateOptionsFromMap(req,"center","- Select -");
	document.getElementById("centerName").value =	document.getElementById("center").options[document.getElementById("center").selectedIndex].text;
...
<html:form action="/candidatesearch" focus="programType">

	<html:hidden property="method" styleId="method"	value="submitCandidateSearch" />
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> <bean:message key="knowledgepro.admission.report"/> </strong></div>
					</td>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								<tr>
									...
									<html:select
										...
										<c:if
											test="${candidateSearchForm.programTypeId != null && candidateSearchForm.programTypeId != ''}">
									...
									<html:select property="courseId"
										...
										<c:if
											test="${candidateSearchForm.programId != null && candidateSearchForm.programId != ''}">
								...
								<tr>
									...
									<input
										...
										value="<bean:write name="candidateSearchForm" property="year"/>" />
									...
									<html:select property="interviewType" styleClass="combo"
										...
										<c:if
											test="${candidateSearchForm.interviewType != null && candidateSearchForm.interviewType != ''}">
								...
								<tr>
									...
									<td height="25" class="row-even"><html:text name="candidateSearchForm" 
								...
								<tr>
									...
									<td height="25" class="row-even">
										<html:select property="status" 
											...
											<html:option value="other">Waitlisted/Rejected</html:option>
										</html:select>
								...
								<tr>
									<td height="25" class="row-odd"><div align="right"><bean:message
										key="knowledgepro.amdission.report.admission.date.from" />:</div></td>
									<td height="25" class="row-even"><html:text name="candidateSearchForm" 
										property="admissionDateFrom" styleId="admissionDateFrom" 
										size="15" maxlength="15" />
											<script
											language="JavaScript">
											new tcal( {
												...
												'formname' :'candidateSearchForm',
												// input name
												'controlname' :'admissionDateFrom'
											});
										</script>
									</td>
									<td height="25" class="row-odd"><div align="right"><bean:message
										key="knowledgepro.amdission.report.admission.date.to" />:</div></td>
									<td height="25" class="row-even"><html:text name="candidateSearchForm" 
										property="admissionDateTo" styleId="admissionDateTo" 
										size="15" maxlength="15" />
											<script
											language="JavaScript">
											new tcal( {
								...
								<tr>
								 ...
								 <tr>
									...
									<td width="17%" height="25" class="row-even"><label>
									<html:select
										property="centerId"  styleId="center" styleClass="combo">
										<html:option value=""><bean:message key="knowledgepro.admin.select" /></html:option>
										<c:if
											test="${candidateSearchForm.centerId != null && candidateSearchForm.centerId != ''}">
											<c:set var="centerMap"
												value="${baseActionForm.collectionMap['centerMap']}" />
											<c:if test="${centerMap != null}">
												<html:optionsCollection name="centerMap" label="value" value="key" />
											</c:if>
										</c:if>
									</html:select>
