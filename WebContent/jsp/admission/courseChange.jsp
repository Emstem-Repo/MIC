...
<html:form action="/CourseChange">
	<html:hidden property="method" value="displayCourse" />
...
<div align="right"> <span class='MandatoryMark'><bean:message key="knowledgepro.mandatoryfields"/></span></div>
						...
						<tr>
							...
							<input type="hidden" id="tempyear" name="tempyear" value="<bean:write name="courseChangeForm" property="applicationYear"/>"/>
							<html:select
