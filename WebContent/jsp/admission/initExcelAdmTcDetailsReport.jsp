...
<script type="text/javascript" language="javascript">
	...
	function cancelAction() {
    	document.location.href = "admTcDetails.do?method=searchAdmTcDetails";
    }
</script>

</head>
<html:form action="/admTcDetails" method="POST">
...
<html:hidden property="formName" value="admissionTcDetailsForm" />
...
<table width="100%" border="0">
  <tr>
    ...
    Admission Tc Details Column Config&gt;&gt;</span></span></td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><strong class="boxheader">Admission Tc Details Column Config</strong></td>
                  ...
                  <tr>
                   ...
                   <tr> 
                    ...
                    <td width="50%">
						...
						<html:option value="RegNo" styleClass="comboBig"></html:option>
						<html:option value="Date Adm" styleClass="comboBig"></html:option>
						<html:option value="Tc No" styleClass="comboBig"></html:option>
						<html:option value="Tc Date" styleClass="comboBig"></html:option>
						...
						<html:option value="Section" styleClass="comboBig"></html:option>
						<html:option value="Second Language" styleClass="comboBig"></html:option>
						<html:option value="Subject1" styleClass="comboBig"></html:option>
						<html:option value="Subject2" styleClass="comboBig"></html:option>
						<html:option value="Subject3" styleClass="comboBig"></html:option>
						<html:option value="Subject4" styleClass="comboBig"></html:option>
						<html:option value="Public Exam" styleClass="comboBig"></html:option>
						<html:option value="Exam RegNo" styleClass="comboBig"></html:option>
						<html:option value="Exam Month Year" styleClass="comboBig"></html:option>
						<html:option value="Passed" styleClass="comboBig"></html:option>
						<html:option value="Passed Language" styleClass="comboBig"></html:option>
						<html:option value="Passed Subject" styleClass="comboBig"></html:option>
						<html:option value="Scholarship" styleClass="comboBig"></html:option>
						<html:option value="Free Ship" styleClass="comboBig"></html:option>
						<html:option value="Fees Paid" styleClass="comboBig"></html:option>
						<html:option value="Deg Class" styleClass="comboBig"></html:option>
						<html:option value="Date Leave" styleClass="comboBig"></html:option>
						<html:option value="Reason Leave" styleClass="comboBig"></html:option>
						<html:option value="Caste" styleClass="comboBig"></html:option>
						<html:option value="Tc Given" styleClass="comboBig"></html:option>
						</html:select>
					</td>
                	<td width="15%">	
