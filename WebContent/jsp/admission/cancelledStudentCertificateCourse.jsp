...
<html:form action="/StudentCertificateCourse">
	<html:hidden property="method" styleId="method"
		value="getCancelledStudentCertificateCourse" />
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<td width="22%"  class="row-even" valign="top"><html:text
										property="registerNO" styleId="registerNo"></html:text></td>
								<td width="23%"  height="25" class="row-odd">
									<div align="right"><span class="Mandatory">*</span>
										<bean:message key="knowledgepro.certificate.course.Semester"/>:</div>
								</td>
									
								<td width="23%"  height="25" valign="top" class="row-even"> <input type="hidden" id="schemeorcourse" name="schemeorcourse"
								value='<bean:write name="studentCertificateCourseForm" property="semester"/>' />
							      <div align="left">  <html:select property="semester" styleClass="combo" styleId="semester">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<div align="center"><html:submit property=""
								styleClass="formbutton" value="Search" styleId="submitbutton">
							</html:submit></div>
							</td>
						</tr>
					</table>
