...
<script language="JavaScript">
	function submitExcel() {
		document.getElementById("method").value = "promoteBioDataUpload";
		var academicYear = document.getElementById("academicYearId").value;
		document.location.href = "promoteBioData.do?method=promoteBioDataUpload&academicYear="
				+ academicYear;
...
<html:form action="/promoteBioData" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method"
		value="promoteBioDataUpload" />
	...
	<table width="98%" border="0">
		<tr>
			<td><span class="Bredcrumbs">Data Migration <span
				class="Bredcrumbs">&gt;&gt;Promote BioData &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> Promote BioData</strong></div>
					</td>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										<tr>
											...
											<td height="25" class="row-even"><label> <html:file
												...
												maxlength="30" name="promoteBioDataUploadForm" /></label></td>
										</tr>
									</table>
									</td>
