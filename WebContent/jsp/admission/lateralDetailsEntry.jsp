...
<table width="98%" border="0">
  <tr>
    <td><span class="Bredcrumbs"><bean:message key="knowledgepro.admission" /><span class="Bredcrumbs">&gt;&gt; <bean:message key="admissionForm.lateralentry.main.label"/> &gt;&gt;</span></span></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="10"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="body" ><div align="left"><strong class="boxheader"><bean:message key="admissionForm.lateralentry.main.label"/></strong></div></td>
        ...
        <td valign="top" class="news"><div align="center">
			 ...
			 <tr >
	           ...
	           <nested:select property="yearPass" styleClass="comboSmall" styleId='<%=dynayearId %>'>
				...
				<tr>
				<td class="row-even" colspan="2" ><div align="center"><html:text property="lateralUniversityName" size="20" maxlength="50" ></html:text> </div></td>
				<td class="row-even" colspan="2" ><div align="center"><html:text property="lateralStateName" size="20" maxlength="20" ></html:text> </div></td>
				<td class="row-even" colspan="2" ><div align="center"><html:textarea property="lateralInstituteAddress" rows="4" cols="25"></html:textarea> </div></td>
				</tr>  
		         <tr>
                ...
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="45%" height="35"><div align="right">
                        <html:button property="" onclick="submitAdmissionForm('submitLateralEntry')" styleClass="formbutton" value="Submit"></html:button>
                    </div></td>
                    ...
                    <td width="53%"><div align="left"><html:button property=""  styleClass="formbutton" value="Cancel" onclick="submitCancelButton()"></html:button></div></td>
                  </tr>
                </table>
                            </td>
                 </tr>
