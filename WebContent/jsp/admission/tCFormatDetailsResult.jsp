...
<script type="text/javascript">
	function cancelAction() {
		document.location.href = "tcFormatDetails.do?method=initTCDetails";
	}
	function editDetails(studentId) {
		document.location.href = "tcFormatDetails.do?method=getStudentDetails&studentId="+studentId;
	}
</script>
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								<tr>
									...
									<td   class="row-even">
									<bean:write name="tCFormatDetailsForm" property="registerNo"/>
									</td>
									<td class="row-odd"></td>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								<nested:notEmpty name="tCFormatDetailsForm" property="boardList">
								<nested:iterate id="bdForm" name="tCFormatDetailsForm" property="boardList" indexId="count">
									<tr class="row-even"> 
