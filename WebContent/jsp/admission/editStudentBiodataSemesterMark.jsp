    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td valign="top" class="news"><div align="center">
             ...
             <c:if test="${StudentBiodataForm.isLanguageWiseMarks == 'false'}">
			 	<tr>
			 		<td colspan="4">
             ...
             <tr >
	            ...
	            <c:if test="${StudentBiodataForm.isLanguageWiseMarks == 'true'}">
					...
					<td height="25" class="row-odd" ><div align="left"><bean:message key="admissionForm.semmark.withlangtotal.label"/></div></td>
 					...
 					<c:choose>
				 	<c:when test="${StudentBiodataForm.isLanguageWiseMarks == 'true'}">
              ...
              <nested:iterate property="semesterList" id="semId"  type="com.kp.cms.to.admin.ApplicantMarkDetailsTO" name="StudentBiodataForm" indexId="count">
				<%
					String dynaStyle="";
					if(count%2==0)
						dynaStyle="row-even";
                ...
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="45%" height="35"><div align="right">
                        <html:button property="" onclick="submitMe('submitSemesterEditMark')" styleClass="formbutton" value="Submit"></html:button>
                    </div></td>
