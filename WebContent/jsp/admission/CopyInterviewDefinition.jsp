...
function searchDetails(){		
	document.getElementById("method").value="searchCopyInterviewDefinition";
}
...
function copySelected(){
	document.getElementById("method").value="copyInterviewDefinition";
}
function cancelAction() {
	document.location.href = "copyInterviewDefinition.do?method=initCopyInterviewDefinition";
}
</script>
<html:form action="/copyInterviewDefinition" method="post">
	<html:hidden property="method" styleId="method" />
	<html:hidden property="formName" value="copyInterviewDefinitionForm" />
	...
	<table width="100%" border="0">
		<tr>
			...
			<bean:message key="knowledgepro.admission.copyInterviewDefinition"/>
			 &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td valign="top">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="body"><strong
						class="boxheader"> <bean:message key="knowledgepro.admission.copyInterviewDefinition"/> Entry</strong></td>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<td width="30%" class="row-even"><input type="hidden"
										id="yr" name="yr"
										value='<bean:write name="copyInterviewDefinitionForm" property="fromYear"/>' />
									...
									<td width="30%" class="row-even"><input type="hidden"
										id="toyrId" name="toyr"
										value='<bean:write name="copyInterviewDefinitionForm" property="toYear"/>' />
				...
				<logic:notEmpty name="copyInterviewDefinitionForm" property="displayInterviewDefinition">	
				<tr>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<nested:iterate id="intList" name="copyInterviewDefinitionForm" property="displayInterviewDefinition"
											indexId="count">
										<tr>
											<c:choose>
											...
											<td width="6%" height="25" class="row-even">
															...
															<td width="20%" class="row-even" align="center"><bean:write
																name="intList" property="programTypeName" /></td>
