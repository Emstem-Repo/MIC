...
function onLoadAddrCheck()
{
	...
	function detailSubmit(count)
	{
		...
		document.StudentBiodataForm.method.value="initDetailMarkPage";
		document.StudentBiodataForm.submit();
	}
	function detailSemesterSubmit(count)
	{
		document.getElementById("countID").value=count;
		document.StudentBiodataForm.method.value="initSemesterMarkEditPage";
		document.StudentBiodataForm.submit();
	}
	...
	{
		document.StudentBiodataForm.method.value="initlateralEntryPage";
		document.StudentBiodataForm.submit();
	}
	function detailTransferSubmit()
	{
		document.StudentBiodataForm.method.value="initTransferEntryPage";
		document.StudentBiodataForm.submit();
	}
...
<html:form action="/studentBiodata" enctype="multipart/form-data" method="POST">
	...
	<input type="hidden" name="applicationId"
		value='<bean:write name="StudentBiodataForm" property="applicantDetails.applicationId" />' />

	<input type="hidden" name="courseId" value='<bean:write	name="StudentBiodataForm" property="applicantDetails.course.id" />' />
	
	<table width="100%">
		<tr>
			<td><span class="Bredcrumbs"><bean:message
				key="knowledgepro.admission" /> <span class="Bredcrumbs">&gt;&gt;
			<bean:message key="admissionForm.studentedit.main.label" />
			&gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"><bean:message
						key="admissionForm.studentbiodata.mainbiodata.label" /></strong></div>
					</td>
				...
				<tr>
					...
					<table width="100%" cellpadding="1"
						cellspacing="2">
						<tr>
							<td colspan="4" class="heading" align="left">&nbsp;<bean:message key="admissionForm.studentedit.main.label"/></td>
						</tr>
						<tr>
							...
							new tcal( {
								...
								'controlname' :'challanDate'
										...
										<tr class="row-even">
											...
											<td height="19" class="row-even"><div align="left">&nbsp;&nbsp;<nested:text property="applicantDetails.admissionDate" styleId="admDate" size="10" maxlength="10"></nested:text>
												<script language="JavaScript">
													new tcal( {
														// form name
														'formname' :'StudentBiodataForm',
						...
						<tr>
							...
							<table width="100%" border="0" align="top" cellpadding="0"
								...
								<tr>
										...
										<tr>
											...
											<td height="35" class="row-even" align="left">
												<nested:select property="applicantDetails.personalData.birthCountry" styleClass="combo" styleId="birthCountry" onchange="getStates(this.value,'birthState');">
													...
													<%String selected=""; %>
													<logic:iterate id="option" property="countries" name="StudentBiodataForm">
									...
									<logic:equal value="Other" property="applicantDetails.personalData.birthState" name="StudentBiodataForm">
										<%dynastyle="display:block;"; %>
									</logic:equal>
									<logic:notEqual value="Other" property="applicantDetails.personalData.birthState" name="StudentBiodataForm">
										<%dynastyle="display:none;"; %>
													...
													<td><nested:select property="applicantDetails.personalData.birthState"
														...
														<c:if
															test="${StudentBiodataForm.applicantDetails.personalData.birthCountry!= null && StudentBiodataForm.applicantDetails.personalData.birthCountry != ''}">
							...
							<table width="100%" border="0" align="center" cellpadding="0"
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<tr>
											...
											<td height="20" class="row-even" align="left"><table width="100%" border="0" cellpadding="0" cellspacing="0">
												...
												<input type="hidden" id="religionType" name="religionType" value='<bean:write name="StudentBiodataForm" property="applicantDetails.personalData.religionId"/>'/>
												<logic:notEqual value="Other" property="applicantDetails.personalData.religionId" name="StudentBiodataForm">
													<%dynastyle="display:none;"; %>
												...
												<logic:equal value="Other" property="applicantDetails.personalData.religionId" name="StudentBiodataForm">
													<%dynastyle="display:block;"; %>												
												<nested:select property="applicantDetails.personalData.religionId" styleClass="combo" styleId="religions" onchange="getSubReligion(this.value,'subreligion');funcOtherShowHide('religions','otherReligion')">
													<option value=""><bean:message key="knowledgepro.admin.select"/></option>
													<nested:optionsCollection property="religions" label="religionName" value="religionId"/>
                              ...
                              <tr><td><nested:select property="applicantDetails.personalData.subReligionId" styleClass="combo" styleId="subreligion" onchange="funcOtherShowHide('subreligion','otherSubReligion')">
									<html:option value="">- Select -</html:option>
									<c:if test="${StudentBiodataForm.applicantDetails.personalData.religionId != null && StudentBiodataForm.applicantDetails.personalData.religionId != ''}">
							...
							<tr><td><nested:text property="applicantDetails.personalData.religionSectionOthers" size="10" maxlength="30" styleId="otherSubReligion" style="<%=dynastyle %>"></nested:text></td></tr>
										...
										<tr>
											...
											<td height="20" class="row-even" align="left"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                              		<tr><td>
									<input type="hidden" id="casteType" name="casteType" value='<bean:write name="StudentBiodataForm" property="applicantDetails.personalData.casteId"/>'/>
									<logic:equal value="Other" property="applicantDetails.personalData.casteId" name="StudentBiodataForm">
										<%dynastyle="display:block;"; %>
									</logic:equal>
									<logic:notEqual value="Other" property="applicantDetails.personalData.casteId" name="StudentBiodataForm">
										<%dynastyle="display:none;"; %>
									</logic:notEqual>
									...
									<option value="">-Select-</option>
										<html:optionsCollection property="casteList" name="StudentBiodataForm" label="casteName" value="casteId"/>
								...
								<nested:radio property="applicantDetails.personalData.gender" value="FEMALE"><bean:message key="admissionForm.studentinfo.sex.female.text"/></nested:radio></td>
										...
										<tr><%String dynaStyle3="display:none;"; %>
												<logic:equal value="true" property="applicantDetails.personalData.sportsPerson" name="StudentBiodataForm">
 										...
 										<tr><%String dynaStyle4="display:none;"; %>
											<logic:equal value="true" property="applicantDetails.personalData.handicapped" name="StudentBiodataForm">
									...
									<nested:select property="applicantDetails.personalData.bloodGroup" styleClass="combo" styleId="bgType">
										...
										<logic:equal value="true" property="displaySecondLanguage" name="StudentBiodataForm">
										 <tr >
	...
	<logic:equal value="true" property="displayExtraDetails" name="StudentBiodataForm">		
						<tr>
                    ...
                    <tr>
                      ...
                      <td valign="top">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="1">
	                          <tr class="row-white">
	                            <logic:equal value="true" property="displayMotherTongue" name="StudentBiodataForm">
	                            ...
	                            <td height="23" class="row-even" align="left">
									<nested:select property="applicantDetails.personalData.motherTongue" styleClass="combo" >
										<html:option value="">-Select-</html:option>
										<nested:optionsCollection  property="mothertongues" name="StudentBiodataForm" label="languageName" value="languageId"/>
									</nested:select>
								</td>
								</logic:equal>
								<logic:equal value="true" property="displayHeightWeight" name="StudentBiodataForm">
							...
							<logic:equal value="true" property="displayLanguageKnown" name="StudentBiodataForm">
							<tr class="row-white">
							...
							<logic:equal value="true" property="displayTrainingDetails" name="StudentBiodataForm">
							<tr class="row-white">
							...
							<logic:equal value="true" property="displayAdditionalInfo" name="StudentBiodataForm">
							<tr class="row-white">
							...
							<tr class="row-white">
	                            <td height="23" class="row-even" align="right"><bean:message key="knowledgepro.applicationform.addninfo.label1"/> <B><bean:write property="organizationName" name="StudentBiodataForm"/></B>:</td>
								 <td height="23" class="row-even" align="left">
								...
								<td height="23" class="row-even" align="right"><bean:message key="knowledgepro.applicationform.addninfo.label2"/><B><bean:write property="applicantDetails.course.name" name="StudentBiodataForm"/> </B>:</td>
								<td height="23" class="row-even" align="left">
								...
								<td height="23" colspan="3" class="row-even" align="left"><bean:message key="knowledgepro.applicationform.addninfo.label3"/> <B><bean:write property="applicantDetails.course.name" name="StudentBiodataForm"/></B>:</td>
								<td height="23" class="row-even" align="left">
							...
							<logic:equal value="true" property="displayExtracurricular" name="StudentBiodataForm">
							<logic:notEmpty property="applicantDetails.personalData.studentExtracurricularsTos" name="StudentBiodataForm">
							<tr class="row-white">
	                            ...
	                            <td height="23" class="row-even" align="left"><bean:message key="knowledgepro.applicationform.extracurr.label2"/></td>
								 <td height="23" class="row-even" align="left">
									...
									<nested:select property="applicantDetails.personalData.extracurricularIds" styleClass="row-even" multiple="true" >
										<nested:optionsCollection property="applicantDetails.personalData.studentExtracurricularsTos" name="StudentBiodataForm" label="name" value="id"/>
									</nested:select>
                      ...
                      <td width="100%" height="29" valign="top"><table width="100%" height="24" border="0" cellpadding="0" cellspacing="1">
                          <tr class="row-white">
                           ...
                           <tr class="row-white">
                            ...
                            <logic:equal value="false" name="StudentBiodataForm" property="isCjc">
								<logic:equal value="Engineering" name="StudentBiodataForm" property="prgId">
								...
								<logic:notEqual value="Engineering" name="StudentBiodataForm" property="prgId">
									<td width="224" height="25" class="row-odd" align="right"></td>
									<td width="244" height="25" class="row-even" align="left"></td>
								</logic:notEqual>
							</logic:equal>
							<logic:equal value="true" name="StudentBiodataForm" property="isCjc">
							<td width="224" height="25" class="row-odd" align="right"></td>
								<td width="244" height="25" class="row-even" align="left"></td>
							</logic:equal>
                          </tr>
	...
	<logic:equal value="true" property="workExpNeeded" name="StudentBiodataForm">
				 <tr>
                  ...
                  <td colspan="2" class="heading"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <td height="31" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="1">
						...
						<nested:iterate property="applicantDetails.workExpList" id="exp" indexId="count">
                          ...
                          <tr class="row-white">
                            ...
                            <td  height="27" class="row-even"><div align="center">
								<nested:text property="phoneNo" styleClass="textbox" size="10" maxlength="50" />
                            </div></td>
                            <td height="27" class="row-even"><div align="center">
                            ...
                            <nested:select property="occupationId" styleClass="combo" styleId="<%=dropOccId %>" onchange="<%=occupationShowHide %>">
								<html:option value="">- Select -</html:option>
								<html:optionsCollection name="StudentBiodataForm" property="occupations" label="occupationName" value="occupationId"/>
                      ...
                      <td><img src="images/06.gif" ></td>
						...
						<tr>
								...
								<tr>
									...
									<logic:equal value="true" name="StudentBiodataForm" property="isCjc">
										...
										<tr class="row-even">
											...
											<td height="20" class="row-even" align="left">&nbsp;
											<logic:equal value="Other" property="applicantDetails.personalData.currentStateId" name="StudentBiodataForm">
										<%dynastyle="display:block;"; %>
									</logic:equal>
									<logic:notEqual value="Other" property="applicantDetails.personalData.currentStateId" name="StudentBiodataForm">
										<%dynastyle="display:none;"; %>
									</logic:notEqual>
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr><td>&nbsp;&nbsp;<nested:select property="applicantDetails.personalData.currentStateId" styleClass="combo" styleId="tempAddrstate" onchange="funcOtherShowHide('tempAddrstate','otherTempAddrState')">
									<html:option value="">- Select -</html:option>
									<c:if test="${StudentBiodataForm.applicantDetails.personalData.currentCountryId != null && StudentBiodataForm.applicantDetails.personalData.currentCountryId!= ''}">
					...
					<tr>
                      ...
                      <html:radio property="sameTempAddr" styleId="sameAddr" value="true" onclick="disableTempAddress()"><bean:message key="knowledgepro.applicationform.yes.label"/></html:radio>
						...
						<tr>
							<td colspan="2" class="heading">
							<table width="100%" cellpadding="0"	cellspacing="0" id="currTable">
								<tr>
									<td><img src="images/01.gif" width="5" height="5"></td>
									<td width="914" background="images/02.gif"></td>
									<td><img src="images/03.gif" width="5" height="5"></td>
								...
								<tr>
									...
									<table width="100%" height="90" border="0" cellpadding="0"
										...
										<tr class="row-even">
											...
											<td height="20" class="row-even" align="left">&nbsp;
												<logic:equal value="Other" property="applicantDetails.personalData.permanentStateId" name="StudentBiodataForm">
												<%dynastyle="display:block;"; %>
												</logic:equal>
											<logic:notEqual value="Other" property="applicantDetails.personalData.permanentStateId" name="StudentBiodataForm">
												<%dynastyle="display:none;"; %>
												</logic:notEqual>
												<table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr><td>&nbsp;&nbsp;<nested:select property="applicantDetails.personalData.permanentStateId" styleClass="combo" styleId="permAddrstate" onchange="funcOtherShowHide('permAddrstate','otherPermAddrState')">
									<html:option value="">- Select -</html:option>
									<c:if test="${StudentBiodataForm.applicantDetails.personalData.permanentCountryId != null && StudentBiodataForm.applicantDetails.personalData.permanentCountryId!= ''}">
						...
						<tr>
							...
							<table width="99%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td valign="top">
									<table width="100%" cellspacing="1" cellpadding="2">
									<logic:notEmpty name="StudentBiodataForm" property="applicantDetails.ednQualificationList">
										<tr>
											<td height="25" class="row-odd">
        ...
        <nested:iterate  name="StudentBiodataForm" property="applicantDetails.ednQualificationList" indexId="count" id="qualDoc">
			<%
				String dynamicStyle="";
				String oppStyle="";
          ...
          <tr >
            ...
            <td class='<%=dynamicStyle %>' >
               ...
               <nested:select property="universityId" styleId="<%=dynaid %>" styleClass="combo" onchange="<%=showhide %>">
					<option value="">Select</option>
					<logic:iterate id="option" property="universities" name="StudentBiodataForm">
			...
			<nested:select property="stateId" styleClass="combo" styleId='<%=dynaStateId %>'>
				<option value=""><bean:message key="knowledgepro.admin.select"/></option>
				<logic:notEmpty name="StudentBiodataForm" property="ednStates">
				 <nested:optionsCollection name="StudentBiodataForm" property="ednStates" label="name" value="id"/>
				</logic:notEmpty>
           ...
           <bean:define id="countIndex" property="id" name="qualDoc"></bean:define>
                     
			
				<logic:equal value="true" property="semesterWise" name="qualDoc">
					<logic:equal value="false" property="consolidated"	name="qualDoc">
						<%
							String semsterMarkLink = "studentBiodata.do?method=initSemesterMarkEditPage&countID="+ countIndex;%>
							<td class="row-even" colspan="2">
							<div align="center"><a href="#"	onclick="detailSemesterSubmit('<%=countIndex%>')">
							Semester Marks Edit</a></div>
							</td>									
					</logic:equal>
				</logic:equal>
            ...
            <td width="8%" class='<%=dynamicStyle %>'><div align="center">
              <nested:text property="totalMarks" size="5" maxlength="8"></nested:text>
									...
									<!--<logic:equal value="true" property="displayTCDetails" name="StudentBiodataForm">
									<tr>
											<td height="25" class="row-odd">
								...
								<!--<logic:equal value="true" property="displayLateralTransfer"	name="StudentBiodataForm">
											<tr>
												<td class="row-even">
												<div align="center">&nbsp;</div>
												</td>
				...
				<logic:equal value="true" property="displayEntranceDetails" name="StudentBiodataForm">
					...
					<tr>
										...
										<tr >
            								<td width="16%" height="25" class="row-odd"><div align="right"><bean:message key="admissionForm.education.entrance.label"/></div></td>
												...
												<nested:select property="applicantDetails.entranceDetail.entranceId" styleClass="comboLarge">
													<html:option value="">-Select-</html:option>
													<logic:notEmpty property="entranceList" name="StudentBiodataForm">
													<html:optionsCollection property="entranceList" name="StudentBiodataForm" label="name" value="id"/>
													</logic:notEmpty>
						...
						<tr>
							...
							<table width="97%" border="0" align="center" cellpadding="0"
								...
								<logic:equal value="true" property="displayFamilyBackground" name="StudentBiodataForm">
							<tr>
							<td>
							<table width="97%" border="0" align="center" cellpadding="0"
								cellspacing="0">
						...
						<tr>
                            ...
                            <tr><td>
							<%String dynaStyle=""; %>
								<logic:equal value="Other" property="applicantDetails.personalData.parentStateId" name="StudentBiodataForm">
										<%dynaStyle="display:block;"; %>
									</logic:equal>
									<logic:notEqual value="Other" property="applicantDetails.personalData.parentStateId" name="StudentBiodataForm">
										<%dynaStyle="display:none;"; %>
									</logic:notEqual>
                  	<nested:select property="applicantDetails.personalData.parentStateId" styleClass="combo" styleId="parentState" onchange="funcOtherShowHide('parentState','otherParentAddrState');">
									<html:option value="">- Select -</html:option>
									<c:if test="${StudentBiodataForm.applicantDetails.personalData.parentCountryId != null && StudentBiodataForm.applicantDetails.personalData.parentCountryId!= ''}">
						...
						<tr>
                            ...
                            <tr><td>
							<%String dynaStyle1=""; %>
								<logic:equal value="Other" property="applicantDetails.personalData.stateByGuardianAddressStateId" name="StudentBiodataForm">
										<%dynaStyle1="display:block;"; %>
									</logic:equal>
									<logic:notEqual value="Other" property="applicantDetails.personalData.stateByGuardianAddressStateId" name="StudentBiodataForm">
                  	...
                  	<nested:select property="applicantDetails.personalData.stateByGuardianAddressStateId" styleClass="combo" styleId="guardianState" onchange="funcGuardianOtherShowHide('guardianState','otherGuardianAddrState');">
									<html:option value="">- Select -</html:option>
									<c:if test="${StudentBiodataForm.applicantDetails.personalData.countryByGuardianAddressCountryId != null && StudentBiodataForm.applicantDetails.personalData.countryByGuardianAddressCountryId!= ''}">
							...
							<table width="99%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<% String sty=""; %>
										<nested:iterate name="StudentBiodataForm"
...
<script type="text/javascript">
	...
	//var id =<%=CMSConstants.KP_DEFAULT_COUNTRY_ID %>;
