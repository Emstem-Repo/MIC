...
<html:form action="/studentEdit" method="POST">
	...
	<table width="99%" border="0">
		...
		<tr>
			...
			&gt;&gt;Student Bio Data &gt;&gt;Detention History</span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td width="9"><img src="images/Tright_03_01.gif" width="9"
						height="29"></td>
					<td background="images/Tcenter.gif" class="heading_white">Detention History</td>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								<nested:iterate property="detentionDetHistoryList" name="studentEditForm">
									...
									<tr>
										...
										<td class="row-even"><nested:write property="reason" /></td>
									</tr>
								</nested:iterate>
							</table>
							</td>
