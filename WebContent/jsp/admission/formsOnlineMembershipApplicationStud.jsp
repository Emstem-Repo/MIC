...
<html:form action="/admissionFormsOnline" method="post">
	...
	<table  width="100%" style="padding: 100px" border="0"  cellpadding="3" cellspacing="0" bordercolor="#E0DFDB">
		...
		<tr><td align="center" class="title2" colspan="2">APPLICATION FOR MEMBERSHIP</td></tr>
			...
			<tr><td>Name of the parent&nbsp;&nbsp;&nbsp;</td><td>:&nbsp;&nbsp;&nbsp;<bean:write name="admissionStatusForm" property="applicantDetails.titleOfFather"/> <bean:write name="admissionStatusForm" property="applicantDetails.personalData.fatherName"/></td></tr>
			<tr><td>Name of the student&nbsp;&nbsp;&nbsp;</td><td>:&nbsp;&nbsp;&nbsp;<bean:write name="admissionStatusForm" property="applicantDetails.personalData.firstName"></bean:write></td></tr>
			<tr><td>Course&nbsp;&nbsp;&nbsp;</td><td>:&nbsp;&nbsp;&nbsp;<%-- <bean:write name="admissionStatusForm" property="applicantDetails.course.name" /> --%></td></tr>
			...
			<%-- <bean:write name="admissionStatusForm" property="applicantDetails.appliedYear" /> --%></td></tr>
			<tr><td>Address of the parent with Phone No.&nbsp;&nbsp;&nbsp;</td><td>:&nbsp;&nbsp;&nbsp;
			<bean:write name="admissionStatusForm" property="applicantDetails.personalData.parentAddressLine1"/>,&nbsp;
			<bean:write name="admissionStatusForm" property="applicantDetails.personalData.parentAddressLine2"/>,&nbsp;
			<bean:write name="admissionStatusForm" property="applicantDetails.personalData.parentCityName"/>,&nbsp;
			<bean:write name="admissionStatusForm" property="applicantDetails.personalData.parentAddressZipCode"/>,&nbsp;
			...
			<br>
			 Phone : &nbsp;<bean:write name="admissionStatusForm" property="applicantDetails.personalData.parentMob2"/>,&nbsp;
			</td></tr>
			<tr height="10px"></tr>
