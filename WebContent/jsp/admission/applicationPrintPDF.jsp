...
<html:form action="/AdmissionStatus" method="POST">
	...
	<tr>
	 ...
	 <table width="100%" border="0" cellpadding="3" >
	   ...
	   <% int num = 14; %>
	   <logic:equal value="true" name="admissionFormForm" property="applicantDetails.personalData.handicapped"> 
	    <tr>
	       <td><%=++num%></td><td>Differently abled</td><td>: </td><td><bean:write name="admissionFormForm" property="applicantDetails.personalData.hadnicappedDescription" />(<bean:write name="admissionFormForm" property="applicantDetails.personalData.handicapedPercentage" />%)</td>
	    </tr>	    
	    </logic:equal>
	                                                      
	   <logic:notEmpty name="admissionFormForm" property="applicantDetails.personalData.sports" >
	   <tr>
	     <td><%=++num%>.</td><td>Participation in Sports</td><td>: </td><td><bean:write name="admissionFormForm" property="applicantDetails.personalData.sports"/> (<bean:write name="admissionFormForm" property="applicantDetails.personalData.sportsParticipate"/>), <bean:write name="admissionFormForm" property="applicantDetails.personalData.sportsId"/></td>
	  </tr>
	   </logic:notEmpty>
	   <logic:notEmpty name="admissionFormForm" property="applicantDetails.personalData.arts" >
	   <tr>
	     <td><%=++num%>.</td><td>Participation in Cultural Activities</td><td>: </td><td><bean:write name="admissionFormForm" property="applicantDetails.personalData.arts"/> (<bean:write name="admissionFormForm" property="applicantDetails.personalData.artsParticipate"/>)</td>
	   </tr>
	   </logic:notEmpty>
	    <tr>
