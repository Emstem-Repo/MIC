...
<html:form action="/uncheckGenSmartCard" >
	<html:hidden property="method" styleId="method" value="getEmployeeDataForUncheck" />	
	...
	<table width="98%" border="0">
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <html:select styleId="departmentId"  property="departmentId" name="uncheckGenSmartCardForm" styleClass="combo">
									<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
									<logic:notEmpty  name="uncheckGenSmartCardForm" property="departmentMap">
									<html:optionsCollection name="uncheckGenSmartCardForm" property="departmentMap" label="value" value="key"/></logic:notEmpty>	
				</html:select></td>
