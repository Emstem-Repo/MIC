              ...
              <tr>
                   <td height="35" colspan="6" class="body" ><table width="100%" cellspacing="1" cellpadding="2">
                     ...
                     <tr>
						...
						<td height="25" class="row-odd" width="22%"><div align="center"><bean:message key="knowledgepro.admin.subject.total.marks.disp"/></div></td>
                     ...
                     <tr>
						...
						<logic:notEmpty property="<%=propertyName %>" name="admissionFormForm">
								...
								<logic:equal value="false" property="<%=dynaMandatory %>" name="admissionFormForm">
									<html:text property="<%=propertyName %>" styleId='<%=propertyName %>' name="admissionFormForm" size="25" maxlength="100"></html:text>
								</logic:equal>
							</logic:notEmpty>
					...
					<tr>
						...
						<td class="row-odd" ><bean:message key="admissionForm.detailmark.totalobtain.label"/></td>
                ...
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="45%" height="35"><div align="right">
                        <html:button property="" onclick="submitAdmissionForm('submitDetailMarkEdit')" styleClass="formbutton" value="Submit"></html:button>
                    </div></td>
                    <td width="2%"><html:button property=""  styleClass="formbutton" value="Reset" onclick='<%=resetmethod %>'></html:button></td>
                    <td width="53%"><html:button property=""  styleClass="formbutton" value="Cancel" onclick='<%=dynaCancel %>'></html:button></td>
                  </tr>
                </table>
                            </td>
                 </tr>
