...
function updateClasses(req) {
	...
	function cancelPage(){
		document.location.href="assignSubjectGroupHistory.do?method=initAssignSubjectGroupHistory";
	}
	function editSubjectGroup(id){
		document.location.href="assignSubjectGroupHistory.do?method=editSubjectGroup&subjectGroupId="+id;
	}
	function updateStudentSubGroups(){
		document.getElementById("subjectGroupName").value = document
		.getElementById("subjectGroup").options[document
		.getElementById("subjectGroup").selectedIndex].text;
	document.getElementById("method").value = "updateSubjectGroups";
	document.assignSubjectGroupHistoryForm.submit();
	}
</script>
<html:form action="/assignSubjectGroupHistory" method="post">
	<html:hidden property="method" styleId="method" />
	<html:hidden property="formName" value="assignSubjectGroupHistoryForm" />
	...
	<table width="99%" border="0">
		<tr>
			<td><span class="Bredcrumbs"><bean:message
				...
				Assign Subject Group History&gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td width="9"><img src="images/Tright_03_01.gif" width="9"
						height="29"></td>
					<td background="images/Tcenter.gif" class="heading_white">Assign Subject Group History</td>
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<logic:equal value="true" name="assignSubjectGroupHistoryForm" property="flag">
									<% disable=true;%>
									</logic:equal>
									<input type="hidden" id="yr" name="yr"
										value='<bean:write name="assignSubjectGroupHistoryForm" property="year"/>' />
									...
									<td width="38%" class="row-even"><input type="hidden"
										name="c1" id="c1"
										value='<bean:write name="assignSubjectGroupHistoryForm" property="classId"/>' />
									<html:select property="classSchemeWiseId"
										...
										<c:choose>
											...
											<c:otherwise>
												<c:if
													test="${assignSubjectGroupHistoryForm.classSchemeWiseId != null && assignSubjectGroupHistoryForm.classSchemeWiseId != ' '}">
													<c:set var="classMap"
				...
				<tr>
		 		...
		 		<logic:present name="assignSubjectGroupHistoryForm" property="studentDetailsList">
					<tr>
						<td valign="top" background="images/Tright_03_03.gif"></td>
						<td valign="top">
						<div><FONT color="red" size="1">
						<bean:write name="assignSubjectGroupHistoryForm" property="displayMessage"/><br>
						<bean:write name="assignSubjectGroupHistoryForm" property="displayMsg"/>
						</FONT></div>
							...
							<tr>
									...
									<tr>
										...
										<table width="100%" cellspacing="1" cellpadding="2">
											...
											<nested:iterate id="studentList" property="studentDetailsList"
												name="assignSubjectGroupHistoryForm" indexId="count">
												
													<c:if test="${count < assignSubjectGroupHistoryForm.halfLength}">
													 <c:choose>
													...
													<td class="row-even">
														<div align="left"><bean:write property="regNo"
								...
								<table width="100%" border="0" align="center" cellpadding="0"
									...
									<tr>
										<td><img src="images/01.gif" width="5" height="5" /></td>
										<td width="914" background="images/02.gif"></td>
										<td><img src="images/03.gif" width="6" height="6" /></td>
									</tr>
									<tr>
										<td width="5" background="images/left.gif"></td>
													...
													<c:if test="${count >= assignSubjectGroupHistoryForm.halfLength}">
														...
														<c:otherwise>
															<tr class="row-white">
																...
																property="regNo" name="studentList" /></div>
																</td>
																<td class="row-even">
																<div align="left"><bean:write
			...
			<tr>
				<logic:present  name="assignSubjectGroupHistoryForm" property="subjectGroupList">
					<tr>
						<td valign="top" background="images/Tright_03_03.gif"></td>
						<td valign="top">
						<table width="100%" border="0" align="center" cellpadding="0"
							...
							<tr>
								...
								<table width="100%" cellspacing="1" cellpadding="2">
									<tr>
										...
										<logic:equal value="true" name="assignSubjectGroupHistoryForm" property="flag1">
										<% disable1=true;%>
										</logic:equal>
										<input type="hidden"
											name="s1" id="s1"
											value='<bean:write name="assignSubjectGroupHistoryForm" property="subjectGroupId"/>' />
										<html:select property="subjectGroupId" styleClass="comboLarge" disabled='<%=disable1%>'
											styleId="subjectGroup">
											<html:option value="">
												<bean:message key="knowledgepro.select" />-</html:option>
															<html:optionsCollection name="assignSubjectGroupHistoryForm" property="subjectGroupList"
							...
							<c:choose>
								<c:when test="${SubjectGroupEntryOperation == 'edit'}">
									<html:button property="" styleClass="formbutton" value="Update"
										onclick="updateStudentSubGroups()"></html:button>
								</c:when>
								<c:otherwise>
									<html:button property="" styleClass="formbutton" value="Submit"
										onclick="submitStudentSubGroups()"></html:button>
								</c:otherwise>
							</c:choose>
								</div>
							</td>
				...
				<tr>
				<logic:present  name="assignSubjectGroupHistoryForm" property="subjectGroupsDetailsList">
					...
					<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                     ...
                     <tr>
                       ...
                       <td valign="top">
	                       ...
	                       <logic:iterate id="subject" name="assignSubjectGroupHistoryForm" property="subjectGroupsDetailsList" indexId="count">
		                       <c:choose>
	                           	 <c:when test="${temp == 0}">
	                           		<tr>
