...
<body>
<html:form action="/PRCstudentEdit" enctype="multipart/form-data" method="POST">
            ...
            <tr>
              ...
              <td valign="top"><table width="100%" height="30" border="0" cellpadding="0" cellspacing="1">
                  <tr class="row-white">
                    ...
                    <td width="164" class="row-even"> <input type="hidden" id="programType" name="programType" value='<bean:write name="studentEditForm" property="programTypeId"/>'/>
                <html:select styleId="programTypeId"  property="programTypeId" styleClass="combo" onchange="getPrograms(this.value,'progPref1')">
                    ...
                    <td width="167" class="row-even"><html:select property="programId" styleClass="combo" styleId="progPref1" onchange="getCourse(this.value,'coursePref1')">
									<html:option value="">- Select -</html:option>
                    ...
                    <td width="127" class="row-odd"><div align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.admission.course"/>:</div></td>
                   ...
                   <tr class="row-white">
                    <td width="161" height="25" class="row-odd"><div align="right"><span class="Mandatory">*</span><bean:message key="knowledgepro.fee.academicyear.col"/>:</div></td>
                ...
                <html:select styleId="academicYear"  property="academicYear" name="studentEditForm" styleClass="combo">
									<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
									<cms:renderAcademicYearForAdmission></cms:renderAcademicYearForAdmission>
				</html:select></td>
                    <td width="140" class="row-odd"></td>
                    <td width="167" class="row-even"></td>
                    <td width="127" class="row-odd"></td>
                    <td width="160" class="row-even"></td>
                  </tr>
              </table></td>
