                   ...
                   <td height="35" colspan="6" class="body" ><table width="100%" cellspacing="1" cellpadding="2">
                     <tr bgcolor="#FFFFFF">
                       <td height="10" colspan="22">
                        ...
                        <h3><font color="red">Enter your preference as 2, 3,4.....<br>Your first preference is <bean:write name="admissionFormForm" property="courseName1"/></br></font></h3>
                       </td>
                     </tr>
						...
						<td class="row-odd" ><div align="center">course </div></td>
 						<td height="25" class="row-odd" ><div align="center">Preference No</div></td>
								...
								<%int preList=0; %>
									...
									<nested:notEmpty name="admissionFormForm" property="prefcourses">
								<nested:iterate id="preForm" name="admissionFormForm" property="prefcourses" indexId="count">
									...
									%>
										...
										<c:when test="${admissionFormForm.courseName1==preForm.name}">
