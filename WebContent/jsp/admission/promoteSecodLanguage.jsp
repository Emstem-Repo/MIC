...
function submitCsv(){
	document.getElementById("method").value ="uploadSecondLang";
...
<html:form action="/admissionPromote" method="POST" enctype="multipart/form-data">
	...
	<html:hidden property="method" value="uploadSecondLang" />
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt; SecondLanguage Upload &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> SecondLanguage Upload</strong></div></td>
						...
						<tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<html:button property="" styleClass="formbutton" onclick="resetLang();">
