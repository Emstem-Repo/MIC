...
<table width="98%" border="0">
  <tr>
    <td><span class="Bredcrumbs"><bean:message key="knowledgepro.admission" /><span class="Bredcrumbs">&gt;&gt; <bean:message key="admissionForm.transferentry.main.label" /> &gt;&gt;</span></span></td>
  </tr>
  <tr>
      ...
      <tr>
        ...
        <td valign="top" class="news"><div align="center">
             ...
             <tr >
              ...
              <nested:iterate property="transferDetails" id="semId"  type="com.kp.cms.to.admin.ApplicantTransferDetailsTO" name="onlineApplicationForm" indexId="count">
				<%
					String dynaStyle="";
					if(count%2==0)
						dynaStyle="row-even";
			 ...
			 <tr >
	           ...
	           <nested:select property="yearPass" styleClass="comboSmall" styleId='<%=dynayearId %>'>
				...
				<tr>
				<td class="row-even" colspan="1" ><div align="center"><nested:text property="transUnvrAppNo" name="onlineApplicationForm" size="20" maxlength="50" ></nested:text> </div></td>
				<td class="row-even" colspan="1" ><div align="center"><nested:text property="transRegistationNo" name="onlineApplicationForm" size="20" maxlength="20" ></nested:text> </div></td>
				<td class="row-even" colspan="2" ><div align="left"><nested:textarea property="transArrearDetail" name="onlineApplicationForm" rows="4" cols="25" ></nested:textarea> </div></td>
				<td class="row-even" colspan="2" ><div align="left"><nested:textarea property="transInstituteAddr" name="onlineApplicationForm" rows="4" cols="25"></nested:textarea> </div></td>
				</tr>  
		         <tr>
                ...
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td width="45%" height="35"><div align="right">
                        <html:button property="" onclick="submitAdmissionForm1('submitTransferConfirmEntry')" styleClass="formbutton" value="Submit"></html:button>
                    </div></td>
                    ...
                    <td width="53%"><div align="left"><html:button property=""  styleClass="formbutton" value="Cancel" onclick='submitConfirmCancelButton1()'></html:button></div></td>
                  </tr>
                </table>
                            </td>
                 </tr>
...
<script language="JavaScript" src="js/admission/OnlineTransferDetailsConfirm.js"></script>
