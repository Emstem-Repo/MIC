...
function hostelAdmission(){
	var applicationNumber=document.getElementById("applicationNumber").value;
	document.location.href = "HostelAdmission.do?method=initHlAdmissionFromAdmission"+"&hostelApplNo="+applicationNumber;
...
<table width="100%" border="0">
  <tr>
    <td><span class="Bredcrumbs"><bean:message key="knowledgepro.admission" /> <span class="Bredcrumbs">&gt;&gt; <bean:message key="knowledgepro.admissionform" /></span></span></td>
  </tr>
  <tr>
    <td valign="top"><table width="98%" border="0" cellpadding="0" cellspacing="0" >
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td width="100%" background="images/Tcenter.gif" class="body" ><strong class="boxheader"> <bean:message key="knowledgepro.admissionform" /></strong></td>
      ...
      <tr>
        ...
        <td height="20" valign="top" background="images/Tright_03_03.gif"></td>
        <td class="heading">
			<bean:message key="admissionForm.admissionformsucess.main.label" /><br>
        ...
        <td valign="top" class="news"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="100%" height="35"><div align="center">
                <html:button property="" onclick="submitApplicationCancelButton()" styleClass="formbutton" value="Back"></html:button>&nbsp;&nbsp;&nbsp;&nbsp;
                 <html:button property="" onclick="hostelAdmission()" styleClass="formbutton" value="Hostel Admission"></html:button>
            </div></td>
          </tr>
        </table></td>
        <td valign="top" background="images/Tright_3_3.gif" class="news"></td>
