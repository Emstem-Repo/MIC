...
function uploadINResult(){
	document.getElementById("method").value="uploadMobileNumbersForStudent";
}
...
<html:form action="/uploadMobileNumber" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="uploadMobileNumbersForStudent" />
	<html:hidden property="formName" value="uploadMobileNumberForm" />
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt; Upload Mobile Numbers &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> Upload Mobile Numbers</strong></div></td>
								...
								<tr>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										<tr class="row-white">
			                				...
			                				<html:select property="programTypeId" styleId="programType" onchange="getPrograms(this.value)" name="uploadMobileNumberForm" styleClass="combo">
			                				...
			                				<td height="25" class="row-even">
			                				<html:select property="programId" name="uploadMobileNumberForm"  styleId="program" onchange="getCourses(this.value)" styleClass="combo">
												<html:option value=""><bean:message key="knowledgepro.admin.select" /></html:option>
										...
										<tr class="row-white">
											...
											<html:select property="courseId" styleId="course" name="uploadMobileNumberForm"  styleClass="combo">
												<html:option value=""><bean:message key="knowledgepro.admin.select" /></html:option>
											...
											<td class="row-even">
											<input type="hidden" id="tempyear" name="tempyear" value="<bean:write name="uploadMobileNumberForm" property="academicYear"/>" />
											<html:select name="uploadMobileNumberForm" property="academicYear" styleId="appliedYear"  styleClass="combo">
												<html:option value=" "><bean:message key="knowledgepro.admin.select" /></html:option>
