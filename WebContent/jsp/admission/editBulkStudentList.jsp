...
<html:form action="/studentEdit">
	<html:hidden property="method" value="updateBulkApplicationEdit" />
		...
		<FONT color="green"> <html:messages id="msg"
                    ...
                    <tr>
                      ...
                      <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
                          <tr >
                            ...
                            <td class="row-odd">Class Number</td>
                            <td class="row-odd">Register Number</td>
			...
			%>
                          <tr>
                            ...
                            <td width="8%" class="row-even" >&nbsp; <nested:text property="rollNo"  styleClass="TextBox" ></nested:text></td>
                            <td width="12%" class="row-even" >&nbsp; <nested:text property="registerNo"  styleClass="TextBox" ></nested:text></td>
                            <td width="12%" class="row-even" >&nbsp; <nested:text property="admissionNumber"  styleClass="TextBox" ></nested:text></td>
                            <td width="8%" class="row-even" >&nbsp; <nested:text property="admissionDate"  styleClass="TextBox" styleId="<%=dynaid %>"></nested:text>
                            ...
                            <nested:select property="classSchemeId"
												...
												<logic:notEmpty name="stdList" property="classesMap">
              ...
              <tr>
                <td height="10" class="body" ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <html:submit styleClass="formbutton" property=""  onclick="cancelMe('initBulkStudentEdit')" >Cancel</html:submit>
