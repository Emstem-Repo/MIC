...
<html:form action="/ddStatus" method="POST">
	<html:hidden property="method" styleId="method" value="updateDDStatus" />
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt; <bean:message key="knowledgepro.admission.ddStatus.displayName" /> &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> <bean:message key="knowledgepro.admission.ddStatus.displayName" /></strong></div></td>
								...
								<tr>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										<tr class="row-white">
											...
											<bean:message key="knowledgepro.admission.dd.status.recievedDD"/>:</div></td>
			                				<td height="25" class="row-even">
			                					<html:text property="recievedDDNo" styleId="recievedDDNo" maxlength="15" size="10"></html:text>
											</td>
										</tr>
										<tr class="row-white">
			                				<td width="15%" class="row-odd" width="25%">
											<div align="right"><span class="Mandatory">*</span>&nbsp;<bean:message key="knowledgepro.admission.dd.status.recievedDate" />:</div></td>
											<td width="16%" class="row-even">
												<html:text name="dDStatusForm" property="recievedDDDate" styleId="recievedDDDate" size="10" maxlength="16"/>
												<script
												language="JavaScript">
												new tcal( {
													// form name
