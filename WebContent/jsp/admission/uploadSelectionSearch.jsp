...
function uploadInterviewSelected(){
	document.getElementById("method").value="uploadInterviewSelected";
}
...
<html:form action="/uploadInterviewSelcted" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="uploadInterviewSelected" />
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt; Upload Interview Selection &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> Upload Interview Selection </strong></div></td>
				...
				<tr>
					...
					<div align="center"><table width="100%" height="20" border="0" cellpadding="1" cellspacing="2">
						<tr>
							<td width="100%" height="46" class="heading" align="center">
							Note: This process will take a while. Please do not refresh or sign out from the application unless the process successful message is displayed
							</td>
					   </tr>
					</table>
					</div>
