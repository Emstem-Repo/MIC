...
<script type="text/javascript">
	function cancelAction() {
		document.location.href = "tcDetailsClassWise.do?method=initTCDetails";
	}
	function editDetails(studentId) {
		document.location.href = "tcDetailsClassWise.do?method=getStudentDetails&studentId="+studentId;
	}
</script>
<html:form action="/tcDetailsClassWise" method="post">
	<html:hidden property="method" styleId="method" value="getTCDetailsClassWise" />
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								<tr>
									...
									<td   class="row-even">
									<bean:write name="tcDetailsClassWiseForm" property="registerNo"/>
									</td>
									<td class="row-odd"></td>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								<nested:notEmpty name="tcDetailsClassWiseForm" property="boardList">
								<nested:iterate id="bdForm" name="tcDetailsClassWiseForm" property="boardList" indexId="count">
									<tr class="row-even"> 
										<td><c:out value="${count+1}"></c:out></td>
										<td>
											<html:multibox styleId="chk" property="passedStudents" name="tcDetailsClassWiseForm"> 
												<bean:write name="bdForm" property="studentId"/>
											</html:multibox>											
										</td>
								...
								<script type="text/javascript">
									var chk=document.getElementsByName("passedStudents");
