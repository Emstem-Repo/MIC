...
<SCRIPT type="text/javascript">
    ...
    function cancelAction() {
    	document.location.href = "BypassInterview.do?method=getBypassInterviewSearchResults";
    }
...
<html:form action="/BypassInterview" focus="selectall">
	...
	<html:hidden property="method" styleId="method"
		value="removeSelectedBypassInterviewList" />
	...
	<table width="98%" border="0">
		<tr>
			<td><span class="Bredcrumbs"><bean:message
				...
				key="knowledgepro.admission.bypassinterviewresults" /> <span
				class="Bredcrumbs">&gt;&gt;<bean:message
				key="knowledgepro.admission.bypassinterviewselectionlist" />&gt;&gt;</span></span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> <bean:message
						key="knowledgepro.admission.bypassinterviewselectionlist" /></strong></div>
					</td>
