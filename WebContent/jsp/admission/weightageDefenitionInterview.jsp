...
<SCRIPT type="text/javascript">
	...
	function calculateTotalValue() {
		...
		for ( var i = 0; i < document.forms[0].elements.length; i++) {
			...
			if ((e.type == 'text')) {
				if (e.name != "totalInterviewWeightage") {
					checkForEmpty(e);
					isValidNumber(e);
		...
		document.getElementById("totalInterviewWeightage").value = totalEducationalWeightValue;
	}
...
<html:form action="/WeightageDefenition" focus="programType">
	<html:hidden property="method" styleId="method"
		value="submitInterviewWeightageDefenition" />
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><span class="Bredcrumbs"><a
						...
						key="knowledgepro.admission.weightagedefenition.interviewweightage" />
					</a></span></div>
					</td>
				...
				<tr>
					...
					<td height="46" colspan="2" class="heading"><img
						src="images/Weighage_Intervifew_Tab.jpg" border="0" usemap="#Map">
					<map name="Map">
						<area shape="rect" coords="6,4,150,29"
							href="WeightageDefenition.do?method=initWeightageDefenition">
						<area shape="rect" coords="275,6,384,30"
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								<nested:iterate name="weightageDefenitionForm"
									property="interviewWeightageList" indexId="count" id = "weightageList">
									<%
										String abc = "weightageentry" + count;
									%>
									<c:choose>
										<c:when test="${temp == 0}">
											<logic:notEmpty name = "weightageList" property="subRoundList">
											<nested:iterate property="subRoundList" indexId="subCount">
												<tr>
													<td height="25" class="row-even">
													<div align="center"><nested:write
														property="subroundName"/></div>
													</td>
													<td height="25" class="row-even"><span class="bodytext">
													<nested:text property="weightagePercentage"
														styleId="weightagePercentage_<c:out value='${subCount}'/>"
											...
											<logic:empty name = "weightageList" property="subRoundList">
											<tr>
												<td height="25" class="row-even">
												<div align="center"><nested:write
													property="interviewType" /></div>
												</td>
												<td height="25" class="row-even"><span class="bodytext">
												<nested:text property="weightagePercentage"
										...
										<c:otherwise>
											<logic:notEmpty name = "weightageList" property="subRoundList">
											<nested:iterate name = "weightageList" property="subRoundList" >
												<tr>
													<td height="25" class="row-odd">
													<div align="center"><nested:write
														property="subroundName"/></div>
													</td>
													<td height="25" class="row-odd"><span class="bodytext">
													<nested:text property="weightagePercentage"
														styleId="weightagePercentage_<c:out value='${count}'/>"
														styleClass="TextBox" size="17" maxlength="6"
														onkeypress="return isDecimalNumberKey(this.value,event)"
								...
								<tr>
									...
									<html:text property="totalInterviewWeightage" readonly="true"
										styleClass="TextBox" styleId="totalInterviewWeightage"
