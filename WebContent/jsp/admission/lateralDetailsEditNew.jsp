      ...
      <tr>
        ...
        <td valign="top" class="news"><div align="center">
             ...
             <tr >
              ...
              <nested:iterate property="lateralDetails" id="semId"  type="com.kp.cms.to.admin.ApplicantLateralDetailsTO" name="applicationEditForm" indexId="count">
				<%
					String dynaStyle="";
					if(count%2==0)
						dynaStyle="row-even";
                ...
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="45%" height="35"><div align="right">
                        <html:button property="" onclick="submitAdmissionFormNew('submitLateralEntryEdit')" styleClass="formbutton" value="Submit"></html:button>
                    </div></td>
