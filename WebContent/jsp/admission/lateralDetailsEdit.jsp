      ...
      <tr>
        ...
        <td valign="top" class="news"><div align="center">
             ...
             <tr >
              ...
              <nested:iterate property="lateralDetails" id="semId"  type="com.kp.cms.to.admin.ApplicantLateralDetailsTO" name="admissionFormForm" indexId="count">
				<%
					String dynaStyle="";
					if(count%2==0)
						dynaStyle="row-even";
			 ...
			 <tr >
				...
				<tr>
				<td class="row-even" colspan="2" ><div align="center"><nested:text property="lateralUniversityName" size="20" maxlength="50" ></nested:text> </div></td>
				<td class="row-even" colspan="2" ><div align="center"><nested:text property="lateralStateName" size="20" maxlength="20" ></nested:text> </div></td>
				<td class="row-even" colspan="2" ><div align="center"><nested:textarea property="lateralInstituteAddress" rows="4" cols="25"></nested:textarea> </div></td>
				</tr>  
		         <tr>
                   <td height="35" colspan="6" class="body" >
				<%String dynaCancel=""; %>
				<logic:equal value="true" property="admissionEdit" name="admissionFormForm">
					<%dynaCancel="submitEditDetailCancelButton()"; %>
				</logic:equal>			
				<logic:equal value="false" property="admissionEdit" name="admissionFormForm">
					<%dynaCancel="submitModifyDetailCancelButton()"; %>
				</logic:equal>	

                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="45%" height="35"><div align="right">
                        <html:button property="" onclick="submitAdmissionForm('submitLateralEntryEdit')" styleClass="formbutton" value="Submit"></html:button>
                    </div></td>
