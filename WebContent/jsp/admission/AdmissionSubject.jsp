...
<script language="JavaScript">
	function submitExcel() {
		document.getElementById("method").value = "uploadAdmissionSubject";
		var academicYear = document.getElementById("academicYearId").value;
		document.location.href = "AdmissionSubject.do?method=uploadAdmissionSubject&academicYear="
				+ academicYear;
			}
	...
	function cancel() {
		document.location.href = "admBioData.do?method=initAdmBioData";knowledgepro.admission.subject
	}
</script>
<html:form action="/AdmissionSubject" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method"
		value="uploadAdmissionSubject" />
	<html:hidden property="formName" value="admissionSubjectForm" />
	<html:hidden property="pageType" styleId="pageType" value="1" />
	<table width="98%" border="0">
		<tr>
			<td><span class="Bredcrumbs">Data Migration <span
				class="Bredcrumbs">&gt;&gt;Admission Subject &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> Admission Subject</strong></div>
					</td>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										<tr>
											...
											<div align="right"><span class="Mandatory">*</span><bean:message
												key="knowledgepro.admission.excelFile" /></div>
											</td>
											<td height="25" class="row-even"><label> <html:file
												property="theFile" styleId="thefile" size="15"
												maxlength="30" name="admissionSubjectForm" /></label></td>
										</tr>
									</table>
									</td>
