...
<html:form action="/generateProcess">
	<html:hidden property="method" styleId="method" value="generateProccessHtml" />	
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt; Generate Process &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader">Generate Process</strong></div>
					</td>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								<tr>
									...
									<html:select property="programId"  styleId="program" onchange="getCourses(this.value);getinterviewTypeByProgram()" styleClass="combo">
										...
										<c:if test="${generateProcessForm.programTypeId != null && generateProcessForm.programTypeId != ''}">
								...
								<tr>
									...
									<input type="hidden" id="tempyear" name="tempyear"
										value="<bean:write name="generateProcessForm" property="appliedYear"/>" />
								...
								<tr>
									...
									<html:text property="interviewStartDate" styleId="interviewStartDate" size="11" maxlength="11"></html:text>
									<script language="JavaScript">
										new tcal( {
											// form name
									...
									<input type="hidden" id="stHours" name="stHours" value="<bean:write name="generateProcessForm" property="startingTimeHours"/>"/>
									<input type="hidden" id="stMins" name="stMins" value="<bean:write name="generateProcessForm" property="startingTimeMins"/>"/>

									<html:text name="generateProcessForm" property="startingTimeHours" styleClass="Timings" value="00" styleId="startingTimeHours" size="2" maxlength="2"  onfocus="clearField(this)" onblur="checkForEmpty(this)" onkeypress="return isNumberKey(event)"/>							
									:
									<html:text name="generateProcessForm" property="startingTimeMins" styleClass="Timings" value="00" styleId="startingTimeMins" size="2" maxlength="2"  onfocus="clearField(this)" onblur="checkForEmpty(this)" onkeypress="return isNumberKey(event)"/>
									</td>
								...
								<tr>
									...
									<td  width="20%" class="row-even">
									<input type="hidden" id="enHours" name="enHours" value="<bean:write name="generateProcessForm" property="endingTimeHours"/>"/>
									<input type="hidden" id="enMins" name="enMins" value="<bean:write name="generateProcessForm" property="endingTimeMins"/>"/>

									<html:text name="generateProcessForm" property="endingTimeHours" styleClass="Timings" value="00" styleId="endingTimeHours" size="2" maxlength="2"  onfocus="clearField(this)" onblur="checkForEmpty(this)" onkeypress="return isNumberKey(event)"/>							
									:
									<html:text name="generateProcessForm" property="endingTimeMins" styleClass="Timings" value="00" styleId="endingTimeMins" size="2" maxlength="2"  onfocus="clearField(this)" onblur="checkForEmpty(this)" onkeypress="return isNumberKey(event)"/>
									</td>
									<td  width="10%" height="25" class="row-odd">
									<div align="right">&nbsp;<bean:message key="knowledgepro.admission.interview.schedule.appNoFOrm" />:</div>
									</td>
									<td  width="20%" height="25" class="row-even">
									<html:text name="generateProcessForm" property="appNoForm" styleId="appNoForm" size="11" maxlength="11" onkeypress="return isNumberKey(event)"></html:text>
									</td>
									<td  width="10%" height="25" class="row-odd">
									<div align="right">&nbsp;<bean:message key="knowledgepro.admission.interview.schedule.appNoTo" />:</div>
									</td>
									<td  width="30%" height="25" class="row-even">
									<html:text name="generateProcessForm" property="appNoTo" styleId="appNoTo" size="11" maxlength="11" onkeypress="return isNumberKey(event)"></html:text>							
									</td>
								</tr>
							</table>
							</td>
