                    ...
                    <tr>
                      ...
                      <td height="57" valign="top"><table width="100%" height="57" border="0" cellpadding="0" cellspacing="1">
                          <tr class="row-white">
                            ...
                            <td width="236" height="23" class="row-even" align="left"><html:text property="passportNo" size="8" maxlength="10"></html:text></td>
                    ...
                    <tr>
                      ...
                      <td height="91" valign="top"><table width="100%" height="90" border="0" cellpadding="0" cellspacing="1">
                          <tr class="row-white">
                            ...
                            <td width="236" height="20" class="row-even" align="left"><html:text property="tempAddr.addrLine1" size="15" maxlength="100" styleId="tempAddraddress1"></html:text></td>
                            <td width="224" class="row-odd"><div align="right">
                                <div align="right"><bean:message key="admissionForm.studentinfo.addrs2.label"/></div>
                            </div></td>
                            <td width="244" class="row-even" align="left"><html:text property="tempAddr.addrLine2" size="15" maxlength="100" styleId="tempAddraddress2"></html:text></td>
                          </tr>
                          <tr class="row-even">
                    ...
                    <tr>
                      ...
                      <td height="91" valign="top"><table width="100%" height="90" border="0" cellpadding="0" cellspacing="1">
                          <tr class="row-white">
                            ...
                            <td width="236" height="20" class="row-even" align="left"><html:text property="permAddr.addrLine1" size="15" maxlength="100" styleId="permAddraddress1"></html:text></td>
                            <td width="224" class="row-odd"><div align="right"><bean:message key="admissionForm.studentinfo.addrs2.label"/></div></td>
                            <td width="244" class="row-even" align="left"><html:text property="permAddr.addrLine2" size="15" maxlength="100" styleId="permAddraddress2"></html:text></td>
                          </tr>
                          <tr class="row-even">
