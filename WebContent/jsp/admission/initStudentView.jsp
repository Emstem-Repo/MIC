...
<html:hidden property="method" styleId="method" value="getViewSearchedStudents"/>
  ...
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td background="images/Tcenter.gif" class="body" ><strong class="boxheader"> <bean:message key="admissionForm.studentview.main.label"/></strong></td>
              ...
              <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
                <tr >
                  ...
                  <td width="26%" height="25" colspan="2" class="row-even" >					
					<html:text name="studentEditForm" property="regNo" styleClass="TextBox" styleId="regNoID" size="10" maxlength="10"/>
				  </td>
                </tr>
                <tr >
