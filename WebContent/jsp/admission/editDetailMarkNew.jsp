                     ...
                     <tr>
						...
						<logic:notEmpty property="<%=propertyName %>" name="applicationEditForm">
								...
								<logic:equal value="false" property="<%=dynaMandatory %>" name="applicationEditForm">
									<html:text property="<%=propertyName %>" styleId='<%=propertyName %>' name="applicationEditForm" size="25" maxlength="100"></html:text>
								</logic:equal>
							</logic:notEmpty>
                ...
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="45%" height="35"><div align="right">
                        <html:button property="" onclick="submitAdmissionFormNew('submitDetailMarkEdit')" styleClass="formbutton" value="Submit"></html:button>
                    </div></td>
