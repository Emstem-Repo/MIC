...
<html:form action="/admissionFormSubmit" enctype="multipart/form-data" method="POST">
	...
	<c:choose>
	<c:when test="${admissionFormForm.pucApplicationDetailEdit}">
									...
									<nested:select property="applicantDetails.personalData.bloodGroup" styleClass="combo" styleId="bgType">
										...
										<logic:equal value="true" property="displaySecondLanguage" name="admissionFormForm">
										 <tr >
					                      ...
					                      <td height="20" class="row-even" align="left">
				                          <nested:text property="applicantDetails.personalData.secondLanguage" size="15" maxlength="30"></nested:text>
										 </td>
				                        </tr>
										</logic:equal>
										<tr>
										...
										<tr>
											...
											<td height="20" class="row-even" align="left">
											<table width="100%" border="0" cellpadding="0" cellspacing="0">
			                              	  <tr><td><bean:message key="admissionForm.phone.cntcode.label"/></td><td><nested:text property="applicantDetails.personalData.mobileNo2" size="4" maxlength="4"></nested:text></td></tr>
			                                  <tr><td> <bean:message key="admissionForm.mob.no.label"/> </td><td><nested:text property="applicantDetails.personalData.mobileNo1" size="10" maxlength="10"></nested:text></td></tr>
											</table>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="51%" height="45" align="left"><html:button
										...
										onclick="submitModifyCancelButtonForPUC()">
