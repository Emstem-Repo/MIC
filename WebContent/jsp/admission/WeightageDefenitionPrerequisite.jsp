...
<SCRIPT type="text/javascript">
	...
	function calculateTotalValue() {
		...
		for ( var i = 0; i < document.forms[0].elements.length; i++) {
			...
			if ((e.type == 'text')) {
				if (e.name != "totalPrerequisiteWeightage") {
					checkForEmpty(e);
					isValidNumber(e);
		...
		document.getElementById("totalPrerequisiteWeightage").value = totalEducationalWeightValue;
	}
...
<html:form action="/WeightageDefenition" focus="programType">
	<html:hidden property="method" styleId="method"
		value="submitPrerequisiteWeightageDefenition" />
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><span class="Bredcrumbs"><a
						...
						key="knowledgepro.admission.weightagedefenition.prerequisiteweightage" /></a></span></div>
					</td>
				...
				<tr>
					...
					<td height="46" colspan="2" class="heading"><img
						src="images/Weighage_Prerequisite_Tab" border="0" usemap="#Map">
					<map name="Map">
						<area shape="rect" coords="6,4,150,29"
							href="WeightageDefenition.do?method=initWeightageDefenition">
						<area shape="rect" coords="276,6,383,30"
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<div align="center"><bean:message
										key="knowledgepro.admission.prerequisitetype" /></div>
									</td>
								...
								<nested:iterate name="weightageDefenitionForm"
									property="prerequisiteWeightageList" indexId="count">
									<%
								...
								<tr>
									...
									<html:text property="totalPrerequisiteWeightage"
										readonly="true" styleClass="TextBox"
										styleId="totalPrerequisiteWeightage" size="6" maxlength="6" />
									</span></div>
									</td>
								</tr>
							</table>
