...
public class MarksEntryDetails implements Serializable{
	...
	public MarksEntryDetails() {
		super();
	}
	
	public MarksEntryDetails(int id, MarksEntry marksEntry, Subject subject,
			...
			Boolean isTheorySecured, Boolean isPracticalSecured,String originalMarks,Boolean isGracing) {
		super();
		this.id = id;
	...
	public void setOriginalMarks(String originalMarks) {
		this.originalMarks = originalMarks;
	}
