...
public class MarksEntry implements Serializable {
	...
	public MarksEntry(int id, ExamDefinitionBO exam, Student student,
	...
	public Set<MarksEntryDetails> getMarksDetails() {
		return marksDetails;
	}

	public void setMarksDetails(Set<MarksEntryDetails> marksDetails) {
