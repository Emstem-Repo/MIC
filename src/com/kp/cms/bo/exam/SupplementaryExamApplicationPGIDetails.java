...
public class SupplementaryExamApplicationPGIDetails implements Serializable{
	private int id;
	...
	public SupplementaryExamApplicationPGIDetails() {
		super();
	}

	public SupplementaryExamApplicationPGIDetails(int id, String candidateRefNo,
