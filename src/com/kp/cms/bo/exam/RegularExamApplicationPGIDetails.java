...
public class RegularExamApplicationPGIDetails implements Serializable{
	private int id;
	...
	public RegularExamApplicationPGIDetails() {
		super();
	}

	public RegularExamApplicationPGIDetails(int id, String candidateRefNo,
