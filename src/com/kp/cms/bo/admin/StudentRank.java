 ...
 */
public class StudentRank implements java.io.Serializable {
	...
	private String tiePreference;
	
	
	
	public String getTiePreference() {
		return tiePreference;
	}



	public void setTiePreference(String tiePreference) {
		this.tiePreference = tiePreference;
	}
