...
public class District implements java.io.Serializable {
	...
	private Set<PersonalData> personalDatasForGuardianAddressStateId = new HashSet<PersonalData>(0);
	private Set<PersonalData> personalDatasForParentAddressStateId = new HashSet<PersonalData>(0);
	private Set<PersonalData> personalDatasForPermanentAddressStateId = new HashSet<PersonalData>(0);
	private Set<PersonalData> personalDatasForStateId = new HashSet<PersonalData>(0);
	private Set<PersonalData> personalDatasForCurrentAddressStateId = new HashSet<PersonalData>(0);
	
	//private Set<EmpOnlineResume> empOnlineResumes = new HashSet<EmpOnlineResume>(0);
	//private String bankStateId;
	//private Set<Recommendor> recommendors = new HashSet<Recommendor>(0);
	//private Set<City> cities = new HashSet<City>(0);
	
	//private Set<EdnQualification> ednQualifications = new HashSet<EdnQualification>(0);
	//private Set<Address> addresses = new HashSet<Address>(0);
	//private Set<HlHostel> hlHostels = new HashSet<HlHostel>(0);
	
	//private Set<InvVendor> invVendors = new HashSet<InvVendor>(0);
	//private Set<Employee> employeesForPermanentAddressStateId = new HashSet<Employee>(0);
	//private Set<Employee> employeesForCommunicationAddressStateId = new HashSet<Employee>(0);
	...
	/*public District(int id, State state, String name, String createdBy,
