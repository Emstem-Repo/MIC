...
public class CandidatePGIDetailsExamRegular implements Serializable{
	...
	public CandidatePGIDetailsExamRegular(int id, String candidateRefNo,
			...
			ExamDefinitionBO exam, Student student) {
		super();
		this.id = id;
