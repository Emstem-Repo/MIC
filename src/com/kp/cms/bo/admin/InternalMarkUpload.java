...
public class InternalMarkUpload implements java.io.Serializable{
	 private int id;
	 ...
	 public InternalMarkUpload(){
		 
	 }

	public InternalMarkUpload(int id, String regNo, String classes, String testIdent,
			String mrkSub1, String mrkSub2, String mrkSub3, String mrkSub4,
			String mrkSub5, String mrkSub6, String mrkSub7, String mrkSub8,
			String mrkSub9, String mrkSub10, String mrkLang, String userCode,String academicYear) {
		super();
		this.id = id;
		this.regNo = regNo;
