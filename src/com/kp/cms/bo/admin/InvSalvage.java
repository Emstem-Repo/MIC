...
/**
 * InvSalvage generated by hbm2java
 */
public class InvSalvage implements java.io.Serializable {
	...
	public InvSalvage(int id) {
		this.id = id;
	}

	public InvSalvage(int id, InvLocation invLocation, String remarks,
