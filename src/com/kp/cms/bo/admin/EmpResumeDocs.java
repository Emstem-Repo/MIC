...
/**
 * EmpResumeDocs generated by hbm2java
 */
public class EmpResumeDocs implements java.io.Serializable {
	...
	public EmpResumeDocs() {
	}

	public EmpResumeDocs(int id) {
		this.id = id;
	}

	public EmpResumeDocs(int id, EmpOnlineResume empOnlineResume,
			byte[] document, String createdBy, Date createdDate,
