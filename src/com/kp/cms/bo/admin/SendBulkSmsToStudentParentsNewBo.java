...
public class SendBulkSmsToStudentParentsNewBo implements Serializable {
	private int id;
	...
	public SendBulkSmsToStudentParentsNewBo() {
		super();
	...
	public SendBulkSmsToStudentParentsNewBo(int id, String destinationNumber,
