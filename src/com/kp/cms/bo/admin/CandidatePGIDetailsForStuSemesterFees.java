...
public class CandidatePGIDetailsForStuSemesterFees implements Serializable {
	...
	public CandidatePGIDetailsForStuSemesterFees() {
		super();
	...
	public CandidatePGIDetailsForStuSemesterFees(int id, String candidateRefNo,
			...
			String unmappedStatus, String mode, BigDecimal additionalCharges,
			 String paymentEmail,Student student) {
		super();
		this.id = id;
