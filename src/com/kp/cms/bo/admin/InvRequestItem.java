...
/**
 * InvRequestItem generated by hbm2java
 */
public class InvRequestItem implements java.io.Serializable {
	...
	public InvRequestItem() {
	}

	public InvRequestItem(int id) {
		this.id = id;
	}

	public InvRequestItem(int id, InvRequest invRequest, InvItem invItem,
			BigDecimal quantity, String createdBy, Date createdDate,
