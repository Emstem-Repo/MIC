...
/**
 * Servlet implementation class PGIResponseServletRevaluationSupply
 */
public class PGIResponseServletRevaluationSupply extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final Log log = LogFactory.getLog(PGIResponseServletRevaluationSupply.class);  
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher=request.getRequestDispatcher("./jsp/pgiRepsonseReceiverRevaluationSupply.jsp");
