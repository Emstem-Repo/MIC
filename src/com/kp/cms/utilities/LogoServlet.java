...
public class LogoServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session!=null){
			...
			if(session.getAttribute("LogoBytes")!=null && count==1)
				photobytes=(byte[])session.getAttribute("LogoBytes");
			if(session.getAttribute("LogoBytes1")!=null && count==2)
				photobytes=(byte[])session.getAttribute("LogoBytes1");
