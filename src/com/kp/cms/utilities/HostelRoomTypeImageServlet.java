...
public class HostelRoomTypeImageServlet extends HttpServlet {
     ...
     */
    public HostelRoomTypeImageServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session!=null){
			int reqroomTypeId=Integer.parseInt(request.getParameter("reqroomTypeId"));			
			List<RoomTypeImageTO> imageList = (List<RoomTypeImageTO>) session.getAttribute("imageList_"+reqroomTypeId);		
