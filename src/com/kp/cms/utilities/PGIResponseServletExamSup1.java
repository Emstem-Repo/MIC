...
/**
 * Servlet implementation class PGIResponseServletExamSup1
 */
public class PGIResponseServletExamSup1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher=request.getRequestDispatcher("./jsp/pgiRepsonseReceiverExamSupply1.jsp");
