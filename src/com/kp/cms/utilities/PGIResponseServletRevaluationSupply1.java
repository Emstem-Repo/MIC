...
/**
 * Servlet implementation class PGIResponseServletRevaluationSupply1
 */
public class PGIResponseServletRevaluationSupply1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher=request.getRequestDispatcher("./jsp/pgiRepsonseReceiverRevaluationSupply1.jsp");
