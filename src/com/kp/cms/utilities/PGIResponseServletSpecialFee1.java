...
/**
 * Servlet implementation class PGIResponseServletSpecialFee1
 */
public class PGIResponseServletSpecialFee1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final Log log = LogFactory.getLog(PGIResponseServletSpecialFee1.class);     
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher=request.getRequestDispatcher("./jsp/pgiRepsonseReceiverSpecialFee1.jsp");
