...
/**
 * Servlet implementation class RegExamAppPGIResponseServlet
 */
public class SupplExamAppPGIResponseServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final Log log = LogFactory.getLog(SupplExamAppPGIResponseServlet.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("In RegExamAppPGIResponseServlet REQUEST");
		...
		RequestDispatcher dispatcher=request.getRequestDispatcher("./jsp/supplExamAppPgiRepsonseReceiver.jsp");
