...
/**
 * Servlet implementation class RegExamAppPGIResponseServlet1
 */
public class SupplExamAppPGIResponseServlet1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final Log log = LogFactory.getLog(SupplExamAppPGIResponseServlet1.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("In RegExamAppPGIResponseServlet1 RESPONSE");
		System.out.println("isStudent "+request.getAttribute("isStudent"));
		...
		RequestDispatcher dispatcher=request.getRequestDispatcher("./jsp/supplExamAppPgiRepsonseReceiver1.jsp");
