package com.kp.cms.utilities;
	...
	public class InternalAcademicYearList  extends TagSupport{
		private static final Log log = LogFactory.getLog(InternalAcademicYearList.class);
		...
		public int doStartTag() {
				/*InputStream propStream=InternalAcademicYearList.class.getResourceAsStream("/resources/application.properties");
