...
/**
 * Servlet implementation class PGIResponseServletExamReg
 */
public class PGIResponseServletExamReg extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher=request.getRequestDispatcher("./jsp/pgiRepsonseReceiverExamReg.jsp");
