 ...
 */
public class FeeApplicableHandler {
		private static FeeApplicableHandler feeApplicableHandler= null;
		public static FeeApplicableHandler getInstance() {
		      if(feeApplicableHandler == null) {
		    	  feeApplicableHandler = new FeeApplicableHandler();
