...
public class CashCollectionNewAction extends BaseDispatchAction{
...
//		ActionErrors errors = new ActionErrors();
		...
		try
		{
			...
			else
			{
				...
				return mapping.findForward(CMSConstants.DISPLAY_CASH_COLLECTION_NEW);	
			}
	...
	/**
	 * getting the list of cashCollectionTo to display inthe input jsp
...
//				 		errors.add(CMSConstants.ERRORS, new ActionError(CMSConstants.FEE_BILLNO_NOTPRESENT));
	...
	private ActionErrors validateDate(
		...
		if(!isValidDateFormat){
			...
			String currentDate = CommonUtil.getTodayDate();
			if(!(currentDate.equalsIgnoreCase(paidDate))){
				errors.add(CMSConstants.ERROR, new ActionError("knowledgepro.pettycash.paidDate.previous"));
			}
