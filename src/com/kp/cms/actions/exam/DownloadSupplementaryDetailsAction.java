...
import com.kp.cms.constants.CMSConstants;
	...
	public class DownloadSupplementaryDetailsAction extends DownloadAction{
		private static final Log log = LogFactory.getLog(DownloadSupplementaryDetailsAction.class);
		@Override
		protected StreamInfo getStreamInfo(ActionMapping mapping, ActionForm form,
				...
				if(session!= null){
					myFileBytes = (byte[])session.getAttribute(CMSConstants.EXCEL_BYTES);
				}
			
				String fileName = "SupplementaryDetails.xls";
