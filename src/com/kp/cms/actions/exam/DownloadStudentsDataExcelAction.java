...
import com.kp.cms.constants.CMSConstants;
	...
	public class DownloadStudentsDataExcelAction  extends DownloadAction{
		private static final Log log = LogFactory.getLog(DownloadStudentsDataExcelAction.class);
		...
		protected StreamInfo getStreamInfo(ActionMapping mapping, ActionForm form,
			...
			if(fileNames.equalsIgnoreCase("AddlBioDataExcel"))
				fileName = "AddlBioDataDetails.xls";
			if(fileNames.equalsIgnoreCase("PreviousClassesExcel"))
				fileName = "PreviousClasses.xls";
			if(fileNames.equalsIgnoreCase("ExamSupplementaryImprovementExcel"))
				fileName = "ExamSupplementaryImprovement.xls";
			if(fileNames.equalsIgnoreCase("ExamInternalMarkSupplementaryExcel"))
				fileName = "ExamInternalMarkSupplementaryExcel.xls";
