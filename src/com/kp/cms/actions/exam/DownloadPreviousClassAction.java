...
public class DownloadPreviousClassAction extends DownloadAction{
private static final Log log = LogFactory.getLog(DownloadPreviousClassAction.class);
	...
	protected StreamInfo getStreamInfo(ActionMapping mapping, ActionForm form,
		...
		log.info("Entered DownloadPreviousClassAction");
...
//				Integer.valueOf(documentDownloadForm.getDocumentId()));
		...
		String fileName = "uploadPreClass.xls";
		...
		try {
			...
			log.info("DownloadPreviousClassAction IOException, " +e);
		} catch (Exception e){
			log.info("DownloadPreviousClassAction Exception, " +e);
		}
		log.info("Exit DownloadPreviousClassAction");
