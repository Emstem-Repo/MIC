 ...
 *
 */
public class DownloadSmartCardDataProcessAction extends DownloadAction {
	
	ActionErrors errors = new ActionErrors();
	ActionMessages messages = new ActionMessages();
	private static final Log log = LogFactory.getLog(DownloadSmartCardDataProcessAction.class);
	...
	protected StreamInfo getStreamInfo(ActionMapping mapping, ActionForm form,
		...
		ScLostCorrectionProcessForm objForm = (ScLostCorrectionProcessForm) form;
