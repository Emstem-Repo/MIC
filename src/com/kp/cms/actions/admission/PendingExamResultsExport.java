...
public class PendingExamResultsExport extends DownloadAction {
	private static final Log log = LogFactory.getLog(PendingExamResultsExport.class);
	@Override
	protected StreamInfo getStreamInfo(ActionMapping mapping, ActionForm form,
		...
		String fileName = "pendingExamResults.xls";
