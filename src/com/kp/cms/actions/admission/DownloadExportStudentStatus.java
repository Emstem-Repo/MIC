...
public class DownloadExportStudentStatus extends DownloadAction {
	private static final Log log = LogFactory.getLog(DownloadExportStudentStatus.class);
	@Override
	protected StreamInfo getStreamInfo(ActionMapping mapping, ActionForm form,
		...
		String fileName = "StudentInterviewStatus.csv";
