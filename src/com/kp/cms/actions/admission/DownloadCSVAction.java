...
public class DownloadCSVAction  extends DownloadAction {
	private static final Log log = LogFactory.getLog(DownloadCSVAction.class);
...
//				Integer.valueOf(documentDownloadForm.getDocumentId()));
		...
		String fileName = "admissionReport.csv";
