...
public class DownloadExcelAction  extends DownloadAction {
	...
	protected StreamInfo getStreamInfo(ActionMapping mapping, ActionForm form,
		...
		log.info("Entered DownloadExcelAction");
...
//				Integer.valueOf(documentDownloadForm.getDocumentId()));
		...
		try {
			...
			log.info("DownloadExcelAction IOException, " +e);
		} catch (Exception e){
			log.info("DownloadExcelAction Exception, " +e);
		}
