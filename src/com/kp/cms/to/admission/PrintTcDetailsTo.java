...
public class PrintTcDetailsTo implements java.io.Serializable,Comparable<PrintTcDetailsTo>
{
	...
	public String getSubjectPassedOptional() {
		return subjectPassedOptional;
	}
	public void setSubjectPassedOptional(String subjectPassedOptional) {
		this.subjectPassedOptional = subjectPassedOptional;
	}
