...
public class PcAccountHeadsTO implements Serializable {
	...
	private Integer pcBankAccNumber;
	...
	public Integer getPcBankAccNumber() {
		return pcBankAccNumber;
	}
	public void setPcBankAccNumber(Integer pcBankAccNumber) {
