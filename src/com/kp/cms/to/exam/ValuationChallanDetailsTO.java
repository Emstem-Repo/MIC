...
public class ValuationChallanDetailsTO {
	...
	private int valuatorsTypeCount;
	...
	public int getValuatorsTypeCount() {
		return valuatorsTypeCount;
	}
	public void setValuatorsTypeCount(int valuatorsTypeCount) {
		this.valuatorsTypeCount = valuatorsTypeCount;
	}
