...
public class ExamSubjectRuleSettingsPracticalInternalTO implements Serializable
{
	...
	public ExamSubjectRuleSettingsPracticalInternalTO() {
		super();
	}
	public ExamSubjectRuleSettingsPracticalInternalTO(String assignmentChecked,
