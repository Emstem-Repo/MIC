...
public class ExamGradeDefinitionTO implements Serializable {
	...
	public ExamGradeDefinitionTO() {
		super();
	}

	public ExamGradeDefinitionTO(int id, String course, String startPercentage,
