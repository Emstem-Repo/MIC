...
public class NewInterviewCommentsDetailsTo {
private int id;
private int newInterviewcommentsId;
private int interviewRatingFactorId;
...
public int getNewInterviewcommentsId() {
	return newInterviewcommentsId;
}
public void setNewInterviewcommentsId(int newInterviewcommentsId) {
	this.newInterviewcommentsId = newInterviewcommentsId;
}
public int getInterviewRatingFactorId() {
	return interviewRatingFactorId;
}
public void setInterviewRatingFactorId(int interviewRatingFactorId) {
	this.interviewRatingFactorId = interviewRatingFactorId;
}
