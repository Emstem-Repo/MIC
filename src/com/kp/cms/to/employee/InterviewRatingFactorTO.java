...
public class InterviewRatingFactorTO {
	private int id;
	...
	private int interviewCommentsDetailsId;
	private int avg;
	...
	public int getInterviewCommentsDetailsId() {
		return interviewCommentsDetailsId;
	}
	public void setInterviewCommentsDetailsId(int interviewCommentsDetailsId) {
		this.interviewCommentsDetailsId = interviewCommentsDetailsId;
	}
	public int getAvg() {
		return avg;
	}
