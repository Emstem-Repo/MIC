...
public class AdmMeritTO implements Serializable{
	private int id;
    private String name;
	...
	public String getChristee() {
		return christee;
	}
	public void setChristee(String christee) {
	...
	public String getSevnyrKar() {
		return sevnyrKar;
	}
	public void setSevnyrKar(String sevnyrKar) {
