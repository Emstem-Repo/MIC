...
public class AdmBioDataCJCTo {
	...
	public String getSelfFinan() {
		return selfFinan;
	}
	public void setSelfFinan(String selfFinan) {
	...
	public String getIndSpCdt() {
		return indSpCdt;
	}
	public void setIndSpCdt(String indSpCdt) {
		this.indSpCdt = indSpCdt;
	}
	public String getsEvnyKar() {
		return sEvnyKar;
	}
	public void setsEvnyKar(String sEvnyKar) {
	...
	public void setAdmTcDt1(String admTcDt1) {
		this.admTcDt1 = admTcDt1;
	}
	public String getAdmTcDt1() {
		return admTcDt1;
	}
