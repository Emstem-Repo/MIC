...
public class ExamGradeDefinitionForm extends BaseActionForm {
	private int id = 0;
	...
	private List<ExamGradeDefinitionTO> listGradeDefinition;
	...
	public List<ExamGradeDefinitionTO> getListGradeDefinition() {
		return listGradeDefinition;
	}

	public void setListGradeDefinition(
			List<ExamGradeDefinitionTO> listGradeDefinition) {
