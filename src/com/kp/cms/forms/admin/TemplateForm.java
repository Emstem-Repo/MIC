...
public class TemplateForm extends BaseActionForm {
	...
	public List<GroupTemplateTO> templateList;
	/**
	 * @return the desc
	 */
	...
	public List<GroupTemplateTO> getTemplateList() {
		return templateList;
	}

	public void setTemplateList(List<GroupTemplateTO> templateList) {
