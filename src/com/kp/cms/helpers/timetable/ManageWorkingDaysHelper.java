...
public class ManageWorkingDaysHelper {
	private static Log log = LogFactory.getLog(ManageWorkingDaysHelper.class);
	public static ManageWorkingDaysHelper manageWorkingDays = null;

	public static ManageWorkingDaysHelper getInstance() {
		if (manageWorkingDays == null) {
			return new ManageWorkingDaysHelper();
		}
		return manageWorkingDays;
	}

	private ManageWorkingDaysHelper() {
